...
{: GLFullscreenViewer<p> 
   ...
   Note: Eng: As Lazarus has a problem of minimizing - the normalization window. 
         ...
         Ru(CP1251)
          ...
          Модуль еще не закончен! В линуксе есть проблемы перехвата мыши 
...
begin
   ...
   //Р’РЅРёРјР°РЅРёРµ!!!РќРµ РїРµСЂРµРјРµС‰Р°С‚СЊ РІРІРµСЂС…, РІРѕР·РјРѕР¶РЅРѕ РїРµСЂРµРјРµРЅРЅРѕРµ СЃСЂР°Р±Р°С‚С‹РІР°РЅРёРµ
   {$ifdef Linux}
