...
begin
  TransposeMatrix(m);
  Result[0] := m.Coord[0].Coord[0];
  Result[1] := m.Coord[0].Coord[1];
  Result[2] := m.Coord[0].Coord[2];
  Result[4] := m.Coord[1].Coord[0];
  Result[5] := m.Coord[1].Coord[1];
  Result[6] := m.Coord[1].Coord[2];
  Result[8] := m.Coord[2].Coord[0];
  Result[9] := m.Coord[2].Coord[1];
  Result[10] := m.Coord[2].Coord[2];
end;
...
begin
  ...
  d := (Direction.Coord[0] * Pos.Coord[0] +
        Direction.Coord[1] * Pos.Coord[1] +
        Direction.Coord[2] * Pos.Coord[2]);
