...
const
  CUDARTDLLNAMES: array [0 .. 6] of string = ('cudart32_32_16', 'cudart32_31_4',
...
var
  ...
  cudaBindTexture: function(var offset: size_t; const texref: PTextureReference;
    var devPtr: Pointer; var desc: TCudaChannelFormatDesc; size: size_t)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaBindTexture2D: function(var offset: size_t;
    const texref: PTextureReference; const devPtr: Pointer;
    var desc: TCudaChannelFormatDesc; width, height, pitch: size_t)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaGetTextureAlignmentOffset: function(offset: size_t;
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMalloc: function(var devPtr; size: size_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMallocHost: function(var ptr: Pointer; size: size_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMallocPitch: function(var devPtr; var pitch: size_t; width: size_t;
    height: size_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMallocArray: function(var aarray: Pointer;
    var desc: TCudaChannelFormatDesc; width: size_t; height: size_t)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaHostAlloc: function(var pHost: Pointer; bytes: size_t; flags: Cardinal)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyToArray: function(var dst: PcudaArray; wOffset: size_t;
    hOffset: size_t; var src; count: size_t; kind: TcudaMemcpyKind)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyArrayToArray: function(dst: PcudaArray; wOffsetDst: size_t;
    hOffsetDst: size_t; const src: PcudaArray; wOffsetSrc: size_t;
    hOffsetSrc: size_t; count: size_t;
    const kind: TcudaMemcpyKind = cudaMemcpyDeviceToDevice): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2D: function(var dst; dpitch: size_t; var src; spitch: size_t;
    width: size_t; height: size_t; kind: TcudaMemcpyKind): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2DToArray: function(dst: PcudaArray; wOffset: size_t;
    hOffset: size_t; var src; spitch: size_t; width: size_t; height: size_t;
    kind: TcudaMemcpyKind): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2DFromArray: function(var dst; dpitch: size_t; src: PcudaArray;
    wOffset: size_t; hOffset: size_t; width: size_t; height: size_t;
    kind: TcudaMemcpyKind): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyToSymbol: function(symbol: PAnsiChar; var src; count: size_t;
    const offset: size_t = 0;
    const kind: TcudaMemcpyKind = cudaMemcpyHostToDevice): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyFromSymbol: function(var dst; symbol: PAnsiChar; count: size_t;
    const offset: size_t = 0;
...
{$ENDIF}
  ...
  cudaMemcpyAsync: function(var dst; const src; count: size_t;
    kind: TcudaMemcpyKind; stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyToArrayAsync: function(dst: PcudaArray; wOffset: size_t;
    hOffset: size_t; const src; count: size_t; kind: TcudaMemcpyKind;
    stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyFromArrayAsync: function(var dst; const src: PcudaArray;
    wOffset: size_t; hOffset: size_t; count: size_t; kind: TcudaMemcpyKind;
    stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2DAsync: function(var dst; dpitch: size_t; const src;
    spitch: size_t; width: size_t; height: size_t; kind: TcudaMemcpyKind;
    stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2DToArrayAsync: function(dst: PcudaArray; wOffset: size_t;
    hOffset: size_t; const src; spitch: size_t; width: size_t; height: size_t;
    kind: TcudaMemcpyKind; stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpy2DFromArrayAsync: function(var dst; dpitch: size_t;
    const src: PcudaArray; wOffset: size_t; hOffset: size_t; width: size_t;
    height: size_t; kind: TcudaMemcpyKind; stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemcpyToSymbolAsync: function(const symbol: PAnsiChar; const src;
    count: size_t; offset: size_t; kind: TcudaMemcpyKind; stream: cudaStream_t)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaMemset2D: function(var devPtr; pitch: size_t; value: Integer;
    width: size_t; height: size_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  /// *****************************************************************************
...
{$ENDIF}
  ...
  cudaConfigureCall: function(gridDim, blockDim: TDim3; sharedMem: size_t;
    stream: cudaStream_t): cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaSetupArgument: function(const arg: Pointer; size: size_t; offset: size_t)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
...
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
  cudaThreadGetLimit: function(var value: size_t; limit: TcudaLimit)
    : cudaError_t;
{$IFDEF CUDA_STDCALL}stdcall;
{$ENDIF}{$IFDEF CUDA_CDECL}cdecl;
{$ENDIF}
