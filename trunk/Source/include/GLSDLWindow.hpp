...
// (DO NOT EDIT: machine generated header) 'GLSDLWindow.pas' rev: 24.00 (Win32)

#ifndef GlsdlwindowHPP
#define GlsdlwindowHPP
...
#include <GLSDL.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Glsdlwindow
{
//-- type declarations -------------------------------------------------------
...
typedef void __fastcall (__closure *TSDLEvent)(System::TObject* sender, const Glsdl::TSDL_Event &event);
...
private:
	...
	Glsdl::TSDL_Surface *FSDLSurface;
...
public:
	...
	__property Glsdl::PSDL_Surface Surface = {read=FSDLSurface};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSDLWINDOW)
using namespace Glsdlwindow;
#endif
#pragma pack(pop)
#pragma option pop
