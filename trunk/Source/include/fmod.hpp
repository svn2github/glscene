...
// (DO NOT EDIT: machine generated header) 'fmod.pas' rev: 24.00 (Win32)
...
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE bool __fastcall FMOD_Load(System::WideChar * LibName);
...
extern PACKAGE char * __stdcall FSOUND_GetDriverName(int Id);
...
extern PACKAGE void * __stdcall FSOUND_Sample_Load(int Index, const char * NameOrData, unsigned Mode, int Offset, int Length);
...
extern PACKAGE char * __stdcall FSOUND_Sample_GetName(void * Sptr);
...
extern PACKAGE System::ByteBool __stdcall FSOUND_Sample_GetDefaultsEx(void * Sptr, int &DefFreq, int &DefVol, int &DefPan, int &DefPri, int &VarFreq, int &VarVol, int &VarPan);
...
extern PACKAGE void * __stdcall FSOUND_Stream_Open(const char * name_or_data, unsigned Mode, int Offset, int Length);
...
extern PACKAGE void * __stdcall FSOUND_Stream_AddSyncPoint(void * Stream, unsigned PCMOffset, char * Name);
...
extern PACKAGE char * __stdcall FSOUND_Stream_GetSyncPointInfo(void * Point, unsigned &PCMOffset);
...
extern PACKAGE System::ByteBool __stdcall FSOUND_Stream_GetTagField(void * Stream, int Num, Fmodtypes::TFSoundTagFieldType &TagType, char * &Name, void * &Value, int &Length);
extern PACKAGE System::ByteBool __stdcall FSOUND_Stream_FindTagField(void * Stream, Fmodtypes::TFSoundTagFieldType TagType, char * Name, void * &Value, int &Length);
extern PACKAGE System::ByteBool __stdcall FSOUND_Stream_Net_SetProxy(char * Proxy);
extern PACKAGE char * __stdcall FSOUND_Stream_Net_GetLastServerStatus(void);
...
extern PACKAGE System::ByteBool __stdcall FSOUND_Reverb_SetProperties(Fmodtypes::TFSoundReverbProperties &Prop);
...
extern PACKAGE char * __stdcall FSOUND_Record_GetDriverName(int Id);
...
extern PACKAGE void * __stdcall FMUSIC_LoadSong(const char * Name);
...
extern PACKAGE char * __stdcall FMUSIC_GetName(void * Module);
