...
// (DO NOT EDIT: machine generated header) 'GLScreenSaver.pas' rev: 24.00 (Win32)
...
public:
	...
	__fastcall virtual ~TGLScreenSaver(void);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSCREENSAVER)
using namespace Glscreensaver;
#endif
#pragma pack(pop)
#pragma option pop
