...
private:
	...
	Glcoordinates::TGLCoordinates3* FAppliedOmega;
	Glcoordinates::TGLCoordinates3* FAppliedVelocity;
...
public:
	...
	Vectortypes::TVector4f __fastcall GetOmega(void);
	void __fastcall SetOmega(const Vectortypes::TVector4f &Omega);
	Vectortypes::TVector4f __fastcall GetVelocity(void);
	void __fastcall SetVelocity(const Vectortypes::TVector4f &Velocity);
...
public:
	__property Vectortypes::TVector4f Velocity = {read=GetVelocity, write=SetVelocity};
	__property Vectortypes::TVector4f Omega = {read=GetOmega, write=SetOmega};
...
__published:
	...
	__property Glcoordinates::TGLCoordinates3* AppliedOmega = {read=FAppliedOmega};
	__property Glcoordinates::TGLCoordinates3* AppliedVelocity = {read=FAppliedVelocity};
