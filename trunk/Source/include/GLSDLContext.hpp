...
#include <GLSDLWindow.hpp>	// Pascal unit
...
private:
	...
	Glsdlwindow::TSDLEvent FOnSDLEvent;
...
protected:
	...
	void __fastcall DoOnSDLEvent(System::TObject* sender, const Glsdl::TSDL_Event &event);
...
__published:
	...
	__property Glsdlwindow::TSDLEvent OnSDLEvent = {read=FOnSDLEvent, write=FOnSDLEvent};
...
private:
	Glsdlwindow::TSDLWindow* FSDLWin;
...
public:
	...
	__property Glsdlwindow::TSDLWindow* SDLWindow = {read=FSDLWin};
};
