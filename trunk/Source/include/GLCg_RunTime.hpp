...
// (DO NOT EDIT: machine generated header) 'GLCg_RunTime.pas' rev: 24.00 (Win32)

#ifndef Glcg_runtimeHPP
#define Glcg_runtimeHPP
...
#include <CGPostTransformationShader.hpp>	// Pascal unit
...
namespace Glcg_runtime
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Glcg_runtime */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLCG_RUNTIME)
using namespace Glcg_runtime;
#endif
#pragma pack(pop)
#pragma option pop
