...
// (DO NOT EDIT: machine generated header) 'GLSVfw.pas' rev: 24.00 (Win32)
...
typedef BOOL __pascal (*TAVISAVECALLBACK)(int i);
...
public:
	...
	virtual HRESULT __stdcall EndExtraction(void) = 0 ;
...
extern PACKAGE unsigned __fastcall MKFOURCC(char ch0, char ch1, char ch2, char ch3);
extern PACKAGE unsigned __fastcall mmioFOURCC(char ch0, char ch1, char ch2, char ch3);
extern PACKAGE System::Word __fastcall aviTWOCC(char ch0, char ch1);
extern PACKAGE BOOL __fastcall ICQueryAbout(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICAbout(NativeUInt hic, HWND hwnd);
extern PACKAGE BOOL __fastcall ICQueryConfigure(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICConfigure(NativeUInt hic, HWND hwnd);
extern PACKAGE unsigned __fastcall ICGetState(NativeUInt hic, void * pv, unsigned cb);
extern PACKAGE unsigned __fastcall ICSetState(NativeUInt hic, void * pv, unsigned cb);
extern PACKAGE unsigned __fastcall ICGetStateSize(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICGetDefaultQuality(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICGetDefaultKeyFrameRate(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawWindow(NativeUInt hic, System::Types::PRect prc);
extern PACKAGE unsigned __fastcall ICCompressBegin(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICCompressQuery(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICCompressGetFormat(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICCompressGetFormatSize(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbi);
extern PACKAGE unsigned __fastcall ICCompressGetSize(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICCompressEnd(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDecompressBegin(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICDecompressQuery(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICDecompressGetFormat(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICDecompressGetFormatSize(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbi);
extern PACKAGE unsigned __fastcall ICDecompressGetPalette(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput, Winapi::Windows::PBitmapInfoHeader lpbiOutput);
extern PACKAGE unsigned __fastcall ICDecompressSetPalette(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiPalette);
extern PACKAGE unsigned __fastcall ICDecompressEnd(NativeUInt hic);
extern PACKAGE unsigned __stdcall ICDecompressEx(NativeUInt hic, unsigned dwFlags, Winapi::Windows::PBitmapInfoHeader lpbiSrc, void * lpSrc, int xSrc, int ySrc, int dxSrc, int dySrc, Winapi::Windows::PBitmapInfoHeader lpbiDst, void * lpDst, int xDst, int yDst, int dxDst, int dyDst);
extern PACKAGE unsigned __stdcall ICDecompressExBegin(NativeUInt hic, unsigned dwFlags, Winapi::Windows::PBitmapInfoHeader lpbiSrc, void * lpSrc, int xSrc, int ySrc, int dxSrc, int dySrc, Winapi::Windows::PBitmapInfoHeader lpbiDst, void * lpDst, int xDst, int yDst, int dxDst, int dyDst);
extern PACKAGE unsigned __stdcall ICDecompressExQuery(NativeUInt hic, unsigned dwFlags, Winapi::Windows::PBitmapInfoHeader lpbiSrc, void * lpSrc, int xSrc, int ySrc, int dxSrc, int dySrc, Winapi::Windows::PBitmapInfoHeader lpbiDst, void * lpDst, int xDst, int yDst, int dxDst, int dyDst);
extern PACKAGE unsigned __fastcall ICDecompressExEnd(NativeUInt hic);
extern PACKAGE unsigned __stdcall ICDrawSuggestFormat(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiIn, Winapi::Windows::PBitmapInfoHeader lpbiOut, int dxSrc, int dySrc, int dxDst, int dyDst, NativeUInt hicDecomp);
extern PACKAGE unsigned __fastcall ICDrawQuery(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput);
extern PACKAGE unsigned __fastcall ICDrawChangePalette(NativeUInt hic, Winapi::Windows::PBitmapInfoHeader lpbiInput);
extern PACKAGE unsigned __fastcall ICGetBuffersWanted(NativeUInt hic, PDWORD lpdwBuffers);
extern PACKAGE unsigned __fastcall ICDrawEnd(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawStart(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawStartPlay(NativeUInt hic, unsigned lFrom, unsigned lTo);
extern PACKAGE unsigned __fastcall ICDrawStop(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawStopPlay(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawGetTime(NativeUInt hic, PDWORD lplTime);
extern PACKAGE unsigned __fastcall ICDrawSetTime(NativeUInt hic, unsigned lTime);
extern PACKAGE unsigned __fastcall ICDrawRealize(NativeUInt hic, HDC hdc, BOOL fBackground);
extern PACKAGE unsigned __fastcall ICDrawFlush(NativeUInt hic);
extern PACKAGE unsigned __fastcall ICDrawRenderBuffer(NativeUInt hic);
extern PACKAGE unsigned __stdcall ICSetStatusProc(NativeUInt hic, unsigned dwFlags, unsigned lParam, TICStatusProc fpfnStatus);
extern PACKAGE NativeUInt __fastcall ICDecompressOpen(unsigned fccType, unsigned fccHandler, Winapi::Windows::PBitmapInfoHeader lpbiIn, Winapi::Windows::PBitmapInfoHeader lpbiOut);
extern PACKAGE NativeUInt __fastcall ICDrawOpen(unsigned fccType, unsigned fccHandler, Winapi::Windows::PBitmapInfoHeader lpbiIn);
extern PACKAGE BOOL __fastcall DrawDibUpdate(NativeUInt hdd, HDC hdc, int x, int y);
extern PACKAGE System::Byte __fastcall FromHex(System::Byte n);
extern PACKAGE System::Byte __fastcall StreamFromFOURCC(unsigned fcc);
extern PACKAGE System::Word __fastcall TWOCCFromFOURCC(unsigned fcc);
extern PACKAGE System::Byte __fastcall ToHex(System::Byte n);
extern PACKAGE unsigned __fastcall MAKEAVICKID(System::Word tcc, System::Byte stream);
extern PACKAGE int __fastcall AVIStreamSampleToSample(_di_IAVIStream pavi1, _di_IAVIStream pavi2, int l);
extern PACKAGE int __fastcall AVIStreamNextSample(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamPrevSample(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamNearestSample(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamNextKeyFrame(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamPrevKeyFrame(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamNearestKeyFrame(_di_IAVIStream pavi, int l);
extern PACKAGE BOOL __fastcall AVIStreamIsKeyFrame(_di_IAVIStream pavi, int l);
extern PACKAGE int __fastcall AVIStreamPrevSampleTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamNextSampleTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamNearestSampleTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamNextKeyFrameTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamPrevKeyFrameTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamNearestKeyFrameTime(_di_IAVIStream pavi, int t);
extern PACKAGE int __fastcall AVIStreamStartTime(_di_IAVIStream pavi);
extern PACKAGE int __fastcall AVIStreamLengthTime(_di_IAVIStream pavi);
extern PACKAGE int __fastcall AVIStreamEnd(_di_IAVIStream pavi);
extern PACKAGE int __fastcall AVIStreamEndTime(_di_IAVIStream pavi);
extern PACKAGE int __fastcall AVIStreamSampleSize(_di_IAVIStream pavi, int lPos, PLONG plSize);
extern PACKAGE HRESULT __fastcall AVIStreamFormatSize(_di_IAVIStream pavi, int lPos, PLONG plSize);
extern PACKAGE HRESULT __fastcall AVIStreamDataSize(_di_IAVIStream pavi, unsigned fcc, PLONG plSize);
extern PACKAGE unsigned __fastcall MCIWndSM(HWND hWnd, unsigned Msg, NativeUInt wParam, NativeInt lParam);
extern PACKAGE BOOL __fastcall MCIWndCanPlay(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndCanRecord(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndCanSave(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndCanWindow(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndCanEject(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndCanConfig(HWND hwnd);
extern PACKAGE BOOL __fastcall MCIWndPaletteKick(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSave(HWND hwnd, char * szFile);
extern PACKAGE unsigned __fastcall MCIWndSaveDialog(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndNew(HWND hwnd, void * lp);
extern PACKAGE unsigned __fastcall MCIWndRecord(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndOpen(HWND hwnd, char * sz, BOOL f);
extern PACKAGE unsigned __fastcall MCIWndOpenDialog(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndClose(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndPlay(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndStop(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndPause(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndResume(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSeek(HWND hwnd, unsigned lPos);
extern PACKAGE unsigned __fastcall MCIWndEject(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndHome(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndEnd(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetSource(HWND hwnd, System::Types::PRect prc);
extern PACKAGE unsigned __fastcall MCIWndPutSource(HWND hwnd, System::Types::PRect prc);
extern PACKAGE unsigned __fastcall MCIWndGetDest(HWND hwnd, System::Types::PRect prc);
extern PACKAGE unsigned __fastcall MCIWndPutDest(HWND hwnd, System::Types::PRect prc);
extern PACKAGE unsigned __fastcall MCIWndPlayReverse(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndPlayFrom(HWND hwnd, unsigned lPos);
extern PACKAGE unsigned __fastcall MCIWndPlayTo(HWND hwnd, unsigned lPos);
extern PACKAGE unsigned __fastcall MCIWndPlayFromTo(HWND hwnd, unsigned lStart, unsigned lEnd);
extern PACKAGE unsigned __fastcall MCIWndGetDeviceID(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetAlias(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetMode(HWND hwnd, char * lp, unsigned len);
extern PACKAGE unsigned __fastcall MCIWndGetPosition(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetPositionString(HWND hwnd, char * lp, unsigned len);
extern PACKAGE unsigned __fastcall MCIWndGetStart(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetLength(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetEnd(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndStep(HWND hwnd, unsigned n);
extern PACKAGE void __fastcall MCIWndDestroy(HWND hwnd);
extern PACKAGE void __fastcall MCIWndSetZoom(HWND hwnd, unsigned iZoom);
extern PACKAGE unsigned __fastcall MCIWndGetZoom(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSetVolume(HWND hwnd, unsigned iVol);
extern PACKAGE unsigned __fastcall MCIWndGetVolume(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSetSpeed(HWND hwnd, unsigned iSpeed);
extern PACKAGE unsigned __fastcall MCIWndGetSpeed(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSetTimeFormat(HWND hwnd, char * lp);
extern PACKAGE unsigned __fastcall MCIWndGetTimeFormat(HWND hwnd, char * lp, unsigned len);
extern PACKAGE void __fastcall MCIWndValidateMedia(HWND hwnd);
extern PACKAGE void __fastcall MCIWndSetRepeat(HWND hwnd, BOOL f);
extern PACKAGE BOOL __fastcall MCIWndGetRepeat(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndUseFrames(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndUseTime(HWND hwnd);
extern PACKAGE void __fastcall MCIWndSetActiveTimer(HWND hwnd, unsigned active);
extern PACKAGE void __fastcall MCIWndSetInactiveTimer(HWND hwnd, unsigned inactive);
extern PACKAGE void __fastcall MCIWndSetTimers(HWND hwnd, unsigned active, unsigned inactive);
extern PACKAGE unsigned __fastcall MCIWndGetActiveTimer(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndGetInactiveTimer(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndRealize(HWND hwnd, BOOL fBkgnd);
extern PACKAGE unsigned __fastcall MCIWndSendString(HWND hwnd, char * sz);
extern PACKAGE unsigned __fastcall MCIWndReturnString(HWND hwnd, char * lp, unsigned len);
extern PACKAGE unsigned __fastcall MCIWndGetError(HWND hwnd, char * lp, unsigned len);
extern PACKAGE HPALETTE __fastcall MCIWndGetPalette(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndSetPalette(HWND hwnd, HPALETTE hpal);
extern PACKAGE unsigned __fastcall MCIWndGetFileName(HWND hwnd, char * lp, unsigned len);
extern PACKAGE unsigned __fastcall MCIWndGetDevice(HWND hwnd, char * lp, unsigned len);
extern PACKAGE unsigned __fastcall MCIWndGetStyles(HWND hwnd);
extern PACKAGE unsigned __fastcall MCIWndChangeStyles(HWND hwnd, unsigned mask, unsigned value);
extern PACKAGE unsigned __fastcall MCIWndOpenInterface(HWND hwnd, PUnknown pUnk);
extern PACKAGE unsigned __fastcall MCIWndSetOwner(HWND hwnd, HWND hwndP);
extern PACKAGE unsigned __fastcall AVICapSM(HWND hwnd, unsigned m, NativeUInt w, NativeInt l);
extern PACKAGE BOOL __fastcall capSetCallbackOnError(HWND hwnd, TCAPERRORCALLBACKA fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnStatus(HWND hwnd, TCAPSTATUSCALLBACKA fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnYield(HWND hwnd, TCAPYIELDCALLBACK fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnFrame(HWND hwnd, TCAPVIDEOCALLBACK fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnVideoStream(HWND hwnd, TCAPVIDEOCALLBACK fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnWaveStream(HWND hwnd, TCAPWAVECALLBACK fpProc);
extern PACKAGE BOOL __fastcall capSetCallbackOnCapControl(HWND hwnd, TCAPCONTROLCALLBACK fpProc);
extern PACKAGE BOOL __fastcall capSetUserData(HWND hwnd, unsigned lUser);
extern PACKAGE unsigned __fastcall capGetUserData(HWND hwnd);
extern PACKAGE BOOL __fastcall capDriverConnect(HWND hwnd, int i);
extern PACKAGE BOOL __fastcall capDriverDisconnect(HWND hwnd);
extern PACKAGE BOOL __fastcall capDriverGetName(HWND hwnd, char * szName, System::Word wSize);
extern PACKAGE BOOL __fastcall capDriverGetVersion(HWND hwnd, char * szVer, System::Word wSize);
extern PACKAGE BOOL __fastcall capDriverGetCaps(HWND hwnd, PCAPDRIVERCAPS s, System::Word wSize);
extern PACKAGE BOOL __fastcall capFileSetCaptureFile(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capFileGetCaptureFile(HWND hwnd, char * szName, System::Word wSize);
extern PACKAGE BOOL __fastcall capFileAlloc(HWND hwnd, unsigned dwSize);
extern PACKAGE BOOL __fastcall capFileSaveAs(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capFileSetInfoChunk(HWND hwnd, PCAPINFOCHUNK lpInfoChunk);
extern PACKAGE BOOL __fastcall capFileSaveDIB(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capEditCopy(HWND hwnd);
extern PACKAGE BOOL __fastcall capSetAudioFormat(HWND hwnd, Winapi::Mmsystem::PWaveFormatEx s, System::Word wSize);
extern PACKAGE unsigned __fastcall capGetAudioFormat(HWND hwnd, Winapi::Mmsystem::PWaveFormatEx s, System::Word wSize);
extern PACKAGE unsigned __fastcall capGetAudioFormatSize(HWND hwnd);
extern PACKAGE BOOL __fastcall capDlgVideoFormat(HWND hwnd);
extern PACKAGE BOOL __fastcall capDlgVideoSource(HWND hwnd);
extern PACKAGE BOOL __fastcall capDlgVideoDisplay(HWND hwnd);
extern PACKAGE BOOL __fastcall capDlgVideoCompression(HWND hwnd);
extern PACKAGE unsigned __fastcall capGetVideoFormat(HWND hwnd, void * s, System::Word wSize);
extern PACKAGE unsigned __fastcall capGetVideoFormatSize(HWND hwnd);
extern PACKAGE BOOL __fastcall capSetVideoFormat(HWND hwnd, void * s, System::Word wSize);
extern PACKAGE BOOL __fastcall capPreview(HWND hwnd, BOOL f);
extern PACKAGE BOOL __fastcall capPreviewRate(HWND hwnd, System::Word wMS);
extern PACKAGE BOOL __fastcall capOverlay(HWND hwnd, BOOL f);
extern PACKAGE BOOL __fastcall capPreviewScale(HWND hwnd, BOOL f);
extern PACKAGE BOOL __fastcall capGetStatus(HWND hwnd, PCAPSTATUS s, System::Word wSize);
extern PACKAGE BOOL __fastcall capSetScrollPos(HWND hwnd, System::Types::PPoint lpP);
extern PACKAGE BOOL __fastcall capGrabFrame(HWND hwnd);
extern PACKAGE BOOL __fastcall capGrabFrameNoStop(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureSequence(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureSequenceNoFile(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureStop(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureAbort(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureSingleFrameOpen(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureSingleFrameClose(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureSingleFrame(HWND hwnd);
extern PACKAGE BOOL __fastcall capCaptureGetSetup(HWND hwnd, PCAPTUREPARMS s, System::Word wSize);
extern PACKAGE BOOL __fastcall capCaptureSetSetup(HWND hwnd, PCAPTUREPARMS s, System::Word wSize);
extern PACKAGE BOOL __fastcall capSetMCIDeviceName(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capGetMCIDeviceName(HWND hwnd, char * szName, System::Word wSize);
extern PACKAGE BOOL __fastcall capPaletteOpen(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capPaletteSave(HWND hwnd, char * szName);
extern PACKAGE BOOL __fastcall capPalettePaste(HWND hwnd);
extern PACKAGE BOOL __fastcall capPaletteAuto(HWND hwnd, int iFrames, int iColors);
extern PACKAGE BOOL __fastcall capPaletteManual(HWND hwnd, BOOL fGrab, int iColors);
extern "C" unsigned __pascal VideoForWindowsVersion(void);
extern "C" BOOL __stdcall ICInfo(unsigned fccType, unsigned fccHandler, PICINFO lpicinfo);
extern "C" BOOL __stdcall ICInstall(unsigned fccType, unsigned fccHandler, NativeInt lParam, char * szDesc, unsigned wFlags);
extern "C" BOOL __stdcall ICRemove(unsigned fccType, unsigned fccHandler, unsigned wFlags);
...
extern "C" NativeUInt __stdcall ICImageCompress(NativeUInt hic, unsigned uiFlags, Winapi::Windows::PBitmapInfo lpbiIn, void * lpBits, Winapi::Windows::PBitmapInfo lpbiOut, int lQuality, PDWORD plSize);
...
extern "C" BOOL __stdcall ICCompressorChoose(HWND hwnd, unsigned uiFlags, void * pvIn, void * lpData, PCOMPVARS pc, char * lpszTitle);
extern "C" BOOL __stdcall ICSeqCompressFrameStart(PCOMPVARS pc, Winapi::Windows::PBitmapInfo lpbiIn);
extern "C" void __stdcall ICSeqCompressFrameEnd(PCOMPVARS pc);
extern "C" void * __stdcall ICSeqCompressFrame(PCOMPVARS pc, unsigned uiFlags, void * lpBits, PBOOL pfKey, PDWORD plSize);
extern "C" void __stdcall ICCompressorFree(PCOMPVARS pc);
extern "C" NativeUInt __stdcall DrawDibOpen(void);
extern "C" BOOL __stdcall DrawDibClose(NativeUInt hdd);
...
extern "C" BOOL __stdcall DrawDibSetPalette(NativeUInt hdd, HPALETTE hpal);
extern "C" BOOL __stdcall DrawDibChangePalette(NativeUInt hdd, int iStart, int iLen, Winapi::Windows::PPaletteEntry lppe);
extern "C" unsigned __stdcall DrawDibRealize(NativeUInt hdd, HDC hdc, BOOL fBackground);
extern "C" BOOL __stdcall DrawDibStart(NativeUInt hdd, unsigned rate);
extern "C" BOOL __stdcall DrawDibStop(NativeUInt hdd);
extern "C" BOOL __stdcall DrawDibBegin(NativeUInt hdd, HDC hdc, int dxDst, int dyDst, Winapi::Windows::PBitmapInfoHeader lpbi, int dxSrc, int dySrc, unsigned wFlags);
extern "C" BOOL __stdcall DrawDibDraw(NativeUInt hdd, HDC hdc, int xDst, int yDst, int dxDst, int dyDst, Winapi::Windows::PBitmapInfoHeader lpbi, void * lpBits, int xSrc, int ySrc, int dxSrc, int dySrc, unsigned wFlags);
extern "C" BOOL __stdcall DrawDibEnd(NativeUInt hdd);
extern "C" BOOL __stdcall DrawDibTime(NativeUInt hdd, PDRAWDIBTIME lpddtime);
...
extern PACKAGE _di_IGetFrame __stdcall AVIStreamGetFrameOpen(_di_IAVIStream pavi, Winapi::Windows::PBitmapInfoHeader lpbiWanted);
...
extern "C" BOOL __stdcall AVISaveOptions(HWND hwnd, unsigned uiFlags, int nStreams, _di_IAVIStream &ppavi, PAVICOMPRESSOPTIONS &plpOptions);
extern "C" HRESULT __stdcall AVISaveOptionsFree(int nStreams, PAVICOMPRESSOPTIONS &plpOptions);
extern "C" HRESULT __stdcall AVIBuildFilterW(System::WideChar * lpszFilter, int cbFilter, BOOL fSaving);
extern "C" HRESULT __stdcall AVIBuildFilterA(char * lpszFilter, int cbFilter, BOOL fSaving);
extern "C" HRESULT __stdcall AVIBuildFilter(char * lpszFilter, int cbFilter, BOOL fSaving);
...
extern "C" BOOL __cdecl MCIWndRegisterClass(void);
...
extern "C" BOOL __stdcall capGetDriverDescriptionA(unsigned wDriverIndex, char * lpszName, int cbName, char * lpszVer, int cbVer);
...
extern "C" BOOL __stdcall capGetDriverDescriptionW(unsigned wDriverIndex, System::WideChar * lpszName, int cbName, System::WideChar * lpszVer, int cbVer);
...
extern "C" BOOL __stdcall capGetDriverDescription(unsigned wDriverIndex, char * lpszName, int cbName, char * lpszVer, int cbVer);
extern "C" BOOL __stdcall GetOpenFileNamePreviewA(Winapi::Commdlg::POpenFilenameA lpofn);
extern "C" BOOL __stdcall GetSaveFileNamePreviewA(Winapi::Commdlg::POpenFilenameA lpofn);
extern "C" BOOL __stdcall GetOpenFileNamePreviewW(Winapi::Commdlg::POpenFilenameW lpofn);
extern "C" BOOL __stdcall GetSaveFileNamePreviewW(Winapi::Commdlg::POpenFilenameW lpofn);
extern "C" BOOL __stdcall GetOpenFileNamePreview(Winapi::Commdlg::POpenFilenameA lpofn);
extern "C" BOOL __stdcall GetSaveFileNamePreview(Winapi::Commdlg::POpenFilenameA lpofn);
...
#if defined(UNICODE)
#pragma option push -w-inl
inline HRESULT __stdcall AVIBuildFilter(char * lpszFilter, int cbFilter, BOOL fSaving)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline BOOL __stdcall capGetDriverDescription(unsigned wDriverIndex, char * lpszName, int cbName, char * lpszVer, int cbVer)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline BOOL __stdcall GetOpenFileNamePreview(Winapi::Commdlg::POpenFilenameA lpofn)
{
...
#if defined(UNICODE)
#pragma option push -w-inl
inline BOOL __stdcall GetSaveFileNamePreview(Winapi::Commdlg::POpenFilenameA lpofn)
{
