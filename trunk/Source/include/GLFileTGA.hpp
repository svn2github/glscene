...
// (DO NOT EDIT: machine generated header) 'GLFileTGA.pas' rev: 24.00 (Win32)
...
public:
	/* TGLBaseImage.Create */ inline __fastcall virtual TGLTGAImage(void) : Glgraphics::TGLBaseImage() { }
	/* TGLBaseImage.Destroy */ inline __fastcall virtual ~TGLTGAImage(void) { }
