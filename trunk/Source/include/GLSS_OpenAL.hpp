...
// (DO NOT EDIT: machine generated header) 'GLSS_OpenAL.pas' rev: 24.00 (Win32)

#ifndef Glss_openalHPP
#define Glss_openalHPP
...
#include <GLSMOpenAL.hpp>	// Pascal unit
#include <openal.hpp>	// Pascal unit
...
namespace Glss_openal
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Glss_openal */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSS_OPENAL)
using namespace Glss_openal;
#endif
#pragma pack(pop)
#pragma option pop
