...
// (DO NOT EDIT: machine generated header) 'GLS_ODE.pas' rev: 24.00 (Win32)
...
#include <GLODERegister.hpp>	// Pascal unit
#include <GLODECustomColliders.hpp>	// Pascal unit
#include <GLODESkeletonColliders.hpp>	// Pascal unit
#include <ODEImport.hpp>	// Pascal unit
#include <ODEGL.hpp>	// Pascal unit
#include <GLODERagdoll.hpp>	// Pascal unit
...
#include <GLSModuleLoader.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_ODE)
using namespace Gls_ode;
#endif
#pragma pack(pop)
#pragma option pop
