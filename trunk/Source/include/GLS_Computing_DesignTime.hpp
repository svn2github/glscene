...
// (DO NOT EDIT: machine generated header) 'GLS_Computing_DesignTime.pas' rev: 24.00 (Win32)

#ifndef Gls_computing_designtimeHPP
#define Gls_computing_designtimeHPP
...
#include <GLSCUDAEditor.hpp>	// Pascal unit
#include <GLSComputingRegister.hpp>	// Pascal unit
...
namespace Gls_computing_designtime
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Gls_computing_designtime */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_COMPUTING_DESIGNTIME)
using namespace Gls_computing_designtime;
#endif
#pragma pack(pop)
#pragma option pop
...
//-- end unit ----------------------------------------------------------------
#endif	// Gls_computing_designtimeHPP
