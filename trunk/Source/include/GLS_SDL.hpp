...
// (DO NOT EDIT: machine generated header) 'GLS_SDL.pas' rev: 24.00 (Win32)
...
#include <GLSDLContext.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_SDL)
using namespace Gls_sdl;
#endif
#pragma pack(pop)
#pragma option pop
