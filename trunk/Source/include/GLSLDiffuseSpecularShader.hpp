...
class DELPHICLASS TGLCustomGLSLDiffuseSpecularShaderAM;
class PASCALIMPLEMENTATION TGLCustomGLSLDiffuseSpecularShaderAM : public TGLBaseGLSLDiffuseSpecularShaderMT
{
...
public:
	__fastcall virtual TGLCustomGLSLDiffuseSpecularShaderAM(System::Classes::TComponent* AOwner);
	__fastcall virtual ~TGLCustomGLSLDiffuseSpecularShaderAM(void);
...
private:
	...
	void __fastcall SetLightCount(const int Value);
...
public:
	...
	__property int LightCount = {read=FLightCount, write=SetLightCount, default=1};
...
class DELPHICLASS TGLSLDiffuseSpecularShaderAM;
class PASCALIMPLEMENTATION TGLSLDiffuseSpecularShaderAM : public TGLCustomGLSLDiffuseSpecularShaderAM
{
	typedef TGLCustomGLSLDiffuseSpecularShaderAM inherited;
...
public:
	/* TGLCustomGLSLDiffuseSpecularShaderAM.Create */ inline __fastcall virtual TGLSLDiffuseSpecularShaderAM(System::Classes::TComponent* AOwner) : TGLCustomGLSLDiffuseSpecularShaderAM(AOwner) { }
	/* TGLCustomGLSLDiffuseSpecularShaderAM.Destroy */ inline __fastcall virtual ~TGLSLDiffuseSpecularShaderAM(void) { }
...
__published:
	...
	__property SpecularPower = {default=0};
	__property LightPower = {default=0};
	__property LightCount = {default=1};
