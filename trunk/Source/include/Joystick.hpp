...
// (DO NOT EDIT: machine generated header) 'Joystick.pas' rev: 24.00 (Win32)
...
class PASCALIMPLEMENTATION TJoystick : public System::Classes::TComponent
{
...
public:
	__fastcall virtual TJoystick(System::Classes::TComponent* AOwner);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_JOYSTICK)
