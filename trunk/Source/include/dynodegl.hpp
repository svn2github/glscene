...
// (DO NOT EDIT: machine generated header) 'dynodegl.pas' rev: 24.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DYNODEGL)
using namespace Dynodegl;
#endif
#pragma pack(pop)
#pragma option pop
