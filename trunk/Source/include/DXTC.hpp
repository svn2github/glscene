...
// (DO NOT EDIT: machine generated header) 'DXTC.pas' rev: 24.00 (Win32)
...
extern PACKAGE System::StaticArray<TGLImageDataFormat, 4> cImageDataFormat8bits;
extern PACKAGE System::StaticArray<TGLImageDataFormat, 5> cImageDataFormat16bits;
extern PACKAGE System::StaticArray<TGLImageDataFormat, 1> cImageDataFormat24bits;
extern PACKAGE System::StaticArray<TGLImageDataFormat, 7> cImageDataFormat32bits;
extern PACKAGE void __fastcall DecodeDXT1toBitmap32(System::Sysutils::PByteArray encData, System::Sysutils::PByteArray decData, int w, int h, bool &trans);
extern PACKAGE void __fastcall DecodeDXT3toBitmap32(System::Sysutils::PByteArray encData, System::Sysutils::PByteArray decData, int w, int h);
extern PACKAGE void __fastcall DecodeDXT5toBitmap32(System::Sysutils::PByteArray encData, System::Sysutils::PByteArray decData, int w, int h);
extern PACKAGE void __fastcall flip_blocks_dxtc1(System::PByte data, int numBlocks);
extern PACKAGE void __fastcall flip_blocks_dxtc3(System::PByte data, int numBlocks);
extern PACKAGE void __fastcall flip_dxt5_alpha(PDXT5AlphaBlock block);
extern PACKAGE void __fastcall flip_blocks_dxtc5(System::PByte data, int numBlocks);
extern PACKAGE bool __fastcall DDSHeaderToGLEnum(const TDDSHeader &DX9header, const TDDS_HEADER_DXT10 &DX11header, const bool useDX11, /* out */ Gltextureformat::TGLInternalFormat &iFormat, /* out */ unsigned &colorFormat, /* out */ unsigned &dataType, /* out */ int &bpe);
extern PACKAGE bool __fastcall GLEnumToDDSHeader(TDDSHeader &DX9header, TDDS_HEADER_DXT10 &DX11header, const bool useDX11, const Gltextureformat::TGLInternalFormat iFormat, const unsigned colorFormat, const unsigned dataType, const int bpe);
extern PACKAGE bool __fastcall FindDDSCompatibleDataFormat(const Gltextureformat::TGLInternalFormat iFormat, /* out */ unsigned &colorFormat, /* out */ unsigned &dataType);
}	/* namespace Dxtc */
