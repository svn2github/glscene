...
// (DO NOT EDIT: machine generated header) 'GLCg_DesignTime.pas' rev: 24.00 (Win32)

#ifndef Glcg_designtimeHPP
#define Glcg_designtimeHPP
...
#include <GLCgRegister.hpp>	// Pascal unit
...
#include <GLCgBombShader.hpp>	// Pascal unit

//-- user supplied -----------------------------------------------------------

namespace Glcg_designtime
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Glcg_designtime */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLCG_DESIGNTIME)
using namespace Glcg_designtime;
#endif
#pragma pack(pop)
#pragma option pop
