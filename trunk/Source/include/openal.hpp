...
// (DO NOT EDIT: machine generated header) 'openal.pas' rev: 24.00 (Win32)
...
extern PACKAGE System::StaticArray<float, 3> AL_EAXREVERB_DEFAULT_REFLECTIONS_PAN;
...
extern PACKAGE System::StaticArray<float, 3> AL_EAXREVERB_DEFAULT_LATE_REVERB_PAN;
...
extern PACKAGE GUID DSPROPSETID_EAX20_ListenerProperties;
extern PACKAGE GUID DSPROPSETID_EAX20_BufferProperties;
...
extern PACKAGE void __cdecl (*alEnable)(int capability);
extern PACKAGE void __cdecl (*alDisable)(int capability);
extern PACKAGE bool __cdecl (*alIsEnabled)(int capability);
extern PACKAGE void __cdecl (*alHint)(int target, int mode);
extern PACKAGE void __cdecl (*alGetBooleanv)(int param, PALboolean data);
extern PACKAGE void __cdecl (*alGetIntegerv)(int param, PALint data);
extern PACKAGE void __cdecl (*alGetFloatv)(int param, PALfloat data);
extern PACKAGE void __cdecl (*alGetDoublev)(int param, PALdouble data);
extern PACKAGE char * __cdecl (*alGetString)(int param);
extern PACKAGE bool __cdecl (*alGetBoolean)(int param);
extern PACKAGE int __cdecl (*alGetInteger)(int param);
extern PACKAGE float __cdecl (*alGetFloat)(int param);
extern PACKAGE double __cdecl (*alGetDouble)(int param);
extern PACKAGE int __cdecl (*alGetError)(void);
extern PACKAGE bool __cdecl (*alIsExtensionPresent)(char * fname);
extern PACKAGE void * __cdecl (*alGetProcAddress)(char * fname);
extern PACKAGE int __cdecl (*alGetEnumValue)(char * ename);
extern PACKAGE void __cdecl (*alListenerf)(int param, float value);
extern PACKAGE void __cdecl (*alListener3f)(int param, float f1, float f2, float f3);
extern PACKAGE void __cdecl (*alListenerfv)(int param, PALfloat values);
extern PACKAGE void __cdecl (*alListeneri)(int param, int value);
extern PACKAGE void __fastcall (*alListener3i)(int param, int value1, int value2, int value3);
extern PACKAGE void __fastcall (*alListeneriv)(int param, const PALint values);
extern PACKAGE void __cdecl (*alGetListeneriv)(int param, PALint values);
extern PACKAGE void __cdecl (*alGetListenerfv)(int param, PALfloat values);
extern PACKAGE void __cdecl (*alGenSources)(unsigned n, PALuint sources);
extern PACKAGE void __cdecl (*alDeleteSources)(unsigned n, PALuint sources);
extern PACKAGE bool __cdecl (*alIsSource)(unsigned id);
extern PACKAGE void __cdecl (*alSourcei)(unsigned source, int param, int value);
extern PACKAGE void __cdecl (*alSource3i)(unsigned source, int param, int v1, int v2, int v3);
extern PACKAGE void __cdecl (*alSourceiv)(unsigned source, int param, PALint values);
extern PACKAGE void __cdecl (*alSourcef)(unsigned source, int param, float value);
extern PACKAGE void __cdecl (*alSource3f)(unsigned source, int param, float v1, float v2, float v3);
extern PACKAGE void __cdecl (*alSourcefv)(unsigned source, int param, PALfloat values);
extern PACKAGE void __cdecl (*alGetSourcei)(unsigned source, int param, PALint value);
extern PACKAGE void __cdecl (*alGetSource3i)(unsigned source, int param, PALint v1, PALint v2, PALint v3);
extern PACKAGE void __cdecl (*alGetSourceiv)(unsigned source, int param, PALint values);
extern PACKAGE void __cdecl (*alGetSourcef)(unsigned source, int param, PALfloat value);
extern PACKAGE void __cdecl (*alGetSource3f)(unsigned source, int param, PALfloat v1, PALfloat v2, PALfloat v3);
extern PACKAGE void __cdecl (*alGetSourcefv)(unsigned source, int param, PALfloat values);
extern PACKAGE void __cdecl (*alSourcePlay)(unsigned source);
extern PACKAGE void __cdecl (*alSourcePause)(unsigned source);
extern PACKAGE void __cdecl (*alSourceStop)(unsigned source);
extern PACKAGE void __cdecl (*alSourceRewind)(unsigned source);
extern PACKAGE void __cdecl (*alSourcePlayv)(unsigned n, PALuint sources);
extern PACKAGE void __cdecl (*alSourceStopv)(unsigned n, PALuint sources);
extern PACKAGE void __cdecl (*alSourceRewindv)(unsigned n, PALuint sources);
extern PACKAGE void __cdecl (*alSourcePausev)(unsigned n, PALuint sources);
extern PACKAGE void __cdecl (*alSourceQueueBuffers)(unsigned source, unsigned n, PALuint buffers);
extern PACKAGE void __cdecl (*alSourceUnqueueBuffers)(unsigned source, unsigned n, PALuint buffers);
extern PACKAGE void __cdecl (*alGenBuffers)(unsigned n, PALuint buffers);
extern PACKAGE void __cdecl (*alDeleteBuffers)(unsigned n, PALuint buffers);
extern PACKAGE bool __cdecl (*alIsBuffer)(unsigned buffer);
extern PACKAGE void __cdecl (*alBufferData)(unsigned buffer, int format, void * data, unsigned size, unsigned freq);
extern PACKAGE void __cdecl (*alBufferi)(unsigned buffer, int param, int value);
extern PACKAGE void __cdecl (*alBuffer3i)(unsigned buffer, int param, int v1, int v2, int v3);
extern PACKAGE void __cdecl (*alBufferiv)(unsigned buffer, int param, PALint values);
extern PACKAGE void __cdecl (*alBufferf)(unsigned buffer, int param, float value);
extern PACKAGE void __cdecl (*alBuffer3f)(unsigned buffer, int param, float v1, float v2, float v3);
extern PACKAGE void __cdecl (*alBufferfv)(unsigned buffer, int param, PALfloat values);
extern PACKAGE void __cdecl (*alGetBufferi)(unsigned buffer, int param, PALint value);
extern PACKAGE void __cdecl (*alGetBuffer3i)(unsigned buffer, int param, PALint v1, PALint v2, PALint v3);
extern PACKAGE void __cdecl (*alGetBufferiv)(unsigned buffer, int param, PALint values);
extern PACKAGE void __cdecl (*alGetBufferf)(unsigned buffer, int param, PALfloat value);
extern PACKAGE void __cdecl (*alGetBuffer3f)(unsigned buffer, int param, PALfloat v1, PALfloat v2, PALfloat v3);
extern PACKAGE void __cdecl (*alGetBufferfv)(unsigned buffer, int param, PALfloat values);
extern PACKAGE void __cdecl (*alDistanceModel)(int value);
extern PACKAGE void __cdecl (*alDopplerFactor)(float value);
extern PACKAGE void __cdecl (*alDopplerVelocity)(float value);
extern PACKAGE void __cdecl (*alSpeedOfSound)(float value);
extern PACKAGE void * __cdecl (*alcCreateContext)(void * device, PALCint attrlist);
extern PACKAGE int __cdecl (*alcMakeContextCurrent)(void * context);
extern PACKAGE void __cdecl (*alcProcessContext)(void * context);
extern PACKAGE void __cdecl (*alcSuspendContext)(void * context);
extern PACKAGE void __cdecl (*alcDestroyContext)(void * context);
extern PACKAGE void * __cdecl (*alcGetCurrentContext)(void);
extern PACKAGE void * __cdecl (*alcGetContextsDevice)(void * context);
extern PACKAGE void * __cdecl (*alcOpenDevice)(char * deviceName);
extern PACKAGE void __cdecl (*alcCloseDevice)(void * device);
extern PACKAGE int __cdecl (*alcGetError)(void * device);
extern PACKAGE bool __cdecl (*alcIsExtensionPresent)(void * device, char * extName);
extern PACKAGE void * __cdecl (*alcGetProcAddress)(void * device, char * funcName);
extern PACKAGE int __cdecl (*alcGetEnumValue)(void * device, char * enumName);
extern PACKAGE char * __cdecl (*alcGetString)(void * device, int param);
extern PACKAGE void __cdecl (*alcGetIntegerv)(void * device, int param, int size, PALCint data);
extern PACKAGE PALCdevice __cdecl (*alcCaptureOpenDevice)(const char * devicename, unsigned frequency, int format, int buffersize);
extern PACKAGE bool __cdecl (*alcCaptureCloseDevice)(PALCdevice device);
extern PACKAGE void __cdecl (*alcCaptureStart)(PALCdevice device);
extern PACKAGE void __cdecl (*alcCaptureStop)(PALCdevice device);
extern PACKAGE void __cdecl (*alcCaptureSamples)(PALCdevice device, void * buffer, int samples);
extern PACKAGE int __cdecl (*EAXSet)(const GUID &Guid, unsigned ALuint1, unsigned ALuint2, void * point, unsigned ALuint3);
extern PACKAGE int __cdecl (*EAXGet)(const GUID &Guid, unsigned ALuint1, unsigned ALuint2, void * point, unsigned ALuint3);
extern PACKAGE int AL_EAX_RAM_SIZE;
extern PACKAGE int AL_EAX_RAM_FREE;
extern PACKAGE int AL_STORAGE_AUTOMATIC;
extern PACKAGE int AL_STORAGE_HARDWARE;
extern PACKAGE int AL_STORAGE_ACCESSIBLE;
extern PACKAGE bool __cdecl (*EAXSetBufferMode)(unsigned n, PALuint buffers, int value);
extern PACKAGE int __cdecl (*EAXGetBufferMode)(unsigned buffer, PALint value);
extern PACKAGE void __cdecl (*ALGENEFFECTS)(unsigned n, PALuint effects);
extern PACKAGE void __cdecl (*ALDELETEEFFECTS)(unsigned n, PALuint effects);
extern PACKAGE bool __cdecl (*ALISEFFECT)(unsigned eid);
extern PACKAGE void __cdecl (*ALEFFECTI)(unsigned eid, int param, int value);
extern PACKAGE void __cdecl (*ALEFFECTIV)(unsigned eid, int param, PALint values);
extern PACKAGE void __cdecl (*ALEFFECTF)(unsigned eid, int param, float value);
extern PACKAGE void __cdecl (*ALEFFECTFV)(unsigned eid, int param, PALfloat values);
extern PACKAGE void __cdecl (*ALGETEFFECTI)(unsigned eid, int param, PALint value);
extern PACKAGE void __cdecl (*ALGETEFFECTIV)(unsigned eid, int param, PALint values);
extern PACKAGE void __cdecl (*ALGETEFFECTF)(unsigned eid, int param, PALfloat value);
extern PACKAGE void __cdecl (*ALGETEFFECTFV)(unsigned eid, int param, PALfloat values);
extern PACKAGE void __cdecl (*ALGENFILTERS)(unsigned n, PALuint filters);
extern PACKAGE void __cdecl (*ALDELETEFILTERS)(unsigned n, PALuint filters);
extern PACKAGE bool __cdecl (*ALISFILTER)(unsigned fid);
extern PACKAGE void __cdecl (*ALFILTERI)(unsigned fid, int param, int value);
extern PACKAGE void __cdecl (*ALFILTERIV)(unsigned fid, int param, PALint values);
extern PACKAGE void __cdecl (*ALFILTERF)(unsigned fid, int param, float value);
extern PACKAGE void __cdecl (*ALFILTERFV)(unsigned fid, int param, PALfloat values);
extern PACKAGE void __cdecl (*ALGETFILTERI)(unsigned fid, int param, PALint value);
extern PACKAGE void __cdecl (*ALGETFILTERIV)(unsigned fid, int param, PALint values);
extern PACKAGE void __cdecl (*ALGETFILTERF)(unsigned fid, int param, PALfloat value);
extern PACKAGE void __cdecl (*ALGETFILTERFV)(unsigned fid, int param, PALfloat values);
extern PACKAGE void __cdecl (*ALGENAUXILIARYEFFECTSLOTS)(unsigned n, PALuint slots);
extern PACKAGE void __cdecl (*ALDELETEAUXILIARYEFFECTSLOTS)(unsigned n, PALuint slots);
extern PACKAGE bool __cdecl (*ALISAUXILIARYEFFECTSLOT)(unsigned slot);
extern PACKAGE void __cdecl (*ALAUXILIARYEFFECTSLOTI)(unsigned asid, int param, int value);
extern PACKAGE void __cdecl (*ALAUXILIARYEFFECTSLOTIV)(unsigned asid, int param, PALint values);
extern PACKAGE void __cdecl (*ALAUXILIARYEFFECTSLOTF)(unsigned asid, int param, float value);
extern PACKAGE void __cdecl (*ALAUXILIARYEFFECTSLOTFV)(unsigned asid, int param, PALfloat values);
extern PACKAGE void __cdecl (*ALGETAUXILIARYEFFECTSLOTI)(unsigned asid, int param, PALint value);
extern PACKAGE void __cdecl (*ALGETAUXILIARYEFFECTSLOTIV)(unsigned asid, int param, PALint values);
extern PACKAGE void __cdecl (*ALGETAUXILIARYEFFECTSLOTF)(unsigned asid, int param, PALfloat value);
extern PACKAGE void __cdecl (*ALGETAUXILIARYEFFECTSLOTFV)(unsigned asid, int param, PALfloat values);
extern PACKAGE NativeUInt LibHandle;
extern PACKAGE NativeUInt EFXUtilLibHandle;
extern PACKAGE bool __fastcall InitOpenAL(System::UnicodeString LibName = L"OpenAL32.dll");
extern PACKAGE void __fastcall ReadOpenALExtensions(void);
extern PACKAGE void __fastcall alutInit(PALint argc, PALbyte *argv, const int argv_Size);
extern PACKAGE void __fastcall alutExit(void);
extern PACKAGE void __fastcall alutLoadWAVFile(System::UnicodeString fname, int &format, void * &data, unsigned &size, unsigned &freq, int &loop);
extern PACKAGE void __fastcall alutLoadWAVMemory(PALbyte memory, int &format, void * &data, unsigned &size, unsigned &freq, int &loop);
extern PACKAGE void __fastcall alutUnloadWAV(int format, void * data, unsigned size, unsigned freq);
}	/* namespace Openal */
