...
// (DO NOT EDIT: machine generated header) 'fmodtypes.pas' rev: 24.00 (Win32)
...
enum TFModErrors : unsigned int { FMOD_ERR_NONE, FMOD_ERR_BUSY, FMOD_ERR_UNINITIALIZED, FMOD_ERR_INIT, FMOD_ERR_ALLOCATED, FMOD_ERR_PLAY, FMOD_ERR_OUTPUT_FORMAT, FMOD_ERR_COOPERATIVELEVEL, FMOD_ERR_CREATEBUFFER, FMOD_ERR_FILE_NOTFOUND, FMOD_ERR_FILE_FORMAT, FMOD_ERR_FILE_BAD, FMOD_ERR_MEMORY, FMOD_ERR_VERSION, FMOD_ERR_INVALID_PARAM, FMOD_ERR_NO_EAX, FMOD_ERR_CHANNEL_ALLOC, FMOD_ERR_RECORD, FMOD_ERR_MEDIAPLAYER, FMOD_ERR_CDDEVICE };

enum TFSoundOutputTypes : unsigned int { FSOUND_OUTPUT_NOSOUND, FSOUND_OUTPUT_WINMM, FSOUND_OUTPUT_DSOUND, FSOUND_OUTPUT_A3D, FSOUND_OUTPUT_OSS, FSOUND_OUTPUT_ESD, FSOUND_OUTPUT_ALSA, FSOUND_OUTPUT_ASIO, FSOUND_OUTPUT_XBOX, FSOUND_OUTPUT_PS2, FSOUND_OUTPUT_MAC, FSOUND_OUTPUT_GC, FSOUND_OUTPUT_PSP, FSOUND_OUTPUT_NOSOUND_NONREALTIME };

enum TFSoundMixerTypes : unsigned int { FSOUND_MIXER_AUTODETECT, FSOUND_MIXER_BLENDMODE, FSOUND_MIXER_MMXP5, FSOUND_MIXER_MMXP6, FSOUND_MIXER_QUALITY_AUTODETECT, FSOUND_MIXER_QUALITY_FPU, FSOUND_MIXER_QUALITY_MMXP5, FSOUND_MIXER_QUALITY_MMXP6, FSOUND_MIXER_MONO, FSOUND_MIXER_QUALITY_MONO, FSOUND_MIXER_MAX };

enum TFMusicTypes : unsigned int { FMUSIC_TYPE_NONE, FMUSIC_TYPE_MOD, FMUSIC_TYPE_S3M, FMUSIC_TYPE_XM, FMUSIC_TYPE_IT, FMUSIC_TYPE_MIDI, FMUSIC_TYPE_FSB };
...
enum TFSoundFXModes : unsigned int { FSOUND_FX_CHORUS, FSOUND_FX_COMPRESSOR, FSOUND_FX_DISTORTION, FSOUND_FX_ECHO, FSOUND_FX_FLANGER, FSOUND_FX_GARGLE, FSOUND_FX_I3DL2REVERB, FSOUND_FX_PARAMEQ, FSOUND_FX_WAVES_REVERB, FSOUND_FX_MAX };

enum TFSoundSpeakerModes : unsigned int { FSOUND_SPEAKERMODE_DOLBYDIGITAL, FSOUND_SPEAKERMODE_HEADPHONES, FSOUND_SPEAKERMODE_MONO, FSOUND_SPEAKERMODE_QUAD, FSOUND_SPEAKERMODE_STEREO, FSOUND_SPEAKERMODE_SURROUND, FSOUND_SPEAKERMODE_DTS };

typedef TFSoundSpeakerModes FSOUND_SPEAKERMODES;

enum TFSoundStreamNetStatus : unsigned int { FSOUND_STREAM_NET_NOTCONNECTED, FSOUND_STREAM_NET_CONNECTING, FSOUND_STREAM_NET_BUFFERING, FSOUND_STREAM_NET_READY, FSOUND_STREAM_NET_ERROR };

enum TFSoundTagFieldType : unsigned int { FSOUND_TAGFIELD_VORBISCOMMENT, FSOUND_TAGFIELD_ID3V1, FSOUND_TAGFIELD_ID3V2, FSOUND_TAGFIELD_SHOUTCAST, FSOUND_TAGFIELD_ICECAST, FSOUND_TAGFIELD_ASF };
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE float FMOD_VERSION;
