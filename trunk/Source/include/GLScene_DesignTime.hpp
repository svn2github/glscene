...
// (DO NOT EDIT: machine generated header) 'GLScene_DesignTime.pas' rev: 24.00 (Win32)

#ifndef Glscene_designtimeHPP
#define Glscene_designtimeHPP
...
#include <FXCollectionEditor.hpp>	// Pascal unit
#include <GLSceneEdit.hpp>	// Pascal unit
#include <GLSceneRegister.hpp>	// Pascal unit
#include <RegisterXCollection.hpp>	// Pascal unit
#include <FShaderMemo.hpp>	// Pascal unit
#include <GLSceneFormDesign.hpp>	// Pascal unit
#include <FGUILayoutEditor.hpp>	// Pascal unit
...
#include <GLJoystick.hpp>	// Pascal unit
#include <GLScreenSaver.hpp>	// Pascal unit
...
namespace Glscene_designtime
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Glscene_designtime */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSCENE_DESIGNTIME)
using namespace Glscene_designtime;
#endif
#pragma pack(pop)
#pragma option pop
