...
// (DO NOT EDIT: machine generated header) 'GLSS_FMOD.pas' rev: 24.00 (Win32)
...
#include <fmod.hpp>	// Pascal unit
#include <GLSMFMOD.hpp>	// Pascal unit
#include <fmodpresets.hpp>	// Pascal unit
#include <fmodtypes.hpp>	// Pascal unit
#include <fmoderrors.hpp>	// Pascal unit
#include <fmoddyn.hpp>	// Pascal unit
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSS_FMOD)
using namespace Glss_fmod;
#endif
#pragma pack(pop)
#pragma option pop
