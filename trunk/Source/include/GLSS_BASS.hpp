...
// (DO NOT EDIT: machine generated header) 'GLSS_BASS.pas' rev: 24.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLSS_BASS)
using namespace Glss_bass;
#endif
#pragma pack(pop)
#pragma option pop
