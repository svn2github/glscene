...
{$IFDEF GLS_REGIONS}{$REGION 'Direct access'}{$ENDIF}
    ...
    TureParameterf: PFNGLTEXTUREPARAMETERFEXTPROC;
    TureParameterfv: PFNGLTEXTUREPARAMETERFVEXTPROC;
    TureParameteri: PFNGLTEXTUREPARAMETERIEXTPROC;
    TureParameteriv: PFNGLTEXTUREPARAMETERIVEXTPROC;
    TureImage1D: PFNGLTEXTUREIMAGE1DEXTPROC;
    TureImage2D: PFNGLTEXTUREIMAGE2DEXTPROC;
    TureSubImage1D: PFNGLTEXTURESUBIMAGE1DEXTPROC;
    TureSubImage2D: PFNGLTEXTURESUBIMAGE2DEXTPROC;
    CopyTureImage1D: PFNGLCOPYTEXTUREIMAGE1DEXTPROC;
    CopyTureImage2D: PFNGLCOPYTEXTUREIMAGE2DEXTPROC;
    CopyTureSubImage1D: PFNGLCOPYTEXTURESUBIMAGE1DEXTPROC;
    CopyTureSubImage2D: PFNGLCOPYTEXTURESUBIMAGE2DEXTPROC;
    GetTureImage: PFNGLGETTEXTUREIMAGEEXTPROC;
    GetTureParameterfv: PFNGLGETTEXTUREPARAMETERFVEXTPROC;
    GetTureParameteriv: PFNGLGETTEXTUREPARAMETERIVEXTPROC;
    GetTureLevelParameterfv: PFNGLGETTEXTURELEVELPARAMETERFVEXTPROC;
    GetTureLevelParameteriv: PFNGLGETTEXTURELEVELPARAMETERIVEXTPROC;
    TureImage3D: PFNGLTEXTUREIMAGE3DEXTPROC;
    TureSubImage3D: PFNGLTEXTURESUBIMAGE3DEXTPROC;
    CopyTureSubImage3D: PFNGLCOPYTEXTURESUBIMAGE3DEXTPROC;
    ...
    BindMultiTure: PFNGLBINDMULTITEXTUREEXTPROC;
    ...
    CompressedTureImage3D: PFNGLCOMPRESSEDTEXTUREIMAGE3DEXTPROC;
    CompressedTureImage2D: PFNGLCOMPRESSEDTEXTUREIMAGE2DEXTPROC;
    CompressedTureImage1D: PFNGLCOMPRESSEDTEXTUREIMAGE1DEXTPROC;
    CompressedTureSubImage3D: PFNGLCOMPRESSEDTEXTURESUBIMAGE3DEXTPROC;
    CompressedTureSubImage2D: PFNGLCOMPRESSEDTEXTURESUBIMAGE2DEXTPROC;
    CompressedTureSubImage1D: PFNGLCOMPRESSEDTEXTURESUBIMAGE1DEXTPROC;
    GetCompressedTureImage: PFNGLGETCOMPRESSEDTEXTUREIMAGEEXTPROC;
    ...
    TureParameterIiv: PFNGLTEXTUREPARAMETERIIVEXTPROC;
    TureParameterIuiv: PFNGLTEXTUREPARAMETERIUIVEXTPROC;
    GetTureParameterIiv: PFNGLGETTEXTUREPARAMETERIIVEXTPROC;
    GetTureParameterIuiv: PFNGLGETTEXTUREPARAMETERIUIVEXTPROC;
    ...
    TureBuffer: PFNGLTEXTUREBUFFEREXTPROC;
    ...
    NamedFramebufferTure1D: PFNGLNAMEDFRAMEBUFFERTEXTURE1DEXTPROC;
    NamedFramebufferTure2D: PFNGLNAMEDFRAMEBUFFERTEXTURE2DEXTPROC;
    NamedFramebufferTure3D: PFNGLNAMEDFRAMEBUFFERTEXTURE3DEXTPROC;
    ...
    GenerateTureMipmap: PFNGLGENERATETEXTUREMIPMAPEXTPROC;
    ...
    NamedFramebufferTure: PFNGLNAMEDFRAMEBUFFERTEXTUREEXTPROC;
    NamedFramebufferTureLayer: PFNGLNAMEDFRAMEBUFFERTEXTURELAYEREXTPROC;
    NamedFramebufferTureFace: PFNGLNAMEDFRAMEBUFFERTEXTUREFACEEXTPROC;
    TureRenderbuffer: PFNGLTEXTURERENDERBUFFEREXTPROC;
...
{$ENDIF}
  ...
  TureParameterf := GetAddress('TureParameterf');
  TureParameterfv := GetAddress('TureParameterfv');
  TureParameteri := GetAddress('TureParameteri');
  TureParameteriv := GetAddress('TureParameteriv');
  TureImage1D := GetAddress('TureImage1D');
  TureImage2D := GetAddress('TureImage2D');
  TureSubImage1D := GetAddress('TureSubImage1D');
  TureSubImage2D := GetAddress('TureSubImage2D');
  CopyTureImage1D := GetAddress('CopyTureImage1D');
  CopyTureImage2D := GetAddress('CopyTureImage2D');
  CopyTureSubImage1D := GetAddress('CopyTureSubImage1D');
  CopyTureSubImage2D := GetAddress('CopyTureSubImage2D');
  GetTureImage := GetAddress('GetTureImage');
  GetTureParameterfv := GetAddress('GetTureParameterfv');
  GetTureParameteriv := GetAddress('GetTureParameteriv');
  GetTureLevelParameterfv := GetAddress('GetTureLevelParameterfv');
  GetTureLevelParameteriv := GetAddress('GetTureLevelParameteriv');
  TureImage3D := GetAddress('TureImage3D');
  TureSubImage3D := GetAddress('TureSubImage3D');
  CopyTureSubImage3D := GetAddress('CopyTureSubImage3D');
  ...
  BindMultiTure := GetAddress('BindMultiTure');
  ...
  CompressedTureImage3D := GetAddress('CompressedTureImage3D');
  CompressedTureImage2D := GetAddress('CompressedTureImage2D');
  CompressedTureImage1D := GetAddress('CompressedTureImage1D');
  CompressedTureSubImage3D := GetAddress('CompressedTureSubImage3D');
  CompressedTureSubImage2D := GetAddress('CompressedTureSubImage2D');
  CompressedTureSubImage1D := GetAddress('CompressedTureSubImage1D');
  GetCompressedTureImage := GetAddress('GetCompressedTureImage');
  ...
  TureParameterIiv := GetAddress('TureParameterIiv');
  TureParameterIuiv := GetAddress('TureParameterIuiv');
  GetTureParameterIiv := GetAddress('GetTureParameterIiv');
  GetTureParameterIuiv := GetAddress('GetTureParameterIuiv');
  ...
  TureBuffer := GetAddress('TureBuffer');
  ...
  NamedFramebufferTure1D := GetAddress('NamedFramebufferTure1D');
  NamedFramebufferTure2D := GetAddress('NamedFramebufferTure2D');
  NamedFramebufferTure3D := GetAddress('NamedFramebufferTure3D');
  ...
  GenerateTureMipmap := GetAddress('GenerateTureMipmap');
  ...
  NamedFramebufferTure := GetAddress('NamedFramebufferTure');
  NamedFramebufferTureLayer := GetAddress('NamedFramebufferTureLayer');
  NamedFramebufferTureFace := GetAddress('NamedFramebufferTureFace');
  TureRenderbuffer := GetAddress('TureRenderbuffer');
...
begin
  ...
  TureParameterf := GetCapAddress();
  TureParameterfv := GetCapAddress();
  TureParameteri := GetCapAddress();
  TureParameteriv := GetCapAddress();
  TureImage1D := GetCapAddress();
  TureImage2D := GetCapAddress();
  TureSubImage1D := GetCapAddress();
  TureSubImage2D := GetCapAddress();
  CopyTureImage1D := GetCapAddress();
  CopyTureImage2D := GetCapAddress();
  CopyTureSubImage1D := GetCapAddress();
  CopyTureSubImage2D := GetCapAddress();
  GetTureImage := GetCapAddress();
  GetTureParameterfv := GetCapAddress();
  GetTureParameteriv := GetCapAddress();
  GetTureLevelParameterfv := GetCapAddress();
  GetTureLevelParameteriv := GetCapAddress();
  TureImage3D := GetCapAddress();
  TureSubImage3D := GetCapAddress();
  CopyTureSubImage3D := GetCapAddress();
  ...
  CompressedTureImage3D := GetCapAddress();
  CompressedTureImage2D := GetCapAddress();
  CompressedTureImage1D := GetCapAddress();
  CompressedTureSubImage3D := GetCapAddress();
  CompressedTureSubImage2D := GetCapAddress();
  CompressedTureSubImage1D := GetCapAddress();
  GetCompressedTureImage := GetCapAddress();
  ...
  TureParameterIiv := GetCapAddress();
  TureParameterIuiv := GetCapAddress();
  GetTureParameterIiv := GetCapAddress();
  GetTureParameterIuiv := GetCapAddress();
  ...
  NamedFramebufferTure1D := GetCapAddress();
  NamedFramebufferTure2D := GetCapAddress();
  NamedFramebufferTure3D := GetCapAddress();
  NamedFramebufferRenderbuffer := GetCapAddress();
  GetNamedFramebufferAttachmentParameteriv := GetCapAddress();
  GenerateTureMipmap := GetCapAddress();
  ...
  NamedFramebufferTure := GetCapAddress();
  NamedFramebufferTureLayer := GetCapAddress();
  NamedFramebufferTureFace := GetCapAddress();
  TureRenderbuffer := GetCapAddress();
