...
begin
  ...
  begin
    ...
    begin
      ...
      PFloatArray(dx)[I] := Nodes[I].FDirection.Coord[0];
      PFloatArray(dy)[I] := Nodes[I].FDirection.Coord[1];
      PFloatArray(dz)[I] := Nodes[I].FDirection.Coord[2];

      PFloatArray(ux)[I] := Nodes[I].FUp.Coord[0];
      PFloatArray(uy)[I] := Nodes[I].FUp.Coord[1];
      PFloatArray(uz)[I] := Nodes[I].FUp.Coord[2];
