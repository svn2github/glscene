...
begin
  ...
  begin
    ...
    begin
      if RayCastPlaneIntersect(localRayStart, localRayVector, PointMake(0, -fHeight * 0.5, 0), YHmgVector, @ip) then
      begin
...
begin
  ...
  GL.Rotatef(-90, 0, 0, 1);
  case Alignment of
    caTop: GL.Translatef(0, 0, FHeight + 1);
    caBottom: GL.Translatef(0, 0, -FHeight);
  else // caCenter
