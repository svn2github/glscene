...
{: dynodegl  <p>
  ...
  <li>2010.08.23 - Yar - Replaced OpenGL1x to OpenGLTokens
  <li>2008.12.08 - PR dBodySetMass no longer accepts zero mass. check added
  <li>2008.02.05 - Mrqzzz - Upgrade to ODE 0.9 (upgrade by Paul Robello; added reference to odeimport)
  <li>02/08/04 - LR, YHC - BCB corrections: use record instead array
  <li>2007.09.11 - Mrqzzz - added reference to odeimport
  <li>2003.02.03 - EG - Fixed CopyPosFromGeomToGL
  <li>2003.02.11 - MF - Added a couple of vector functions for copying between
