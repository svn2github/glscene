...
{$IFNDEF FPC}
  ...
  DesignEditors;
{$ELSE}
  SysUtils, Controls, GLSceneForm, FormEditingIntf;
...
begin
  Result:=
    'object '+ ResourceName+ ':' + 'T'+ ResourceName + #13#10 +
    '  Left = 759'+ #13#10 +
    '  Height = 240'+ #13#10 +
    '  Top = 102'+ #13#10 +
    '  Width = 320'+ #13#10 +
...
begin
  Result:=
    ...
    '  ClientHeight = 600' + LineEnding +
    '  ClientWidth = 800' + LineEnding +
    '  Camera = GLCamera1' + LineEnding +
    ...
    '    Font.CharSet = RUSSIAN_CHARSET' + LineEnding +
    '    Font.Color = clWhite' + LineEnding +
    '    Font.Height = -32' + LineEnding +
    '    Font.Name = ''@Arial Unicode MS''' + LineEnding +
