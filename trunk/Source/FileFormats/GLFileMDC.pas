      ...
      begin
        ...
        begin
          ...
          begin
            ...
            MorphTarget.Vertices.Add(Xyz.Coord[0], Xyz.Coord[2], -Xyz.Coord[1]);
            MorphTarget.Normals.Add(Normal.Coord[0], Normal.Coord[2],
              -Normal.Coord[1]);
          end;
        end;
      end;
