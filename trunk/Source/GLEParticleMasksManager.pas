...
begin
  Vec.Coord[0] := Vec.Coord[0] * Mask.FScale.DirectX * TargetObject.Scale.DirectX +
    Mask.FPosition.DirectX + TargetObject.AbsolutePosition.Coord[0];
  Vec.Coord[1] := Vec.Coord[1] * Mask.FScale.DirectY * TargetObject.Scale.DirectY +
    Mask.FPosition.DirectY + TargetObject.AbsolutePosition.Coord[1];
  Vec.Coord[2] := Vec.Coord[2] * Mask.FScale.DirectZ * TargetObject.Scale.DirectZ +
    Mask.FPosition.DirectZ + TargetObject.AbsolutePosition.Coord[2];
end;
