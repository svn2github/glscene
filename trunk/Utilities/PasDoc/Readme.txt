...
5.Run the hhw.exe program from C:\Program Files (x86)\HTML Help Workshop\ folder
6.Open GLSysHelp.hhp project in ..\Utilities\PasDoc\HTML\ folder and compile it.
7.Clean HTML folder using _CleanHTML.bat and find there the GLSysHelp.chm
