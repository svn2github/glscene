...
uses
  ...
  GL3xNishitaSky, GL3xObjects, GLSGraphStructure, GLShaderEnvironment, 
  GLShaderManager, GLSRedBlackTree, GLVBOManager, VectorGeometryEXT, Const3DS, 
  DDSImage, DXTC, File3DS, FileB3D, FileGL2, FileMD2, FileMD3, FileNMF, 
  ...
  GLRenderContextInfo, GLROAMPatch, GLSArchiveManager, GLScene, GLScriptBase, 
  GLSelection, GLShadowHDS, GLShadowPlane, GLShadowVolume, GLSilhouette, 
