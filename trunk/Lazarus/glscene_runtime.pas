...
uses
  ...
  GL3xFactory, GL3xFreeForm, GL3xLensFlare, GL3xMaterial, GL3xMaterialTokens, 
  GL3xMesh, GL3xNishitaSky, GL3xObjects, GLDrawTechnique, GLSceneForm, 
  GLSGraphStructure, GLShaderEnvironment, GLShaderManager, GLSRedBlackTree, 
  GLVBOManager, VectorGeometryEXT, Const3DS, DDSImage, DXTC, File3DS, FileB3D, 
  FileGL2, FileMD2, FileMD3, FileNMF, FileOCT, FileX, GLFile3DS, 
  GLFile3DSSceneObjects, GLFileASE, GLFileB3D, GLFileDDS, GLFileGL2, 
  GLFileGTS, GLFileHDR, GLFileJPEG, GLFileLMTS, GLFileLWO, GLFileMD2, 
  GLFileMD3, GLFileMD5, GLFileMDC, GLFileMP3, GLFileMS3D, GLFileNMF, 
  GLFileNurbs, GLFileO3TC, GLFileOBJ, GLFilePAK, GLFilePLY, GLFilePNG, 
