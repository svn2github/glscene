...
{$ifdef FPC}
function InitOpenGLFromLibrary(const GLName, GLUName : PChar) : Boolean;
{$else}
...
{$ifdef FPC}
const
  SDefaultGLLibrary : PChar = 'OpenGL32.dll';
  SDefaultGLULibrary : PChar = 'GLU32.dll';
{$else}
resourcestring
...
begin
   ...
   pointer(glDrawRangeElements) := GLGetProcAddress('glDrawRangeElements');
   pointer(glTexImage3D) := GLGetProcAddress('glTexImage3D');

   // GL 1.2 ARB imaging
   pointer(glBlendColor) := GLGetProcAddress('glBlendColor');
   pointer(glBlendEquation) := GLGetProcAddress('glBlendEquation');
   pointer(glColorSubTable) := GLGetProcAddress('glColorSubTable');
   pointer(glCopyColorSubTable) := GLGetProcAddress('glCopyColorSubTable');
   pointer(glColorTable) := GLGetProcAddress('glCopyColorSubTable');
   pointer(glCopyColorTable) := GLGetProcAddress('glCopyColorTable');
   pointer(glColorTableParameteriv) := GLGetProcAddress('glColorTableParameteriv');
   pointer(glColorTableParameterfv) := GLGetProcAddress('glColorTableParameterfv');
   pointer(glGetColorTable) := GLGetProcAddress('glGetColorTable');
   pointer(glGetColorTableParameteriv) := GLGetProcAddress('glGetColorTableParameteriv');
   pointer(glGetColorTableParameterfv) := GLGetProcAddress('glGetColorTableParameterfv');
   pointer(glConvolutionFilter1D) := GLGetProcAddress('glConvolutionFilter1D');
   pointer(glConvolutionFilter2D) := GLGetProcAddress('glConvolutionFilter2D');
   pointer(glCopyConvolutionFilter1D) := GLGetProcAddress('glCopyConvolutionFilter1D');
   pointer(glCopyConvolutionFilter2D) := GLGetProcAddress('glCopyConvolutionFilter2D');
   pointer(glGetConvolutionFilter) := GLGetProcAddress('glGetConvolutionFilter');
   pointer(glSeparableFilter2D) := GLGetProcAddress('glSeparableFilter2D');
   pointer(glGetSeparableFilter) := GLGetProcAddress('glGetSeparableFilter');
   pointer(glConvolutionParameteri) := GLGetProcAddress('glConvolutionParameteri');
   pointer(glConvolutionParameteriv) := GLGetProcAddress('glConvolutionParameteriv');
   pointer(glConvolutionParameterf) := GLGetProcAddress('glConvolutionParameterf');
   pointer(glConvolutionParameterfv) := GLGetProcAddress('glConvolutionParameterfv');
   pointer(glGetConvolutionParameteriv) := GLGetProcAddress('glGetConvolutionParameteriv');
   pointer(glGetConvolutionParameterfv) := GLGetProcAddress('glGetConvolutionParameterfv');
   pointer(glHistogram) := GLGetProcAddress('glHistogram');
   pointer(glResetHistogram) := GLGetProcAddress('glResetHistogram');
   pointer(glGetHistogram) := GLGetProcAddress('glGetHistogram');
   pointer(glGetHistogramParameteriv) := GLGetProcAddress('glGetHistogramParameteriv');
   pointer(glGetHistogramParameterfv) := GLGetProcAddress('glGetHistogramParameterfv');
   pointer(glMinmax) := GLGetProcAddress('glMinmax');
   pointer(glResetMinmax) := GLGetProcAddress('glResetMinmax');
   pointer(glGetMinmax) := GLGetProcAddress('glGetMinmax');
   pointer(glGetMinmaxParameteriv) := GLGetProcAddress('glGetMinmaxParameteriv');
   pointer(glGetMinmaxParameterfv) := GLGetProcAddress('glGetMinmaxParameterfv');

   // GL extensions
   pointer(glArrayElementArrayEXT) := GLGetProcAddress('glArrayElementArrayEXT');
   pointer(glColorTableEXT) := GLGetProcAddress('glColorTableEXT');
   pointer(glColorSubTableEXT) := GLGetProcAddress('glColorSubTableEXT');
   pointer(glGetColorTableEXT) := GLGetProcAddress('glGetColorTableEXT');
   pointer(glGetColorTablePameterivEXT) := GLGetProcAddress('glGetColorTablePameterivEXT');
   pointer(glGetColorTablePameterfvEXT) := GLGetProcAddress('glGetColorTablePameterfvEXT');
   pointer(glCopyTexImage1DEXT) := GLGetProcAddress('glCopyTexImage1DEXT');
   pointer(glCopyTexSubImage1DEXT) := GLGetProcAddress('glCopyTexSubImage1DEXT');
   pointer(glCopyTexImage2DEXT) := GLGetProcAddress('glCopyTexImage2DEXT');
   pointer(glCopyTexSubImage2DEXT) := GLGetProcAddress('glCopyTexSubImage2DEXT');
   pointer(glCopyTexSubImage3DEXT) := GLGetProcAddress('glCopyTexSubImage3DEXT');
   pointer(glIndexFuncEXT) := GLGetProcAddress('glIndexFuncEXT');
   pointer(glIndexMaterialEXT) := GLGetProcAddress('glIndexMaterialEXT');
   pointer(glPolygonOffsetEXT) := GLGetProcAddress('glPolygonOffsetEXT');
   pointer(glTexSubImage1dEXT) := GLGetProcAddress('glTexSubImage1DEXT');
   pointer(glTexSubImage2dEXT) := GLGetProcAddress('glTexSubImage2DEXT');
   pointer(glTexSubImage3dEXT) := GLGetProcAddress('glTexSubImage3DEXT');
   pointer(glGenTexturesEXT) := GLGetProcAddress('glGenTexturesEXT');
   pointer(glDeleteTexturesEXT) := GLGetProcAddress('glDeleteTexturesEXT');
   pointer(glBindTextureEXT) := GLGetProcAddress('glBindTextureEXT');
   pointer(glPrioritizeTexturesEXT) := GLGetProcAddress('glPrioritizeTexturesEXT');
   pointer(glAreTexturesResidentEXT) := GLGetProcAddress('glAreTexturesResidentEXT');
   pointer(glIsTextureEXT) := GLGetProcAddress('glIsTextureEXT');

   // EXT_compiled_vertex_array
   pointer(glLockArraysEXT) := GLGetProcAddress('glLockArraysEXT');
   pointer(glUnlockArraysEXT) := GLGetProcAddress('glUnlockArraysEXT');

   // ARB_multitexture
   pointer(glMultiTexCoord1dARB) := GLGetProcAddress('glMultiTexCoord1dARB');
   pointer(glMultiTexCoord1dVARB) := GLGetProcAddress('glMultiTexCoord1dVARB');
   pointer(glMultiTexCoord1fARB) := GLGetProcAddress('glMultiTexCoord1fARB');
   pointer(glMultiTexCoord1fVARB) := GLGetProcAddress('glMultiTexCoord1fVARB');
   pointer(glMultiTexCoord1iARB) := GLGetProcAddress('glMultiTexCoord1iARB');
   pointer(glMultiTexCoord1iVARB) := GLGetProcAddress('glMultiTexCoord1iVARB');
   pointer(glMultiTexCoord1sARB) := GLGetProcAddress('glMultiTexCoord1sARB');
   pointer(glMultiTexCoord1sVARB) := GLGetProcAddress('glMultiTexCoord1sVARB');
   pointer(glMultiTexCoord2dARB) := GLGetProcAddress('glMultiTexCoord2dARB');
   pointer(glMultiTexCoord2dvARB) := GLGetProcAddress('glMultiTexCoord2dvARB');
   pointer(glMultiTexCoord2fARB) := GLGetProcAddress('glMultiTexCoord2fARB');
   pointer(glMultiTexCoord2fvARB) := GLGetProcAddress('glMultiTexCoord2fvARB');
   pointer(glMultiTexCoord2iARB) := GLGetProcAddress('glMultiTexCoord2iARB');
   pointer(glMultiTexCoord2ivARB) := GLGetProcAddress('glMultiTexCoord2ivARB');
   pointer(glMultiTexCoord2sARB) := GLGetProcAddress('glMultiTexCoord2sARB');
   pointer(glMultiTexCoord2svARB) := GLGetProcAddress('glMultiTexCoord2svARB');
   pointer(glMultiTexCoord3dARB) := GLGetProcAddress('glMultiTexCoord3dARB');
   pointer(glMultiTexCoord3dvARB) := GLGetProcAddress('glMultiTexCoord3dvARB');
   pointer(glMultiTexCoord3fARB) := GLGetProcAddress('glMultiTexCoord3fARB');
   pointer(glMultiTexCoord3fvARB) := GLGetProcAddress('glMultiTexCoord3fvARB');
   pointer(glMultiTexCoord3iARB) := GLGetProcAddress('glMultiTexCoord3iARB');
   pointer(glMultiTexCoord3ivARB) := GLGetProcAddress('glMultiTexCoord3ivARB');
   pointer(glMultiTexCoord3sARB) := GLGetProcAddress('glMultiTexCoord3sARB');
   pointer(glMultiTexCoord3svARB) := GLGetProcAddress('glMultiTexCoord3svARB');
   pointer(glMultiTexCoord4dARB) := GLGetProcAddress('glMultiTexCoord4dARB');
   pointer(glMultiTexCoord4dvARB) := GLGetProcAddress('glMultiTexCoord4dvARB');
   pointer(glMultiTexCoord4fARB) := GLGetProcAddress('glMultiTexCoord4fARB');
   pointer(glMultiTexCoord4fvARB) := GLGetProcAddress('glMultiTexCoord4fvARB');
   pointer(glMultiTexCoord4iARB) := GLGetProcAddress('glMultiTexCoord4iARB');
   pointer(glMultiTexCoord4ivARB) := GLGetProcAddress('glMultiTexCoord4ivARB');
   pointer(glMultiTexCoord4sARB) := GLGetProcAddress('glMultiTexCoord4sARB');
   pointer(glMultiTexCoord4svARB) := GLGetProcAddress('glMultiTexCoord4svARB');
   pointer(glActiveTextureARB) := GLGetProcAddress('glActiveTextureARB');
   pointer(glClientActiveTextureARB) := GLGetProcAddress('glClientActiveTextureARB');

   // EXT_stencil_two_side
   pointer(glActiveStencilFaceEXT) := GLGetProcAddress('glActiveStencilFaceEXT');

   // WIN_swap_hint
   pointer(glAddSwapHintRectWIN) := GLGetProcAddress('glAddSwapHintRectWIN');

   // GL_ARB_point_parameter
   pointer(glPointParameterfARB) := GLGetProcAddress('glPointParameterfARB');
   pointer(glPointParameterfvARB) := GLGetProcAddress('glPointParameterfvARB');

   // GL_ARB_transpose_matrix
   pointer(glLoadTransposeMatrixfARB) := GLGetProcAddress('glLoadTransposeMatrixfARB');
   pointer(glLoadTransposeMatrixdARB) := GLGetProcAddress('glLoadTransposeMatrixdARB');
   pointer(glMultTransposeMatrixfARB) := GLGetProcAddress('glMultTransposeMatrixfARB');
   pointer(glMultTransposeMatrixdARB) := GLGetProcAddress('glMultTransposeMatrixdARB');

   pointer(glSampleCoverageARB) := GLGetProcAddress('glSampleCoverageARB');
   pointer(glSamplePassARB) := GLGetProcAddress('glSamplePassARB');

   // GL_ARB_multisample
   pointer(glCompressedTexImage3DARB) := GLGetProcAddress('glCompressedTexImage3DARB');
   pointer(glCompressedTexImage2DARB) := GLGetProcAddress('glCompressedTexImage2DARB');
   pointer(glCompressedTexImage1DARB) := GLGetProcAddress('glCompressedTexImage1DARB');
   pointer(glCompressedTexSubImage3DARB) := GLGetProcAddress('glCompressedTexSubImage3DARB');
   pointer(glCompressedTexSubImage2DARB) := GLGetProcAddress('glCompressedTexSubImage2DARB');
   pointer(glCompressedTexSubImage1DARB) := GLGetProcAddress('glCompressedTexSubImage1DARB');
   pointer(glGetCompressedTexImageARB) := GLGetProcAddress('glGetCompressedTexImageARB');

   // GL_ARB_vertex_program
   pointer(glVertexAttrib1sARB) := GLGetProcAddress('glVertexAttrib1sARB');
   pointer(glVertexAttrib1fARB) := GLGetProcAddress('glVertexAttrib1fARB');
   pointer(glVertexAttrib1dARB) := GLGetProcAddress('glVertexAttrib1dARB');
   pointer(glVertexAttrib2sARB) := GLGetProcAddress('glVertexAttrib2sARB');
   pointer(glVertexAttrib2fARB) := GLGetProcAddress('glVertexAttrib2fARB');
   pointer(glVertexAttrib2dARB) := GLGetProcAddress('glVertexAttrib2dARB');
   pointer(glVertexAttrib3sARB) := GLGetProcAddress('glVertexAttrib3sARB');
   pointer(glVertexAttrib3fARB) := GLGetProcAddress('glVertexAttrib3fARB');
   pointer(glVertexAttrib3dARB) := GLGetProcAddress('glVertexAttrib3dARB');
   pointer(glVertexAttrib4sARB) := GLGetProcAddress('glVertexAttrib4sARB');
   pointer(glVertexAttrib4fARB) := GLGetProcAddress('glVertexAttrib4fARB');
   pointer(glVertexAttrib4dARB) := GLGetProcAddress('glVertexAttrib4dARB');
   pointer(glVertexAttrib4NubARB) := GLGetProcAddress('glVertexAttrib4NubARB');
   pointer(glVertexAttrib1svARB) := GLGetProcAddress('glVertexAttrib1svARB');
   pointer(glVertexAttrib1fvARB) := GLGetProcAddress('glVertexAttrib1fvARB');
   pointer(glVertexAttrib1dvARB) := GLGetProcAddress('glVertexAttrib1dvARB');
   pointer(glVertexAttrib2svARB) := GLGetProcAddress('glVertexAttrib2svARB');
   pointer(glVertexAttrib2fvARB) := GLGetProcAddress('glVertexAttrib2fvARB');
   pointer(glVertexAttrib2dvARB) := GLGetProcAddress('glVertexAttrib2dvARB');
   pointer(glVertexAttrib3svARB) := GLGetProcAddress('glVertexAttrib3svARB');
   pointer(glVertexAttrib3fvARB) := GLGetProcAddress('glVertexAttrib3fvARB');
   pointer(glVertexAttrib3dvARB) := GLGetProcAddress('glVertexAttrib3dvARB');
   pointer(glVertexAttrib4bvARB) := GLGetProcAddress('glVertexAttrib4bvARB');
   pointer(glVertexAttrib4svARB) := GLGetProcAddress('glVertexAttrib4svARB');
   pointer(glVertexAttrib4ivARB) := GLGetProcAddress('glVertexAttrib4ivARB');
   pointer(glVertexAttrib4ubvARB) := GLGetProcAddress('glVertexAttrib4ubvARB');
   pointer(glVertexAttrib4usvARB) := GLGetProcAddress('glVertexAttrib4usvARB');
   pointer(glVertexAttrib4uivARB) := GLGetProcAddress('glVertexAttrib4uivARB');
   pointer(glVertexAttrib4fvARB) := GLGetProcAddress('glVertexAttrib4fvARB');
   pointer(glVertexAttrib4dvARB) := GLGetProcAddress('glVertexAttrib4dvARB');
   pointer(glVertexAttrib4NbvARB) := GLGetProcAddress('glVertexAttrib4NbvARB');
   pointer(glVertexAttrib4NsvARB) := GLGetProcAddress('glVertexAttrib4NsvARB');
   pointer(glVertexAttrib4NivARB) := GLGetProcAddress('glVertexAttrib4NivARB');
   pointer(glVertexAttrib4NubvARB) := GLGetProcAddress('glVertexAttrib4NubvARB');
   pointer(glVertexAttrib4NusvARB) := GLGetProcAddress('glVertexAttrib4NusvARB');
   pointer(glVertexAttrib4NuivARB) := GLGetProcAddress('glVertexAttrib4NuivARB');
   pointer(glVertexAttribPointerARB) := GLGetProcAddress('glVertexAttribPointerARB');
   pointer(glEnableVertexAttribArrayARB) := GLGetProcAddress('glEnableVertexAttribArrayARB');
   pointer(glDisableVertexAttribArrayARB) := GLGetProcAddress('glDisableVertexAttribArrayARB');
   pointer(glProgramStringARB) := GLGetProcAddress('glProgramStringARB');
   pointer(glBindProgramARB) := GLGetProcAddress('glBindProgramARB');
   pointer(glDeleteProgramsARB) := GLGetProcAddress('glDeleteProgramsARB');
   pointer(glGenProgramsARB) := GLGetProcAddress('glGenProgramsARB');
   pointer(glProgramEnvParameter4dARB) := GLGetProcAddress('glProgramEnvParameter4dARB');
   pointer(glProgramEnvParameter4dvARB) := GLGetProcAddress('glProgramEnvParameter4dvARB');
   pointer(glProgramEnvParameter4fARB) := GLGetProcAddress('glProgramEnvParameter4fARB');
   pointer(glProgramEnvParameter4fvARB) := GLGetProcAddress('glProgramEnvParameter4fvARB');
   pointer(glProgramLocalParameter4dARB) := GLGetProcAddress('glProgramLocalParameter4dARB');
   pointer(glProgramLocalParameter4dvARB) := GLGetProcAddress('glProgramLocalParameter4dvARB');
   pointer(glProgramLocalParameter4fARB) := GLGetProcAddress('glProgramLocalParameter4fARB');
   pointer(glProgramLocalParameter4fvARB) := GLGetProcAddress('glProgramLocalParameter4fvARB');
   pointer(glGetProgramEnvParameterdvARB) := GLGetProcAddress('glGetProgramEnvParameterdvARB');
   pointer(glGetProgramEnvParameterfvARB) := GLGetProcAddress('glGetProgramEnvParameterfvARB');
   pointer(glGetProgramLocalParameterdvARB) := GLGetProcAddress('glGetProgramLocalParameterdvARB');
   pointer(glGetProgramLocalParameterfvARB) := GLGetProcAddress('glGetProgramLocalParameterfvARB');
   pointer(glGetProgramivARB) := GLGetProcAddress('glGetProgramivARB');
   pointer(glGetProgramStringARB) := GLGetProcAddress('glGetProgramStringARB');
   pointer(glGetVertexAttribdvARB) := GLGetProcAddress('glGetVertexAttribdvARB');
   pointer(glGetVertexAttribfvARB) := GLGetProcAddress('glGetVertexAttribfvARB');
   pointer(glGetVertexAttribivARB) := GLGetProcAddress('glGetVertexAttribivARB');
   pointer(glGetVertexAttribPointervARB) := GLGetProcAddress('glGetVertexAttribPointervARB');
   pointer(glIsProgramARB) := GLGetProcAddress('glIsProgramARB');

   // GL_ARB_vertex_buffer_object
   pointer(glBindBufferARB) := GLGetProcAddress('glBindBufferARB');
   pointer(glDeleteBuffersARB) := GLGetProcAddress('glDeleteBuffersARB');
   pointer(glGenBuffersARB) := GLGetProcAddress('glGenBuffersARB');
   pointer(glIsBufferARB) := GLGetProcAddress('glIsBufferARB');
   pointer(glBufferDataARB) := GLGetProcAddress('glBufferDataARB');
   pointer(glBufferSubDataARB) := GLGetProcAddress('glBufferSubDataARB');
   pointer(glGetBufferSubDataARB) := GLGetProcAddress('glGetBufferSubDataARB');
   pointer(glMapBufferARB) := GLGetProcAddress('glMapBufferARB');
   pointer(glUnmapBufferARB) := GLGetProcAddress('glUnmapBufferARB');
   pointer(glGetBufferParameterivARB) := GLGetProcAddress('glGetBufferParameterivARB');
   pointer(glGetBufferPointervARB) := GLGetProcAddress('glGetBufferPointervARB');

   // GL_ARB_shader_objects
   pointer(glDeleteObjectARB) := GLGetProcAddress('glDeleteObjectARB');
   pointer(glGetHandleARB) := GLGetProcAddress('glGetHandleARB');
   pointer(glDetachObjectARB) := GLGetProcAddress('glDetachObjectARB');
   pointer(glCreateShaderObjectARB) := GLGetProcAddress('glCreateShaderObjectARB');
   pointer(glShaderSourceARB) := GLGetProcAddress('glShaderSourceARB');
   pointer(glCompileShaderARB) := GLGetProcAddress('glCompileShaderARB');
   pointer(glCreateProgramObjectARB) := GLGetProcAddress('glCreateProgramObjectARB');
   pointer(glAttachObjectARB) := GLGetProcAddress('glAttachObjectARB');
   pointer(glLinkProgramARB) := GLGetProcAddress('glLinkProgramARB');
   pointer(glUseProgramObjectARB) := GLGetProcAddress('glUseProgramObjectARB');
   pointer(glValidateProgramARB) := GLGetProcAddress('glValidateProgramARB');
   pointer(glUniform1fARB) := GLGetProcAddress('glUniform1fARB');
   pointer(glUniform2fARB) := GLGetProcAddress('glUniform2fARB');
   pointer(glUniform3fARB) := GLGetProcAddress('glUniform3fARB');
   pointer(glUniform4fARB) := GLGetProcAddress('glUniform4fARB');
   pointer(glUniform1iARB) := GLGetProcAddress('glUniform1iARB');
   pointer(glUniform2iARB) := GLGetProcAddress('glUniform2iARB');
   pointer(glUniform3iARB) := GLGetProcAddress('glUniform3iARB');
   pointer(glUniform4iARB) := GLGetProcAddress('glUniform4iARB');
   pointer(glUniform1fvARB) := GLGetProcAddress('glUniform1fvARB');
   pointer(glUniform2fvARB) := GLGetProcAddress('glUniform2fvARB');
   pointer(glUniform3fvARB) := GLGetProcAddress('glUniform3fvARB');
   pointer(glUniform4fvARB) := GLGetProcAddress('glUniform4fvARB');
   pointer(glUniform1ivARB) := GLGetProcAddress('glUniform1ivARB');
   pointer(glUniform2ivARB) := GLGetProcAddress('glUniform2ivARB');
   pointer(glUniform3ivARB) := GLGetProcAddress('glUniform3ivARB');
   pointer(glUniform4ivARB) := GLGetProcAddress('glUniform4ivARB');
   pointer(glUniformMatrix2fvARB) := GLGetProcAddress('glUniformMatrix2fvARB');
   pointer(glUniformMatrix3fvARB) := GLGetProcAddress('glUniformMatrix3fvARB');
   pointer(glUniformMatrix4fvARB) := GLGetProcAddress('glUniformMatrix4fvARB');
   pointer(glGetObjectParameterfvARB) := GLGetProcAddress('glGetObjectParameterfvARB');
   pointer(glGetObjectParameterivARB) := GLGetProcAddress('glGetObjectParameterivARB');
   pointer(glGetInfoLogARB) := GLGetProcAddress('glGetInfoLogARB');
   pointer(glGetAttachedObjectsARB) := GLGetProcAddress('glGetAttachedObjectsARB');
   pointer(glGetUniformLocationARB) := GLGetProcAddress('glGetUniformLocationARB');
   pointer(glGetActiveUniformARB) := GLGetProcAddress('glGetActiveUniformARB');
   pointer(glGetUniformfvARB) := GLGetProcAddress('glGetUniformfvARB');
   pointer(glGetUniformivARB) := GLGetProcAddress('glGetUniformivARB');
   pointer(glGetShaderSourceARB) := GLGetProcAddress('glGetShaderSourceARB');

   // GL_ARB_vertex_shader
   pointer(glBindAttribLocationARB) := GLGetProcAddress('glBindAttribLocationARB');
   pointer(glGetActiveAttribARB) := GLGetProcAddress('glGetActiveAttribARB');
   pointer(glGetAttribLocationARB) := GLGetProcAddress('glGetAttribLocationARB');

   // GL_EXT_blend_color
   pointer(glBlendColorEXT) := GLGetProcAddress('glBlendColorEXT');

   // GL_EXT_texture3D
   pointer(glTexImage3DEXT) := GLGetProcAddress('glTexImage3DEXT');

   // GL_SGIS_multisample
   pointer(glSampleMaskSGIS) := GLGetProcAddress('glSampleMaskSGIS');
   pointer(glSamplePatternSGIS) := GLGetProcAddress('glSamplePatternSGIS');

   // GL_EXT_blend_minmax
   pointer(glBlendEquationEXT) := GLGetProcAddress('glBlendEquationEXT');

   // GL_EXT_paletted_texture
   pointer(glGetColorTableParameterivEXT) := GLGetProcAddress('glGetColorTableParameterivEXT');
   pointer(glGetColorTableParameterfvEXT) := GLGetProcAddress('glGetColorTableParameterfvEXT');

   // GL_EXT_draw_range_elements
   pointer(glDrawRangeElementsEXT) := GLGetProcAddress('glDrawRangeElementsEXT');

   // GL_EXT_secondary_color
   pointer(glSecondaryColor3bEXT) := GLGetProcAddress('glSecondaryColor3bEXT');
   pointer(glSecondaryColor3bvEXT) := GLGetProcAddress('glSecondaryColor3bvEXT');
   pointer(glSecondaryColor3dEXT) := GLGetProcAddress('glSecondaryColor3dEXT');
   pointer(glSecondaryColor3dvEXT) := GLGetProcAddress('glSecondaryColor3dvEXT');
   pointer(glSecondaryColor3fEXT) := GLGetProcAddress('glSecondaryColor3fEXT');
   pointer(glSecondaryColor3fvEXT) := GLGetProcAddress('glSecondaryColor3fvEXT');
   pointer(glSecondaryColor3iEXT) := GLGetProcAddress('glSecondaryColor3iEXT');
   pointer(glSecondaryColor3ivEXT) := GLGetProcAddress('glSecondaryColor3ivEXT');
   pointer(glSecondaryColor3sEXT) := GLGetProcAddress('glSecondaryColor3sEXT');
   pointer(glSecondaryColor3svEXT) := GLGetProcAddress('glSecondaryColor3svEXT');
   pointer(glSecondaryColor3ubEXT) := GLGetProcAddress('glSecondaryColor3ubEXT');
   pointer(glSecondaryColor3ubvEXT) := GLGetProcAddress('glSecondaryColor3ubvEXT');
   pointer(glSecondaryColor3uiEXT) := GLGetProcAddress('glSecondaryColor3uiEXT');
   pointer(glSecondaryColor3uivEXT) := GLGetProcAddress('glSecondaryColor3uivEXT');
   pointer(glSecondaryColor3usEXT) := GLGetProcAddress('glSecondaryColor3usEXT');
   pointer(glSecondaryColor3usvEXT) := GLGetProcAddress('glSecondaryColor3usvEXT');
   pointer(glSecondaryColorPointerEXT) := GLGetProcAddress('glSecondaryColorPointerEXT');

   // GL_EXT_multi_draw_arrays
   pointer(glMultiDrawArraysEXT) := GLGetProcAddress('glMultiDrawArraysEXT');
   pointer(glMultiDrawElementsEXT) := GLGetProcAddress('glMultiDrawElementsEXT');

   // GL_EXT_fog_coord
   pointer(glFogCoordfEXT) := GLGetProcAddress('glFogCoordfEXT');
   pointer(glFogCoordfvEXT) := GLGetProcAddress('glFogCoordfvEXT');
   pointer(glFogCoorddEXT) := GLGetProcAddress('glFogCoorddEXT');
   pointer(glFogCoorddvEXT) := GLGetProcAddress('glFogCoorddvEXT');
   pointer(glFogCoordPointerEXT) := GLGetProcAddress('glFogCoordPointerEXT');

   // GL_EXT_blend_func_separate
   pointer(glBlendFuncSeparateEXT) := GLGetProcAddress('glBlendFuncSeparateEXT');

   // GL_NV_vertex_array_range
   pointer(glFlushVertexArrayRangeNV) := GLGetProcAddress('glFlushVertexArrayRangeNV');
   pointer(glVertexArrayRangeNV) := GLGetProcAddress('glVertexArrayRangeNV');
   pointer(wglAllocateMemoryNV) := GLGetProcAddress('wglAllocateMemoryNV');
   pointer(wglFreeMemoryNV) := GLGetProcAddress('wglFreeMemoryNV');

   // GL_NV_register_combiners
   pointer(glCombinerParameterfvNV) := GLGetProcAddress('glCombinerParameterfvNV');
   pointer(glCombinerParameterfNV) := GLGetProcAddress('glCombinerParameterfNV');
   pointer(glCombinerParameterivNV) := GLGetProcAddress('glCombinerParameterivNV');
   pointer(glCombinerParameteriNV) := GLGetProcAddress('glCombinerParameteriNV');
   pointer(glCombinerInputNV) := GLGetProcAddress('glCombinerInputNV');
   pointer(glCombinerOutputNV) := GLGetProcAddress('glCombinerOutputNV');
   pointer(glFinalCombinerInputNV) := GLGetProcAddress('glFinalCombinerInputNV');
   pointer(glGetCombinerInputParameterfvNV) := GLGetProcAddress('glGetCombinerInputParameterfvNV');
   pointer(glGetCombinerInputParameterivNV) := GLGetProcAddress('glGetCombinerInputParameterivNV');
   pointer(glGetCombinerOutputParameterfvNV) := GLGetProcAddress('glGetCombinerOutputParameterfvNV');
   pointer(glGetCombinerOutputParameterivNV) := GLGetProcAddress('glGetCombinerOutputParameterivNV');
   pointer(glGetFinalCombinerInputParameterfvNV) := GLGetProcAddress('glGetFinalCombinerInputParameterfvNV');
   pointer(glGetFinalCombinerInputParameterivNV) := GLGetProcAddress('glGetFinalCombinerInputParameterivNV');

   // GL_NV_fence
   pointer(glGenFencesNV) := GLGetProcAddress('glGenFencesNV');
   pointer(glDeleteFencesNV) := GLGetProcAddress('glDeleteFencesNV');
   pointer(glSetFenceNV) := GLGetProcAddress('glSetFenceNV');
   pointer(glTestFenceNV) := GLGetProcAddress('glTestFenceNV');
   pointer(glFinishFenceNV) := GLGetProcAddress('glFinishFenceNV');
   pointer(glIsFenceNV) := GLGetProcAddress('glIsFenceNV');
   pointer(glGetFenceivNV) := GLGetProcAddress('glGetFenceivNV');

   // GL_NV_occlusion_query
   pointer(glGenOcclusionQueriesNV) := GLGetProcAddress('glGenOcclusionQueriesNV');
   pointer(glDeleteOcclusionQueriesNV) := GLGetProcAddress('glDeleteOcclusionQueriesNV');
   pointer(glIsOcclusionQueryNV) := GLGetProcAddress('glIsOcclusionQueryNV');
   pointer(glBeginOcclusionQueryNV) := GLGetProcAddress('glBeginOcclusionQueryNV');
   pointer(glEndOcclusionQueryNV) := GLGetProcAddress('glEndOcclusionQueryNV');
   pointer(glGetOcclusionQueryivNV) := GLGetProcAddress('glGetOcclusionQueryivNV');
   pointer(glGetOcclusionQueryuivNV) := GLGetProcAddress('glGetOcclusionQueryuivNV');

   // GL_MESA_resize_buffers
   pointer(glResizeBuffersMESA) := GLGetProcAddress('glResizeBuffersMESA');

   // GL_3DFX_tbuffer
   pointer(glTbufferMask3DFX) := GLGetProcAddress('glTbufferMask3DFX');

   // GL_EXT_multisample
   pointer(glSampleMaskEXT) := GLGetProcAddress('glSampleMaskEXT');
   pointer(glSamplePatternEXT) := GLGetProcAddress('glSamplePatternEXT');

   // GL_SGIS_texture_color_mask
   pointer(glTextureColorMaskSGIS) := GLGetProcAddress('glTextureColorMaskSGIS');

   // GLU extensions
   pointer(gluNurbsCallbackDataEXT) := GLGetProcAddress('gluNurbsCallbackDataEXT');
   pointer(gluNewNurbsTessellatorEXT) := GLGetProcAddress('gluNewNurbsTessellatorEXT');
   pointer(gluDeleteNurbsTessellatorEXT) := GLGetProcAddress('gluDeleteNurbsTessellatorEXT');

   // GL_NV_vertex_program
   pointer(glAreProgramsResidentNV) := GLGetProcAddress('glAreProgramsResidentNV');
   pointer(glBindProgramNV) := GLGetProcAddress('glBindProgramNV');
   pointer(glDeleteProgramsNV) := GLGetProcAddress('glDeleteProgramsNV');
   pointer(glExecuteProgramNV) := GLGetProcAddress('glExecuteProgramNV');
   pointer(glGenProgramsNV) := GLGetProcAddress('glGenProgramsNV');
   pointer(glGetProgramParameterdvNV) := GLGetProcAddress('glGetProgramParameterdvNV');
   pointer(glGetProgramParameterfvNV) := GLGetProcAddress('glGetProgramParameterfvNV');
   pointer(glGetProgramivNV) := GLGetProcAddress('glGetProgramivNV');
   pointer(glGetProgramStringNV) := GLGetProcAddress('glGetProgramStringNV');
   pointer(glGetTrackMatrixivNV) := GLGetProcAddress('glGetTrackMatrixivNV');
   pointer(glGetVertexAttribdvNV) := GLGetProcAddress('glGetVertexAttribdvNV');
   pointer(glGetVertexAttribfvNV) := GLGetProcAddress('glGetVertexAttribfvNV');
   pointer(glGetVertexAttribivNV) := GLGetProcAddress('glGetVertexAttribivNV');
   pointer(glGetVertexAttribPointervNV) := GLGetProcAddress ('glGetVertexAttribPointervNV');
   pointer(glIsProgramNV) := GLGetProcAddress('glIsProgramNV');
   pointer(glLoadProgramNV) := GLGetProcAddress('glLoadProgramNV');
   pointer(glProgramParameter4dNV) := GLGetProcAddress('glProgramParameter4dNV');
   pointer(glProgramParameter4dvNV) := GLGetProcAddress('glProgramParameter4dvNV');
   pointer(glProgramParameter4fNV) := GLGetProcAddress('glProgramParameter4fNV');
   pointer(glProgramParameter4fvNV) := GLGetProcAddress('glProgramParameter4fvNV');
   pointer(glProgramParameters4dvNV) := GLGetProcAddress ('glProgramParameters4dvNV');
   pointer(glProgramParameters4fvNV) := GLGetProcAddress ('glProgramParameters4fvNV');
   pointer(glRequestResidentProgramsNV) := GLGetProcAddress ('glRequestResidentProgramsNV');
   pointer(glTrackMatrixNV) := GLGetProcAddress('glTrackMatrixNV');
   pointer(glVertexAttribPointerNV) := GLGetProcAddress('glVertexAttribPointerNV');
   pointer(glVertexAttrib1dNV) := GLGetProcAddress('glVertexAttrib1dNV');
   pointer(glVertexAttrib1dvNV) := GLGetProcAddress('glVertexAttrib1dvNV');
   pointer(glVertexAttrib1fNV) := GLGetProcAddress('glVertexAttrib1fNV');
   pointer(glVertexAttrib1fvNV) := GLGetProcAddress('glVertexAttrib1fvNV');
   pointer(glVertexAttrib1sNV) := GLGetProcAddress('glVertexAttrib1sNV');
   pointer(glVertexAttrib1svNV) := GLGetProcAddress('glVertexAttrib1svNV');
   pointer(glVertexAttrib2dNV) := GLGetProcAddress('glVertexAttrib2dNV');
   pointer(glVertexAttrib2dvNV) := GLGetProcAddress('glVertexAttrib2dvNV');
   pointer(glVertexAttrib2fNV) := GLGetProcAddress('glVertexAttrib2fNV');
   pointer(glVertexAttrib2fvNV) := GLGetProcAddress('glVertexAttrib2fvNV');
   pointer(glVertexAttrib2sNV) := GLGetProcAddress('glVertexAttrib2sNV');
   pointer(glVertexAttrib2svNV) := GLGetProcAddress('glVertexAttrib2svNV');
   pointer(glVertexAttrib3dNV) := GLGetProcAddress('glVertexAttrib3dNV');
   pointer(glVertexAttrib3dvNV) := GLGetProcAddress('glVertexAttrib3dvNV');
   pointer(glVertexAttrib3fNV) := GLGetProcAddress('glVertexAttrib3fNV');
   pointer(glVertexAttrib3fvNV) := GLGetProcAddress('glVertexAttrib3fvNV');
   pointer(glVertexAttrib3sNV) := GLGetProcAddress('glVertexAttrib3sNV');
   pointer(glVertexAttrib3svNV) := GLGetProcAddress('glVertexAttrib3svNV');
   pointer(glVertexAttrib4dNV) := GLGetProcAddress('glVertexAttrib4dNV');
   pointer(glVertexAttrib4dvNV) := GLGetProcAddress('glVertexAttrib4dvNV');
   pointer(glVertexAttrib4fNV) := GLGetProcAddress('glVertexAttrib4fNV');
   pointer(glVertexAttrib4fvNV) := GLGetProcAddress('glVertexAttrib4fvNV');
   pointer(glVertexAttrib4sNV) := GLGetProcAddress('glVertexAttrib4sNV');
   pointer(glVertexAttrib4svNV) := GLGetProcAddress('glVertexAttrib4svNV');
   pointer(glVertexAttrib4ubvNV) := GLGetProcAddress('glVertexAttrib4ubvNV');
   pointer(glVertexAttribs1dvNV) := GLGetProcAddress('glVertexAttribs1dvNV');
   pointer(glVertexAttribs1fvNV) := GLGetProcAddress('glVertexAttribs1fvNV');
   pointer(glVertexAttribs1svNV) := GLGetProcAddress('glVertexAttribs1svNV');
   pointer(glVertexAttribs2dvNV) := GLGetProcAddress('glVertexAttribs2dvNV');
   pointer(glVertexAttribs2fvNV) := GLGetProcAddress('glVertexAttribs2fvNV');
   pointer(glVertexAttribs2svNV) := GLGetProcAddress('glVertexAttribs2svNV');
   pointer(glVertexAttribs3dvNV) := GLGetProcAddress('glVertexAttribs3dvNV');
   pointer(glVertexAttribs3fvNV) := GLGetProcAddress('glVertexAttribs3fvNV');
   pointer(glVertexAttribs3svNV) := GLGetProcAddress('glVertexAttribs3svNV');
   pointer(glVertexAttribs4dvNV) := GLGetProcAddress('glVertexAttribs4dvNV');
   pointer(glVertexAttribs4fvNV) := GLGetProcAddress('glVertexAttribs4fvNV');
   pointer(glVertexAttribs4svNV) := GLGetProcAddress('glVertexAttribs4svNV');
   pointer(glVertexAttribs4ubvNV) := GLGetProcAddress('glVertexAttribs4ubvN');

   // GL_ATI_draw_buffers
   pointer(glDrawBuffersATI) := GLGetProcAddress('glDrawBuffersATI');
