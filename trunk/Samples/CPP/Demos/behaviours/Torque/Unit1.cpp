...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
	...
	// ...using properties...
	GetOrCreateInertia(Cube->Behaviours)->RotationDamping->Constant = 1;
	GetOrCreateInertia(Cube->Behaviours)->RotationDamping->Linear = 1;
	GetOrCreateInertia(Cube->Behaviours)->RotationDamping->Quadratic = 0;
