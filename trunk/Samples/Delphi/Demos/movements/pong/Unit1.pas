...
uses
  Windows, Forms, Classes, SysUtils, ExtCtrls, Controls, Dialogs,
  //GLS
  GLScene, GLObjects, GLTexture, GLVectorGeometry, GLCadencer, GLWin32Viewer,
  GLSpaceText, GLShadowPlane, GLShadowVolume, GLCrossPlatform, GLMaterial,
