...
uses
  Winapi.Windows,
  System.SysUtils, System.Classes, Vcl.Graphics, Vcl.Imaging.Jpeg, Vcl.Controls, Vcl.Forms,
  Vcl.Dialogs, Vcl.Menus, Vcl.ExtDlgs, Vcl.ExtCtrls, Vcl.ComCtrls, Vcl.StdCtrls,
  //GLS
