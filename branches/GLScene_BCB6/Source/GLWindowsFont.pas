...
begin
  ...
  begin
    ...
    try
      ...
      begin
        S.Read(F1, SizeOf(FCharRects[i].Coord[0]));
        S.Read(F2, SizeOf(FCharRects[i].Coord[1]));
        S.Read(F3, SizeOf(FCharRects[i].Coord[2]));
        S.Read(F4, SizeOf(FCharRects[i].Coord[3]));
...
begin
  ...
  try
    ...
    for i := 0 to High(FCharRects) do
    begin
      S.Write(FCharRects[i].Coord[0], SizeOf(FCharRects[i].Coord[0]));
      S.Write(FCharRects[i].Coord[1], SizeOf(FCharRects[i].Coord[1]));
      S.Write(FCharRects[i].Coord[2], SizeOf(FCharRects[i].Coord[2]));
      S.Write(FCharRects[i].Coord[3], SizeOf(FCharRects[i].Coord[3]));
    end;
    // char wds
