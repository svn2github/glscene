...
uses
  ...
  OpenGLAdapter, OpenGLTokens, GLPerlinNoise3D, GLPersistentClasses, GLPolynomials,
  GLSpacePartition, GLSpline, GLVectorGeometry, GLVectorLists, GLVectorTypes,
  GLVerletTypes, GLVerletHairClasses, XCollection, XOpenGL, Const3DS, DDSImage,
  ...
  Q3MD3, GLS_RGBE, TGA, Types3DS, TypesB3D, TypesMD2, TypesMDC, TypesMS3D,
  ...
  GLScreen, GLViewer, GLWidgetContext, FShaderUniformEditor, GLAsmShader,
