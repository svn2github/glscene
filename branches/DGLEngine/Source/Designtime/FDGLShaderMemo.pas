...
type
  ...
  TDGLShaderMemoForm = class(TForm)
...
procedure TDGLShaderMemoForm.FormCreate(Sender: TObject);
var
  reg: TRegistry;
  No: Integer;
  item: TMenuItem;
...
procedure TDGLShaderMemoForm.FormDestroy(Sender: TObject);
var
  reg: TRegistry;
begin
  reg := TRegistry.Create;
...
procedure TDGLShaderMemoForm.FormShow(Sender: TObject);
begin
  if GLSLMemo.Lines.Count = 0 then
    GLSLMemo.Lines.Add('');
end;

procedure TDGLShaderMemoForm.GLSLMemoGutterClick(Sender: TObject; LineNo: Integer);
begin
  with GLSLMemo do
  begin
...
procedure TDGLShaderMemoForm.GLSLMemoGutterDraw(Sender: TObject; ACanvas: TCanvas;
...
procedure TDGLShaderMemoForm.GLSLMemoUndoChange(Sender: TObject; CanUndo, CanRedo: Boolean);
begin
  TBUndo.Enabled := CanUndo;
  TBRedo.Enabled := CanRedo;
end;

procedure TDGLShaderMemoForm.OnTemplateClick(Sender: TObject);
begin
  GLSLMemo.InsertTemplate(cTemplates[TMenuItem(Sender).Tag]);
end;

procedure TDGLShaderMemoForm.TBCommentClick(Sender: TObject);
var
  I: Integer;
  S, E: Integer;
begin
...
procedure TDGLShaderMemoForm.TBUncomentClick(Sender: TObject);
var
  I: Integer;
  S, E: Integer;
  C: string;
...
procedure TDGLShaderMemoForm.TBCopyClick(Sender: TObject);
begin
  GLSLMemo.CopyToClipBoard;
end;

procedure TDGLShaderMemoForm.TBCutClick(Sender: TObject);
begin
  GLSLMemo.CutToClipBoard;
end;

procedure TDGLShaderMemoForm.TBIncIndentClick(Sender: TObject);
var
  I: Integer;
  S, E: Integer;
begin
...
procedure TDGLShaderMemoForm.TBDecIndentClick(Sender: TObject);
var
  I, J: Integer;
  S, E: Integer;
  C: string;
...
procedure TDGLShaderMemoForm.TBOpenClick(Sender: TObject);
begin
...
procedure TDGLShaderMemoForm.TBPasteClick(Sender: TObject);
begin
  GLSLMemo.PasteFromClipBoard;
end;

procedure TDGLShaderMemoForm.TBRedoClick(Sender: TObject);
begin
  with GLSLMemo do
  begin
    Redo;
...
procedure TDGLShaderMemoForm.TBSaveClick(Sender: TObject);
begin
...
procedure TDGLShaderMemoForm.TBStayOnTopClick(Sender: TObject);
begin
...
procedure TDGLShaderMemoForm.TBUndoClick(Sender: TObject);
begin
  with GLSLMemo do
  begin
    Undo;
...
procedure TDGLShaderMemoForm.CheckButtonClick(Sender: TObject);
begin
