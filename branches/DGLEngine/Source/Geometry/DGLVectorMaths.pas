...
type
  ...
  TTransType = (ttScaleX, ttScaleY, ttScaleZ, ttShearXY, ttShearXZ, ttShearYZ, ttRotateX, ttRotateY, ttRotateZ, ttTranslateX, ttTranslateY, ttTranslateZ, ttPerspectiveX, ttPerspectiveY, ttPerspectiveZ, ttPerspectiveW);
...
const
  ...
  IdentityMatrix: TAffineMatrix               = (V: ((X: 1; Y: 0; Z: 0), (X: 0; Y: 1; Z: 0), (X: 0; Y: 0; Z: 1)));
  IdentityHmgMatrix: TMatrix                  = (V: ((X: 1; Y: 0; Z: 0; W: 0), (X: 0; Y: 1; Z: 0; W: 0), (X: 0; Y: 0; Z: 1; W: 0), (X: 0; Y: 0; Z: 0; W: 1)));
  IdentityHmgDblMatrix: THomogeneousDblMatrix = (V: ((X: 1; Y: 0; Z: 0; W: 0), (X: 0; Y: 1; Z: 0; W: 0), (X: 0; Y: 0; Z: 1; W: 0), (X: 0; Y: 0; Z: 0; W: 1)));
  EmptyMatrix: TAffineMatrix                  = (V: ((X: 0; Y: 0; Z: 0), (X: 0; Y: 0; Z: 0), (X: 0; Y: 0; Z: 0)));
  EmptyHmgMatrix: TMatrix                     = (V: ((X: 0; Y: 0; Z: 0; W: 0), (X: 0; Y: 0; Z: 0; W: 0), (X: 0; Y: 0; Z: 0; W: 0), (X: 0; Y: 0; Z: 0; W: 0)));
...
//function CreateProjectionMatrix(const Rigth, Left, Top, Bottom: Integer):TMatrix; overload;
function CreatePerspectiveMatrix(FOV, Aspect, ZNear, ZFar: Single): TMatrix;
//function CreateProjectionMatrix(const fov: single; aspect: single; znear:single; zfar: single): TMatrix; overload;
...
function IntersectSphereBox(const SpherePos: TVector; const SphereRadius: Single; const BoxMatrix: TMatrix; const BoxScale: TAffineVector; intersectPoint: PAffineVector = nil; normal: PAffineVector = nil; depth: PSingle = nil): Boolean;
...
function GetSafeTurnAngle(const AOriginalPosition, AOriginalUpVector, ATargetPosition, AMoveAroundTargetCenter: TVector): TVector2f; overload;
function GetSafeTurnAngle(const AOriginalPosition, AOriginalUpVector, ATargetPosition, AMoveAroundTargetCenter: TAffineVector): TVector2f; overload;
...
// VectorArrayAdd
//
procedure VectorArrayAdd(const src: PAffineVectorArray; const delta: TAffineVector; const nb: Integer; dest: PAffineVectorArray);
{$IFNDEF GLS_NO_ASM}
asm
  or    ecx, ecx
  jz    @@End
...
asm
  ...
  {$ELSE}
begin
  result := V1.V[0] * V2.V[0] + V1.V[1] * V2.V[1] + V1.V[2] * V2.V[2] + V1.V[3] * V2.V[3];
  {$ENDIF}
end;
...
asm
  ...
  {$ELSE}
begin
  result := direction.V[0] * (p.V[0] - origin.V[0]) + direction.V[1] * (p.V[1] - origin.V[1]) + direction.V[2] * (p.V[2] - origin.V[2]);
  {$ENDIF}
end;
...
begin
  result := (Rect1.Left = Rect2.Left) and (Rect1.Right = Rect2.Right) and (Rect1.Top = Rect2.Top) and (Rect1.Bottom = Rect2.Left);
end;
...
begin
  dest.V[0].X := src.V[0].X;
  dest.V[0].Y := src.V[0].Y;
  dest.V[0].Z := src.V[0].Z;
  dest.V[1].X := src.V[1].X;
  dest.V[1].Y := src.V[1].Y;
  dest.V[1].Z := src.V[1].Z;
  dest.V[2].X := src.V[2].X;
  dest.V[2].Y := src.V[2].Y;
  dest.V[2].Z := src.V[2].Z;
end;
...
begin
  result := M.X.X * MatrixDetInternal(M.Y.Y, M.Z.Y, M.W.Y, M.Y.Z, M.Z.Z, M.W.Z, M.Y.W, M.Z.W, M.W.W) - M.X.Y * MatrixDetInternal(M.Y.X, M.Z.X, M.W.X, M.Y.Z, M.Z.Z, M.W.Z, M.Y.W, M.Z.W, M.W.W) + M.X.Z *
    MatrixDetInternal(M.Y.X, M.Z.X, M.W.X, M.Y.Y, M.Z.Y, M.W.Y, M.Y.W, M.Z.W, M.W.W) - M.X.W * MatrixDetInternal(M.Y.X, M.Z.X, M.W.X, M.Y.Y, M.Z.Y, M.W.Y, M.Y.Z, M.Z.Z, M.W.Z);
end;
...
begin
  M.V[0].V[3] := 0;
  NormalizeVector(M.V[0]);
  M.V[1].V[3] := 0;
  NormalizeVector(M.V[1]);
...
begin
  ...
  result.V[3].V[0] := -(result.V[0].V[0] * mat.V[3].V[0] + result.V[1].V[0] * mat.V[3].V[1] + result.V[2].V[0] * mat.V[3].V[2]);
  result.V[3].V[1] := -(result.V[0].V[1] * mat.V[3].V[0] + result.V[1].V[1] * mat.V[3].V[1] + result.V[2].V[1] * mat.V[3].V[2]);
  result.V[3].V[2] := -(result.V[0].V[2] * mat.V[3].V[0] + result.V[1].V[2] * mat.V[3].V[1] + result.V[2].V[2] * mat.V[3].V[2]);
end;
...
begin
  ...
  result           := CreateTranslationMatrix(AffineVectorMake((viewport.V[2] - 2 * (X - viewport.V[0])) / deltax, (viewport.V[3] - 2 * (Y - viewport.V[1])) / deltay, 0.0));
...
asm
  ...
  {$ELSE}
begin
  result := (point.V[0] - planePoint.V[0]) * planeNormal.V[0] + (point.V[1] - planePoint.V[1]) * planeNormal.V[1] + (point.V[2] - planePoint.V[2]) * planeNormal.V[2];
  {$ENDIF}
end;
...
begin
  ...
  {$ELSE}
  det := Abs((linePt1.V[0] - linePt0.V[0]) * (lineDir0.V[1] * lineDir1.V[2] - lineDir1.V[1] * lineDir0.V[2]) - (linePt1.V[1] - linePt0.V[1]) * (lineDir0.V[0] * lineDir1.V[2] - lineDir1.V[0] * lineDir0.V[2]) + (linePt1.V[2] - linePt0.V[2]) *
    (lineDir0.V[0] * lineDir1.V[1] - lineDir1.V[0] * lineDir0.V[1]));
  {$ENDIF}
  if det < cBIAS then
...
begin
  n := Length(Imag);
  if n >= 1 then
    result.ImagPart.V[0] := Imag[0];
  if n >= 2 then
    result.ImagPart.V[1] := Imag[1];
  if n >= 3 then
    result.ImagPart.V[2] := Imag[2];
...
begin
  ...
  else if (mat.V[0].V[0] > mat.V[1].V[1]) and (mat.V[0].V[0] > mat.V[2].V[2]) then
  begin // Row 0:
  ...
  else if (mat.V[1].V[1] > mat.V[2].V[2]) then
  begin // Row 1:
...
var
  Temp: TQuaternion;
begin
  Temp.RealPart      := qL.RealPart * qR.RealPart - qL.ImagPart.V[X] * qR.ImagPart.V[X] - qL.ImagPart.V[Y] * qR.ImagPart.V[Y] - qL.ImagPart.V[Z] * qR.ImagPart.V[Z];
  Temp.ImagPart.V[X] := qL.RealPart * qR.ImagPart.V[X] + qL.ImagPart.V[X] * qR.RealPart + qL.ImagPart.V[Y] * qR.ImagPart.V[Z] - qL.ImagPart.V[Z] * qR.ImagPart.V[Y];
  Temp.ImagPart.V[Y] := qL.RealPart * qR.ImagPart.V[Y] + qL.ImagPart.V[Y] * qR.RealPart + qL.ImagPart.V[Z] * qR.ImagPart.V[X] - qL.ImagPart.V[X] * qR.ImagPart.V[Z];
  Temp.ImagPart.V[Z] := qL.RealPart * qR.ImagPart.V[Z] + qL.ImagPart.V[Z] * qR.RealPart + qL.ImagPart.V[X] * qR.ImagPart.V[Y] - qL.ImagPart.V[Y] * qR.ImagPart.V[X];
  result             := Temp;
end;
...
var
  ...
  const
    cOrder: array [Low(TEulerOrder) .. High(TEulerOrder)] of array [1 .. 3] of Byte = ((1, 2, 3), (1, 3, 2), (2, 1, 3), // eulXYZ, eulXZY, eulYXZ,
...
function IsInCube(const p, d: TAffineVector): Boolean; overload;
begin
  result := ((p.V[0] >= -d.V[0]) and (p.V[0] <= d.V[0])) and ((p.V[1] >= -d.V[1]) and (p.V[1] <= d.V[1])) and ((p.V[2] >= -d.V[2]) and (p.V[2] <= d.V[2]));
end;
...
begin
  result := 0.5 * ((p2.V[0] - p1.V[0]) * (p3.V[1] - p1.V[1]) - (p3.V[0] - p1.V[0]) * (p2.V[1] - p1.V[1]));
end;
...
begin
  ...
  begin
    ...
    begin
      p3     := @(p^[i]);
      result := result + (p2^.V[0] - p1^.V[0]) * (p3^.V[1] - p1^.V[1]) - (p3^.V[0] - p1^.V[0]) * (p2^.V[1] - p1^.V[1]);
      p2     := p3;
    end;
    result := result * 0.5;
  end;
...
begin
  if V1.V[0] > V.V[0] then
    V.V[0] := V1.V[0];
  if V1.V[1] > V.V[1] then
    V.V[1] := V1.V[1];
  if V1.V[2] > V.V[2] then
    V.V[2] := V1.V[2];
  if V1.V[3] > V.V[3] then
    V.V[3] := V1.V[3];
end;
...
begin
  ...
  cost1 := 1 - cost;
  SetVector(result, Sqrt((M.X.X - cost) / cost1), Sqrt((M.Y.Y - cost) / cost1), Sqrt((M.Z.Z - cost) / cost1), ArcCosine(cost));
  ...
  begin
    ...
    if (i and 4) > 1 then
      ...
      s3 := 1;
    if (Abs(s1 * result.V[X] * sint - M.Y.Z + M.Z.Y) < EPSILON2) and (Abs(s2 * result.V[Y] * sint - M.Z.X + M.X.Z) < EPSILON2) and (Abs(s3 * result.V[Z] * sint - M.X.Y + M.Y.X) < EPSILON2) then
    begin
...
begin
  // calc cosine
  cosom := source.ImagPart.V[0] * dest.ImagPart.V[0] + source.ImagPart.V[1] * dest.ImagPart.V[1] + source.ImagPart.V[2] * dest.ImagPart.V[2] + source.RealPart * dest.RealPart;
...
//
function RayCastPlaneIntersect(const rayStart, rayVector: TVector; const planePoint, planeNormal: TVector; intersectPoint: PVector = nil): Boolean;
var
  sp:   TVector;
  T, d: Single;
begin
...
//
function RayCastPlaneXZIntersect(const rayStart, rayVector: TVector; const planeY: Single; intersectPoint: PVector = nil): Boolean;
var
  T: Single;
begin
...
//
function RayCastTriangleIntersect(const rayStart, rayVector: TVector; const p1, p2, p3: TAffineVector; intersectPoint: PVector = nil; intersectNormal: PVector = nil): Boolean;
var
  pvec:                 TAffineVector;
...
//
function RayCastIntersectsSphere(const rayStart, rayVector: TVector; const sphereCenter: TVector; const SphereRadius: Single): Boolean;
var
  proj: Single;
begin
...
//
function RayCastSphereIntersect(const rayStart, rayVector: TVector; const sphereCenter: TVector; const SphereRadius: Single; var i1, i2: TVector): Integer;
var
  proj, d2:  Single;
  id2:       Integer;
  projPoint: TVector;
    ...
    begin
      for i := 0 to 2 do
        ...
        begin
          ...
          result      := (ResAFV.V[i] >= aMinExtent.V[i]) and (ResAFV.V[i] <= aMaxExtent.V[i]);
          if not result then
            Exit;
        end;
      if intersectPoint <> nil then
...
// IntersectLinePlane
//
function IntersectLinePlane(const point, direction: TVector; const plane: THmgPlane; intersectPoint: PVector = nil): Integer;
var
  a, b: Extended;
  T:    Single;
begin
...
begin
  ...
  if result then
    result := VectorNorm(VectorSubtract(p1, iPoint)) < VectorNorm(VectorSubtract(p1, p2));
  if result then
    Exit;
  ...
  result := RayCastBoxIntersect(p1, RayDir, aMinExtent, aMaxExtent, @iPoint);
  if result then
    result := VectorNorm(VectorSubtract(p1, iPoint)) < VectorNorm(VectorSubtract(p1, p3));
  if result then
    Exit;
  ...
  if result then
    result := VectorNorm(VectorSubtract(p3, iPoint)) < VectorNorm(VectorSubtract(p3, p2));
  if result then
    Exit;
  ...
  if result then
    result := VectorNorm(VectorSubtract(BoxDiagPt, iPnt)) < VectorNorm(VectorSubtract(aMaxExtent, aMinExtent));
  if result then
    Exit;
  ...
  result := RayCastTriangleIntersect(BoxDiagPt, BoxDiagDir, p1, p2, p3, @iPnt);
  if result then
    result := VectorNorm(VectorSubtract(BoxDiagPt, iPnt)) < VectorNorm(VectorSubtract(BoxDiagPt, BoxDiagPt2));
  if result then
    Exit;
  ...
  result := RayCastTriangleIntersect(BoxDiagPt, BoxDiagDir, p1, p2, p3, @iPnt);
  if result then
    result := VectorLength(VectorSubtract(BoxDiagPt, iPnt)) < VectorLength(VectorSubtract(BoxDiagPt, BoxDiagPt));
  if result then
    Exit;
...
// IntersectSphereBox
//
function IntersectSphereBox(const SpherePos: TVector; const SphereRadius: Single; const BoxMatrix: TMatrix; // Up Direction and Right must be normalized!
  ...
  begin
    result := V.V[0] * M.V[0].V[aColumn] + V.V[1] * M.V[1].V[aColumn] + V.V[2] * M.V[2].V[aColumn];
  end;
  ...
  begin
    ...
    result := V.V[0] * M.V[aRow].V[0] + V.V[1] * M.V[aRow].V[1] + V.V[2] * M.V[aRow].V[2];
  end;
...
// IsVolumeClipped
//
function IsVolumeClipped(const objPos: TAffineVector; const objRadius: Single; const Frustum: TFrustum): Boolean;
var
  negRadius: Single;
begin
  negRadius := -objRadius;
  result := (PlaneEvaluatePoint(Frustum.pLeft, objPos) < negRadius) or (PlaneEvaluatePoint(Frustum.pTop, objPos) < negRadius) or (PlaneEvaluatePoint(Frustum.pRight, objPos) < negRadius) or (PlaneEvaluatePoint(Frustum.pBottom, objPos) < negRadius) or
    (PlaneEvaluatePoint(Frustum.pNear, objPos) < negRadius) or (PlaneEvaluatePoint(Frustum.pFar, objPos) < negRadius);
end;

// IsVolumeClipped
//
function IsVolumeClipped(const objPos: TVector; const objRadius: Single; const Frustum: TFrustum): Boolean;
begin
...
// IsVolumeClipped
//
function IsVolumeClipped(const min, max: TAffineVector; const Frustum: TFrustum): Boolean;
begin
  // change box to sphere
  result := IsVolumeClipped(VectorScale(VectorAdd(min, max), 0.5), VectorDistance(min, max) * 0.5, Frustum);
end;
...
begin
  ...
  planeNormal3 := -(planeNormal.V[0] * planePoint.V[0] + planeNormal.V[1] * planePoint.V[1] + planeNormal.V[2] * planePoint.V[2]);
  // Dot product of plane and light position
  dot := planeNormal.V[0] * lightPos.V[0] + planeNormal.V[1] * lightPos.V[1] + planeNormal.V[2] * lightPos.V[2] + planeNormal3 * lightPos.V[3];
...
begin
  result := VectorEquals(Matrix1.V[0], Matrix2.V[0]) and VectorEquals(Matrix1.V[1], Matrix2.V[1]) and VectorEquals(Matrix1.V[2], Matrix2.V[2]);
end;
...
begin
  result := VectorEquals(Matrix1.V[0], Matrix2.V[0]) and VectorEquals(Matrix1.V[1], Matrix2.V[1]) and VectorEquals(Matrix1.V[2], Matrix2.V[2]) and VectorEquals(Matrix1.V[3], Matrix2.V[3]);
end;
...
function VectorMoreThen(const SourceVector, ComparedVector: TVector3f): Boolean; overload;
begin
  result := (SourceVector.V[0] > ComparedVector.V[0]) and (SourceVector.V[1] > ComparedVector.V[1]) and (SourceVector.V[2] > ComparedVector.V[2]);
end;
...
function VectorMoreThen(const SourceVector, ComparedVector: TVector4f): Boolean; overload;
begin
  result := (SourceVector.V[0] > ComparedVector.V[0]) and (SourceVector.V[1] > ComparedVector.V[1]) and (SourceVector.V[2] > ComparedVector.V[2]) and (SourceVector.V[3] > ComparedVector.V[3]);
end;
...
function VectorMoreThen(const SourceVector: TVector3f; const ComparedNumber: Single): Boolean; overload;
begin
  result := (SourceVector.V[0] > ComparedNumber) and (SourceVector.V[1] > ComparedNumber) and (SourceVector.V[2] > ComparedNumber);
end;
...
function VectorMoreThen(const SourceVector: TVector4f; const ComparedNumber: Single): Boolean; overload;
begin
  result := (SourceVector.V[0] > ComparedNumber) and (SourceVector.V[1] > ComparedNumber) and (SourceVector.V[2] > ComparedNumber) and (SourceVector.V[3] > ComparedNumber);
end;
...
function RectanglesIntersect(const ACenterOfRect1, ACenterOfRect2, ASizeOfRect1, ASizeOfRect2: TVector2f): Boolean;
begin
  result := (Abs(ACenterOfRect1.V[0] - ACenterOfRect2.V[0]) < (ASizeOfRect1.V[0] + ASizeOfRect2.V[0]) / 2) and (Abs(ACenterOfRect1.V[1] - ACenterOfRect2.V[1]) < (ASizeOfRect1.V[1] + ASizeOfRect2.V[1]) / 2);
end;

{ : Determine if BigRect completely contains SmallRect. }
function RectangleContains(const ACenterOfBigRect1, ACenterOfSmallRect2, ASizeOfBigRect1, ASizeOfSmallRect2: TVector2f; const AEps: Single = 0.0): Boolean;
begin
  result := (Abs(ACenterOfBigRect1.V[0] - ACenterOfSmallRect2.V[0]) + ASizeOfSmallRect2.V[0] / 2 - ASizeOfBigRect1.V[0] / 2 < AEps) and
    (Abs(ACenterOfBigRect1.V[1] - ACenterOfSmallRect2.V[1]) + ASizeOfSmallRect2.V[1] / 2 - ASizeOfBigRect1.V[1] / 2 < AEps);
end;

function GetSafeTurnAngle(const AOriginalPosition, AOriginalUpVector, ATargetPosition, AMoveAroundTargetCenter: TVector): TVector2f;
var
  pitchangle0, pitchangle1, turnangle0, turnangle1, pitchangledif, turnangledif, dx0, dy0, dz0, dx1, dy1, dz1: Double;
  Sign:                                                                                                        shortint;
begin
...
function GetSafeTurnAngle(const AOriginalPosition, AOriginalUpVector, ATargetPosition, AMoveAroundTargetCenter: TAffineVector): TVector2f;
var
  pitchangle0, pitchangle1, turnangle0, turnangle1, pitchangledif, turnangledif, dx0, dy0, dz0, dx1, dy1, dz1: Double;
  Sign:                                                                                                        shortint;
begin
...
begin
  ...
  pitchNow := ClampValue(pitchNow + DegToRadian(pitchDelta), 0 + 0.025, PI - 0.025);
  ...
  result := VectorAdd(AMovingObjectPosition, VectorSubtract(normalT2C, originalT2C));
end;

{ : Calcualtes Angle between 2 Vectors: (A-CenterPoint) and (B-CenterPoint). In radians. }
function AngleBetweenVectors(const a, b, ACenterPoint: TVector): Single;
begin
  result := ArcCosine(VectorAngleCosine(VectorNormalize(VectorSubtract(a, ACenterPoint)), VectorNormalize(VectorSubtract(b, ACenterPoint))));
end;
...
function ShiftObjectFromCenter(const AOriginalPosition: TVector; const ACenter: TVector; const ADistance: Single; const AFromCenterSpot: Boolean): TVector;
var
  lDirection: TVector;
begin
...
function ShiftObjectFromCenter(const AOriginalPosition: TAffineVector; const ACenter: TAffineVector; const ADistance: Single; const AFromCenterSpot: Boolean): TAffineVector;
var
