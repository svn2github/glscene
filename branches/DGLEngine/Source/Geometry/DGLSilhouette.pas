...
uses Classes, DGLVectorMaths, DGLVectorLists, DGLCrossPlatform;

type
   // TDGLSilhouetteStyle
   //
   TDGLSilhouetteStyle = (ssOmni, ssParallel);
   ...
   {: Base class storing a volume silhouette.<p>
      ...
      This is the base class, you can use the TDGLSilhouette subclass if you
   ...
   TBaseConnectivity = class
       ...
       public
          ...
          procedure CreateSilhouette(const ASilhouetteParameters : TDGLSilhouetteParameters; var ASilhouette : TDGLSilhouette; AddToSilhouette : boolean); virtual;
...
// ------------------
{ TDGLSilhouette }
{$IFDEF GLS_REGIONS}{$REGION 'TDGLSilhouette'}{$ENDIF}
...
procedure TDGLSilhouette.Flush;
begin
   FVertices.Flush;
   FIndices.Flush;
   FCapIndices.Flush;
...
procedure TDGLSilhouette.Clear;
begin
   FVertices.Clear;
   FIndices.Clear;
   FCapIndices.Clear;
...
procedure TDGLSilhouette.ExtrudeVerticesToInfinity(const origin : TAffineVector);
var
...
procedure TDGLSilhouette.AddEdgeToSilhouette(const v0, v1 : TAffineVector; tightButSlow : Boolean);
begin
...
procedure TDGLSilhouette.AddIndexedEdgeToSilhouette(const Vi0, Vi1 : integer);
begin
   Indices.Add(Vi0, Vi1);
end;

procedure TDGLSilhouette.AddCapToSilhouette(const v0, v1, v2 : TAffineVector; tightButSlow : Boolean);
begin
   if tightButSlow then
...
procedure TDGLSilhouette.AddIndexedCapToSilhouette(const vi0, vi1, vi2 : Integer);
begin
...
// ------------------
{ TBaseConnectivity }
{$IFDEF GLS_REGIONS}{$REGION 'TBaseConnectivity'}{$ENDIF}
...
procedure TBaseConnectivity.CreateSilhouette(const ASilhouetteParameters : TDGLSilhouetteParameters; var ASilhouette : TDGLSilhouette; AddToSilhouette : boolean);
begin
  // Purely virtual!
end;
...
procedure TConnectivity.CreateSilhouette(const silhouetteParameters : TDGLSilhouetteParameters; var aSilhouette : TDGLSilhouette; addToSilhouette : boolean);
var
   i : Integer;
   vis : PIntegerArray;
   tVi0, tVi1 : Integer;
...
begin
   if not Assigned(aSilhouette) then
      aSilhouette:=TDGLSilhouette.Create
...
function TConnectivity.ReuseOrFindVertexID( const seenFrom : TAffineVector; aSilhouette : TDGLSilhouette; index : Integer) : Integer;
var
   pMemIndex : PInteger;
   memIndex, i : Integer;
   oldCount : Integer;
...
begin
   ...
   begin
      ...
      if ((edgesVertices^[0]=vertexIndex0) and (edgesVertices^[1]=vertexIndex1))
         or ((edgesVertices^[0]=vertexIndex1) and (edgesVertices^[1]=vertexIndex0)) then
         begin
