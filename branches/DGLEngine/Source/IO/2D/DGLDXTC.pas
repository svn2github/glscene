...
{ @HTML ( DXTC<p>
   ...
   <b>History : </b><font size=-1><ul>
      <li>28/12/15 - SG - Imported and updated from GLScene
   </ul></font>
}
unit DGLDXTC;
...
uses
   SysUtils, DGLCrossPlatform, dglOpenGL, DGLTextureFormat;
...
function DDSHeaderToGLEnum(const DX9header: TDDSHeader;
                           ...
                           out iFormat: TDGLInternalFormat;
...
function GLEnumToDDSHeader(var DX9header: TDDSHeader;
                           ...
                           const useDX11: Boolean;
                           const iFormat: TDGLInternalFormat;
                           const colorFormat: GLEnum;
                           const dataType: GLenum;
                           const bpe: Integer): Boolean;

function FindDDSCompatibleDataFormat(const iFormat: TDGLInternalFormat;
  ...
  begin
    ...
    begin
      ...
      case iFormat of
        ...
        tfRGBA16F:                     dwFourCC := FOURCC_A16B16G16R16F;
        tfINTENSITY32F,
        tfLUMINANCE32F,
        ...
        tfRGBA32F:                     dwFourCC := FOURCC_A32B32G32R32F
        else Result := false;
      end;
    end;
  end
