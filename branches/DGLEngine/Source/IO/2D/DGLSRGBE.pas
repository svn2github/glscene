...
{ : GLSRGBE<p>
  ...
  <li>20/01/10 - JD - Imported from GLScene
  </ul><p>
}
unit DGLSRGBE;
...
uses
  Classes, SysUtils,
  //GLS
  DGLVectorTypes, DGLVectorMaths, DGLCrossPlatform;
...
procedure LoadRLEpixels(Stream: TStream; Dst: PSingle;Scanline_width, Num_scanlines: Integer);
