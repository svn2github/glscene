...
{: GLS.RenderContextInfo<p>
 ...
 <b>History : </b><font size=-1><ul>
      ...
      <li>14/03/09 - DanB - Removed IsVolumeClipped functions, instead replaced with
                            IsVolumeClipped functions in GLS.VectorGeometry.pas that use TFrustrum
      <li>09/10/08 - DanB - Added TRenderContextClippingInfo + IsVolumeClipped
                            functions from GLS.VectorGeometry.pas, added nearClippingDistance
      <li>05/10/08 - DanB - Created from GLS.Texture.pas split
   </ul></font>
}
