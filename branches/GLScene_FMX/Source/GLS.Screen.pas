...
{ : GLS.Screen<p>
  ...
  GLS.CrossPlatform.pas (thanks Predator)
  ...
  <li>03/07/04 - LR - Suppress CurrentScreenColorDepth because there are in GLS.CrossPlatform
...
// GLS.Screen    - This units contains routines to interact with the screen/desktop.
// Version     - 0.0.8
