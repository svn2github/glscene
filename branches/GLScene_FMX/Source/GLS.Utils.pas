...
{: GLS.Utils<p>
 ...
 <b>History : </b><font size=-1><ul>
      ...
      <li>24/03/09 - DanB - removed TryStrToFloat (exists in SysUtils or GLS.CrossPlatform already)
                            changed StrToFloatDef to accept only 1 param + now overloaded
      <li>24/03/09 - DanB - Moved Dialog utilities here from GLS.CrossPlatform, because
      ...
      <li>24/03/08 - DaStr - Removed OpenGL1x dependancy
                             Moved TGLMinFilter and TGLMagFilter from GLS.Utils.pas
                              to GLS.Graphics.pas (BugTracker ID = 1923844)
      <li>25/03/07 - DaStr - Replaced StrUtils with GLS.CrossPlatform
