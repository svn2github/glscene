...
//
{: GLS.TextureSharingShader (originally GlProxMultiMatShader)<p>
    <p>
  ...
  <b>History : </b><font size=-1><ul>
      <li>16/03/11 - Yar - Fixes after emergence of GLS.MaterialEx
...
uses
  ...
  GLVectorFileObjects, XOpenGL, GLS.State, GLS.PersistentClasses,
