...
{: GLS.Texture<p>
 ...
 <b>History : </b><font size=-1><ul>
       ...
       <li>04/01/13 - PW - Moved cubic map texture consts CmtPX..CmtNZ from GLS.Color unit to here
      ...
      <li>08/10/08 - DanB - split materials related stuff into GLS.Material.pas
      ...
      <li>05/10/08 - DanB - separated texture image editor from texture unit
                            moved color related stuff to GLS.Color.pas
      ...
      <li>06/06/07 - DaStr - Moved all color types, constants and functions
                              to GLS.Color.pas (Bugtracker ID = 1732211)
      ...
      <li>03/07/04 - LR - Move InitWinColors to GLS.CrossPlatform
