...
uses
  ...
  GLS.Color, GLS.BaseClasses, GLS.Coordinates, GLS.RenderContextInfo, 
  GLS.Material, GLS.TextureFormat, GLS.Selection, GLS.Strings, 
  GLS.XOpenGL, GLS.VectorTypes, GLS.ApplicationFileIO, GLS.Utils, GLS.Log;
