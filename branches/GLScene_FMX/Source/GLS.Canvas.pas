...
{: GLS.Canvas<p>
 ...
 <b>History : </b><font size=-1><ul>
      ...
      <li>04/04/10 - Yar - Fixes after GLS.State revision
      ...
      <li>06/06/07 - DaStr - Removed ConvertColorVector and ConvertWinColor (now in GLS.Color.pas)
                             Added GLS.Color to uses (BugtrackerID = 1732211)
                             Removed TColor declaration (now in GLS.CrossPlatform.pas)
      ...
      <li>08/07/04 - LR - Replace Graphics and TPoint by GLS.CrossPlatform for Linux
