...
begin
  YZGrid.ObjectStyle := YZGrid.ObjectStyle + [osStreamDraw];
  XZGrid.ObjectStyle := XZGrid.ObjectStyle + [osStreamDraw];
  XYGrid.ObjectStyle := XYGrid.ObjectStyle + [osStreamDraw];
end;
