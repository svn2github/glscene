...
type
  TForm1 = class(TForm)
    ...
    GLCamera3: TGLCamera;
    Splitter1: TSplitter;
    GLFreetypeVectorFont1: TGLFreetypeVectorFont;
...
const
  StringNames: array [0 .. Ord(cbmFaces)] of String = ('Point', 'Sphere',
    'Ellipsoid', 'Cube', 'Faces');
...
begin
  ...
  begin
    ...
    Memo1.Lines.Add(object1.Name + '(' + StringNames
      [Ord(TGLBCollision(object1.Behaviours.GetByClass(TGLBCollision))
      .BoundingMode)] + ')' + '  -  ' + object2.Name + '(' + StringNames
      [Ord(TGLBCollision(object2.Behaviours.GetByClass(TGLBCollision))
      .BoundingMode)] + ')');
  end
  else
  begin
