...
begin
  ...
  GLLines1.MaterialLibrary := GLMaterialLibraryEx1;
  GLLines1.LibMaterialName := GLMaterialLibraryEx1.Materials[0].Name;
  GLLines2.MaterialLibrary := GLMaterialLibraryEx1;
  GLLines2.LibMaterialName := GLMaterialLibraryEx1.Materials[1].Name;
end;
...
begin
  ...
  begin
    ...
    // Draw normal
    GLLines2.Nodes.AddNode(intersPoint);
    GLLines2.Nodes.AddNode(VectorAdd(intersPoint, VectorScale(ResNormal,
      SphereRadius * 3)));
  end
  else
  begin
