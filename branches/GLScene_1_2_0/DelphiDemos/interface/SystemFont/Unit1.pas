...
begin
  ...
  GLSystemBitmapFont1.EnsureString(HUDText1.Text);
end;
...
begin
  ...
  begin
    Picture := GLSystemBitmapFont1.Glyphs;
...
begin
  Caption := Format('%.1f FPS - %d x %d Font Texture',
    [GLSceneViewer1.FramesPerSecond, GLSystemBitmapFont1.FontTextureWidth,
    GLSystemBitmapFont1.FontTextureHeight]);
