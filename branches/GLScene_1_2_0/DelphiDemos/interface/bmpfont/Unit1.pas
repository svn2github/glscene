...
uses
  ...
  GLScene.Cadencer, GLScene.BitmapFont,
  GLScene.Core, GLScene.Objects.HUD, GLScene.Objects, GLScene.Objects.Teapot,
  GLScene.Base.Coordinates, GLScene.Platform, GLScene.Viewer.VCL, ExtCtrls;
