...
uses
  ...
  GLScene_Cadencer, GLScene_BitmapFont,
  GLScene_Core, GLScene_Objects_HUD, GLScene_Objects, GLScene_Objects_Teapot,
  GLScene_Base_Coordinates, GLScene_Platform, GLScene_Viewer_VCL, ExtCtrls;
