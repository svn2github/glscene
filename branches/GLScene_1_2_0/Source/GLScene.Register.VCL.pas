...
uses
  ...
  Dialogs,
  GLScene.PropertyEditor.MaterialPicker.VCL,
  GLScene.PropertyEditor.Uniform.VCL,
  GLScene.Shader.Memo,
  GLScene.GUI.LayoutEditor,
  ...
  GLScene.Shader.Bump,
  GLScene.Cadencer,
  GLScene.CameraController,
  GLScene.Shader.Cel,
  GLScene.Collision,
  GLScene.Image.Composite,
  GLScene.GUI.Console,
  GLScene.Base.Coordinates,
  GLScene.DCE,
  GLScene.Texture.Dynamic,
  GLScene.ParticleManager.Masks,
  GLScene.Fx.Explosion,
  GLScene.Objects.Extrusion,
  GLScene.Objects.FrameBuffer,
  GLScene.Objects.Feedback,
  GLScene.Fx.Fire,
  GLScene.Movement.FPS,
  GLScene.GameMenu,
  GLScene.ObjectsEx,
  GLScene.Gizmo,
  ...
  GLScene.GUI,
  GLScene.HeightData,
  GLScene.HDS.HeightTileFile,
  GLScene.Shader.HiddenLine,
  GLScene.Objects.HUD,
  GLScene.Imposter,
  GLScene.LensFlare,
  GLScene.PFX.Line,
  GLScene.Material,
  GLScene.MaterialEx,
  GLScene.Material.MultiProxy,
  GLScene.Material.Script,
  GLScene.Objects.Mesh,
  GLScene.Mirror,
  GLScene.Shader.MultiMaterial,
  GLScene.Objects.MultiPolygon,
  GLScene.Objects.MultiProxy,
  GLScene.Navigator,
  GLScene.Nodes,
  GLScene.Objects,
  GLScene.Shader.Outline,
  GLScene.Fx.Particle,
  GLScene.Particles,
  GLScene.Perlin,
  GLScene.PFX.Perlin,
  GLScene.Shader.Phong,
  GLScene.Portal,
  GLScene.PostEffects,
  GLScene.Texture.Projected,
  GLScene.Objects.Proxy,
  GLScene.Base.Context.Info,
  GLScene.Archive.Manager,
  GLScene.Edit.VCL,
  GLScene.Screen,
  GLScene.Base.Script,
  GLScene.Shader.Combiner,
  GLScene.HDS.Shadow,
  GLScene.ShadowPlane,
  GLScene.ShadowVolume,
  GLScene.SimpleNavigation,
  GLScene.Objects.SkyBox,
  GLScene.Objects.Skydome,
  GLScene.Objects.NishitaSky,
  GLScene.Language,
  GLScene.Shader.GLSL.Bump,
  GLScene.Shader.GLSL.DiffuseSpecular,
  GLScene.Base.Log,
  GLScene.Shader.GLSL.PostBlur,
  GLScene.Texture.Projected.GLSL,
  ...
  GLScene.Shader.TextureCombiner,
  GLScene.LensFlare.Textured,
  GLScene.Texture,
  GLScene.HDS.Textured,
  GLScene.PropertyEditor.TextureImage,
  GLScene.Shader.TextureSharing,
  GLScene.FX.Thor,
  GLScene.Objects.TilePlane,
  GLScene.TimeEvents.Manager,
  GLScene.Objects.Trail,
  GLScene.Objects.Tree,
  GLScene.Shader.User,
  GLScene.Utils,
  GLScene.Vector.FileObjects,
  GLScene.VfsPAK,
  GLScene.Viewer,
  GLScene.Objects.WaterPlane,
  GLScene.GUI.Windows,
  GLScene.ZBuffer,
  GLScene.VCL.Memo,
  SysUtils,
  ...
  GLScene.Objects.SpaceText,
  GLScene.Base.Joystick,
  GLScene.Base.ScreenSaver,
  GLScene.Viewer.FullScreen;
