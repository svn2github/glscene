...
unit GLScene_PropertyEditor_Face_LCL;
...
uses
  LResources,
  Forms, ComCtrls, GLScene_PropertyEditor_TrackBar_LCL,
  StdCtrls, GLScene_PropertyEditor_Color_LCL, Controls,  Classes,
  GLScene_Texture, GLScene_Material;
