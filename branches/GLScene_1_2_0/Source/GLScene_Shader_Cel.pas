...
uses
  Classes, SysUtils, GLScene_Texture, GLScene_Base_Context, GLScene_Graphics, GLScene_Utils,
  GLScene_Base_Vector_Geometry, GLScene_Base_OpenGL_Tokens, GLScene_Base_Color, GLScene_Base_Context_Info,
  GLScene_Material, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
