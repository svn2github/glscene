...
unit GLScene_Shader_CG_PostTransformation;
...
uses
  ...
  // GLScene_Core
  GLScene_Texture,  GLScene_Cadencer, GLScene_Base_Context, GLScene_Base_OpenGL_Tokens, GLScene, GLScene_Shader_Custom,
  GLScene_Base_Context_Info, GLScene_Texture_Format,

  // GLScene_Shader_CG Shaders
  GLScene_Shader_CG, GLScene_Shader_CG_GL, GLScene_Shader_CG_Components;
