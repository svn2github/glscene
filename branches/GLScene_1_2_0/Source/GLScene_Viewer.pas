...
uses
  ...
  {$IFDEF GLS_DELPHI_OR_CPPB} GLScene_Viewer_VCL; {$ENDIF}
  {$IFDEF FPC}                GLScene_Viewer_LCL;   {$ENDIF}
type
{$IFDEF FPC}
  TGLSceneViewer = GLScene_Viewer_LCL.TGLSceneViewer;
{$ELSE}
  TGLSceneViewer = GLScene_Viewer_VCL.TGLSceneViewer;
{$ENDIF FPC}
...
uses
  GLScene_Base_OpenGL_Tokens, GLScene_Base_OpenGL_Adapter;
