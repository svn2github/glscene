...
unit GLScene_Base_Context_Info;
...
uses
  Classes,
  GLScene_Base_PersistentClasses, GLScene_Base_Vector_Geometry, GLScene_Base_GLStateMachine,
  GLScene_Base_Transformation, GLScene_Base_Color;
