...
unit GLScene_HDS_Shadow;

interface

uses
  Classes, GLScene_HeightData, GLScene_Graphics, GLScene_Base_Vector_Geometry, GLScene_Texture,
  Dialogs, Forms, GLScene_Base_Vector_Types, GLScene_Base_Coordinates, GLScene_Material;
...
uses SysUtils, GLScene_Base_OpenGL_Tokens, GLScene_Base_Vector_Lists;
