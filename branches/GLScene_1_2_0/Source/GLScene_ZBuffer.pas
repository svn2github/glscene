...
unit GLScene_ZBuffer;

interface

{$I GLScene.inc}

uses Classes, SysUtils, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Graphics,
  GLScene_Objects, GLScene_Base_Context, GLScene_Viewer, GLScene_Base_Color,
  GLScene_Base_Context_Info, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
...
uses GLScene_Base_OpenGL_Tokens {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
