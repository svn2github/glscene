...
uses
   Classes, GLScene_Sound, GLScene_Core, SysUtils, GLScene_Sound_FileObjects;
...
uses Forms, GLScene_Base_Vector_Geometry, Dialogs, GLScene_OpenAL_API{al, alut, alTypes};
