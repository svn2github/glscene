...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Base_XCollection, GLScene_Base_OpenGL_Tokens, GLScene_Base_Spline, GLScene_Objects,
  GLScene_Platform, GLScene_Base_Strings, GLScene_Base_Classes;
