...
unit DWS2_GLScene_OpenGL_Adapter;
...
uses
  dws2Functions, GLScene_Base_OpenGL_Tokens, GLScene_Base_OpenGL_Adapter, GLScene_Base_Context, GLScene_Base_Vector_Geometry;
