...
unit GLScene_PropertyEditor_Material_VCL;
...
uses
  ...
  ComCtrls,
  // GLScene
  GLScene_PropertyEditor_MaterialPreview_VCL,
  GLScene_PropertyEditor_Color_VCL,
  GLScene_PropertyEditor_Face_VCL,
  GLScene_Texture,
  GLScene_PropertyEditor_Texture_VCL,
  GLScene_Viewer,
  GLScene_Material,
