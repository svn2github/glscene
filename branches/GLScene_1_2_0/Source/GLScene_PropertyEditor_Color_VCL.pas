...
unit GLScene_PropertyEditor_Color_VCL;
...
uses
  Windows, Forms, StdCtrls, ComCtrls, ExtCtrls, GLScene_PropertyEditor_TrackBar_VCL, Dialogs, Controls,
  Classes, GLScene_Base_Vector_Geometry, Graphics, SysUtils, GLScene_Base_Color;
...
uses
  GLScene_Texture, GLScene_Platform, GLScene_Base_Vector_Types;
