...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_Objects, GLScene_Objects_HUD, GLScene_Viewer, GLScene_BitmapFont,
  GLScene_Base_PersistentClasses, GLScene_Base_Context, GLScene_Texture, GLScene_MaterialEx, GLScene_Utils, GLScene_Base_Strings,
  GLScene_Platform, GLScene_Material{$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
