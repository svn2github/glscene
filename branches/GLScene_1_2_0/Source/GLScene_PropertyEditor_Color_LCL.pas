...
unit GLScene_PropertyEditor_Color_LCL;
...
uses
  ...
  Classes, GLScene_Base_Vector_Geometry, Graphics, SysUtils, GLScene_Base_Color,lresources;
...
uses
  GLScene_Texture, GLScene_Platform;
