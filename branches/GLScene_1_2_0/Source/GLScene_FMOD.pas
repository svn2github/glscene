...
uses Classes, GLScene_Sound, GLScene_Core;
...
uses SysUtils, {$IFNDEF FPC}GLScene_FMOD_API{$ELSE}GLScene_FMOD_Import{$ENDIF}, GLScene_FMOD_Types, GLScene_FMOD_Presets, GLScene_Base_Vector_Geometry;
