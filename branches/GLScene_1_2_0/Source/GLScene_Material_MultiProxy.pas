...
unit GLScene_Material_MultiProxy;
...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Texture, GLScene_Material, GLScene_Silhouette, GLScene_Base_Strings,
  GLScene_Platform, GLScene_Base_PersistentClasses, GLScene_Base_Context_Info, GLScene_Base_Classes;
...
uses SysUtils, GLScene_Base_Context {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
