...
uses GLScene_Files_STL_Types, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists, SysUtils, GLScene_Utils;
...
var
   ...
   begin
      ...
      if sl.Count<>5 then
         ...
         aNormal[0]:=GLScene_Utils.StrToFloatDef(sl[2], 0);
         aNormal[1]:=GLScene_Utils.StrToFloatDef(sl[3], 0);
         aNormal[2]:=GLScene_Utils.StrToFloatDef(sl[4], 0);
      end;
   end;
   ...
   begin
      ...
      if (sl.Count<>4) or (CompareText(sl[0], cVERTEX_LABEL)<>0) then
         ...
         aVertex[0]:=GLScene_Utils.StrToFloatDef(sl[1], 0);
         aVertex[1]:=GLScene_Utils.StrToFloatDef(sl[2], 0);
         aVertex[2]:=GLScene_Utils.StrToFloatDef(sl[3], 0);
      end;
   end;
