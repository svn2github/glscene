...
unit GLScene_Viewer_Form_Design;
...
const
  sSource =
    ...
    '  GLScene_Core, GLScene.Form.VCL;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
...
const
  sSource =
    ...
    'uses' + LineEnding +
    '  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,' + LineEnding +
    '  GLScene_Core, GLScene_Viewer_Form, GLScene_Cadencer;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
    '  T%1:s = class(TGLSceneForm)' + LineEnding +
...
const
  sSource =
    ...
    '  Dialogs, GLScene_Core, GLScene_Viewer_Form, GLScene_Cadencer, GLScene_Material, GLScene_Objects, ' + LineEnding +
    '  GLScene_Objects_HUD, GLScene_BitmapFont_System, GLScene_Objects_Skydome, GLScene_ObjectsEx, GLScene_ShadowPlane,' + LineEnding +
    '  GLScene_Base_Classes, GLScene_Files_PNG;' + LineEnding +
...
begin
   Result:=
    ' Classes, SysUtils, Forms, Controls, Graphics,  Dialogs,' + LineEnding +
    '  GLScene_Viewer_Form, GLScene_Core, GLScene_Objects, GLScene_Cadencer;' ;
end;
...
begin
   Result:=
    ...
    ' GLScene_Viewer_Form, GLScene_Cadencer, GLScene_Material, GLScene_Objects, GLScene_Objects_HUD, GLScene_BitmapFont_System,' + LineEnding +
    ' GLScene_Objects_Skydome, GLScene_ObjectsEx, GLScene_ShadowPlane, GLScene_Viewer_LCL, GLScene_Base_Classes, GLScene_Files_PNG;' + LineEnding;
