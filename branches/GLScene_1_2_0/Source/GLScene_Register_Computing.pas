...
unit GLScene_Register_Computing;

interface

uses
  Classes, SysUtils, GLScene_Register_VCL,
  {$IFNDEF FPC}
...
uses
  GLScene_CUDA_Runtime,
  GLScene_CUDA_Editor,
  GLScene_CUDA_Context,
  GLScene_CUDA,
  GLScene_CUDA_Compiler,
  GLScene_CUDA_FFTPlan,
  GLScene_CUDA_Graphics,
  GLScene_CUDA_Parser;
