...
uses
  ...
  // GLScene_Core
  GLScene_Base_Vector_Types, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists, GLScene_Base_PersistentClasses, GLScene_Utils;
