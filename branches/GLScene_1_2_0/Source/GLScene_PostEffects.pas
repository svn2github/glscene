...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_Texture, GLScene_Base_OpenGL_Tokens, GLScene_Graphics, GLScene_Base_Strings, GLScene_Shader_Custom, GLScene_Base_Context,
  GLScene_Base_Vector_Geometry, GLScene_Base_Context_Info, GLScene_Material, GLScene_Texture_Format;
