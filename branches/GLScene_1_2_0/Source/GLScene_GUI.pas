...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_BitmapFont, GLScene_Material, GLScene_Platform, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context,
  GLScene_Base_PersistentClasses, GLScene_Base_Vector_Geometry, GLScene_Base_Coordinates, GLScene_Base_Classes;
