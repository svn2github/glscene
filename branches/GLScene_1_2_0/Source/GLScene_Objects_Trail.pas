...
uses
  ...
  // GLScene_Core
  GLScene_Core, GLScene_Base_Vector_Types, GLScene_Mesh_Utils, GLScene_Base_Vector_Geometry, GLScene_Vector_FileObjects,
  GLScene_Objects_Mesh, GLScene_Objects, GLScene_Material, GLScene_Base_Strings, GLScene_Base_Classes;
