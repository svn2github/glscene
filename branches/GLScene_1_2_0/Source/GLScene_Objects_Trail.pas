...
type
  ...
  public
    ...
    procedure CreateMark(obj: TGLBaseSceneObject; width: single;
  ...
  published
    ...
    property TrailObject: TGLBaseSceneObject read FTrailObject
...
procedure TGLTrail.CreateMark(obj: TGLBaseSceneObject; width: single;
  CurrentTime: Double);
var
...
procedure TGLTrail.CreateMark(APos, ADir, AUp: TVector3f; AWidth: single;
  ACurrentTime: Double);
var
...
procedure TGLTrail.Notification(AComponent: TComponent; Operation: TOperation);
begin
