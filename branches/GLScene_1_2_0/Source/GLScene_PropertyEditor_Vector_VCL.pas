...
unit GLScene_PropertyEditor_Vector_VCL;
...
uses
  SysUtils, GLScene_Base_Vector_Geometry, GLScene_Utils, GLScene_Base_Vector_Types; 
...
var
   v : TAffineVector;
begin
   SetVector(v, GLScene_Utils.StrToFloatDef(EDx.Text, 0), GLScene_Utils.StrToFloatDef(EDy.Text, 0), GLScene_Utils.StrToFloatDef(EDz.Text, 0));
