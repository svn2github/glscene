...
uses
  ...
  // GLScene_Core
  GLScene_Texture, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Types, GLScene_Cadencer, GLScene_Base_Strings,
  GLScene_Base_OpenGL_Tokens, GLScene_Shader_GLSL_Components, GLScene_Shader_Custom, GLScene_Base_Color, GLScene_Base_Context_Info,
  GLScene_Material;
