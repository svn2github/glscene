...
unit GLScene_PropertyEditor_Texture_VCL;
...
uses
  ...
  GLScene_Graphics, GLScene_Texture_Format, GLScene_Texture;
...
uses
  SysUtils, GLScene_Base_GLStateMachine, GLScene_PropertyEditor_TextureImage;
