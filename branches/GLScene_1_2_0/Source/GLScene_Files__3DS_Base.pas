...
uses
  GLScene_Files__3DS_Consts,
  GLScene_Files__3DS_Utils,
  SysUtils,
  GLScene_Base_FileIO;
...
begin
  ...
  // satisfy the D4 compiler by cast the (longint) position to a cardinal
...
begin
  Result := GLScene_Files__3DS_Utils.GetDatabaseRelease(Self, FDatabase);
end;
...
begin
  Result := GLScene_Files__3DS_Utils.GetMeshRelease(Self, FDatabase);
end;
