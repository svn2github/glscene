...
unit GLScene_Register_LCL_WinOnly;
...
uses
   Classes, GLScene_Register_LCL, GLScene_Base_Strings,
   GLWideBitmapFont, GLScene_Objects_SpaceText,
   GLScene_AVIRecorder, GLScene_Base_Joystick, GLScene_Base_ScreenSaver, GLScene_WaveOut, LResources;
