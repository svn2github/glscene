...
unit GLScene_PropertyEditor_Face_VCL;
...
uses
  Windows, Forms, ComCtrls, GLScene_PropertyEditor_TrackBar_VCL, StdCtrls, GLScene_PropertyEditor_Color_VCL, ImgList, Controls,
  Classes, GLScene_Texture, GLScene_Material, GLScene_Base_GLStateMachine;
