...
unit GLScene_Collision_Ellipse;

interface

{$I GLScene.inc}

uses GLScene_Base_Vector_Geometry, GLScene_Base_Octree, GLScene_Base_Vector_Lists {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
