...
{$ENDIF}
    function GetAddress(ProcName: string;glCap:TProc): Pointer;
    function GetAddressNoSuffixes(ProcName: string;glCap:TProc): Pointer;
    function GetAddressAlt(ProcName1, ProcName2: string;glCap:TProc): Pointer;
    function GetCapAddress(glCap:TProc): Pointer;
  public
...
function TGLExtensionsAndEntryPoints.GetAddress(ProcName: string;glCap:TProc): Pointer;
var
  vName: string;
begin
...
function TGLExtensionsAndEntryPoints.GetAddressNoSuffixes(ProcName: string;glCap:TProc): Pointer;
var
  vName: string;
begin
  vName := glPrefix + ProcName;
...
function TGLExtensionsAndEntryPoints.GetCapAddress(glCap:TProc): Pointer;
begin
  Result := @glCap;
end;
...
begin
  ...
  BindTexture := GetCapAddress(@glCapBindTexture);
  BlendFunc := GetCapAddress(@glCapBlendFunc);
  Clear := GetCapAddress(@glCapClear);
  ClearColor := GetCapAddress(@glCapClearColor);
  ClearDepth := GetCapAddress(@glCapClearDepth);
  ClearStencil := GetCapAddress(@glCapClearStencil);
  ColorMask := GetCapAddress(@glCapColorMask);
  CopyTexImage1D := GetCapAddress(@glCapCopyTexImage1D);
  CopyTexImage2D := GetCapAddress(@glCapCopyTexImage2D);
  CopyTexSubImage1D := GetCapAddress(@glCapCopyTexSubImage1D);
  CopyTexSubImage2D := GetCapAddress(@glCapCopyTexSubImage2D);
  CullFace := GetCapAddress(@glCapCullFace);
  DeleteTextures := GetCapAddress(@glCapDeleteTextures);
  DepthFunc := GetCapAddress(@glCapDepthFunc);
  DepthMask := GetCapAddress(@glCapDepthMask);
  DepthRange := GetCapAddress(@glCapDepthRange);
  Disable := GetCapAddress(@glCapDisable);
  DrawArrays := GetCapAddress(@glCapDrawArrays);
  DrawBuffer := GetCapAddress(@glCapDrawBuffer);
  DrawElements := GetCapAddress(@glCapDrawElements);
  Enable := GetCapAddress(@glCapEnable);
  Finish := GetCapAddress(@glCapFinish);
  Flush := GetCapAddress(@glCapFlush);
  FrontFace := GetCapAddress(@glCapFrontFace);
  GenTextures := GetCapAddress(@glCapGenTextures);
  GetBooleanv := GetCapAddress(@glCapGetBooleanv);
  GetDoublev := GetCapAddress(@glCapGetDoublev);
  GetError := GetCapAddress(@glCapGetError);
  GetFloatv := GetCapAddress(@glCapGetFloatv);
  GetPointerv := GetCapAddress(@glCapGetPointerv);
  GetString := GetCapAddress(@glCapGetString);
  GetTexImage := GetCapAddress(@glCapGetTexImage);
  GetTexLevelParameterfv := GetCapAddress(@glCapGetTexLevelParameterfv);
  GetTexLevelParameteriv := GetCapAddress(@glCapGetTexLevelParameteriv);
  GetTexParameterfv := GetCapAddress(@glCapGetTexParameterfv);
  GetTexParameteriv := GetCapAddress(@glCapGetTexParameteriv);
  Hint := GetCapAddress(@glCapHint);
  IsEnabled := GetCapAddress(@glCapIsEnabled);
  IsTexture := GetCapAddress(@glCapIsTexture);
  LineWidth := GetCapAddress(@glCapLineWidth);
  LogicOp := GetCapAddress(@glCapLogicOp);
  PixelStoref := GetCapAddress(@glCapPixelStoref);
  PixelStorei := GetCapAddress(@glCapPixelStorei);
  PointSize := GetCapAddress(@glCapPointSize);
  PolygonMode := GetCapAddress(@glCapPolygonMode);
  PolygonOffset := GetCapAddress(@glCapPolygonOffset);
  ReadBuffer := GetCapAddress(@glCapReadBuffer);
  ReadPixels := GetCapAddress(@glCapReadPixels);
  Scissor := GetCapAddress(@glCapScissor);
  StencilFunc := GetCapAddress(@glCapStencilFunc);
  StencilMask := GetCapAddress(@glCapStencilMask);
  StencilOp := GetCapAddress(@glCapStencilOp);
  TexImage1D := GetCapAddress(@glCapTexImage1D);
  TexImage2D := GetCapAddress(@glCapTexImage2D);
  TexParameterf := GetCapAddress(@glCapTexParameterf);
  TexParameterfv := GetCapAddress(@glCapTexParameterfv);
  TexParameteri := GetCapAddress(@glCapTexParameteri);
  TexParameteriv := GetCapAddress(@glCapTexParameteriv);
  TexSubImage1D := GetCapAddress(@glCapTexSubImage1D);
  TexSubImage2D := GetCapAddress(@glCapTexSubImage2D);
  Viewport := GetCapAddress(@glCapViewport);
  Accum := GetCapAddress(@glCapAccum);
  AlphaFunc := GetCapAddress(@glCapAlphaFunc);
  AreTexturesResident := GetCapAddress(@glCapAreTexturesResident);
  ArrayElement := GetCapAddress(@glCapArrayElement);
  Begin_ := GetCapAddress(@glCapBegin_);
  Bitmap := GetCapAddress(@glCapBitmap);
  CallList := GetCapAddress(@glCapCallList);
  CallLists := GetCapAddress(@glCapCallLists);
  ClearAccum := GetCapAddress(@glCapClearAccum);
  ClearIndex := GetCapAddress(@glCapClearIndex);
  ClipPlane := GetCapAddress(@glCapClipPlane);
  Color3b := GetCapAddress(@glCapColor3b);
  Color3bv := GetCapAddress(@glCapColor3bv);
  Color3d := GetCapAddress(@glCapColor3d);
  Color3dv := GetCapAddress(@glCapColor3dv);
  Color3f := GetCapAddress(@glCapColor3f);
  Color3fv := GetCapAddress(@glCapColor3fv);
  Color3i := GetCapAddress(@glCapColor3i);
  Color3iv := GetCapAddress(@glCapColor3iv);
  Color3s := GetCapAddress(@glCapColor3s);
  Color3sv := GetCapAddress(@glCapColor3sv);
  Color3ub := GetCapAddress(@glCapColor3ub);
  Color3ubv := GetCapAddress(@glCapColor3ubv);
  Color3ui := GetCapAddress(@glCapColor3ui);
  Color3uiv := GetCapAddress(@glCapColor3uiv);
  Color3us := GetCapAddress(@glCapColor3us);
  Color3usv := GetCapAddress(@glCapColor3usv);
  Color4b := GetCapAddress(@glCapColor4b);
  Color4bv := GetCapAddress(@glCapColor4bv);
  Color4d := GetCapAddress(@glCapColor4d);
  Color4dv := GetCapAddress(@glCapColor4dv);
  Color4f := GetCapAddress(@glCapColor4f);
  Color4fv := GetCapAddress(@glCapColor4fv);
  Color4i := GetCapAddress(@glCapColor4i);
  Color4iv := GetCapAddress(@glCapColor4iv);
  Color4s := GetCapAddress(@glCapColor4s);
  Color4sv := GetCapAddress(@glCapColor4sv);
  Color4ub := GetCapAddress(@glCapColor4ub);
  Color4ubv := GetCapAddress(@glCapColor4ubv);
  Color4ui := GetCapAddress(@glCapColor4ui);
  Color4uiv := GetCapAddress(@glCapColor4uiv);
  Color4us := GetCapAddress(@glCapColor4us);
  Color4usv := GetCapAddress(@glCapColor4usv);
  ColorMaterial := GetCapAddress(@glCapColorMaterial);
  ColorPointer := GetCapAddress(@glCapColorPointer);
  CopyPixels := GetCapAddress(@glCapCopyPixels);
  DeleteLists := GetCapAddress(@glCapDeleteLists);
  DisableClientState := GetCapAddress(@glCapDisableClientState);
  DrawPixels := GetCapAddress(@glCapDrawPixels);
  EdgeFlag := GetCapAddress(@glCapEdgeFlag);
  EdgeFlagPointer := GetCapAddress(@glCapEdgeFlagPointer);
  EdgeFlagv := GetCapAddress(@glCapEdgeFlagv);
  EnableClientState := GetCapAddress(@glCapEnableClientState);
  End_ := GetCapAddress(@glCapEnd_);
  EndList := GetCapAddress(@glCapEndList);
  EvalCoord1d := GetCapAddress(@glCapEvalCoord1d);
  EvalCoord1dv := GetCapAddress(@glCapEvalCoord1dv);
  EvalCoord1f := GetCapAddress(@glCapEvalCoord1f);
  EvalCoord1fv := GetCapAddress(@glCapEvalCoord1fv);
  EvalCoord2d := GetCapAddress(@glCapEvalCoord2d);
  EvalCoord2dv := GetCapAddress(@glCapEvalCoord2dv);
  EvalCoord2f := GetCapAddress(@glCapEvalCoord2f);
  EvalCoord2fv := GetCapAddress(@glCapEvalCoord2fv);
  EvalMesh1 := GetCapAddress(@glCapEvalMesh1);
  EvalMesh2 := GetCapAddress(@glCapEvalMesh2);
  EvalPoint1 := GetCapAddress(@glCapEvalPoint1);
  EvalPoint2 := GetCapAddress(@glCapEvalPoint2);
  FeedbackBuffer := GetCapAddress(@glCapFeedbackBuffer);
  Fogf := GetCapAddress(@glCapFogf);
  Fogfv := GetCapAddress(@glCapFogfv);
  Fogi := GetCapAddress(@glCapFogi);
  Fogiv := GetCapAddress(@glCapFogiv);
  Frustum := GetCapAddress(@glCapFrustum);
  GenLists := GetCapAddress(@glCapGenLists);
  GetClipPlane := GetCapAddress(@glCapGetClipPlane);
  GetLightfv := GetCapAddress(@glCapGetLightfv);
  GetLightiv := GetCapAddress(@glCapGetLightiv);
  GetMapdv := GetCapAddress(@glCapGetMapdv);
  GetMapfv := GetCapAddress(@glCapGetMapfv);
  GetMapiv := GetCapAddress(@glCapGetMapiv);
  GetMaterialfv := GetCapAddress(@glCapGetMaterialfv);
  GetMaterialiv := GetCapAddress(@glCapGetMaterialiv);
  GetPixelMapfv := GetCapAddress(@glCapGetPixelMapfv);
  GetPixelMapuiv := GetCapAddress(@glCapGetPixelMapuiv);
  GetPixelMapusv := GetCapAddress(@glCapGetPixelMapusv);
  GetPolygonStipple := GetCapAddress(@glCapGetPolygonStipple);
  GetTexEnvfv := GetCapAddress(@glCapGetTexEnvfv);
  GetTexEnviv := GetCapAddress(@glCapGetTexEnviv);
  GetTexGendv := GetCapAddress(@glCapGetTexGendv);
  GetTexGenfv := GetCapAddress(@glCapGetTexGenfv);
  GetTexGeniv := GetCapAddress(@glCapGetTexGeniv);
  IndexMask := GetCapAddress(@glCapIndexMask);
  IndexPointer := GetCapAddress(@glCapIndexPointer);
  Indexd := GetCapAddress(@glCapIndexd);
  Indexdv := GetCapAddress(@glCapIndexdv);
  Indexf := GetCapAddress(@glCapIndexf);
  Indexfv := GetCapAddress(@glCapIndexfv);
  Indexi := GetCapAddress(@glCapIndexi);
  Indexiv := GetCapAddress(@glCapIndexiv);
  Indexs := GetCapAddress(@glCapIndexs);
  Indexsv := GetCapAddress(@glCapIndexsv);
  Indexub := GetCapAddress(@glCapIndexub);
  Indexubv := GetCapAddress(@glCapIndexubv);
  InitNames := GetCapAddress(@glCapInitNames);
  InterleavedArrays := GetCapAddress(@glCapInterleavedArrays);
  IsList := GetCapAddress(@glCapIsList);
  LightModelf := GetCapAddress(@glCapLightModelf);
  LightModelfv := GetCapAddress(@glCapLightModelfv);
  LightModeli := GetCapAddress(@glCapLightModeli);
  LightModeliv := GetCapAddress(@glCapLightModeliv);
  Lightf := GetCapAddress(@glCapLightf);
  Lightfv := GetCapAddress(@glCapLightfv);
  Lighti := GetCapAddress(@glCapLighti);
  Lightiv := GetCapAddress(@glCapLightiv);
  LineStipple := GetCapAddress(@glCapLineStipple);
  ListBase := GetCapAddress(@glCapListBase);
  LoadIdentity := GetCapAddress(@glCapLoadIdentity);
  LoadMatrixd := GetCapAddress(@glCapLoadMatrixd);
  LoadMatrixf := GetCapAddress(@glCapLoadMatrixf);
  LoadName := GetCapAddress(@glCapLoadName);
  Map1d := GetCapAddress(@glCapMap1d);
  Map1f := GetCapAddress(@glCapMap1f);
  Map2d := GetCapAddress(@glCapMap2d);
  Map2f := GetCapAddress(@glCapMap2f);
  MapGrid1d := GetCapAddress(@glCapMapGrid1d);
  MapGrid1f := GetCapAddress(@glCapMapGrid1f);
  MapGrid2d := GetCapAddress(@glCapMapGrid2d);
  MapGrid2f := GetCapAddress(@glCapMapGrid2f);
  Materialf := GetCapAddress(@glCapMaterialf);
  Materialfv := GetCapAddress(@glCapMaterialfv);
  Materiali := GetCapAddress(@glCapMateriali);
  Materialiv := GetCapAddress(@glCapMaterialiv);
  MatrixMode := GetCapAddress(@glCapMatrixMode);
  MultMatrixd := GetCapAddress(@glCapMultMatrixd);
  MultMatrixf := GetCapAddress(@glCapMultMatrixf);
  NewList := GetCapAddress(@glCapNewList);
  Normal3b := GetCapAddress(@glCapNormal3b);
  Normal3bv := GetCapAddress(@glCapNormal3bv);
  Normal3d := GetCapAddress(@glCapNormal3d);
  Normal3dv := GetCapAddress(@glCapNormal3dv);
  Normal3f := GetCapAddress(@glCapNormal3f);
  Normal3fv := GetCapAddress(@glCapNormal3fv);
  Normal3i := GetCapAddress(@glCapNormal3i);
  Normal3iv := GetCapAddress(@glCapNormal3iv);
  Normal3s := GetCapAddress(@glCapNormal3s);
  Normal3sv := GetCapAddress(@glCapNormal3sv);
  NormalPointer := GetCapAddress(@glCapNormalPointer);
  Ortho := GetCapAddress(@glCapOrtho);
  PassThrough := GetCapAddress(@glCapPassThrough);
  PixelMapfv := GetCapAddress(@glCapPixelMapfv);
  PixelMapuiv := GetCapAddress(@glCapPixelMapuiv);
  PixelMapusv := GetCapAddress(@glCapPixelMapusv);
  PixelTransferf := GetCapAddress(@glCapPixelTransferf);
  PixelTransferi := GetCapAddress(@glCapPixelTransferi);
  PixelZoom := GetCapAddress(@glCapPixelZoom);
  PolygonStipple := GetCapAddress(@glCapPolygonStipple);
  PopAttrib := GetCapAddress(@glCapPopAttrib);
  PopClientAttrib := GetCapAddress(@glCapPopClientAttrib);
  PopMatrix := GetCapAddress(@glCapPopMatrix);
  PopName := GetCapAddress(@glCapPopName);
  PrioritizeTextures := GetCapAddress(@glCapPrioritizeTextures);
  PushAttrib := GetCapAddress(@glCapPushAttrib);
  PushClientAttrib := GetCapAddress(@glCapPushClientAttrib);
  PushMatrix := GetCapAddress(@glCapPushMatrix);
  PushName := GetCapAddress(@glCapPushName);
  RasterPos2d := GetCapAddress(@glCapRasterPos2d);
  RasterPos2dv := GetCapAddress(@glCapRasterPos2dv);
  RasterPos2f := GetCapAddress(@glCapRasterPos2f);
  RasterPos2fv := GetCapAddress(@glCapRasterPos2fv);
  RasterPos2i := GetCapAddress(@glCapRasterPos2i);
  RasterPos2iv := GetCapAddress(@glCapRasterPos2iv);
  RasterPos2s := GetCapAddress(@glCapRasterPos2s);
  RasterPos2sv := GetCapAddress(@glCapRasterPos2sv);
  RasterPos3d := GetCapAddress(@glCapRasterPos3d);
  RasterPos3dv := GetCapAddress(@glCapRasterPos3dv);
  RasterPos3f := GetCapAddress(@glCapRasterPos3f);
  RasterPos3fv := GetCapAddress(@glCapRasterPos3fv);
  RasterPos3i := GetCapAddress(@glCapRasterPos3i);
  RasterPos3iv := GetCapAddress(@glCapRasterPos3iv);
  RasterPos3s := GetCapAddress(@glCapRasterPos3s);
  RasterPos3sv := GetCapAddress(@glCapRasterPos3sv);
  RasterPos4d := GetCapAddress(@glCapRasterPos4d);
  RasterPos4dv := GetCapAddress(@glCapRasterPos4dv);
  RasterPos4f := GetCapAddress(@glCapRasterPos4f);
  RasterPos4fv := GetCapAddress(@glCapRasterPos4fv);
  RasterPos4i := GetCapAddress(@glCapRasterPos4i);
  RasterPos4iv := GetCapAddress(@glCapRasterPos4iv);
  RasterPos4s := GetCapAddress(@glCapRasterPos4s);
  RasterPos4sv := GetCapAddress(@glCapRasterPos4sv);
  Rectd := GetCapAddress(@glCapRectd);
  Rectdv := GetCapAddress(@glCapRectdv);
  Rectf := GetCapAddress(@glCapRectf);
  Rectfv := GetCapAddress(@glCapRectfv);
  Recti := GetCapAddress(@glCapRecti);
  Rectiv := GetCapAddress(@glCapRectiv);
  Rects := GetCapAddress(@glCapRects);
  Rectsv := GetCapAddress(@glCapRectsv);
  RenderMode := GetCapAddress(@glCapRenderMode);
  Rotated := GetCapAddress(@glCapRotated);
  Rotatef := GetCapAddress(@glCapRotatef);
  Scaled := GetCapAddress(@glCapScaled);
  Scalef := GetCapAddress(@glCapScalef);
  SelectBuffer := GetCapAddress(@glCapSelectBuffer);
  ShadeModel := GetCapAddress(@glCapShadeModel);
  TexCoord1d := GetCapAddress(@glCapTexCoord1d);
  TexCoord1dv := GetCapAddress(@glCapTexCoord1dv);
  TexCoord1f := GetCapAddress(@glCapTexCoord1f);
  TexCoord1fv := GetCapAddress(@glCapTexCoord1fv);
  TexCoord1i := GetCapAddress(@glCapTexCoord1i);
  TexCoord1iv := GetCapAddress(@glCapTexCoord1iv);
  TexCoord1s := GetCapAddress(@glCapTexCoord1s);
  TexCoord1sv := GetCapAddress(@glCapTexCoord1sv);
  TexCoord2d := GetCapAddress(@glCapTexCoord2d);
  TexCoord2dv := GetCapAddress(@glCapTexCoord2dv);
  TexCoord2f := GetCapAddress(@glCapTexCoord2f);
  TexCoord2fv := GetCapAddress(@glCapTexCoord2fv);
  TexCoord2i := GetCapAddress(@glCapTexCoord2i);
  TexCoord2iv := GetCapAddress(@glCapTexCoord2iv);
  TexCoord2s := GetCapAddress(@glCapTexCoord2s);
  TexCoord2sv := GetCapAddress(@glCapTexCoord2sv);
  TexCoord3d := GetCapAddress(@glCapTexCoord3d);
  TexCoord3dv := GetCapAddress(@glCapTexCoord3dv);
  TexCoord3f := GetCapAddress(@glCapTexCoord3f);
  TexCoord3fv := GetCapAddress(@glCapTexCoord3fv);
  TexCoord3i := GetCapAddress(@glCapTexCoord3i);
  TexCoord3iv := GetCapAddress(@glCapTexCoord3iv);
  TexCoord3s := GetCapAddress(@glCapTexCoord3s);
  TexCoord3sv := GetCapAddress(@glCapTexCoord3sv);
  TexCoord4d := GetCapAddress(@glCapTexCoord4d);
  TexCoord4dv := GetCapAddress(@glCapTexCoord4dv);
  TexCoord4f := GetCapAddress(@glCapTexCoord4f);
  TexCoord4fv := GetCapAddress(@glCapTexCoord4fv);
  TexCoord4i := GetCapAddress(@glCapTexCoord4i);
  TexCoord4iv := GetCapAddress(@glCapTexCoord4iv);
  TexCoord4s := GetCapAddress(@glCapTexCoord4s);
  TexCoord4sv := GetCapAddress(@glCapTexCoord4sv);
  TexCoordPointer := GetCapAddress(@glCapTexCoordPointer);
  TexEnvf := GetCapAddress(@glCapTexEnvf);
  TexEnvfv := GetCapAddress(@glCapTexEnvfv);
  TexEnvi := GetCapAddress(@glCapTexEnvi);
  TexEnviv := GetCapAddress(@glCapTexEnviv);
  TexGend := GetCapAddress(@glCapTexGend);
  TexGendv := GetCapAddress(@glCapTexGendv);
  TexGenf := GetCapAddress(@glCapTexGenf);
  TexGenfv := GetCapAddress(@glCapTexGenfv);
  TexGeni := GetCapAddress(@glCapTexGeni);
  TexGeniv := GetCapAddress(@glCapTexGeniv);
  Translated := GetCapAddress(@glCapTranslated);
  Translatef := GetCapAddress(@glCapTranslatef);
  Vertex2d := GetCapAddress(@glCapVertex2d);
  Vertex2dv := GetCapAddress(@glCapVertex2dv);
  Vertex2f := GetCapAddress(@glCapVertex2f);
  Vertex2fv := GetCapAddress(@glCapVertex2fv);
  Vertex2i := GetCapAddress(@glCapVertex2i);
  Vertex2iv := GetCapAddress(@glCapVertex2iv);
  Vertex2s := GetCapAddress(@glCapVertex2s);
  Vertex2sv := GetCapAddress(@glCapVertex2sv);
  Vertex3d := GetCapAddress(@glCapVertex3d);
  Vertex3dv := GetCapAddress(@glCapVertex3dv);
  Vertex3f := GetCapAddress(@glCapVertex3f);
  Vertex3fv := GetCapAddress(@glCapVertex3fv);
  Vertex3i := GetCapAddress(@glCapVertex3i);
  Vertex3iv := GetCapAddress(@glCapVertex3iv);
  Vertex3s := GetCapAddress(@glCapVertex3s);
  Vertex3sv := GetCapAddress(@glCapVertex3sv);
  Vertex4d := GetCapAddress(@glCapVertex4d);
  Vertex4dv := GetCapAddress(@glCapVertex4dv);
  Vertex4f := GetCapAddress(@glCapVertex4f);
  Vertex4fv := GetCapAddress(@glCapVertex4fv);
  Vertex4i := GetCapAddress(@glCapVertex4i);
  Vertex4iv := GetCapAddress(@glCapVertex4iv);
  Vertex4s := GetCapAddress(@glCapVertex4s);
  Vertex4sv := GetCapAddress(@glCapVertex4sv);
  VertexPointer := GetCapAddress(@glCapVertexPointer);
  BlendColor := GetCapAddress(@glCapBlendColor);
  BlendEquation := GetCapAddress(@glCapBlendEquation);
  DrawRangeElements := GetCapAddress(@glCapDrawRangeElements);
  TexImage3D := GetCapAddress(@glCapTexImage3D);
  TexSubImage3D := GetCapAddress(@glCapTexSubImage3D);
  CopyTexSubImage3D := GetCapAddress(@glCapCopyTexSubImage3D);

  IsRenderbuffer := GetCapAddress(@glCapIsRenderbuffer);
  BindRenderbuffer := GetCapAddress(@glCapBindRenderbuffer);
  DeleteRenderbuffers := GetCapAddress(@glCapDeleteRenderbuffers);
  GenRenderbuffers := GetCapAddress(@glCapGenRenderbuffers);
  RenderbufferStorage := GetCapAddress(@glCapRenderbufferStorage);
  RenderbufferStorageMultisample := GetCapAddress(@glCapRenderbufferStorageMultisample);
  GetRenderbufferParameteriv := GetCapAddress(@glCapGetRenderbufferParameteriv);
  IsFramebuffer := GetCapAddress(@glCapIsFramebuffer);
  BindFramebuffer := GetCapAddress(@glCapBindFramebuffer);
  DeleteFramebuffers := GetCapAddress(@glCapDeleteFramebuffers);
  GenFramebuffers := GetCapAddress(@glCapGenFramebuffers);
  CheckFramebufferStatus := GetCapAddress(@glCapCheckFramebufferStatus);
  FramebufferTexture := GetCapAddress(@glCapFramebufferTexture);
  FramebufferTexture1D := GetCapAddress(@glCapFramebufferTexture1D);
  FramebufferTexture2D := GetCapAddress(@glCapFramebufferTexture2D);
  FramebufferTexture3D := GetCapAddress(@glCapFramebufferTexture3D);
  FramebufferTextureLayer := GetCapAddress(@glCapFramebufferTextureLayer);
  FramebufferTextureFace := GetCapAddress(@glCapFramebufferTextureFace);
  FramebufferRenderbuffer := GetCapAddress(@glCapFramebufferRenderbuffer);
  GetFramebufferAttachmentParameteriv := GetCapAddress(@glCapGetFramebufferAttachmentParameteriv);
  BlitFramebuffer := GetCapAddress(@glCapBlitFramebuffer);
  GenerateMipmap := GetCapAddress(@glCapGenerateMipmap);
  ClearBufferiv := GetCapAddress(@glCapClearBufferiv);
  ClearBufferuiv := GetCapAddress(@glCapClearBufferuiv);
  ClearBufferfv := GetCapAddress(@glCapClearBufferfv);
  ClearBufferfi := GetCapAddress(@glCapClearBufferfi);
  LockArrays := GetCapAddress(@glCapLockArrays);
  UnlockArrays := GetCapAddress(@glCapUnlockArrays);
  BindBuffer := GetCapAddress(@glCapBindBuffer);
  DeleteBuffers := GetCapAddress(@glCapDeleteBuffers);
  GenBuffers := GetCapAddress(@glCapGenBuffers);
  IsBuffer := GetCapAddress(@glCapIsBuffer);
  BufferData := GetCapAddress(@glCapBufferData);
  BufferSubData := GetCapAddress(@glCapBufferSubData);
  GetBufferSubData := GetCapAddress(@glCapGetBufferSubData);
  MapBuffer := GetCapAddress(@glCapMapBuffer);
  UnmapBuffer := GetCapAddress(@glCapUnmapBuffer);
  GetBufferParameteriv := GetCapAddress(@glCapGetBufferParameteriv);
  GetBufferPointerv := GetCapAddress(@glCapGetBufferPointerv);
  MapBufferRange := GetCapAddress(@glCapMapBufferRange);
  FlushMappedBufferRange := GetCapAddress(@glCapFlushMappedBufferRange);
  BindBufferRange := GetCapAddress(@glCapBindBufferRange);
  BindBufferOffset := GetCapAddress(@glCapBindBufferOffset);
  BindBufferBase := GetCapAddress(@glCapBindBufferBase);
  BeginTransformFeedback := GetCapAddress(@glCapBeginTransformFeedback);
  EndTransformFeedback := GetCapAddress(@glCapEndTransformFeedback);
  TransformFeedbackVaryings := GetCapAddress(@glCapTransformFeedbackVaryings);
  GetTransformFeedbackVarying := GetCapAddress(@glCapGetTransformFeedbackVarying);

  TransformFeedbackAttribs := GetCapAddress(@glCapTransformFeedbackAttribs);
  TransformFeedbackVaryingsNV := GetCapAddress(@glCapTransformFeedbackVaryingsNV);
  TexBuffer := GetCapAddress(@glCapTexBuffer);
  BindVertexArray := GetCapAddress(@glCapBindVertexArray);
  DeleteVertexArrays := GetCapAddress(@glCapDeleteVertexArrays);
  GenVertexArrays := GetCapAddress(@glCapGenVertexArrays);
  IsVertexArray := GetCapAddress(@glCapIsVertexArray);
  FlushVertexArrayRangeNV := GetCapAddress(@glCapFlushVertexArrayRangeNV);
  VertexArrayRangeNV := GetCapAddress(@glCapVertexArrayRangeNV);
  CopyBufferSubData := GetCapAddress(@glCapCopyBufferSubData);
  UniformBuffer := GetCapAddress(@glCapUniformBuffer);
  GetUniformBufferSize := GetCapAddress(@glCapGetUniformBufferSize);
  GetUniformOffset := GetCapAddress(@glCapGetUniformOffset);
  PrimitiveRestartIndex := GetCapAddress(@glCapPrimitiveRestartIndex);

  DrawElementsBaseVertex := GetCapAddress(@glCapDrawElementsBaseVertex);
  DrawRangeElementsBaseVertex := GetCapAddress(@glCapDrawRangeElementsBaseVertex);
  DrawElementsInstancedBaseVertex := GetCapAddress(@glCapDrawElementsInstancedBaseVertex);
  MultiDrawElementsBaseVertex := GetCapAddress(@glCapMultiDrawElementsBaseVertex);
  DrawArraysInstanced := GetCapAddress(@glCapDrawArraysInstanced);
  DrawElementsInstanced := GetCapAddress(@glCapDrawElementsInstanced);

  VertexAttrib1d := GetCapAddress(@glCapVertexAttrib1d);
  VertexAttrib1dv := GetCapAddress(@glCapVertexAttrib1dv);
  VertexAttrib1f := GetCapAddress(@glCapVertexAttrib1f);
  VertexAttrib1fv := GetCapAddress(@glCapVertexAttrib1fv);
  VertexAttrib1s := GetCapAddress(@glCapVertexAttrib1s);
  VertexAttrib1sv := GetCapAddress(@glCapVertexAttrib1sv);
  VertexAttrib2d := GetCapAddress(@glCapVertexAttrib2d);
  VertexAttrib2dv := GetCapAddress(@glCapVertexAttrib2dv);
  VertexAttrib2f := GetCapAddress(@glCapVertexAttrib2f);
  VertexAttrib2fv := GetCapAddress(@glCapVertexAttrib2fv);
  VertexAttrib2s := GetCapAddress(@glCapVertexAttrib2s);
  VertexAttrib2sv := GetCapAddress(@glCapVertexAttrib2sv);
  VertexAttrib3d := GetCapAddress(@glCapVertexAttrib3d);
  VertexAttrib3dv := GetCapAddress(@glCapVertexAttrib3dv);
  VertexAttrib3f := GetCapAddress(@glCapVertexAttrib3f);
  VertexAttrib3fv := GetCapAddress(@glCapVertexAttrib3fv);
  VertexAttrib3s := GetCapAddress(@glCapVertexAttrib3s);
  VertexAttrib3sv := GetCapAddress(@glCapVertexAttrib3sv);
  VertexAttrib4Nbv := GetCapAddress(@glCapVertexAttrib4Nbv);
  VertexAttrib4Niv := GetCapAddress(@glCapVertexAttrib4Niv);
  VertexAttrib4Nsv := GetCapAddress(@glCapVertexAttrib4Nsv);
  VertexAttrib4Nub := GetCapAddress(@glCapVertexAttrib4Nub);
  VertexAttrib4Nubv := GetCapAddress(@glCapVertexAttrib4Nubv);
  VertexAttrib4Nuiv := GetCapAddress(@glCapVertexAttrib4Nuiv);
  VertexAttrib4Nusv := GetCapAddress(@glCapVertexAttrib4Nusv);
  VertexAttrib4bv := GetCapAddress(@glCapVertexAttrib4bv);
  VertexAttrib4d := GetCapAddress(@glCapVertexAttrib4d);
  VertexAttrib4dv := GetCapAddress(@glCapVertexAttrib4dv);
  VertexAttrib4f := GetCapAddress(@glCapVertexAttrib4f);
  VertexAttrib4fv := GetCapAddress(@glCapVertexAttrib4fv);
  VertexAttrib4iv := GetCapAddress(@glCapVertexAttrib4iv);
  VertexAttrib4s := GetCapAddress(@glCapVertexAttrib4s);
  VertexAttrib4sv := GetCapAddress(@glCapVertexAttrib4sv);
  VertexAttrib4ubv := GetCapAddress(@glCapVertexAttrib4ubv);
  VertexAttrib4uiv := GetCapAddress(@glCapVertexAttrib4uiv);
  VertexAttrib4usv := GetCapAddress(@glCapVertexAttrib4usv);
  VertexAttribPointer := GetCapAddress(@glCapVertexAttribPointer);
  VertexAttribI1i := GetCapAddress(@glCapVertexAttribI1i);
  VertexAttribI2i := GetCapAddress(@glCapVertexAttribI2i);
  VertexAttribI3i := GetCapAddress(@glCapVertexAttribI3i);
  VertexAttribI4i := GetCapAddress(@glCapVertexAttribI4i);
  VertexAttribI1ui := GetCapAddress(@glCapVertexAttribI1ui);
  VertexAttribI2ui := GetCapAddress(@glCapVertexAttribI2ui);
  VertexAttribI3ui := GetCapAddress(@glCapVertexAttribI3ui);
  VertexAttribI4ui := GetCapAddress(@glCapVertexAttribI4ui);
  VertexAttribI1iv := GetCapAddress(@glCapVertexAttribI1iv);
  VertexAttribI2iv := GetCapAddress(@glCapVertexAttribI2iv);
  VertexAttribI3iv := GetCapAddress(@glCapVertexAttribI3iv);
  VertexAttribI4iv := GetCapAddress(@glCapVertexAttribI4iv);
  VertexAttribI1uiv := GetCapAddress(@glCapVertexAttribI1uiv);
  VertexAttribI2uiv := GetCapAddress(@glCapVertexAttribI2uiv);
  VertexAttribI3uiv := GetCapAddress(@glCapVertexAttribI3uiv);
  VertexAttribI4uiv := GetCapAddress(@glCapVertexAttribI4uiv);
  VertexAttribI4bv := GetCapAddress(@glCapVertexAttribI4bv);
  VertexAttribI4sv := GetCapAddress(@glCapVertexAttribI4sv);
  VertexAttribI4ubv := GetCapAddress(@glCapVertexAttribI4ubv);
  VertexAttribI4usv := GetCapAddress(@glCapVertexAttribI4usv);
  VertexAttribIPointer := GetCapAddress(@glCapVertexAttribIPointer);
  GetVertexAttribIiv := GetCapAddress(@glCapGetVertexAttribIiv);
  GetVertexAttribIuiv := GetCapAddress(@glCapGetVertexAttribIuiv);
  EnableVertexAttribArray := GetCapAddress(@glCapEnableVertexAttribArray);
  DisableVertexAttribArray := GetCapAddress(@glCapDisableVertexAttribArray);
  VertexAttribDivisor := GetCapAddress(@glCapVertexAttribDivisor);

  GenQueries := GetCapAddress(@glCapGenQueries);
  DeleteQueries := GetCapAddress(@glCapDeleteQueries);
  IsQuery := GetCapAddress(@glCapIsQuery);
  BeginQuery := GetCapAddress(@glCapBeginQuery);
  EndQuery := GetCapAddress(@glCapEndQuery);
  GetQueryiv := GetCapAddress(@glCapGetQueryiv);
  GetQueryObjectiv := GetCapAddress(@glCapGetQueryObjectiv);
  GetQueryObjectuiv := GetCapAddress(@glCapGetQueryObjectuiv);
  QueryCounter := GetCapAddress(@glCapQueryCounter);
  GetQueryObjecti64v := GetCapAddress(@glCapGetQueryObjecti64v);
  GetQueryObjectui64v := GetCapAddress(@glCapGetQueryObjectui64v);

  DeleteObject := GetCapAddress(@glCapDeleteObject);
{$IFDEF GLS_OPENGL_ES}
  DeleteShader := GetCapAddress(@glCapDeleteShader);
  DeleteProgram := GetCapAddress(@glCapDeleteProgram);
{$ENDIF}
  GetHandle := GetCapAddress(@glCapGetHandle);
  DetachShader := GetCapAddress(@glCapDetachShader);
  CreateShader := GetCapAddress(@glCapCreateShader);
  ShaderSource := GetCapAddress(@glCapShaderSource);
  CompileShader := GetCapAddress(@glCapCompileShader);
  CreateProgram := GetCapAddress(@glCapCreateProgram);
  AttachShader := GetCapAddress(@glCapAttachShader);
  LinkProgram := GetCapAddress(@glCapLinkProgram);
  UseProgram := GetCapAddress(@glCapUseProgram);
  ValidateProgram := GetCapAddress(@glCapValidateProgram);
  Uniform1f := GetCapAddress(@glCapUniform1f);
  Uniform2f := GetCapAddress(@glCapUniform2f);
  Uniform3f := GetCapAddress(@glCapUniform3f);
  Uniform4f := GetCapAddress(@glCapUniform4f);
  Uniform1i := GetCapAddress(@glCapUniform1i);
  Uniform2i := GetCapAddress(@glCapUniform2i);
  Uniform3i := GetCapAddress(@glCapUniform3i);
  Uniform4i := GetCapAddress(@glCapUniform4i);
  Uniform1fv := GetCapAddress(@glCapUniform1fv);
  Uniform2fv := GetCapAddress(@glCapUniform2fv);
  Uniform3fv := GetCapAddress(@glCapUniform3fv);
  Uniform4fv := GetCapAddress(@glCapUniform4fv);
  Uniform1iv := GetCapAddress(@glCapUniform1iv);
  Uniform2iv := GetCapAddress(@glCapUniform2iv);
  Uniform3iv := GetCapAddress(@glCapUniform3iv);
  Uniform4iv := GetCapAddress(@glCapUniform4iv);
  Uniform1ui := GetCapAddress(@glCapUniform1ui);
  Uniform2ui := GetCapAddress(@glCapUniform2ui);
  Uniform3ui := GetCapAddress(@glCapUniform3ui);
  Uniform4ui := GetCapAddress(@glCapUniform4ui);
  Uniform1uiv := GetCapAddress(@glCapUniform1uiv);
  Uniform2uiv := GetCapAddress(@glCapUniform2uiv);
  Uniform3uiv := GetCapAddress(@glCapUniform3uiv);
  Uniform4uiv := GetCapAddress(@glCapUniform4uiv);
  GetUniformuiv := GetCapAddress(@glCapGetUniformuiv);
  UniformMatrix2fv := GetCapAddress(@glCapUniformMatrix2fv);
  UniformMatrix3fv := GetCapAddress(@glCapUniformMatrix3fv);
  UniformMatrix4fv := GetCapAddress(@glCapUniformMatrix4fv);
  BindFragDataLocation := GetCapAddress(@glCapBindFragDataLocation);
  GetFragDataLocation := GetCapAddress(@glCapGetFragDataLocation);
  ClampColor := GetCapAddress(@glCapClampColor);
  ColorMaski := GetCapAddress(@glCapColorMaski);
  GetBooleani_v := GetCapAddress(@glCapGetBooleani_v);
  GetIntegeri_v := GetCapAddress(@glCapGetIntegeri_v);
  Enablei := GetCapAddress(@glCapEnablei);
  Disablei := GetCapAddress(@glCapDisablei);
  IsEnabledi := GetCapAddress(@glCapIsEnabledi);
  BindFragDataLocationIndexed := GetCapAddress(@glCapBindFragDataLocationIndexed);
  GetFragDataIndex := GetCapAddress(@glCapGetFragDataIndex);
  GetObjectParameterfv := GetCapAddress(@glCapGetObjectParameterfv);
  GetObjectParameteriv := GetCapAddress(@glCapGetObjectParameteriv);
  GetAttachedObjects := GetCapAddress(@glCapGetAttachedObjects);
  GetActiveAttrib := GetCapAddress(@glCapGetActiveAttrib);
  GetActiveUniform := GetCapAddress(@glCapGetActiveUniform);
  GetAttachedShaders := GetCapAddress(@glCapGetAttachedShaders);
  GetAttribLocation := GetCapAddress(@glCapGetAttribLocation);
  GetProgramiv := GetCapAddress(@glCapGetProgramiv);
  GetProgramInfoLog := GetCapAddress(@glCapGetProgramInfoLog);
  GetShaderiv := GetCapAddress(@glCapGetShaderiv);
  GetInfoLog := GetCapAddress(@glCapGetInfoLog);
  GetShaderInfoLog := GetCapAddress(@glCapGetShaderInfoLog);
  GetShaderSource := GetCapAddress(@glCapGetShaderSource);
  GetUniformLocation := GetCapAddress(@glCapGetUniformLocation);
  GetUniformfv := GetCapAddress(@glCapGetUniformfv);
  GetUniformiv := GetCapAddress(@glCapGetUniformiv);
  GetVertexAttribdv := GetCapAddress(@glCapGetVertexAttribdv);
  GetVertexAttribfv := GetCapAddress(@glCapGetVertexAttribfv);
  GetVertexAttribiv := GetCapAddress(@glCapGetVertexAttribiv);
  GetVertexAttribPointerv := GetCapAddress(@glCapGetVertexAttribPointerv);
  IsProgram := GetCapAddress(@glCapIsProgram);
  IsShader := GetCapAddress(@glCapIsShader);
  GetUniformLocation := GetCapAddress(@glCapGetUniformLocation);
  BindAttribLocation := GetCapAddress(@glCapBindAttribLocation);
  GetVaryingLocation := GetCapAddress(@glCapGetVaryingLocation);
  GetActiveVarying := GetCapAddress(@glCapGetActiveVarying);
  ActiveVarying := GetCapAddress(@glCapActiveVarying);
  GetUniformIndices := GetCapAddress(@glCapGetUniformIndices);
  GetActiveUniformsiv := GetCapAddress(@glCapGetActiveUniformsiv);
  GetActiveUniformName := GetCapAddress(@glCapGetActiveUniformName);
  GetUniformBlockIndex := GetCapAddress(@glCapGetUniformBlockIndex);
  GetActiveUniformBlockiv := GetCapAddress(@glCapGetActiveUniformBlockiv);
  GetActiveUniformBlockName := GetCapAddress(@glCapGetActiveUniformBlockName);
  UniformBlockBinding := GetCapAddress(@glCapUniformBlockBinding);
  GetProgramBinary := GetCapAddress(@glCapGetProgramBinary);
  ProgramBinary := GetCapAddress(@glCapProgramBinary);
  UseProgramStages := GetCapAddress(@glCapUseProgramStages);
  ActiveShaderProgram := GetCapAddress(@glCapActiveShaderProgram);
  CreateShaderProgramv := GetCapAddress(@glCapCreateShaderProgramv);
  BindProgramPipeline := GetCapAddress(@glCapBindProgramPipeline);
  DeleteProgramPipelines := GetCapAddress(@glCapDeleteProgramPipelines);
  GenProgramPipelines := GetCapAddress(@glCapGenProgramPipelines);
  IsProgramPipeline := GetCapAddress(@glCapIsProgramPipeline);
  GetProgramPipelineiv := GetCapAddress(@glCapGetProgramPipelineiv);
  ProgramUniform1i := GetCapAddress(@glCapProgramUniform1i);
  ProgramUniform1iv := GetCapAddress(@glCapProgramUniform1iv);
  ProgramUniform1f := GetCapAddress(@glCapProgramUniform1f);
  ProgramUniform1fv := GetCapAddress(@glCapProgramUniform1fv);
  ProgramUniform1d := GetCapAddress(@glCapProgramUniform1d);
  ProgramUniform1dv := GetCapAddress(@glCapProgramUniform1dv);
  ProgramUniform1ui := GetCapAddress(@glCapProgramUniform1ui);
  ProgramUniform1uiv := GetCapAddress(@glCapProgramUniform1uiv);
  ProgramUniform2i := GetCapAddress(@glCapProgramUniform2i);
  ProgramUniform2iv := GetCapAddress(@glCapProgramUniform2iv);
  ProgramUniform2f := GetCapAddress(@glCapProgramUniform2f);
  ProgramUniform2fv := GetCapAddress(@glCapProgramUniform2fv);
  ProgramUniform2d := GetCapAddress(@glCapProgramUniform2d);
  ProgramUniform2dv := GetCapAddress(@glCapProgramUniform2dv);
  ProgramUniform2ui := GetCapAddress(@glCapProgramUniform2ui);
  ProgramUniform2uiv := GetCapAddress(@glCapProgramUniform2uiv);
  ProgramUniform3i := GetCapAddress(@glCapProgramUniform3i);
  ProgramUniform3iv := GetCapAddress(@glCapProgramUniform3iv);
  ProgramUniform3f := GetCapAddress(@glCapProgramUniform3f);
  ProgramUniform3fv := GetCapAddress(@glCapProgramUniform3fv);
  ProgramUniform3d := GetCapAddress(@glCapProgramUniform3d);
  ProgramUniform3dv := GetCapAddress(@glCapProgramUniform3dv);
  ProgramUniform3ui := GetCapAddress(@glCapProgramUniform3ui);
  ProgramUniform3uiv := GetCapAddress(@glCapProgramUniform3uiv);
  ProgramUniform4i := GetCapAddress(@glCapProgramUniform4i);
  ProgramUniform4iv := GetCapAddress(@glCapProgramUniform4iv);
  ProgramUniform4f := GetCapAddress(@glCapProgramUniform4f);
  ProgramUniform4fv := GetCapAddress(@glCapProgramUniform4fv);
  ProgramUniform4d := GetCapAddress(@glCapProgramUniform4d);
  ProgramUniform4dv := GetCapAddress(@glCapProgramUniform4dv);
  ProgramUniform4ui := GetCapAddress(@glCapProgramUniform4ui);
  ProgramUniform4uiv := GetCapAddress(@glCapProgramUniform4uiv);
  ProgramUniformMatrix2fv := GetCapAddress(@glCapProgramUniformMatrix2fv);
  ProgramUniformMatrix3fv := GetCapAddress(@glCapProgramUniformMatrix3fv);
  ProgramUniformMatrix4fv := GetCapAddress(@glCapProgramUniformMatrix4fv);
  ProgramUniformMatrix2dv := GetCapAddress(@glCapProgramUniformMatrix2dv);
  ProgramUniformMatrix3dv := GetCapAddress(@glCapProgramUniformMatrix3dv);
  ProgramUniformMatrix4dv := GetCapAddress(@glCapProgramUniformMatrix4dv);
  ProgramUniformMatrix2x3fv := GetCapAddress(@glCapProgramUniformMatrix2x3fv);
  ProgramUniformMatrix3x2fv := GetCapAddress(@glCapProgramUniformMatrix3x2fv);
  ProgramUniformMatrix2x4fv := GetCapAddress(@glCapProgramUniformMatrix2x4fv);
  ProgramUniformMatrix4x2fv := GetCapAddress(@glCapProgramUniformMatrix4x2fv);
  ProgramUniformMatrix3x4fv := GetCapAddress(@glCapProgramUniformMatrix3x4fv);
  ProgramUniformMatrix4x3fv := GetCapAddress(@glCapProgramUniformMatrix4x3fv);
  ProgramUniformMatrix2x3dv := GetCapAddress(@glCapProgramUniformMatrix2x3dv);
  ProgramUniformMatrix3x2dv := GetCapAddress(@glCapProgramUniformMatrix3x2dv);
  ProgramUniformMatrix2x4dv := GetCapAddress(@glCapProgramUniformMatrix2x4dv);
  ProgramUniformMatrix4x2dv := GetCapAddress(@glCapProgramUniformMatrix4x2dv);
  ProgramUniformMatrix3x4dv := GetCapAddress(@glCapProgramUniformMatrix3x4dv);
  ProgramUniformMatrix4x3dv := GetCapAddress(@glCapProgramUniformMatrix4x3dv);
  ValidateProgramPipeline := GetCapAddress(@glCapValidateProgramPipeline);
  GetProgramPipelineInfoLog := GetCapAddress(@glCapGetProgramPipelineInfoLog);

  DrawBuffers := GetCapAddress(@glCapDrawBuffers);

  ActiveTexture := GetCapAddress(@glCapActiveTexture);
  CompressedTexImage3D := GetCapAddress(@glCapCompressedTexImage3D);
  CompressedTexImage2D := GetCapAddress(@glCapCompressedTexImage2D);
  CompressedTexImage1D := GetCapAddress(@glCapCompressedTexImage1D);
  CompressedTexSubImage3D := GetCapAddress(@glCapCompressedTexSubImage3D);
  CompressedTexSubImage2D := GetCapAddress(@glCapCompressedTexSubImage2D);
  CompressedTexSubImage1D := GetCapAddress(@glCapCompressedTexSubImage1D);
  GetCompressedTexImage := GetCapAddress(@glCapGetCompressedTexImage);
  ClientActiveTexture := GetCapAddress(@glCapClientActiveTexture);
  MultiTexCoord1d := GetCapAddress(@glCapMultiTexCoord1d);
  MultiTexCoord1dV := GetCapAddress(@glCapMultiTexCoord1dV);
  MultiTexCoord1f := GetCapAddress(@glCapMultiTexCoord1f);
  MultiTexCoord1fv := GetCapAddress(@glCapMultiTexCoord1fv);
  MultiTexCoord1i := GetCapAddress(@glCapMultiTexCoord1i);
  MultiTexCoord1iv := GetCapAddress(@glCapMultiTexCoord1iv);
  MultiTexCoord1s := GetCapAddress(@glCapMultiTexCoord1s);
  MultiTexCoord1sv := GetCapAddress(@glCapMultiTexCoord1sv);
  MultiTexCoord2d := GetCapAddress(@glCapMultiTexCoord2d);
  MultiTexCoord2dv := GetCapAddress(@glCapMultiTexCoord2dv);
  MultiTexCoord2f := GetCapAddress(@glCapMultiTexCoord2f);
  MultiTexCoord2fv := GetCapAddress(@glCapMultiTexCoord2fv);
  MultiTexCoord2i := GetCapAddress(@glCapMultiTexCoord2i);
  MultiTexCoord2iv := GetCapAddress(@glCapMultiTexCoord2iv);
  MultiTexCoord2s := GetCapAddress(@glCapMultiTexCoord2s);
  MultiTexCoord2sv := GetCapAddress(@glCapMultiTexCoord2sv);
  MultiTexCoord3d := GetCapAddress(@glCapMultiTexCoord3d);
  MultiTexCoord3dv := GetCapAddress(@glCapMultiTexCoord3dv);
  MultiTexCoord3f := GetCapAddress(@glCapMultiTexCoord3f);
  MultiTexCoord3fv := GetCapAddress(@glCapMultiTexCoord3fv);
  MultiTexCoord3i := GetCapAddress(@glCapMultiTexCoord3i);
  MultiTexCoord3iv := GetCapAddress(@glCapMultiTexCoord3iv);
  MultiTexCoord3s := GetCapAddress(@glCapMultiTexCoord3s);
  MultiTexCoord3sv := GetCapAddress(@glCapMultiTexCoord3sv);
  MultiTexCoord4d := GetCapAddress(@glCapMultiTexCoord4d);
  MultiTexCoord4dv := GetCapAddress(@glCapMultiTexCoord4dv);
  MultiTexCoord4f := GetCapAddress(@glCapMultiTexCoord4f);
  MultiTexCoord4fv := GetCapAddress(@glCapMultiTexCoord4fv);
  MultiTexCoord4i := GetCapAddress(@glCapMultiTexCoord4i);
  MultiTexCoord4iv := GetCapAddress(@glCapMultiTexCoord4iv);
  MultiTexCoord4s := GetCapAddress(@glCapMultiTexCoord4s);
  MultiTexCoord4sv := GetCapAddress(@glCapMultiTexCoord4sv);

  GetInteger64i_v := GetCapAddress(@glCapGetInteger64i_v);
  GetBufferParameteri64v := GetCapAddress(@glCapGetBufferParameteri64v);
  ProgramParameteri := GetCapAddress(@glCapProgramParameteri);

  ProgramString := GetCapAddress(@glCapProgramString);
  BindProgram := GetCapAddress(@glCapBindProgram);
  DeletePrograms := GetCapAddress(@glCapDeletePrograms);
  GenPrograms := GetCapAddress(@glCapGenPrograms);
  ProgramEnvParameter4d := GetCapAddress(@glCapProgramEnvParameter4d);
  ProgramEnvParameter4dv := GetCapAddress(@glCapProgramEnvParameter4dv);
  ProgramEnvParameter4f := GetCapAddress(@glCapProgramEnvParameter4f);
  ProgramEnvParameter4fv := GetCapAddress(@glCapProgramEnvParameter4fv);
  ProgramLocalParameter4d := GetCapAddress(@glCapProgramLocalParameter4d);
  ProgramLocalParameter4dv := GetCapAddress(@glCapProgramLocalParameter4dv);
  ProgramLocalParameter4f := GetCapAddress(@glCapProgramLocalParameter4f);
  ProgramLocalParameter4fv := GetCapAddress(@glCapProgramLocalParameter4fv);
  GetProgramEnvParameterdv := GetCapAddress(@glCapGetProgramEnvParameterdv);
  GetProgramEnvParameterfv := GetCapAddress(@glCapGetProgramEnvParameterfv);
  GetProgramLocalParameterdv := GetCapAddress(@glCapGetProgramLocalParameterdv);
  GetProgramLocalParameterfv := GetCapAddress(@glCapGetProgramLocalParameterfv);

  ClearColorIi := GetCapAddress(@glCapClearColorIi);
  ClearColorIui := GetCapAddress(@glCapClearColorIui);
  TexParameterIiv := GetCapAddress(@glCapTexParameterIiv);
  TexParameterIuiv := GetCapAddress(@glCapTexParameterIuiv);
  GetTexParameterIiv := GetCapAddress(@glCapGetTexParameterIiv);
  GetTexParameterIuiv := GetCapAddress(@glCapGetTexParameterIuiv);
  PatchParameteri := GetCapAddress(@glCapPatchParameteri);
  PatchParameterfv := GetCapAddress(@glCapPatchParameterfv);

  BufferAddressRangeNV := GetCapAddress(@glCapBufferAddressRangeNV);
  VertexFormatNV := GetCapAddress(@glCapVertexFormatNV);
  NormalFormatNV := GetCapAddress(@glCapNormalFormatNV);
  ColorFormatNV := GetCapAddress(@glCapColorFormatNV);
  IndexFormatNV := GetCapAddress(@glCapIndexFormatNV);
  TexCoordFormatNV := GetCapAddress(@glCapTexCoordFormatNV);
  EdgeFlagFormatNV := GetCapAddress(@glCapEdgeFlagFormatNV);
  SecondaryColorFormatNV := GetCapAddress(@glCapSecondaryColorFormatNV);
  FogCoordFormatNV := GetCapAddress(@glCapFogCoordFormatNV);
  VertexAttribFormatNV := GetCapAddress(@glCapVertexAttribFormatNV);
  VertexAttribIFormatNV := GetCapAddress(@glCapVertexAttribIFormatNV);
  GetIntegerui64i_vNV := GetCapAddress(@glCapGetIntegerui64i_vNV);
  GetBufferParameterui64vNV := GetCapAddress(@glCapGetBufferParameterui64vNV);
  MakeBufferResidentNV := GetCapAddress(@glCapMakeBufferResidentNV);
  MakeBufferNonResidentNV := GetCapAddress(@glCapMakeBufferNonResidentNV);
  IsBufferResidentNV := GetCapAddress(@glCapIsBufferResidentNV);
  MakeNamedBufferResidentNV := GetCapAddress(@glCapMakeNamedBufferResidentNV);
  MakeNamedBufferNonResidentNV := GetCapAddress(@glCapMakeNamedBufferNonResidentNV);
  IsNamedBufferResidentNV := GetCapAddress(@glCapIsNamedBufferResidentNV);
  GetNamedBufferParameterui64vNV := GetCapAddress(@glCapGetNamedBufferParameterui64vNV);
  GetIntegerui64vNV := GetCapAddress(@glCapGetIntegerui64vNV);
  Uniformui64NV := GetCapAddress(@glCapUniformui64NV);
  Uniformui64vNV := GetCapAddress(@glCapUniformui64vNV);
  GetUniformui64vNV := GetCapAddress(@glCapGetUniformui64vNV);
  ProgramUniformui64NV := GetCapAddress(@glCapProgramUniformui64NV);
  ProgramUniformui64vNV := GetCapAddress(@glCapProgramUniformui64vNV);

  TexImage2DMultisample := GetCapAddress(@glCapTexImage2DMultisample);
  TexImage3DMultisample := GetCapAddress(@glCapTexImage3DMultisample);
  GetMultisamplefv := GetCapAddress(@glCapGetMultisamplefv);
  SampleMaski := GetCapAddress(@glCapSampleMaski);

  ProvokingVertex := GetCapAddress(@glCapProvokingVertex);

  FenceSync := GetCapAddress(@glCapFenceSync);
  IsSync := GetCapAddress(@glCapIsSync);
  DeleteSync := GetCapAddress(@glCapDeleteSync);
  ClientWaitSync := GetCapAddress(@glCapClientWaitSync);
  WaitSync := GetCapAddress(@glCapWaitSync);
  GetInteger64v := GetCapAddress(@glCapGetInteger64v);
  GetSynciv := GetCapAddress(@glCapGetSynciv);

  BlendEquationi := GetCapAddress(@glCapBlendEquationi);
  BlendEquationSeparatei := GetCapAddress(@glCapBlendEquationSeparatei);
  BlendFunci := GetCapAddress(@glCapBlendFunci);
  BlendFuncSeparatei := GetCapAddress(@glCapBlendFuncSeparatei);
  MinSampleShading := GetCapAddress(@glCapMinSampleShading);

  GenSamplers := GetCapAddress(@glCapGenSamplers);
  DeleteSamplers := GetCapAddress(@glCapDeleteSamplers);
  IsSampler := GetCapAddress(@glCapIsSampler);
  BindSampler := GetCapAddress(@glCapBindSampler);
  SamplerParameteri := GetCapAddress(@glCapSamplerParameteri);
  SamplerParameteriv := GetCapAddress(@glCapSamplerParameteriv);
  SamplerParameterf := GetCapAddress(@glCapSamplerParameterf);
  SamplerParameterfv := GetCapAddress(@glCapSamplerParameterfv);
  SamplerParameterIiv := GetCapAddress(@glCapSamplerParameterIiv);
  SamplerParameterIuiv := GetCapAddress(@glCapSamplerParameterIuiv);
  GetSamplerParameteriv := GetCapAddress(@glCapGetSamplerParameteriv);
  GetSamplerParameterIiv := GetCapAddress(@glCapGetSamplerParameterIiv);
  GetSamplerParameterfv := GetCapAddress(@glCapGetSamplerParameterfv);
  GetSamplerParameterIfv := GetCapAddress(@glCapGetSamplerParameterIfv);

  ClientAttribDefault := GetCapAddress(@glCapClientAttribDefault);
  PushClientAttribDefault := GetCapAddress(@glCapPushClientAttribDefault);
  MatrixLoadf := GetCapAddress(@glCapMatrixLoadf);
  MatrixLoadd := GetCapAddress(@glCapMatrixLoadd);
  MatrixMultf := GetCapAddress(@glCapMatrixMultf);
  MatrixMultd := GetCapAddress(@glCapMatrixMultd);
  MatrixLoadIdentity := GetCapAddress(@glCapMatrixLoadIdentity);
  MatrixRotatef := GetCapAddress(@glCapMatrixRotatef);
  MatrixRotated := GetCapAddress(@glCapMatrixRotated);
  MatrixScalef := GetCapAddress(@glCapMatrixScalef);
  MatrixScaled := GetCapAddress(@glCapMatrixScaled);
  MatrixTranslatef := GetCapAddress(@glCapMatrixTranslatef);
  MatrixTranslated := GetCapAddress(@glCapMatrixTranslated);
  MatrixFrustum := GetCapAddress(@glCapMatrixFrustum);
  MatrixOrtho := GetCapAddress(@glCapMatrixOrtho);
  MatrixPop := GetCapAddress(@glCapMatrixPop);
  MatrixPush := GetCapAddress(@glCapMatrixPush);
  MatrixLoadTransposef := GetCapAddress(@glCapMatrixLoadTransposef);
  MatrixLoadTransposed := GetCapAddress(@glCapMatrixLoadTransposed);
  MatrixMultTransposef := GetCapAddress(@glCapMatrixMultTransposef);
  MatrixMultTransposed := GetCapAddress(@glCapMatrixMultTransposed);
  TextureParameterf := GetCapAddress(@glCapTextureParameterf);
  TextureParameterfv := GetCapAddress(@glCapTextureParameterfv);
  TextureParameteri := GetCapAddress(@glCapTextureParameteri);
  TextureParameteriv := GetCapAddress(@glCapTextureParameteriv);
  TextureImage1D := GetCapAddress(@glCapTextureImage1D);
  TextureImage2D := GetCapAddress(@glCapTextureImage2D);
  TextureSubImage1D := GetCapAddress(@glCapTextureSubImage1D);
  TextureSubImage2D := GetCapAddress(@glCapTextureSubImage2D);
  CopyTextureImage1D := GetCapAddress(@glCapCopyTextureImage1D);
  CopyTextureImage2D := GetCapAddress(@glCapCopyTextureImage2D);
  CopyTextureSubImage1D := GetCapAddress(@glCapCopyTextureSubImage1D);
  CopyTextureSubImage2D := GetCapAddress(@glCapCopyTextureSubImage2D);
  GetTextureImage := GetCapAddress(@glCapGetTextureImage);
  GetTextureParameterfv := GetCapAddress(@glCapGetTextureParameterfv);
  GetTextureParameteriv := GetCapAddress(@glCapGetTextureParameteriv);
  GetTextureLevelParameterfv := GetCapAddress(@glCapGetTextureLevelParameterfv);
  GetTextureLevelParameteriv := GetCapAddress(@glCapGetTextureLevelParameteriv);
  TextureImage3D := GetCapAddress(@glCapTextureImage3D);
  TextureSubImage3D := GetCapAddress(@glCapTextureSubImage3D);
  CopyTextureSubImage3D := GetCapAddress(@glCapCopyTextureSubImage3D);
  MultiTexParameterf := GetCapAddress(@glCapMultiTexParameterf);
  MultiTexParameterfv := GetCapAddress(@glCapMultiTexParameterfv);
  MultiTexParameteri := GetCapAddress(@glCapMultiTexParameteri);
  MultiTexParameteriv := GetCapAddress(@glCapMultiTexParameteriv);
  MultiTexImage1D := GetCapAddress(@glCapMultiTexImage1D);
  MultiTexImage2D := GetCapAddress(@glCapMultiTexImage2D);
  MultiTexSubImage1D := GetCapAddress(@glCapMultiTexSubImage1D);
  MultiTexSubImage2D := GetCapAddress(@glCapMultiTexSubImage2D);
  CopyMultiTexImage1D := GetCapAddress(@glCapCopyMultiTexImage1D);
  CopyMultiTexImage2D := GetCapAddress(@glCapCopyMultiTexImage2D);
  CopyMultiTexSubImage1D := GetCapAddress(@glCapCopyMultiTexSubImage1D);
  CopyMultiTexSubImage2D := GetCapAddress(@glCapCopyMultiTexSubImage2D);
  GetMultiTexImage := GetCapAddress(@glCapGetMultiTexImage);
  GetMultiTexParameterfv := GetCapAddress(@glCapGetMultiTexParameterfv);
  GetMultiTexParameteriv := GetCapAddress(@glCapGetMultiTexParameteriv);
  GetMultiTexLevelParameterfv := GetCapAddress(@glCapGetMultiTexLevelParameterfv);
  GetMultiTexLevelParameteriv := GetCapAddress(@glCapGetMultiTexLevelParameteriv);
  MultiTexImage3D := GetCapAddress(@glCapMultiTexImage3D);
  MultiTexSubImage3D := GetCapAddress(@glCapMultiTexSubImage3D);
  CopyMultiTexSubImage3D := GetCapAddress(@glCapCopyMultiTexSubImage3D);
  BindMultiTexture := GetCapAddress(@glCapBindMultiTexture);
  EnableClientStateIndexed := GetCapAddress(@glCapEnableClientStateIndexed);
  DisableClientStateIndexed := GetCapAddress(@glCapDisableClientStateIndexed);
  MultiTexCoordPointer := GetCapAddress(@glCapMultiTexCoordPointer);
  MultiTexEnvf := GetCapAddress(@glCapMultiTexEnvf);
  MultiTexEnvfv := GetCapAddress(@glCapMultiTexEnvfv);
  MultiTexEnvi := GetCapAddress(@glCapMultiTexEnvi);
  MultiTexEnviv := GetCapAddress(@glCapMultiTexEnviv);
  MultiTexGend := GetCapAddress(@glCapMultiTexGend);
  MultiTexGendv := GetCapAddress(@glCapMultiTexGendv);
  MultiTexGenf := GetCapAddress(@glCapMultiTexGenf);
  MultiTexGenfv := GetCapAddress(@glCapMultiTexGenfv);
  MultiTexGeni := GetCapAddress(@glCapMultiTexGeni);
  MultiTexGeniv := GetCapAddress(@glCapMultiTexGeniv);
  GetMultiTexEnvfv := GetCapAddress(@glCapGetMultiTexEnvfv);
  GetMultiTexEnviv := GetCapAddress(@glCapGetMultiTexEnviv);
  GetMultiTexGendv := GetCapAddress(@glCapGetMultiTexGendv);
  GetMultiTexGenfv := GetCapAddress(@glCapGetMultiTexGenfv);
  GetMultiTexGeniv := GetCapAddress(@glCapGetMultiTexGeniv);
  GetFloatIndexedv := GetCapAddress(@glCapGetFloatIndexedv);
  GetDoubleIndexedv := GetCapAddress(@glCapGetDoubleIndexedv);
  GetPointerIndexedv := GetCapAddress(@glCapGetPointerIndexedv);
  CompressedTextureImage3D := GetCapAddress(@glCapCompressedTextureImage3D);
  CompressedTextureImage2D := GetCapAddress(@glCapCompressedTextureImage2D);
  CompressedTextureImage1D := GetCapAddress(@glCapCompressedTextureImage1D);
  CompressedTextureSubImage3D := GetCapAddress(@glCapCompressedTextureSubImage3D);
  CompressedTextureSubImage2D := GetCapAddress(@glCapCompressedTextureSubImage2D);
  CompressedTextureSubImage1D := GetCapAddress(@glCapCompressedTextureSubImage1D);
  GetCompressedTextureImage := GetCapAddress(@glCapGetCompressedTextureImage);
  CompressedMultiTexImage3D := GetCapAddress(@glCapCompressedMultiTexImage3D);
  CompressedMultiTexImage2D := GetCapAddress(@glCapCompressedMultiTexImage2D);
  CompressedMultiTexImage1D := GetCapAddress(@glCapCompressedMultiTexImage1D);
  CompressedMultiTexSubImage3D := GetCapAddress(@glCapCompressedMultiTexSubImage3D);
  CompressedMultiTexSubImage2D := GetCapAddress(@glCapCompressedMultiTexSubImage2D);
  CompressedMultiTexSubImage1D := GetCapAddress(@glCapCompressedMultiTexSubImage1D);
  GetCompressedMultiTexImage := GetCapAddress(@glCapGetCompressedMultiTexImage);
  NamedProgramString := GetCapAddress(@glCapNamedProgramString);
  NamedProgramLocalParameter4d := GetCapAddress(@glCapNamedProgramLocalParameter4d);
  NamedProgramLocalParameter4dv := GetCapAddress(@glCapNamedProgramLocalParameter4dv);
  NamedProgramLocalParameter4f := GetCapAddress(@glCapNamedProgramLocalParameter4f);
  NamedProgramLocalParameter4fv := GetCapAddress(@glCapNamedProgramLocalParameter4fv);
  GetNamedProgramLocalParameterdv := GetCapAddress(@glCapGetNamedProgramLocalParameterdv);
  GetNamedProgramLocalParameterfv := GetCapAddress(@glCapGetNamedProgramLocalParameterfv);
  GetNamedProgramiv := GetCapAddress(@glCapGetNamedProgramiv);
  GetNamedProgramString := GetCapAddress(@glCapGetNamedProgramString);
  NamedProgramLocalParameters4fv := GetCapAddress(@glCapNamedProgramLocalParameters4fv);
  NamedProgramLocalParameterI4i := GetCapAddress(@glCapNamedProgramLocalParameterI4i);
  NamedProgramLocalParameterI4iv := GetCapAddress(@glCapNamedProgramLocalParameterI4iv);
  NamedProgramLocalParametersI4iv := GetCapAddress(@glCapNamedProgramLocalParametersI4iv);
  NamedProgramLocalParameterI4ui := GetCapAddress(@glCapNamedProgramLocalParameterI4ui);
  NamedProgramLocalParameterI4uiv := GetCapAddress(@glCapNamedProgramLocalParameterI4uiv);
  NamedProgramLocalParametersI4uiv := GetCapAddress(@glCapNamedProgramLocalParametersI4uiv);
  GetNamedProgramLocalParameterIiv := GetCapAddress(@glCapGetNamedProgramLocalParameterIiv);
  GetNamedProgramLocalParameterIuiv := GetCapAddress(@glCapGetNamedProgramLocalParameterIuiv);
  TextureParameterIiv := GetCapAddress(@glCapTextureParameterIiv);
  TextureParameterIuiv := GetCapAddress(@glCapTextureParameterIuiv);
  GetTextureParameterIiv := GetCapAddress(@glCapGetTextureParameterIiv);
  GetTextureParameterIuiv := GetCapAddress(@glCapGetTextureParameterIuiv);
  MultiTexParameterIiv := GetCapAddress(@glCapMultiTexParameterIiv);
  MultiTexParameterIuiv := GetCapAddress(@glCapMultiTexParameterIuiv);
  GetMultiTexParameterIiv := GetCapAddress(@glCapGetMultiTexParameterIiv);
  GetMultiTexParameterIuiv := GetCapAddress(@glCapGetMultiTexParameterIuiv);
  NamedBufferData := GetCapAddress(@glCapNamedBufferData);
  NamedBufferSubData := GetCapAddress(@glCapNamedBufferSubData);
  MapNamedBuffer := GetCapAddress(@glCapMapNamedBuffer);
  UnmapNamedBuffer := GetCapAddress(@glCapUnmapNamedBuffer);
  MapNamedBufferRange := GetCapAddress(@glCapMapNamedBufferRange);
  FlushMappedNamedBufferRange := GetCapAddress(@glCapFlushMappedNamedBufferRange);
  NamedCopyBufferSubData := GetCapAddress(@glCapNamedCopyBufferSubData);
  GetNamedBufferParameteriv := GetCapAddress(@glCapGetNamedBufferParameteriv);
  GetNamedBufferPointerv := GetCapAddress(@glCapGetNamedBufferPointerv);
  GetNamedBufferSubData := GetCapAddress(@glCapGetNamedBufferSubData);
  TextureBuffer := GetCapAddress(@glCapTextureBuffer);
  MultiTexBuffer := GetCapAddress(@glCapMultiTexBuffer);
  NamedRenderbufferStorage := GetCapAddress(@glCapNamedRenderbufferStorage);
  GetNamedRenderbufferParameteriv := GetCapAddress(@glCapGetNamedRenderbufferParameteriv);
  CheckNamedFramebufferStatus := GetCapAddress(@glCapCheckNamedFramebufferStatus);
  NamedFramebufferTexture1D := GetCapAddress(@glCapNamedFramebufferTexture1D);
  NamedFramebufferTexture2D := GetCapAddress(@glCapNamedFramebufferTexture2D);
  NamedFramebufferTexture3D := GetCapAddress(@glCapNamedFramebufferTexture3D);
  NamedFramebufferRenderbuffer := GetCapAddress(@glCapNamedFramebufferRenderbuffer);
  GetNamedFramebufferAttachmentParameteriv := GetCapAddress(@glCapGetNamedFramebufferAttachmentParameteriv);
  GenerateTextureMipmap := GetCapAddress(@glCapGenerateTextureMipmap);
  GenerateMultiTexMipmap := GetCapAddress(@glCapGenerateMultiTexMipmap);
  FramebufferDrawBuffer := GetCapAddress(@glCapFramebufferDrawBuffer);
  FramebufferDrawBuffers := GetCapAddress(@glCapFramebufferDrawBuffers);
  FramebufferReadBuffer := GetCapAddress(@glCapFramebufferReadBuffer);
  GetFramebufferParameteriv := GetCapAddress(@glCapGetFramebufferParameteriv);
  NamedRenderbufferStorageMultisample := GetCapAddress(@glCapNamedRenderbufferStorageMultisample);
  NamedRenderbufferStorageMultisampleCoverage := GetCapAddress(@glCapNamedRenderbufferStorageMultisampleCoverage);
  NamedFramebufferTexture := GetCapAddress(@glCapNamedFramebufferTexture);
  NamedFramebufferTextureLayer := GetCapAddress(@glCapNamedFramebufferTextureLayer);
  NamedFramebufferTextureFace := GetCapAddress(@glCapNamedFramebufferTextureFace);
  TextureRenderbuffer := GetCapAddress(@glCapTextureRenderbuffer);
  MultiTexRenderbuffer := GetCapAddress(@glCapMultiTexRenderbuffer);

  FrameTerminatorGREMEDY := GetCapAddress(@glCapFrameTerminatorGREMEDY);
  StringMarkerGREMEDY := GetCapAddress(@glCapStringMarkerGREMEDY);
  DebugMessageControl := GetCapAddress(@glCapDebugMessageControl);
  DebugMessageInsert := GetCapAddress(@glCapDebugMessageInsert);
  DebugMessageCallback := GetCapAddress(@glCapDebugMessageCallback);
  GetDebugMessageLog := GetCapAddress(@glCapGetDebugMessageLog);

  GenPathsNV := GetCapAddress(@glCapGenPathsNV);
  DeletePathsNV := GetCapAddress(@glCapDeletePathsNV);
  IsPathNV := GetCapAddress(@glCapIsPathNV);
  PathCommandsNV := GetCapAddress(@glCapPathCommandsNV);
  PathCoordsNV := GetCapAddress(@glCapPathCoordsNV);
  PathSubCommandsNV := GetCapAddress(@glCapPathSubCommandsNV);
  PathSubCoordsNV := GetCapAddress(@glCapPathSubCoordsNV);
  PathStringNV := GetCapAddress(@glCapPathStringNV);
  PathGlyphsNV := GetCapAddress(@glCapPathGlyphsNV);
  PathGlyphRangeNV := GetCapAddress(@glCapPathGlyphRangeNV);
  WeightPathsNV := GetCapAddress(@glCapWeightPathsNV);
  CopyPathNV := GetCapAddress(@glCapCopyPathNV);
  InterpolatePathsNV := GetCapAddress(@glCapInterpolatePathsNV);
  PathParameterivNV := GetCapAddress(@glCapPathParameterivNV);
  PathParameteriNV := GetCapAddress(@glCapPathParameteriNV);
  PathParameterfvNV := GetCapAddress(@glCapPathParameterfvNV);
  PathParameterfNV := GetCapAddress(@glCapPathParameterfNV);
  PathDashArrayNV := GetCapAddress(@glCapPathDashArrayNV);
  PathStencilFuncNV := GetCapAddress(@glCapPathStencilFuncNV);
  StencilFillPathNV := GetCapAddress(@glCapStencilFillPathNV);
  StencilStrokePathNV := GetCapAddress(@glCapStencilStrokePathNV);
  StencilFillPathInstancedNV := GetCapAddress(@glCapStencilFillPathInstancedNV);
  StencilStrokePathInstancedNV := GetCapAddress(@glCapStencilStrokePathInstancedNV);
  PathColorGenNV := GetCapAddress(@glCapPathColorGenNV);
  PathTexGenNV := GetCapAddress(@glCapPathTexGenNV);
  PathFogGenNV := GetCapAddress(@glCapPathFogGenNV);
  CoverFillPathNV := GetCapAddress(@glCapCoverFillPathNV);
  CoverStrokePathNV := GetCapAddress(@glCapCoverStrokePathNV);
  CoverFillPathInstancedNV := GetCapAddress(@glCapCoverFillPathInstancedNV);
  CoverStrokePathInstancedNV := GetCapAddress(@glCapCoverStrokePathInstancedNV);
  GetPathParameterivNV := GetCapAddress(@glCapGetPathParameterivNV);
  GetPathParameterfvNV := GetCapAddress(@glCapGetPathParameterfvNV);
  GetPathCommandsNV := GetCapAddress(@glCapGetPathCommandsNV);
  GetPathCoordsNV := GetCapAddress(@glCapGetPathCoordsNV);
  GetPathDashArrayNV := GetCapAddress(@glCapGetPathDashArrayNV);
  GetPathMetricsNV := GetCapAddress(@glCapGetPathMetricsNV);
  GetPathMetricRangeNV := GetCapAddress(@glCapGetPathMetricRangeNV);
  GetPathSpacingNV := GetCapAddress(@glCapGetPathSpacingNV);
  GetPathColorGenivNV := GetCapAddress(@glCapGetPathColorGenivNV);
  GetPathColorGenfvNV := GetCapAddress(@glCapGetPathColorGenfvNV);
  GetPathTexGenivNV := GetCapAddress(@glCapGetPathTexGenivNV);
  GetPathTexGenfvNV := GetCapAddress(@glCapGetPathTexGenfvNV);
  IsPointInFillPathNV := GetCapAddress(@glCapIsPointInFillPathNV);
  IsPointInStrokePathNV := GetCapAddress(@glCapIsPointInStrokePathNV);
  GetPathLengthNV := GetCapAddress(@glCapGetPathLengthNV);
  PointAlongPathNV := GetCapAddress(@glCapPointAlongPathNV);
  PathStencilDepthOffsetNV := GetCapAddress(@glCapPathStencilDepthOffsetNV);
  PathCoverDepthFuncNV := GetCapAddress(@glCapPathCoverDepthFuncNV);
