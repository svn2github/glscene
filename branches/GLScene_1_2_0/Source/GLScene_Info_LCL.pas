...
uses
  ...
  lresources, Forms, GLScene_Core, Classes,  Controls, Buttons, StdCtrls,
...
uses
  {$IFDEF Linux}xlib,{$ENDIF}GLScene_Base_OpenGL_Tokens, GLScene_Base_OpenGL_Adapter, GLScene_Base_Context,
