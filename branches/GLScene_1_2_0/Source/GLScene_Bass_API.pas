...
type
  ...
  STREAMFILEPROC = function(action, param1, param2, user: DWORD)
    : DWORD; stdcall;
  {
...
var
  ...
  BASS_PluginLoad: function(filename: PAnsiChar; flags: DWORD)
    : HPLUGIN; stdcall;
  ...
  BASS_Set3DPosition: function(var pos, vel, front, top: BASS_3DVECTOR)
    : BOOL; stdcall;
  BASS_Get3DPosition: function(var pos, vel, front, top: BASS_3DVECTOR)
    : BOOL; stdcall;
  BASS_Apply3D: procedure(); stdcall;
  BASS_SetEAXParameters: function(env: Integer; vol, decay, damp: FLOAT)
    : BOOL; stdcall;
  BASS_GetEAXParameters: function(var env: DWORD; var vol, decay, damp: FLOAT)
    : BOOL; stdcall;

  BASS_MusicLoad: function(mem: BOOL; f: Pointer;
    offset, length, flags, freq: DWORD): HMUSIC; stdcall;
  BASS_MusicFree: function(handle: HMUSIC): BOOL; stdcall;
  BASS_MusicSetAttribute: function(handle: HMUSIC; attrib, value: DWORD)
    : DWORD; stdcall;
  BASS_MusicGetAttribute: function(handle: HMUSIC; attrib: DWORD)
    : DWORD; stdcall;
  BASS_MusicGetOrders: function(handle: HMUSIC): DWORD; stdcall;
  BASS_MusicGetOrderPosition: function(handle: HMUSIC): DWORD; stdcall;

  BASS_SampleLoad: function(mem: BOOL; f: Pointer;
    offset, length, max, flags: DWORD): HSAMPLE; stdcall;
  BASS_SampleCreate: function(length, freq, chans, max, flags: DWORD)
    : Pointer; stdcall;
  BASS_SampleCreateDone: function(): HSAMPLE; stdcall;
  BASS_SampleFree: function(handle: HSAMPLE): BOOL; stdcall;
  BASS_SampleGetInfo: function(handle: HSAMPLE; var info: BASS_SAMPLE)
    : BOOL; stdcall;
  BASS_SampleSetInfo: function(handle: HSAMPLE; var info: BASS_SAMPLE)
    : BOOL; stdcall;
  BASS_SampleGetChannel: function(handle: HSAMPLE; onlynew: BOOL)
    : HCHANNEL; stdcall;
  BASS_SampleGetChannels: function(handle: HSAMPLE; channels: Pointer)
    : DWORD; stdcall;
  BASS_SampleStop: function(handle: HSAMPLE): BOOL; stdcall;

  BASS_StreamCreate: function(freq, chans, flags: DWORD; proc: Pointer;
    user: DWORD): HSTREAM; stdcall;
  BASS_StreamCreateFile: function(mem: BOOL; f: Pointer;
    offset, length, flags: DWORD): HSTREAM; stdcall;
  BASS_StreamCreateURL: function(url: PAnsiChar; offset: DWORD; flags: DWORD;
    proc: DOWNLOADPROC; user: DWORD): HSTREAM; stdcall;
  BASS_StreamCreateFileUser: function(buffered: BOOL; flags: DWORD;
    proc: STREAMFILEPROC; user: DWORD): HSTREAM; stdcall;
  BASS_StreamFree: function(handle: HSTREAM): BOOL; stdcall;
  BASS_StreamGetFilePosition: function(handle: HSTREAM; mode: DWORD)
    : DWORD; stdcall;
  ...
  BASS_RecordStart: function(freq, chans, flags: DWORD; proc: RECORDPROC;
    user: DWORD): HRECORD; stdcall;

  BASS_ChannelBytes2Seconds: function(handle: DWORD; pos: QWORD)
    : FLOAT; stdcall;
  BASS_ChannelSeconds2Bytes: function(handle: DWORD; pos: FLOAT)
    : QWORD; stdcall;
  ...
  BASS_ChannelGetInfo: function(handle: DWORD; var info: BASS_CHANNELINFO)
    : BOOL; stdcall;
  BASS_ChannelGetTags: function(handle: HSTREAM; tags: DWORD)
    : PAnsiChar; stdcall;
  ...
  BASS_ChannelSetAttributes: function(handle: DWORD; freq, volume, pan: Integer)
    : BOOL; stdcall;
  BASS_ChannelGetAttributes: function(handle: DWORD; var freq, volume: DWORD;
    var pan: Integer): BOOL; stdcall;
  BASS_ChannelSlideAttributes: function(handle: DWORD;
    freq, volume, pan: Integer; time: DWORD): BOOL; stdcall;
  BASS_ChannelIsSliding: function(handle: DWORD): DWORD; stdcall;
  BASS_ChannelSet3DAttributes: function(handle: DWORD; mode: Integer;
    min, max: FLOAT; iangle, oangle, outvol: Integer): BOOL; stdcall;
  BASS_ChannelGet3DAttributes: function(handle: DWORD; var mode: DWORD;
    var min, max: FLOAT; var iangle, oangle, outvol: DWORD): BOOL; stdcall;
  BASS_ChannelSet3DPosition: function(handle: DWORD;
    var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall;
  BASS_ChannelGet3DPosition: function(handle: DWORD;
    var pos, orient, vel: BASS_3DVECTOR): BOOL; stdcall;
  ...
  BASS_ChannelGetData: function(handle: DWORD; buffer: Pointer; length: DWORD)
    : DWORD; stdcall;
  BASS_ChannelSetSync: function(handle: DWORD; stype: DWORD; param: QWORD;
    proc: SYNCPROC; user: DWORD): HSYNC; stdcall;
  BASS_ChannelRemoveSync: function(handle: DWORD; sync: HSYNC): BOOL; stdcall;
  BASS_ChannelSetDSP: function(handle: DWORD; proc: DSPPROC; user: DWORD;
    priority: Integer): HDSP; stdcall;
  ...
  BASS_ChannelSetFX: function(handle, etype: DWORD; priority: Integer)
    : HFX; stdcall;
...
begin
  ...
  BASS_GetDeviceDescription := getprocaddress(BASSHandle,
  ...
  BASS_MusicSetAttribute := getprocaddress(BASSHandle,
    'BASS_MusicSetAttribute');
  BASS_MusicGetAttribute := getprocaddress(BASSHandle,
    'BASS_MusicGetAttribute');
  BASS_MusicGetOrders := getprocaddress(BASSHandle, 'BASS_MusicGetOrders');
  BASS_MusicGetOrderPosition := getprocaddress(BASSHandle,
  ...
  BASS_SampleGetChannels := getprocaddress(BASSHandle,
  ...
  BASS_StreamCreateFileUser := getprocaddress(BASSHandle,
    'BASS_StreamCreateFileUser');
  BASS_StreamFree := getprocaddress(BASSHandle, 'BASS_StreamFree');
  BASS_StreamGetFilePosition := getprocaddress(BASSHandle,
    'BASS_StreamGetFilePosition');

  BASS_RecordGetDeviceDescription := getprocaddress(BASSHandle,
  ...
  BASS_RecordGetInputName := getprocaddress(BASSHandle,
  ...
  BASS_ChannelBytes2Seconds := getprocaddress(BASSHandle,
    'BASS_ChannelBytes2Seconds');
  BASS_ChannelSeconds2Bytes := getprocaddress(BASSHandle,
  ...
  BASS_ChannelSetAttributes := getprocaddress(BASSHandle,
    'BASS_ChannelSetAttributes');
  BASS_ChannelGetAttributes := getprocaddress(BASSHandle,
    'BASS_ChannelGetAttributes');
  BASS_ChannelSlideAttributes := getprocaddress(BASSHandle,
    'BASS_ChannelSlideAttributes');
  BASS_ChannelIsSliding := getprocaddress(BASSHandle, 'BASS_ChannelIsSliding');
  BASS_ChannelSet3DAttributes := getprocaddress(BASSHandle,
    'BASS_ChannelSet3DAttributes');
  BASS_ChannelGet3DAttributes := getprocaddress(BASSHandle,
    'BASS_ChannelGet3DAttributes');
  BASS_ChannelSet3DPosition := getprocaddress(BASSHandle,
    'BASS_ChannelSet3DPosition');
  BASS_ChannelGet3DPosition := getprocaddress(BASSHandle,
    'BASS_ChannelGet3DPosition');
  BASS_ChannelGetLength := getprocaddress(BASSHandle, 'BASS_ChannelGetLength');
  BASS_ChannelSetPosition := getprocaddress(BASSHandle,
    'BASS_ChannelSetPosition');
  BASS_ChannelGetPosition := getprocaddress(BASSHandle,
  ...
  BASS_ChannelRemoveSync := getprocaddress(BASSHandle,
  ...
  BASS_ChannelRemoveLink := getprocaddress(BASSHandle,
