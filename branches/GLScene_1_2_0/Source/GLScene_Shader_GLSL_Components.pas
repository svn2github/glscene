...
unit GLScene_Shader_GLSL_Components;
...
uses
  ...
  // GLScene_Core
  GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Types, GLScene_Texture, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context, GLScene_Shader_Custom,
  GLScene_Base_Context_Info, GLScene_Texture_Format, GLScene_Shader_Parameter;
