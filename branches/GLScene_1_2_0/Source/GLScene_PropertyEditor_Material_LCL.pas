...
unit GLScene_PropertyEditor_Material_LCL;
...
uses
  ...
  GLScene_PropertyEditor_Color_LCL, ComCtrls, GLScene_PropertyEditor_Face_LCL, StdCtrls, Controls,
  Graphics,
  Classes, Buttons, TypInfo, GLScene_PropertyEditor_Texture_LCL,
  GLScene_Core, GLScene_Objects, GLScene_Texture, GLScene_Objects_HUD, GLScene_Objects_Teapot,
  GLScene_ObjectsEx, GLScene_Base_Color, GLScene_Viewer_LCL, GLScene_Base_Coordinates,
  GLScene_Platform, GLScene_Material, GLScene_Base_GLStateMachine,
  LResources;
