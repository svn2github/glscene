...
// ------------------------------------------------------------------
// ------------------------------------------------------------------
{$R GLScene.PropertyEditor.Vector.LCL.lfm}
...
begin
  SetVector(v,
    GLScene.Utils.StrToFloatDef(EDx.Text, 0),
    GLScene.Utils.StrToFloatDef(EDy.Text, 0),
    GLScene.Utils.StrToFloatDef(EDz.Text, 0));
