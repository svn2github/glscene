...
uses
  Classes, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Objects, GLScene_Base_OpenGL_Tokens,
  GLScene_Base_Context, GLScene_Base_Color, GLScene_Base_Classes, GLScene_Base_Context_Info, GLScene_Base_GLStateMachine,
...
uses GLScene_Utils {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
