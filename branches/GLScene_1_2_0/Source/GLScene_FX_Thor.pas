...
unit GLScene_FX_Thor;

interface

{$I GLScene.inc}

uses Classes, GLScene_Core, GLScene_Base_XCollection, GLScene_Base_Vector_Geometry,
    GLScene_Cadencer, GLScene_Base_Color, GLScene_Base_Classes, GLScene_Base_Coordinates, GLScene_Base_Context_Info,
    GLScene_Manager, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
...
uses SysUtils, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context, GLScene_Base_Vector_Lists {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
