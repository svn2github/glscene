...
unit GLScene_Objects_AnimatedSprite;

interface

uses
  Classes, SysUtils, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Base_OpenGL_Tokens, GLScene_Material,
  GLScene_Base_PersistentClasses, GLScene_Base_XCollection, GLScene_Platform, GLScene_Base_Context_Info,
  GLScene_Base_Classes, GLScene_Base_Context, GLScene_Base_GLStateMachine;
