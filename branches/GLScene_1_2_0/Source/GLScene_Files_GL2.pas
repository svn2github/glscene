  ...
  try
    ...
    begin
      ...
      begin
        ...
        NumSurfVert := NumSurfVert + GLMFile.LODs[d].Surfaces[i]
          .SurfaceHeader.numVerts;
      end;
          ...
          begin
            ...
            for k := 0 to mesh.BonesPerVertex - 1 do
              ...
              begin
                ...
                boneweight := G2_GetVertBoneWeight(Vertices[j], k, weighttot,
                  numweights);
                mesh.VerticesBonesWeights^[mesh.Vertices.Count - 1]^[k].boneid
                  := boneid;
                mesh.VerticesBonesWeights^[mesh.Vertices.Count - 1]^[k].Weight
                  := boneweight;
              end
              else
              begin
                mesh.VerticesBonesWeights^[mesh.Vertices.Count - 1]^[k]
                  .boneid := 0;
                mesh.VerticesBonesWeights^[mesh.Vertices.Count - 1]^[k]
                  .Weight := 0;
              end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        bone := Owner.Skeleton.RootBones.BoneByID
          (GLAFile.Skeleton[bonelist[0]].parent);
    ...
    begin
      ...
      begin
        ...
        quat := QuaternionMake([CompBone[1] - 32726, CompBone[2] - 32726,
          CompBone[3] - 32726], CompBone[0] - 32726);
...
RegisterVectorFileFormat('gla', 'Ghoul2 (GLA) animation files',
  TGLGLAVectorFile);
