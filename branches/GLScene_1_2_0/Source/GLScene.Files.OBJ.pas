          ...
          begin
            ...
            try
              ...
              begin
                ...
                Diffuse.Alpha := GLScene.Utils.StrToFloatDef(objMtl.MaterialStringProperty(matName, 'd'), 1);
...
begin
  ...
  try
    ...
    begin
      ...
      for i := 0 to 3 do
        if sl.Count > i then
          Result[i] := GLScene.Utils.StrToFloatDef(sl[i], 0)
        else
          Break;
    end
    else
...
initialization
  ...
  GLScene.Vector.FileObjects.RegisterVectorFileFormat('obj', 'WaveFront model file', TGLOBJVectorFile);
  GLScene.Vector.FileObjects.RegisterVectorFileFormat('objf', 'Stripe model file', TGLOBJVectorFile);
