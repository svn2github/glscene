...
unit GLScene_PropertyEditor_Vector_LCL;
...
uses
  SysUtils, GLScene_Base_Vector_Geometry, GLScene_Utils;
...
begin
  SetVector(v,
    GLScene_Utils.StrToFloatDef(EDx.Text, 0),
    GLScene_Utils.StrToFloatDef(EDy.Text, 0),
    GLScene_Utils.StrToFloatDef(EDz.Text, 0));
