  ...
  try
    ...
    begin
      ...
      begin
        ...
        frame.Position.Add(GLScene.Utils.StrToFloatDef(tl[1]),
          GLScene.Utils.StrToFloatDef(tl[2]),
          GLScene.Utils.StrToFloatDef(tl[3]));
        v := AffineVectorMake(GLScene.Utils.StrToFloatDef(tl[4]),
          GLScene.Utils.StrToFloatDef(tl[5]),
          GLScene.Utils.StrToFloatDef(tl[6]));
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                boneIDs[j].Weight := GLScene.Utils.StrToFloatDef
                  (tl[11 + j * 2]);
              end;

              nVert := FindOrAdd(boneIDs,
                AffineVectorMake(GLScene.Utils.StrToFloatDef(tl[1]),
                GLScene.Utils.StrToFloatDef(tl[2]),
                GLScene.Utils.StrToFloatDef(tl[3])),
                AffineVectorMake(GLScene.Utils.StrToFloatDef(tl[4]),
                GLScene.Utils.StrToFloatDef(tl[5]),
                GLScene.Utils.StrToFloatDef(tl[6])));
              nTex := TexCoords.FindOrAdd
                (AffineVectorMake(GLScene.Utils.StrToFloatDef(tl[7]),
                GLScene.Utils.StrToFloatDef(tl[8]), 0));
