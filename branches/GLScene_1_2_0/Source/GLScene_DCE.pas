...
uses Classes, GLScene_Core, GLScene_Base_XCollection, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists, GLScene_Vector_FileObjects,
   GLScene_Platform, GLScene_DCE_Misc, GLScene_Collision_Ellipse,
   GLScene_Objects_Terrain, GLScene_Base_Coordinates, GLScene_Base_Classes, GLScene_Manager;
...
uses SysUtils {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
