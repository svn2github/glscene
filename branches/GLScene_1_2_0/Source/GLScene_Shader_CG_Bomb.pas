...
uses
  ...
  // GLScene_Core
  GLScene_Texture, GLScene_Cadencer, GLScene_Base_Context, GLScene_Base_OpenGL_Tokens, GLScene_Base_Strings, GLScene_Material,
  GLScene_Base_Context_Info, GLScene_Texture_Format,

  // GLScene_Shader_CG Shaders
  GLScene_Shader_CG_GL, GLScene_Shader_CG_Components;
