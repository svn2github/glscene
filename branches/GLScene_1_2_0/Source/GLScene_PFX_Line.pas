...
unit GLScene_PFX_Line;

interface

{$I GLScene.inc}

uses Classes, GLScene_Base_PersistentClasses, GLScene_Base_Vector_Geometry, GLScene_Fx_Particle, GLScene_Texture,
     GLScene_Base_Color, GLScene_Base_Context_Info;
...
uses SysUtils, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context {$IFDEF GLS_DELPHI}, GLScene_Base_Vector_Types{$ENDIF};
