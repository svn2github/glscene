...
uses
  Classes, GLScene_Core, GLScene_Base_Context, GLScene_Base_Vector_Types, GLScene_Base_Vector_Geometry,
  GLScene_Base_PersistentClasses, GLScene_Platform, GLScene_Graphics, GLScene_Base_Color,
  GLScene_Base_Context_Info, GLScene_Base_Coordinates, GLScene_Base_Classes, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
...
uses SysUtils, GLScene_Base_OpenGL_Tokens, GLScene_Utils;
