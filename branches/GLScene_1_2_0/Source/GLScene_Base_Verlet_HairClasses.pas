...
unit GLScene_Base_Verlet_HairClasses;
...
uses
  Classes, SysUtils, GLScene_Base_Verlet_Classes, GLScene_Base_Vector_Types, GLScene_Base_Vector_Lists, GLScene_Base_Vector_Geometry;
