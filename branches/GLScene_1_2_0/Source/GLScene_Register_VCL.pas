...
uses
  ...
  Dialogs,
  GLScene_PropertyEditor_MaterialPicker_VCL,
  GLScene_PropertyEditor_Uniform_VCL,
  GLScene_Shader_Memo,
  GLScene_GUI_LayoutEditor,
  GLScene_PropertyEditor_Material_VCL,
  GLScene_PropertyEditor_Vector_VCL,
  GLScene_Objects_AnimatedSprite,
  GLScene_Shader_Assm,
  GLScene_HDS_Async,
  GLScene_Objects_Atmosphere,
  GLScene_AVIRecorder,
  GLScene_BitmapFont,
  GLScene_BitmapFont_System,
  GLScene_VectorFont,
  GLScene_VectorFont_Freetype,
  GLScene_DrawTechnique,
  GLScene_Blur,
  GLScene_HDS_Bumpmap,
  GLScene_Shader_Bump,
  GLScene_Cadencer,
  GLScene_CameraController,
  GLScene_Shader_Cel,
  GLScene_Collision,
  GLScene_Image_Composite,
  GLScene_GUI_Console,
  GLScene_Base_Coordinates,
  GLScene_DCE,
  GLScene_Texture_Dynamic,
  GLScene_ParticleManager_Masks,
  GLScene_Fx_Explosion,
  GLScene_Objects_Extrusion,
  GLScene_Objects_FrameBuffer,
  GLScene_Objects_Feedback,
  GLScene_Fx_Fire,
  GLScene_Movement_FPS,
  GLScene_GameMenu,
  GLScene_ObjectsEx,
  GLScene_Gizmo,
  ...
  GLScene_GUI,
  GLScene_HeightData,
  GLScene_HDS_HeightTileFile,
  GLScene_Shader_HiddenLine,
  GLScene_Objects_HUD,
  GLScene_Imposter,
  GLScene_LensFlare,
  GLScene_PFX_Line,
  GLScene_Material,
  GLScene_MaterialEx,
  GLScene_Material_MultiProxy,
  GLScene_Material_Script,
  GLScene_Objects_Mesh,
  GLScene_Mirror,
  GLScene_Shader_MultiMaterial,
  GLScene_Objects_MultiPolygon,
  GLScene_Objects_MultiProxy,
  GLScene_Navigator,
  GLScene_Nodes,
  GLScene_Objects,
  GLScene_Shader_Outline,
  GLScene_Fx_Particle,
  GLScene_Particles,
  GLScene_Perlin,
  GLScene_PFX_Perlin,
  GLScene_Shader_Phong,
  GLScene_Portal,
  GLScene_PostEffects,
  GLScene_Texture_Projected,
  GLScene_Objects_Proxy,
  GLScene_Base_Context_Info,
  GLScene_Archive_Manager,
  GLScene_Edit_VCL,
  GLScene_Screen,
  GLScene_Base_Script,
  GLScene_Shader_Combiner,
  GLScene_HDS_Shadow,
  GLScene_ShadowPlane,
  GLScene_ShadowVolume,
  GLScene_SimpleNavigation,
  GLScene_Objects_SkyBox,
  GLScene_Objects_Skydome,
  GLScene_Objects_NishitaSky,
  GLScene_Language,
  GLScene_Shader_GLSL_Bump,
  GLScene_Shader_GLSL_DiffuseSpecular,
  GLScene_Base_Log,
  GLScene_Shader_GLSL_PostBlur,
  GLScene_Texture_Projected_GLSL,
  ...
  GLScene_Objects_Terrain,
  GLScene_Shader_TextureCombiner,
  GLScene_LensFlare_Textured,
  GLScene_Texture,
  GLScene_HDS_Textured,
  GLScene_PropertyEditor_TextureImage,
  GLScene_Shader_TextureSharing,
  GLScene_FX_Thor,
  GLScene_Objects_TilePlane,
  GLScene_TimeEvents_Manager,
  GLScene_Objects_Trail,
  ...
  GLScene_Sound,
  GLScene_Sound_FileObjects,
  GLScene_Objects_SpaceText,
  GLScene_Base_Joystick,
  GLScene_Base_ScreenSaver,
  GLScene_Viewer_FullScreen;
...
{$ENDIF}
  ...
  GLScene_DrawTechnique.vBindlessGraphicsEnabled := False;
