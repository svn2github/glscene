...
unit GLScene_PropertyEditor_MaterialPreview_LCL;
...
uses lresources,
  ...
  GLScene_ObjectsEx, GLScene_Base_Color, GLScene_Base_Coordinates,
  GLScene_Platform, GLScene_Material,GLScene_Graphics, LCLIntf;
...
{$R GLScene_PropertyEditor_MaterialPreview_LCL.lfm}
