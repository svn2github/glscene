...
unit GLScene_PropertyEditor_MaterialPicker_LCL;
...
uses
  ...
  GLScene_Viewer, GLScene_Material, GLScene_Core, GLScene_Objects, GLScene_Texture,
  GLScene_Objects_HUD, GLScene_Objects_Teapot, GLScene_ObjectsEx, GLScene_Base_Color,
