...
unit GLScene_ParticleManager_Masks;
...
uses
  ...
  // GLScene_Core
  GLScene_Texture, GLScene_Material, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Types,
  GLScene_Fx_Particle, GLScene_Platform, GLScene_Base_Coordinates;
