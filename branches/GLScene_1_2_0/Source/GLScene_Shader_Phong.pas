...
uses
  ...
  // GLScene_Core
  GLScene_Texture, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context,
  GLScene_Shader_Assm, GLScene_Base_Context_Info, GLScene_Shader_Custom, GLScene_Base_GLStateMachine;
