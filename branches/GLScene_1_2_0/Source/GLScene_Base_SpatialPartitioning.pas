...
unit GLScene_Base_SpatialPartitioning;
...
uses
  Classes, GLScene_Base_Vector_Types, GLScene_Base_Vector_Geometry, SysUtils, GLScene_Base_GeometryBB, GLScene_Base_PersistentClasses,
  Math;
