...
uses
  Classes, SysUtils,
  GLScene_Vector_FileObjects, GLScene_Base_FileIO,
  GLScene_Base_Vector_Types, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists,
  GLScene_Platform, GLScene_Texture, GLScene_Material;
