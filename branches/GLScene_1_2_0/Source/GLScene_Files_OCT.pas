...
unit GLScene_Files_OCT;

interface

{$I GLScene.inc}

uses Classes, GLScene_Objects_VectorFile, GLScene_Base_Vector_Geometry, GLScene_Base_FileIO, GLScene_Files_OCT_Base;
...
uses
  SysUtils, GLScene_Texture, GLScene_Material, GLScene_Graphics, GLScene_Platform, GLScene_Base_GLStateMachine,
  GLScene_Utils, GLScene_Texture_Format;
