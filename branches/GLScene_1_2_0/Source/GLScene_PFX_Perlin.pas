...
unit GLScene_PFX_Perlin;

interface

{$I GLScene.inc}

uses Classes, GLScene_Fx_Particle, GLScene_Graphics, GLScene_Platform;
...
uses GLScene_Base_PerlinNoise, GLScene_Base_OpenGL_Tokens, GLScene_Base_Vector_Geometry;
