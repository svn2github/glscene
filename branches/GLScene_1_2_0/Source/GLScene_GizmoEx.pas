...
//   Date            : 07/10/2009
// - Ю쮮 র楥졭 믤 嬿 寡㠠᢮  櫲᭨
// - Ю촷飸檱 믤 ���楠沲鬠 ౥妤鬠⯫楠鯭ᬥ퍊// ɧ㦱 ⡣荊//  1) GLLines
//   k᫠ ࡭塤檱㴥 宠浠௰ ௪͊//   鳼 ᬼ᫠ ⡱㯩㥠   lineColor.Alpha
//   (졇LObjects->procedure TGLLineBase.SetupLineStyle)
//  2)  槻���檪Ჲ࡬Ჱ塢妫殨塡妲 ﱬ﨨 駠蠍
//  c롭鱮㡭鿠촷欬 襤ࡪ᪠⡇etPickedobj ���衤᳼ Ჲ ᭪荊//  3) Does not work in lazarus
//------------------------------------------------------------------------------

unit GLScene_GizmoEx;
...
type
  ...
  private
    ...
    FChangeRate: TAffineVector;   //��� 䯫 㱠殨 - ���ᢨ
...
uses
  GLScene_Base_OpenGL_Tokens, GLScene_Base_Context;
...
begin
  ...
  //沫衠Ⲷ鲱 ︥ꡱᥠ, 汥渥 לּ뮠⡮宮顲︪半  //а��� 衮뱳箮 魥 ︪ 롱ᮨ
    ...
    with glc do
      case FSelectionRegion of
        ...
        begin
          ...
          //glc.PenWidth יּ鮠 ౿���䯫͊          //ⶮ婬 ௪ᨠ ௫询᳥쾍
          //Ḡ쮠餳 ﲲ쯢ᬠ  믭ﬠ:)
          //ҥ㩱 ���汴린! \m/
          // 冷 봱렠믤ࡢ ﬠ襤ࡪﰠ泌
          //௡쩧ﲲ衮 ᬠ ���飠 鲳泱 룠屠骍
...
begin
  ...
  //Ҳ鱠欠즬殲 沫衪ﬨ沲㯩 衯鲥顯棻殮 ௲שׁ͊  if Count - 1 > MaxCount then
  begin
    Delete(0);
    FItemIndex := Count - 1;
  end;
