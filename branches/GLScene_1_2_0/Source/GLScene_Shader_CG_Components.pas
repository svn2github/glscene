...
unit GLScene_Shader_CG_Components;
...
uses
  ...
  // GLScene_Core
  GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Lists, GLScene_Base_Vector_Types, GLScene_Texture, GLScene_Base_Strings,
  GLScene_Cadencer, GLScene_Base_OpenGL_Tokens, GLScene_Platform, GLScene_Base_Context, GLScene_Base_Classes,
  GLScene_Base_Context_Info, GLScene_Material, GLScene_Texture_Format,

  // GLScene_Shader_CG
  GLScene_Shader_CG, GLScene_Shader_CG_GL;
