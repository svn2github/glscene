...
uses
  Classes, GLScene_Material, GLScene_Platform, GLScene_Base_Color, GLScene_Base_Context_Info;
...
uses GLScene_Base_OpenGL_Tokens, GLScene_Base_Context, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
