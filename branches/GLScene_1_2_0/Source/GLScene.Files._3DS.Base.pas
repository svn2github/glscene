...
uses
  GLScene.Files._3DS.Consts,
  GLScene.Files._3DS.Utils,
  SysUtils,
  GLScene.Base.FileIO;
...
begin
  Result := GLScene.Files._3DS.Utils.GetDatabaseRelease(Self, FDatabase);
end;
...
begin
  Result := GLScene.Files._3DS.Utils.GetMeshRelease(Self, FDatabase);
end;
