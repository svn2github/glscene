...
unit GLScene_Viewer_FullScreen;
...
uses Forms, Classes, Controls, Menus, Messages
     ,GLScene_Viewer, GLScene_Core, GLScene_Base_Context
     {$IFDEF FPC}
     ,LcLtype, LCLIntf
     {$ENDIF}
     {$IFDEF MSWindows}
...
uses GLScene_Base_OpenGL_Tokens, GLScene_Base_OpenGL_Adapter, SysUtils, GLScene_Platform, GLScene_Screen
  {$IFDEF FPC}
    {$ifdef Linux}
      {$IFDEF LCLGTK2}
      ,gtk2proc
