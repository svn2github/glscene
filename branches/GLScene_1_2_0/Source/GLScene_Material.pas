...
unit GLScene_Material;

interface

uses
  Classes, SysUtils, GLScene_Base_Context_Info, GLScene_Base_Classes, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context,
  GLScene_Texture, GLScene_Base_Color, GLScene_Base_Coordinates, GLScene_Base_Vector_Geometry, GLScene_Base_PersistentClasses,
  GLScene_Platform, GLScene_Base_GLStateMachine, GLScene_Texture_Format;
...
uses GLScene_Base_Strings, GLScene_Base_FileIO, GLScene_Graphics, GLScene_Utils, GLScene_Base_Log;
