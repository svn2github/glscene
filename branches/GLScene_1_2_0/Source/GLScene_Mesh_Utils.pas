...
uses
  Classes, GLScene_Base_PersistentClasses, GLScene_Base_Vector_Lists, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Types;
...
uses GLScene_Platform, SysUtils;
...
begin
  ...
  boundaryList[b0].maxSqArea := GLScene_Mesh_Utils.polygonArea(b0);
...
begin
  ...
  begin
    ...
    boundaryList[0].maxSqArea := GLScene_Mesh_Utils.polygonArea(0);
    maxMaxSqArea := boundaryList[0].maxSqArea;

    for i := 1 to count - 1 do
    begin
      boundaryList[i].maxSqArea := GLScene_Mesh_Utils.polygonArea(i);
