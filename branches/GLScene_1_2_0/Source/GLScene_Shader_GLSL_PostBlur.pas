...
unit GLScene_Shader_GLSL_PostBlur;
...
uses
  ...
  // GLScene_Core
  GLScene_Texture, GLScene_Core, GLScene_Base_Vector_Geometry, GLScene_Base_Context,
  GLScene_Shader_GLSL_Components, GLScene_Shader_Custom, GLScene_Base_Context_Info, GLScene_Texture_Format;
