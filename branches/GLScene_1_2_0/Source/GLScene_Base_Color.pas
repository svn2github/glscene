...
uses
  // GLScene_Core
  Classes, GLScene_Base_Vector_Types, GLScene_Base_Vector_Geometry, Graphics, GLScene_Platform,
  GLScene_Base_PersistentClasses, GLScene_Base_Classes;
