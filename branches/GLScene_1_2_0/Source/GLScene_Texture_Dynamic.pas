...
uses
  Classes, SysUtils, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context, GLScene_Texture, GLScene_Texture_Format,
  GLScene_Graphics, GLScene_Platform;
