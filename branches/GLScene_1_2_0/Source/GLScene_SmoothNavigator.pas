...
begin
  ...
  if Value > 1 then
  begin
    FMovementInertia := FMovementInertia * GLScene_Base_Vector_Geometry.Power(2,
      1 / Value);
    FTurnInertia := FTurnInertia * GLScene_Base_Vector_Geometry.Power(2,
      1 / Value);
  end
  else
  begin
    FMovementInertia := FMovementInertia / GLScene_Base_Vector_Geometry.Power
      (2, Value);
    FTurnInertia := FTurnInertia / GLScene_Base_Vector_Geometry.Power(2, Value);
  end;
...
begin
  ...
  if Value < 1 then
    FInertia := FInertia / GLScene_Base_Vector_Geometry.Power(2, Value)
  else
    FInertia := FInertia * GLScene_Base_Vector_Geometry.Power(2, 1 / Value);
