...
unit GLScene_Base_Coordinates;

interface

uses Classes, GLScene_Base_Vector_Geometry, GLScene_Base_Vector_Types, GLScene_Base_OpenGL_Tokens, GLScene_Base_Classes, GLScene_Platform;
...
begin
   Result:=GLScene_Base_Vector_Geometry.VectorLength(FCoords);
end;
...
begin
   Result:=GLScene_Base_Vector_Geometry.VectorNorm(FCoords);
end;
...
begin
   Result:=GLScene_Base_Vector_Geometry.MaxXYZComponent(FCoords);
end;
...
begin
  ...
  GLScene_Base_Vector_Geometry.SetVector(FCoords, x, y, z);
  NotifyChange(Self);
end;
...
begin
  Assert(FStyle = csVector, csVectorHelp);
  GLScene_Base_Vector_Geometry.SetVector(FCoords, v);
  NotifyChange(Self);
end;
...
begin
  Assert(FStyle = csVector, csVectorHelp);
  GLScene_Base_Vector_Geometry.SetVector(FCoords, x, y, z, w);
  NotifyChange(Self);
end;
...
begin
  ...
  GLScene_Base_Vector_Geometry.MakePoint(FCoords, x, y, z);
  NotifyChange(Self);
end;
...
begin
  Assert(FStyle = csPoint, csPointHelp);
  GLScene_Base_Vector_Geometry.MakePoint(FCoords, v);
  NotifyChange(Self);
end;
...
begin
  ...
  GLScene_Base_Vector_Geometry.MakeVector(FCoords, x, y, 0);
  NotifyChange(Self);
end;
...
begin
  Assert(FStyle = csPoint2D, csPoint2DHelp);
  GLScene_Base_Vector_Geometry.MakeVector(FCoords, v);
  NotifyChange(Self);
end;
...
begin
  Assert(FStyle = csPoint2D, csPoint2DHelp);
  GLScene_Base_Vector_Geometry.MakeVector(FCoords, v[0], v[1], 0);
  NotifyChange(Self);
end;
...
begin
   GLScene_Base_Vector_Geometry.SetVector(Result, FCoords);
end;
