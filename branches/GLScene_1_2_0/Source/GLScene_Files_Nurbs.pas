...
uses
  ...
  GLScene_Base_FileIO,
  GLScene_Objects_ParametricSurfaces,
  GLScene_Utils;
    ...
    try
      ...
      begin
        ...
        for k := 0 to vals.Count - 1 do
          if vals[k] <> '' then
            list.Add(GLScene_Utils.StrToFloatDef(vals[k], 0));
        Inc(idx);
      end;
      Result := idx;
    finally
    ...
    try
      ...
      begin
        ...
        if vals.Count >= 3 then
          list.Add(GLScene_Utils.StrToFloatDef(vals[0], 0),
            GLScene_Utils.StrToFloatDef(vals[1], 0),
            GLScene_Utils.StrToFloatDef(vals[2], 0));
        Inc(idx);
      end;
      Result := idx;
    finally
