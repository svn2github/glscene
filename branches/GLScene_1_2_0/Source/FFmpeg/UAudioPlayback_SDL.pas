 ...
 * $URL: https://ultrastardx.svn.sourceforge.net/svnroot/ultrastardx/trunk/src/media/UAudioPlayback_SDL.pas $
 *}
...
begin
  ...
  begin
    GLSLogger.LogError('SDL_InitSubSystem failed!'+ ' TAudioPlayback_SDL.InitializeAudioPlaybackEngine');
    Exit;
  end;

  SampleBufferSize := 2048{IAudioOutputBufferSizeVals[Ini.AudioOutputBufferSizeIndex]};
  ...
  begin
    GLSLogger.LogInfo('SDL_OpenAudio: ' + SDL_GetError()+ ' TAudioPlayback_SDL.InitializeAudioPlaybackEngine');
    Exit;
  end;
  ...
  GLSLogger.LogInfo('Opened audio device'+ ' TAudioPlayback_SDL.InitializeAudioPlaybackEngine');
