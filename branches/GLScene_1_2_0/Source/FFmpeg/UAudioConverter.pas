...
begin
  ...
  begin
    GLSLogger.LogError('Audio-format not supported by SDL'+ 'TSoftMixerPlaybackStream.InitFormatConversion');
    Exit;
  end;
  ...
  begin
    GLSLogger.LogError(SDL_GetError()+ 'TSoftMixerPlaybackStream.InitFormatConversion');
    Exit;
  end;
...
begin
  ...
  begin
    GLSLogger.LogError('Unsupported format'+ 'TAudioConverter_FFmpeg.Init');
    Exit;
  end;
  ...
  begin
    GLSLogger.LogError('Incompatible formats'+ 'TAudioConverter_FFmpeg.Init');
    Exit;
  end;
  ...
  begin
    GLSLogger.LogError('audio_resample_init() failed'+ 'TAudioConverter_FFmpeg.Init');
    Exit;
  end;
...
begin
  ...
  begin
    GLSLogger.LogError('audio_resample() failed'+ 'TAudioConverter_FFmpeg.Convert');
    Exit;
  end;
