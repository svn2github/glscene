...
uses
  Classes, SysUtils,
  GLScene_Platform, GLScene_Base_OpenGL_Tokens, GLScene_Base_Context, GLScene_Graphics, GLScene_Texture_Format,
  GLScene_Base_FileIO;
...
begin
  ...
  begin
    ...
    try
      ...
      // Ordered ist nicht schneller, aber h堬icher
      else
      ...
      begin
        ...
        // fr den letzten Pass die tats夨lich gewnschte Ausgabequalit崍
      ...
      // letzter Pass fr progressive JPGs, erster & einziger fr Baseline-JPGs
      while (jc.d.output_scanline < jc.d.output_height) do
      begin
        DestScanLine := Pointer(PtrUInt(fData) +
          (jc.d.output_height - jc.d.output_scanline - 1) *
