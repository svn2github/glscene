...
uses
  ...
  GLX.Scene, GLX.VectorGeometry, GLX.Context, GLX.CrossPlatform,
  GLX.Texture, GLX.State, GLX.Utils, GLX.Graphics, GLX.Color, GLX.BaseClasses,
  GLX.RenderContextInfo, GLX.TextureFormat,
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.XOpenGL, GLX.VectorTypes;
