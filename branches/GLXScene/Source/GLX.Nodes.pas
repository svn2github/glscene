...
uses
  ...
  GLX.VectorGeometry,  GLX.OpenGLAdapter,
  GLX.Context, GLX.BaseClasses,  GLX.Coordinates, GLX.Spline,
  GLX.XOpenGL, GLX.VectorTypes;
...
begin
  GLX.VectorGeometry.SetVector(FCoords, Value);
  (Collection as TGLNodes).NotifyChange;
end;
