...
uses
  ...
  ODEGL, ODEImport, GLX.Scene, GLX.VectorGeometry, GLX.Texture,
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.XOpenGL, GLX.Objects, GLX.XCollection,
  GLX.PersistentClasses, GLX.VectorLists, GLX.Color, GLX.Coordinates,
  GLX.RenderContextInfo, GLX.Manager, GLX.State;
