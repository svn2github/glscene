...
uses
  ...
  GLX.VectorGeometry, // PVector TVector TMatrix PMatrix NullHmgVector...
  GLX.VectorLists, // TaffineVectorList for Tree
  GLX.XCollection,  //TGLXCollection file function
  GLX.BaseClasses,
  GLX.Scene,
  GLX.Manager,
  GLX.CrossPlatform,
...
type
  ...
  protected
    ...
    procedure SetLines(const Value: TGLLines);
  ...
  published
    ...
    property DebugOption: TNGDDebugOption read FNGDDebugOption write
      FNGDDebugOption;
    property Line: TGLLines read FGLLines write SetLines;
...
procedure TGLNGDManager.SetLines(const Value: TGLLines);
begin
  if Assigned(FGLLines) then
    FGLLines.Nodes.Clear;
