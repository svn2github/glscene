...
uses
  System.Classes, System.SysUtils, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context, 
  GLX.Texture, GLX.TextureFormat, GLX.Graphics, GLX.CrossPlatform;
...
begin
  ...
  begin
    ...
    CurrentVKContext.VKStates.TextureBinding[0, LTarget] := TGLTexture(OwnerTexture).Handle;
    case LTarget of
      ttNoShape: ;
      ttTexture1D: ;
      ttTexture2D:
        glTexImage2D(GL_TEXTURE_2D, 0, TGLTexture(OwnerTexture).OpenGLTextureFormat, Width, Height, 0, TextureFormat, GL_UNSIGNED_BYTE, nil);
      ttTexture3D: ;
      ttTexture1DArray: ;
      ttTexture2DArray: ;
      ttTextureRect: ;
