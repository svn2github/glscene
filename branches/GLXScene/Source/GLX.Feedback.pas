...
uses
  ...
  GLX.VectorGeometry, GLX.VectorLists, GLX.Scene, GLX.VectorFileObjects,
  GLX.Texture, GLX.RenderContextInfo, GLX.Context, GLX.State, Winapi.OpenGL, Winapi.OpenGLext, 
  GLX.MeshUtils, GLX.VectorTypes;
