...
uses
  System.Classes, GLX.Scene, GLX.VectorGeometry, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context,
  GLX.Material, GLX.Objects, GLX.CrossPlatform, GLX.PersistentClasses,
  GLX.VectorLists, GLX.RenderContextInfo, GLX.XOpenGL;
