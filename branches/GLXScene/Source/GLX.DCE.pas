...
uses
  ...
  GLX.Scene, GLX.XCollection, GLX.VectorGeometry, GLX.VectorLists,
  GLX.VectorFileObjects, GLX.CrossPlatform, GLX.DCEMisc, GLX.EllipseCollision,
  GLX.TerrainRenderer, GLX.Coordinates, GLX.BaseClasses, GLX.Manager,
  GLX.VectorTypes;
