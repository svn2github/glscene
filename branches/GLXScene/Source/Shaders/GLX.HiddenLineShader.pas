...
uses
  ...
  GLX.Material, Winapi.OpenGL, Winapi.OpenGLext,  GLX.CrossPlatform, GLX.Scene, GLX.Color,
  GLX.BaseClasses, GLX.RenderContextInfo, GLX.State, GLX.Context;
...
procedure TGLLineSettings.SetPattern(const value: GLushort);
begin
