...
uses
  ...
  GLX.VectorGeometry, GLX.VectorTypes, GLX.Texture, GLX.Cadencer, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Scene,
  GLX.Strings, GLX.CrossPlatform, GLX.Context, GLX.RenderContextInfo, GLX.Material,
  GLX.VectorLists, GLX.TextureFormat, GLX.GLSLParameter;
...
procedure TGLGeometryProgram.SetVerticesOut(const Value: GLint);
begin
