...
uses
  ...
  GLX.Scene, GLX.VectorGeometry, GLX.Color, GLX.Material, GLX.Strings,
  GLX.VectorFileObjects, GLX.XOpenGL, GLX.State, GLX.PersistentClasses,
  GLX.CrossPlatform, GLX.Coordinates, GLX.RenderContextInfo;
