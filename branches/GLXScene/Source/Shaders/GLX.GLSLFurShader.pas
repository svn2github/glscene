...
uses
  ...
  GLX.Context, GLX.RenderContextInfo, GLX.Coordinates, GLX.VectorGeometry, GLX.VectorTypes,
  GLX.TextureFormat, GLX.Color, GLX.Texture, GLX.Material, GLSLS.Shader, GLX.CustomShader;
