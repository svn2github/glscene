...
unit GLX.GLSLDiffuseSpecularShader;
...
uses
  ...
  GLX.Texture, GLX.Scene, GLX.VectorGeometry, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Strings,
  GLX.CustomShader, GLX.GLSLShader, GLX.Color, GLX.RenderContextInfo, GLX.Material;
