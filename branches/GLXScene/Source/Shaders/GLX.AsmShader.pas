    ...
    
{
  ...
  private
    ...
    FFPHandle: TGLFragmentProgramHandle;
    FGPHandle: TGLGeometryProgramHandle;
  ...
  begin
    ...
    begin
      if not Assigned(FVPHandle) then
        FVPHandle := TGLVertexProgramHandle.CreateAndAllocate;
    ...
    begin
      if not Assigned(FFPHandle) then
        FFPHandle := TGLFragmentProgramHandle.CreateAndAllocate;
    ...
    begin
      if not Assigned(FGPHandle) then
        FGPHandle := TGLGeometryProgramHandle.CreateAndAllocate;
