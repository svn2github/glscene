...
uses
  ...
  GLX.Texture, GLX.Scene, GLX.VectorGeometry, GLX.Context, GLX.Material,
  GLX.GLSLShader, GLX.CustomShader, GLX.RenderContextInfo, GLX.TextureFormat,
  GLX.VectorTypes;
