...
unit GLX.GLSLProjectedTextures;
...
uses
  ...
  GLX.OpenGLAdapter,
  GLX.CrossPlatform, GLX.Scene, GLX.Texture, GLX.VectorGeometry, GLX.Context,
  GLX.Color, GLX.RenderContextInfo, GLX.TextureFormat, GLX.VectorTypes;
