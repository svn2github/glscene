...
type
  ...
  private
    FVertexProgramHandle: TGLVertexProgramHandle;
    FFragmentProgramHandle: TGLFragmentProgramHandle;
...
begin
  ...
  try
    ...
    begin
      FVertexProgramHandle := TGLVertexProgramHandle.CreateAndAllocate;
    ...
    if not Assigned(FFragmentProgramHandle) then
      ...
      begin
        FFragmentProgramHandle := TGLFragmentProgramHandle.CreateAndAllocate;
