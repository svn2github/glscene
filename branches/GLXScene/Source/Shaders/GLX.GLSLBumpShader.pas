...
uses
  ...
  GLX.Texture, GLX.Scene, GLX.VectorGeometry, GLX.VectorTypes,
  GLX.Cadencer, GLX.Strings, Winapi.OpenGL, Winapi.OpenGLext,  GLX.CustomShader, GLX.Color,
  GLX.RenderContextInfo, GLX.Material, GLX.GLSLShader;
