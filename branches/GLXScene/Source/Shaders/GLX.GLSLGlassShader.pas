...
uses
  ...
  GLX.Scene, GLX.CrossPlatform, GLX.BaseClasses, GLX.State, Winapi.OpenGL, Winapi.OpenGLext,  GLX.OpenGL1x, 
  GLX.Context, GLX.RenderContextInfo, GLX.VectorGeometry, GLX.Coordinates, 
  GLX.TextureFormat, GLX.Color, GLX.Texture, GLX.Material, GLX.PersistentClasses, GLX.Graphics,
  GLSLS.Shader, GLX.CustomShader;
