...
type
  ...
  private
    ...
    dglEnable, dglDisable, dgtEnable, dgtDisable, dgcEnable, dgcDisable,
      dglaEnable, dglaDisable, dgliEnable, dgliDisable: TGLDirectVulkan;
...
begin
  ...
  DglDisable := TGLDirectVulkan(_GZORootLines.AddNewChild(TGLDirectVulkan));
  DglDisable.OnRender := DirectGlDisable;
  DgtDisable := TGLDirectVulkan(_GZORootTorus.AddNewChild(TGLDirectVulkan));
  DgtDisable.OnRender := DirectGlDisable;
  DgcDisable := TGLDirectVulkan(_GZORootCubes.AddNewChild(TGLDirectVulkan));
  DgcDisable.OnRender := DirectGlDisable;
  DglaDisable := TGLDirectVulkan
    (_GZORootAxisLabel.AddNewChild(TGLDirectVulkan));
  DglaDisable.OnRender := DirectGlDisable;
  DgliDisable := TGLDirectVulkan(_GZORootVisibleInfoLabels.AddNewChild
    (TGLDirectVulkan));
  ...
  DglEnable := TGLDirectVulkan(_GZORootLines.AddNewChild(TGLDirectVulkan));
  DglEnable.OnRender := DirectGlEnable;
  DgtEnable := TGLDirectVulkan(_GZORootTorus.AddNewChild(TGLDirectVulkan));
  DgtEnable.OnRender := DirectGlEnable;
  DgcEnable := TGLDirectVulkan(_GZORootCubes.AddNewChild(TGLDirectVulkan));
  DgcEnable.OnRender := DirectGlEnable;
  DglaEnable := TGLDirectVulkan(_GZORootAxisLabel.AddNewChild(TGLDirectVulkan));
  DglaEnable.OnRender := DirectGlEnable;
  DgliEnable := TGLDirectVulkan(_GZORootVisibleInfoLabels.AddNewChild
    (TGLDirectVulkan));
...
procedure TGLGizmo.SetVKGizmoThickness(const Value: Single);
var
  Thk: Single;
begin
