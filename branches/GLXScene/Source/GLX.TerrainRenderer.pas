...
type
  ...
  TGLTerrainHighResStyle = (hrsFullGeometry, hrsTesselated);
  TGLTerrainOcclusionTesselate = (totTesselateAlways, totTesselateIfVisible);

  TGLTileManagementFlag = (tmClearUsedFlags, tmMarkUsedTiles,
    tmReleaseUnusedTiles, tmAllocateNewTiles, tmWaitForPreparing);
  TGLTileManagementFlags = set of TGLTileManagementFlag;
  ...
  private
    ...
    FQualityStyle: TGLTerrainHighResStyle;
    FOcclusionFrameSkip: Integer;
    FOcclusionTesselate: TGLTerrainOcclusionTesselate;
  ...
  protected
    ...
    procedure SetQualityStyle(const Val: TGLTerrainHighResStyle);
  ...
  public
    ...
    TileManagement: TGLTileManagementFlags;
  ...
  published
    ...
    property QualityStyle: TGLTerrainHighResStyle read FQualityStyle
    ...
    property OcclusionTesselate: TGLTerrainOcclusionTesselate
...
procedure TGLTerrainRenderer.SetQualityStyle(const val: TGLTerrainHighResStyle);
begin
