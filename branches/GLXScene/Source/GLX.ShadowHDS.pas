...
uses
  System.Classes, GLX.HeightData, GLX.Graphics, GLX.VectorGeometry, GLX.Texture,
  GLX.VectorTypes, GLX.Coordinates, GLX.Material;
...
uses
  System.SysUtils,
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.VectorLists;
