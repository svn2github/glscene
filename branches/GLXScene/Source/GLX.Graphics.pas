...
{$IFDEF VKS_REGIONS}{$REGION 'TGLBaseImage'}{$ENDIF}
// Create
//
...
procedure TGLBaseImage.RegisterAsVulkanTexture(
  AHandle: TGLTextureHandle;
  aMipmapGen: Boolean;
  aTexFormat: GLEnum;
  out texWidth: integer;
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLImage'}{$ENDIF}
// Create
//
...
procedure TGLImage.AssignToBitmap(aBitmap: TBitmap); //TBitmap = TBitmap
var
  y: integer;
  pSrc, pDest: PAnsiChar;
begin
