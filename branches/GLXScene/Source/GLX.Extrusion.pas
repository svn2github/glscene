...
uses
  System.Classes,
  Winapi.OpenGL, Winapi.OpenGLext,   GLX.Context,  GLX.Objects,  GLX.Scene, GLX.MultiPolygon,
  GLX.Color, GLX.VectorGeometry, GLX.RenderContextInfo, GLX.Nodes,
...
procedure TGLExtrusionSolid.SetHeight(const Value: GLfloat);
begin
