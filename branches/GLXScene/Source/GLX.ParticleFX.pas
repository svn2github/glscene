...
uses
  ...
  GLX.Scene, Winapi.OpenGL, Winapi.OpenGLext,  GLX.CrossPlatform, GLX.State,
  GLX.VectorTypes, GLX.PersistentClasses, GLX.VectorGeometry,
  GLX.XCollection, GLX.Material, GLX.Cadencer, GLX.VectorLists,
  GLX.Graphics, GLX.Context, GLX.Color, GLX.BaseClasses,
  GLX.Coordinates, GLX.RenderContextInfo, GLX.Manager, GLX.TextureFormat;
