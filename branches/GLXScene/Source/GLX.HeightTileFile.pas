...
uses
  ...
  GLX.CrossPlatform, GLX.ApplicationFileIO;
...
// ExtractRow
//
procedure TGLHeightTileFile.ExtractRow(x, y, len : Integer; dest : PSmallIntArray);
var
   rx : Integer;
   n : Cardinal;
   tileInfo : PHeightTileInfo;
...
begin
   ...
   if (c mod SizeOf(TGLHeightTileInfo))=0 then begin
