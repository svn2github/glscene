...
uses
  ...
  GLX.Scene, GLX.XCollection, GLX.VectorGeometry,
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context, GLX.VectorLists, GLX.VectorTypes,
  GLX.Cadencer, GLX.Color, GLX.BaseClasses, GLX.Coordinates,
  GLX.Manager, GLX.RenderContextInfo, GLX.State, GLX.TextureFormat;
