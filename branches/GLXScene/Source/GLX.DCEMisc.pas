...
uses
  GLX.VectorFileObjects, GLX.EllipseCollision, GLX.VectorGeometry, GLX.VectorLists,
  GLX.Scene, GLX.TerrainRenderer, GLX.ProxyObjects, GLX.MultiProxy, GLX.VectorTypes;
