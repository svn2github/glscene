...
uses
  ...
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context, GLX.CrossPlatform, GLX.VectorGeometry,
  GLX.Scene, GLX.VectorFileObjects, GLX.VectorLists, GLX.XCollection,
  GLX.GeomObjects, GLX.Navigator, GLX.RenderContextInfo, GLX.BaseClasses,
  GLX.Manager, GLX.State;
...
begin
  ...
  dirGl := TGLDirectVulkan.Create(nil);
