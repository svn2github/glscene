...
type
  ...
  // TGLArrowHeadStackingStyle
  //
  TGLArrowHeadStackingStyle = (ahssStacked, ahssCentered, ahssIncluded);
  ...
  private
    ...
    FHeadStackingStyle: TGLArrowHeadStackingStyle;
  ...
  protected
    ...
    procedure SetHeadStackingStyle(const val: TGLArrowHeadStackingStyle);
  ...
  published
    ...
    property TopRadius: GLfloat read FTopRadius write SetTopRadius;
    property HeadStackingStyle: TGLArrowHeadStackingStyle read FHeadStackingStyle
...
procedure TGLCylinderBase.SetSlices(aValue: GLint);
begin
  if aValue <> FSlices then
  begin
    FSlices := aValue;
...
procedure TGLCylinderBase.SetStacks(aValue: GLint);
begin
...
procedure TGLCylinderBase.SetLoops(aValue: GLint);
begin
...
procedure TGLArrowLine.SetHeadStackingStyle(const val: TGLArrowHeadStackingStyle);
begin
...
procedure TGLArrowArc.SetHeadStackingStyle(const val: TGLArrowHeadStackingStyle);
begin
  if val <> FHeadStackingStyle then
  begin
    FHeadStackingStyle := val;
...
function TGLFrustrum.TopDepth: GLfloat;
begin
  Result := FBaseDepth * (FApexHeight - FHeight) / FApexHeight;
end;

function TGLFrustrum.TopWidth: GLfloat;
begin
