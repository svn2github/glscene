...
{$IFDEF MSWINDOWS} stdcall;{$ENDIF}{$IFDEF unix} cdecl;{$ENDIF}
    ...
    { Saves GLX.XOpenGL State on the stack. }
    procedure PushState;
    { Restores GLX.XOpenGL State from the stack. }
    procedure PopState;
    ...
    { Whenever called, 2nd texture units changes will be forbidden to . 
       ...
       purposes and don't want GLX.XOpenGL to alter it. }
    procedure ForbidSecondTextureUnit;
    { Allow GLX.XOpenGL to use the second texture unit again. }
