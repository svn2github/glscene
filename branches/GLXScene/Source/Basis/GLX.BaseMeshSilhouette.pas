...
type
  ...
  private
    ...
    procedure SetVKBaseMesh(const Value: TGLBaseMesh);
  ...
  public
    ...
    property VKBaseMesh: TGLBaseMesh read FVKBaseMesh write SetVKBaseMesh;
    ...
    constructor Create(APrecomputeFaceNormal: boolean); override;
    constructor CreateFromMesh(aVKBaseMesh: TGLBaseMesh);
    destructor Destroy; override;
  end;
...
constructor TGLBaseMeshConnectivity.CreateFromMesh(aVKBaseMesh: TGLBaseMesh);
  begin
    Create(not(aVKBaseMesh is TGLActor));
    VKBaseMesh := aVKBaseMesh;
  end;

procedure TGLBaseMeshConnectivity.SetVKBaseMesh(const Value: TGLBaseMesh);
  var
    i: integer;
    MO: TGLMeshObject;
