...
type
  ...
  private
    ...
    FVertexArrayBinding: GLuint;
    FArrayBufferBinding: GLuint;
    FElementBufferBinding: GLuint;
    FTextureBufferBinding: GLuint;
    FEnablePrimitiveRestart: GLboolean;
    FPrimitiveRestartIndex: GLuint;
    ...
    // Coloring state
    FClampReadColor: GLEnum; // GL_FIXED_ONLY
    FProvokingVertex: GLEnum; // GL_LAST_VERTEX_CONVENTION

    // Rasterization state
    FPointSize: GLfloat;
    FPointFadeThresholdSize: GLfloat;
    FPointSpriteCoordOrigin: GLEnum; // GL_UPPER_LEFT
    FLineWidth: Single;
    ...
    // Texture state
    FMaxTextureSize: GLuint;
    FMax3DTextureSize: GLuint;
    FMaxCubeTextureSize: GLuint;
    FMaxArrayTextureSize: GLuint;
    FMaxTextureImageUnits: GLuint;
    FMaxTextureAnisotropy: GLuint;
    FMaxSamples: GLuint;
    FTextureBinding: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1, TGLTextureTarget] of GLuint;
    FTextureBindingTime: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1, TGLTextureTarget] of Double;
    FSamplerBinding: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1] of GLuint;
    ...
    // Framebuffer state
    FDrawFrameBuffer: GLuint;
    FReadFrameBuffer: GLuint;
    ...
    FTransformFeedbackBufferBinding: GLuint;
  ...
  public
    ...
    procedure SetVKState(const aState : TGLState); deprecated;
    procedure UnSetVKState(const aState : TGLState); deprecated;
    ...
    property TextureBinding[Index: Integer; target: TGLTextureTarget]: GLuint
  ...
  { Sets the blend equation for RGB + alpha to the same value. }
    ...
    procedure SetBufferIndexedBinding(const Value: GLuint; ATarget: TGLBufferBindingTarget; AIndex: GLuint; ABufferSize: GLsizeiptr); overload;
    procedure SetBufferIndexedBinding(const Value: GLuint; ATarget: TGLBufferBindingTarget; AIndex: GLuint; AOffset: GLintptr; ARangeSize: GLsizeiptr); overload;
...
{$WARN SYMBOL_DEPRECATED OFF}
  cGLStateTypeToGLEnum: array[TGLStateType] of GLEnum = (
...
{$WARN SYMBOL_DEPRECATED ON}
  ...
  cGLBufferBindingTarget: array[TGLBufferBindingTarget] of GLEnum =
...
procedure TGLStateCache.SetMaterialColors(const aFace: TCullFaceMode;
  const emission, ambient, diffuse, specular: TVector;
  const shininess: Integer);
var
  i: Integer;
...
procedure TGLStateCache.SetMaterialAlphaChannel(const aFace: GLEnum; const
  alpha: GLfloat);
var
  i: Integer;
  color: TVector4f;
...
procedure TGLStateCache.SetMaterialDiffuseColor(const aFace: GLEnum; const diffuse: TVector);
var
  i: Integer;
begin
  if FForwardContext then Exit;
...
procedure TGLStateCache.SetActiveTexture(const Value: GLint);
begin
...
procedure TGLStateCache.SetVertexArrayBinding(const Value: GLuint);
begin
...
function TGLStateCache.GetArrayBufferBinding: GLuint;
begin
  Result := FArrayBufferBinding;
end;

procedure TGLStateCache.SetArrayBufferBinding(const Value: GLuint);
begin
...
function TGLStateCache.GetElementBufferBinding: GLuint;
begin
  Result := FElementBufferBinding
end;

procedure TGLStateCache.SetElementBufferBinding(const Value: GLuint);
begin
...
function TGLStateCache.GetEnablePrimitiveRestart: GLboolean;
begin
  Result := FEnablePrimitiveRestart;
end;

procedure TGLStateCache.SetEnablePrimitiveRestart(const enabled: GLboolean);
begin
...
function TGLStateCache.GetPrimitiveRestartIndex: GLuint;
begin
  Result := FPrimitiveRestartIndex;
end;

procedure TGLStateCache.SetPrimitiveRestartIndex(const index: GLuint);
begin
...
procedure TGLStateCache.SetEnableProgramPointSize(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetClampReadColor(const Value: GLEnum);
begin
...
procedure TGLStateCache.SetCopyReadBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetCopyWriteBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetCurrentProgram(const Value: GLuint);
begin
...
procedure TGLStateCache.SetTextureBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetDepthClearValue(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetDepthRange(const ZNear, ZFar: GLclampd);
begin
...
procedure TGLStateCache.SetDepthRangeFar(const Value: GLclampd);
begin
...
procedure TGLStateCache.SetDepthRangeNear(const Value: GLclampd);
begin
...
procedure TGLStateCache.SetDepthWriteMask(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetDrawFrameBuffer(const Value: GLuint);
begin
...
procedure TGLStateCache.SetEnableColorLogicOp(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetEnableCullFace(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableDepthClamp(const enabled: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableDepthTest(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableDither(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableFramebufferSRGB(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableLineSmooth(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableMultisample(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnablePolygonOffsetFill(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnablePolygonOffsetLine(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnablePolygonOffsetPoint(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnablePolygonSmooth(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableSampleAlphaToCoverage(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetEnableSampleCoverage(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetEnableSampleMask(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetEnableSampleAlphaToOne(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetEnableScissorTest(const Value: GLboolean);
begin

end;

procedure TGLStateCache.SetEnableStencilTest(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetFrameBuffer(const Value: GLuint);
begin
...
procedure TGLStateCache.SetAlphaFunction(func: TComparisonFunction;
  ref: GLclampf);
begin
  if FForwardContext then
    exit;
...
function TGLStateCache.GetCurrentQuery(Index: TQueryType): GLuint;
begin
...
function TGLStateCache.GetDepthRangeFar: GLclampd;
begin
  Result := FDepthRange[1];
end;

function TGLStateCache.GetDepthRangeNear: GLclampd;
begin
  Result := FDepthRange[0];
end;

function TGLStateCache.GetEnableBlend(Index: Integer): GLboolean;
begin
...
function TGLStateCache.GetSampleMaskValue(Index: Integer): GLbitfield;
begin
  Result := FSampleMaskValue[Index];
end;

function TGLStateCache.GetMaxTextureSize: GLuint;
begin
...
function TGLStateCache.GetMax3DTextureSize: GLuint;
begin
...
function TGLStateCache.GetMaxCubeTextureSize: GLuint;
begin
...
function TGLStateCache.GetMaxArrayTextureSize: GLuint;
begin
...
function TGLStateCache.GetMaxTextureImageUnits: GLuint;
begin
...
function TGLStateCache.GetMaxTextureAnisotropy: GLuint;
begin
...
function TGLStateCache.GetMaxSamples: GLuint;
begin
...
function TGLStateCache.GetTextureBinding(Index: Integer;
  target: TGLTextureTarget): GLuint;
begin
...
function TGLStateCache.GetSamplerBinding(Index: GLuint): GLuint;
begin
  Result := FSamplerBinding[Index];
end;

procedure TGLStateCache.SetSamplerBinding(Index: GLuint; const Value: GLuint);
begin
...
procedure TGLStateCache.SetTextureMatrix(const matrix: TMatrix);
begin
  if FForwardContext then
    exit;
  if FInsideList then
...
procedure TGLStateCache.SetLineWidth(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetLineStippleFactor(const Value: GLint);
begin
...
procedure TGLStateCache.SetLineStipplePattern(const Value: GLushort);
begin
...
procedure TGLStateCache.SetPackAlignment(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackImageHeight(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackLSBFirst(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetPackRowLength(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackSkipImages(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackSkipPixels(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackSkipRows(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPackSwapBytes(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetPixelPackBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPixelUnpackBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetPointFadeThresholdSize(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetPointSize(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetPointSpriteCoordOrigin(const Value: GLEnum);
begin
...
procedure TGLStateCache.SetPolygonOffset(const factor, units: GLfloat);
begin
...
procedure TGLStateCache.SetPolygonOffsetFactor(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetPolygonOffsetUnits(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetProvokingVertex(const Value: GLEnum);
begin
...
procedure TGLStateCache.SetReadFrameBuffer(const Value: GLuint);
begin
...
procedure TGLStateCache.SetRenderBuffer(const Value: GLuint);
begin
...
procedure TGLStateCache.SetSampleCoverage(const Value: GLfloat;
  invert: GLboolean);
begin
...
procedure TGLStateCache.SetSampleCoverageInvert(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetSampleCoverageValue(const Value: GLfloat);
begin
...
procedure TGLStateCache.SetStencilBackWriteMask(const Value: GLuint);
begin
...
procedure TGLStateCache.SetStencilClearValue(const Value: GLuint);
begin
...
procedure TGLStateCache.SetStencilWriteMask(const Value: GLuint);
{$IFDEF VKS_CACHE_MISS_CHECK}
var I: GLuint;
{$ENDIF}
begin
...
procedure TGLStateCache.SetTransformFeedbackBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.NewList(list: GLuint; mode: GLEnum);
var
  I: GLuint;
begin
...
procedure TGLStateCache.CallList(list: GLuint);
begin
...
procedure TGLStateCache.SetUniformBufferBinding(const Value: GLuint);
begin
...
procedure TGLStateCache.SetBufferIndexedBinding(const Value: GLuint;
  ATarget: TGLBufferBindingTarget; AIndex: GLuint; ABufferSize: GLsizeiptr);
begin
  Assert(not FInsideList);
...
procedure TGLStateCache.SetBufferIndexedBinding(const Value: GLuint;
  ATarget: TGLBufferBindingTarget; AIndex: GLuint;
...
function TGLStateCache.GetMaxTextureUnits: GLuint;
begin
...
procedure TGLStateCache.SetUnpackAlignment(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackImageHeight(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackLSBFirst(const Value: GLboolean);
begin
...
procedure TGLStateCache.SetUnpackRowLength(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackSkipImages(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackSkipPixels(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackSkipRows(const Value: GLuint);
begin
...
procedure TGLStateCache.SetUnpackSwapBytes(const Value: GLboolean);
begin
...
// SetGLState
//
procedure TGLStateCache.SetVKState(const aState : TGLState);
begin
	Enable(aState);
end;
...
// UnSetGLState
//
procedure TGLStateCache.UnSetVKState(const aState : TGLState);
begin
	Disable(aState);
end;
...
procedure TGLStateCache.ResetPolygonMode;
begin
...
procedure TGLStateCache.ResetMaterialColors;
begin
...
procedure TGLStateCache.ResetTexture(const TextureUnit: Integer);
var
  t: TGLTextureTarget;
  glTarget: GLEnum;
begin
...
procedure TGLStateCache.ResetCurrentTexture;
var
  a: GLint;
  t: TGLTextureTarget;
  glTarget: GLEnum;
...
procedure TGLStateCache.ResetFrontFace;
begin
  glFrontFace(GL_CCW);
  FFrontFace := fwCounterClockWise;
end;
