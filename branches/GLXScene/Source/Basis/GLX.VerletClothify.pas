...
uses
  ...
  GLX.VectorFileObjects, GLX.VerletTypes, GLX.VectorTypes, GLX.VectorLists,
  GLX.VectorGeometry, GLX.Texture, Winapi.OpenGL, Winapi.OpenGLext,  GLX.RenderContextInfo,
  GLX.State, GLX.Context;
