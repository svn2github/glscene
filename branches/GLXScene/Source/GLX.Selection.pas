...
uses
  ...
  GLX.Context, GLX.VectorLists, GLX.VectorGeometry,
  GLX.BaseClasses, GLX.PersistentClasses;
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLPickList'}{$ENDIF}
// ------------------
// ------------------ TGLPickList ------------------
// ------------------
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLSelectRenderModeTechnique'}{$ENDIF}
// ------------------
// ------------------ TGLSelectRenderModeTechnique ------------------
// ------------------
