...
uses
  System.Classes,
  GLX.Scene, GLX.VectorGeometry, GLX.OpenGLAdapter, Winapi.OpenGL, Winapi.OpenGLext, 
  GLX.Context, GLX.Material, GLX.Color, GLX.RenderContextInfo,
...
procedure TGLMirror.SetWidth(AValue: GLfloat);
begin
...
procedure TGLMirror.SetHeight(AValue: GLfloat);
begin
...
procedure TGLMirror.SetSlices(const aValue: GLint);
begin
...
function TGLMirror.GetSlices: GLint;
begin
  result := FSlices;
end;
