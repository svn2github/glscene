...
type
  ...
  TGLWinContext = class(TGLContext)
  protected
    
    FDC: HDC;
    FRC: HGLRC;
    FShareContext: TGLWinContext;
    FHPBUFFER: Integer;
...
// Create
//
constructor TGLWinContext.Create;
begin
  inherited Create;
  ClearIAttribs;
  ClearFAttribs;
...
// Destroy
//
destructor TGLWinContext.Destroy;
begin
  inherited Destroy;
end;
...
// ClearIAttribs
//
procedure TGLWinContext.ClearIAttribs;
begin
...
// AddIAttrib
//
procedure TGLWinContext.AddIAttrib(attrib, value: Integer);
var
  n: Integer;
begin
  n := Length(FiAttribs);
...
// ChangeIAttrib
//
procedure TGLWinContext.ChangeIAttrib(attrib, newValue: Integer);
var
  i: Integer;
begin
  i := 0;
...
// DropIAttrib
//
procedure TGLWinContext.DropIAttrib(attrib: Integer);
var
  i: Integer;
begin
  i := 0;
...
// ClearFAttribs
//
procedure TGLWinContext.ClearFAttribs;
begin
...
// AddFAttrib
//
procedure TGLWinContext.AddFAttrib(attrib, value: Single);
var
  n: Integer;
begin
  n := Length(FfAttribs);
...
//
procedure TGLWinContext.DestructionEarlyWarning(sender: TObject);
begin
  if IsValid then
    DestroyContext;
end;
...
// ChooseWGLFormat
//
procedure TGLWinContext.ChooseWGLFormat(DC: HDC; nMaxFormats: Cardinal;
...
procedure TGLWinContext.CreateOldContext(aDC: HDC);
begin
...
procedure TGLWinContext.CreateNewContext(aDC: HDC);
var
...
// DoCreateContext
//
procedure TGLWinContext.DoCreateContext(ADeviceHandle: THandle);
const
...
begin
  ...
  begin
    ...
    begin
      if wglShareLists(TGLWinContext(ServiceContext).FRC, FRC) then
      begin
...
// SpawnLegacyContext
//
procedure TGLWinContext.SpawnLegacyContext(aDC: HDC);
begin
  try
...
//
procedure TGLWinContext.DoCreateMemoryContext(OutputDevice: THandle;
...
// DoShareLists
//
function TGLWinContext.DoShareLists(aContext: TGLContext): Boolean;
begin
  if aContext is TGLWinContext then
  begin
    FShareContext := TGLWinContext(aContext);
...
// DoDestroyContext
//
procedure TGLWinContext.DoDestroyContext;
begin
...
// DoActivate
//
procedure TGLWinContext.DoActivate;
begin
  if not wglMakeCurrent(FDC, FRC) then
  begin
    ShowMessage(Format(strContextActivationFailed,
...
// Deactivate
//
procedure TGLWinContext.DoDeactivate;
begin
...
// IsValid
//
function TGLWinContext.IsValid: Boolean;
begin
  Result := (FRC <> 0);
end;
...
// SwapBuffers
//
procedure TGLWinContext.SwapBuffers;
begin
...
// RenderOutputDevice
//
function TGLWinContext.RenderOutputDevice: Pointer;
begin
  Result := Pointer(FDC);
end;
...
RegisterVKContextClass(TGLWinContext);
