...
uses
  ...
  GLX.Texture, GLX.ProcTextures,
  GLX.CrossPlatform, GLX.Utils;
...
function EditTextureImage(aTexImage : TGLTextureImage) : Boolean;
procedure RegisterTextureImageEditor(aTexImageClass : TGLTextureImageClass;
                                       texImageEditor : TGLTextureImageEditorClass);
procedure UnRegisterTextureImageEditor(texImageEditor : TGLTextureImageEditorClass);
...
// ------------------------------------------------------------------
  ...
  RegisterTextureImageEditor(TGLBlankImage, TGLBlankTIE);
	RegisterTextureImageEditor(TGLPersistentImage, TGLPersistentTIE);
	RegisterTextureImageEditor(TGLPicFileImage, TGLPicFileTIE);
  RegisterTextureImageEditor(TGLProcTextureNoise, TGLProcTextureNoiseTIE);

finalization

  UnRegisterTextureImageEditor(TGLBlankTIE);
	UnRegisterTextureImageEditor(TGLPersistentTIE);
	UnRegisterTextureImageEditor(TGLPicFileTIE);
  UnRegisterTextureImageEditor(TGLProcTextureNoiseTIE);
