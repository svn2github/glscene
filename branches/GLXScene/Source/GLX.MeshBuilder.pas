...
uses
  System.SysUtils, System.Classes, GLX.Scene, GLX.VectorFileObjects,
  GLX.VectorTypes, GLX.VectorGeometry, GLX.VectorLists;

procedure BuildCube(Mesh: TGLMeshObject; Position, Scale: TAffineVector);
procedure BuildCylinder(Mesh: TGLMeshObject; Position, Scale: TAffineVector;
  Slices: Integer);
procedure BuildCylinder2(Mesh: TGLMeshObject; Position, Scale: TAffineVector;
