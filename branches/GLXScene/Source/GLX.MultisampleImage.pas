...
{$IFDEF VKS_REGIONS}{$REGION 'TGLMultisampleImage'}{$ENDIF}
...
procedure TGLMultisampleImage.SetFixedSamplesLocation(val: GLboolean);
begin
...
procedure TGLMultisampleImage.LoadTexture(AInternalFormat: GLinternalFormat);
var
...
initialization
  RegisterTextureImageClass(TGLMultisampleImage);
