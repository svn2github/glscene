...
uses
  ...
  GLX.VectorFileObjects, GLX.Texture, GLX.ApplicationFileIO,
  GLX.VectorTypes, GLX.VectorGeometry, GLX.Material;
   ...
   try
      ...
      while sl[i]<>'end' do begin
         ...
         while Pos(Copy(sl[i], 1, 1), ' 1234567890')>0 do begin
            ...
            frame.Position.Add(GLX.Utils.StrToFloatDef(tl[1]), GLX.Utils.StrToFloatDef(tl[2]), GLX.Utils.StrToFloatDef(tl[3]));
            v:=AffineVectorMake(GLX.Utils.StrToFloatDef(tl[4]), GLX.Utils.StrToFloatDef(tl[5]), GLX.Utils.StrToFloatDef(tl[6]));
         ...
         while sl[i]<>'end' do begin
            ...
            for k:=1 to 3 do with mesh do begin
                 ...
                 then begin
                   ...
                   nVert:=FindOrAdd(boneIDs, AffineVectorMake(GLX.Utils.StrToFloatDef(tl[1]), GLX.Utils.StrToFloatDef(tl[2]), GLX.Utils.StrToFloatDef(tl[3])),                                AffineVectorMake(GLX.Utils.StrToFloatDef(tl[4]), GLX.Utils.StrToFloatDef(tl[5]), GLX.Utils.StrToFloatDef(tl[6])));
                   nTex:=TexCoords.FindOrAdd(AffineVectorMake(GLX.Utils.StrToFloatDef(tl[7]), GLX.Utils.StrToFloatDef(tl[8]), 0));
                 ...
                 begin
                   ...
                   nVert:=FindOrAdd(boneID,AffineVectorMake(GLX.Utils.StrToFloatDef(tl[1]), GLX.Utils.StrToFloatDef(tl[2]), GLX.Utils.StrToFloatDef(tl[3])),                                AffineVectorMake(GLX.Utils.StrToFloatDef(tl[4]), GLX.Utils.StrToFloatDef(tl[5]), GLX.Utils.StrToFloatDef(tl[6])));
                   nTex:=TexCoords.FindOrAdd(AffineVectorMake(GLX.Utils.StrToFloatDef(tl[7]), GLX.Utils.StrToFloatDef(tl[8]), 0));
                   faceGroup.Add(nVert, nVert, nTex);
                   Inc(i);
                 end;
