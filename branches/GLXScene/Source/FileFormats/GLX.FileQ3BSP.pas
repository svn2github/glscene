...
uses
  ...
  //
  GLX.VectorFileObjects, GLX.ApplicationFileIO, GLX.VectorGeometry,
  GLX.VectorTypes, GLX.VectorLists, Q3BSP, GLX.BSP, GLX.Texture,
  GLX.Graphics, GLX.CrossPlatform, GLX.State, GLX.Utils,
  GLX.Material, GLX.TextureFormat;
