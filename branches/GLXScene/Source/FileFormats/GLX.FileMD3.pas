...
//
{
  GLX.FileMD3 - Code for loading animated MD3 files into GLScene
...
uses
  ...
  GLX.VectorFileObjects, GLX.Material, GLX.ApplicationFileIO,
  GLX.VectorGeometry, FileMD3, GLX.Texture;
