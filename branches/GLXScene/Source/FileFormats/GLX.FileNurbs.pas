...
uses
  ...
  GLX.VectorFileObjects, GLX.VectorGeometry, GLX.VectorLists, 
  GLX.ApplicationFileIO, GLX.ParametricSurfaces, GLX.Utils;
      ...
      try
         while idx<sl.Count do begin
            ...
            if vals.Count>=3 then
               list.Add(GLX.Utils.StrToFloatDef(vals[0],0), GLX.Utils.StrToFloatDef(vals[1],0), GLX.Utils.StrToFloatDef(vals[2],0));
            Inc(idx);
         end;
         Result:=idx;
      finally
