...
uses
  ...
  GLX.CrossPlatform, GLX.PersistentClasses, GLX.VectorGeometry,
  GLX.Scene,  GLX.VectorFileObjects, GLX.VectorLists,  GLX.Texture,  GLX.Color,
          ...
          begin
            ...
            try
              ...
              begin
                ...
                Diffuse.Alpha := GLX.Utils.StrToFloatDef(objMtl.MaterialStringProperty(matName, 'd'), 1);
...
initialization
  ...
  GLX.VectorFileObjects.RegisterVectorFileFormat('obj', 'WaveFront model file', TGLOBJVectorFile);
  GLX.VectorFileObjects.RegisterVectorFileFormat('objf', 'Stripe model file', TGLOBJVectorFile);
