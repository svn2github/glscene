...
uses
  ...
  System.SysUtils,
  // GLS
  GLX.VectorGeometry, GLX.VectorLists,
  GLX.VectorFileObjects, GLX.ApplicationFileIO,
  GLX.Utils, GLX.CrossPlatform;
...
var
  ...
  begin
    ...
    begin
      aNormal.X := GLX.Utils.StrToFloatDef(sl[2], 0);
      aNormal.Y := GLX.Utils.StrToFloatDef(sl[3], 0);
      aNormal.Z := GLX.Utils.StrToFloatDef(sl[4], 0);
    end;
  end;
  ...
  begin
    ...
    begin
      aVertex.X := GLX.Utils.StrToFloatDef(sl[1], 0);
      aVertex.Y := GLX.Utils.StrToFloatDef(sl[2], 0);
      aVertex.Z := GLX.Utils.StrToFloatDef(sl[3], 0);
    end;
  end;
