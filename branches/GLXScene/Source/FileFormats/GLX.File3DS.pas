...
uses
  ...
  GLX.Scene, GLX.Objects, GLX.VectorFileObjects, GLX.Texture, GLX.ApplicationFileIO,
  GLX.VectorGeometry, File3DS, Types3DS, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context, GLX.PersistentClasses,
  GLX.Strings, GLX.File3DSSceneObjects, GLX.CrossPlatform, GLX.VectorTypes, GLX.VectorLists,
  GLX.RenderContextInfo, GLX.Material;
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSScaleAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSRotationAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSPositionAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSColorAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TTGLFile3DSPositionAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSSpotLightCutOffAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSLightHotSpotAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSRollAnimationKeys'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSAnimationKeyList'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSDummyObject'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSMeshObject'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSOmniLightObject'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSSpotLightObject'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGLFile3DSCameraObject'}{$ENDIF}
...
{$IFDEF VKS_REGIONS}{$REGION 'TGL3DSVectorFile'}{$ENDIF}
...
var
  ...
  {$IFDEF VKS_REGIONS}{$REGION 'TGL3DSVectorFile.LoadFromStream Local functions'}{$ENDIF}
  //--------------- local functions -------------------------------------------
