...
uses
  System.Classes, System.SysUtils, GLX.VectorFileObjects, GLX.Utils, 
  GLX.ApplicationFileIO, GLX.VectorTypes, GLX.VectorGeometry, GLX.VectorLists;
        ...
        if temp = 'shader' then begin
          ...
          if FTempString.Count>=6 then begin
            ...
            mesh.TexCoords[vnum]:=AffineVectorMake(
              ...
              1-GLX.Utils.StrToFloatDef(FTempString[3]),
              0);
    ...
    repeat
      ...
      if FTempString.Count>=6 then begin
        pos:=AffineVectorMake(
          GLX.Utils.StrToFloatDef(FTempString[0]),
          GLX.Utils.StrToFloatDef(FTempString[1]),
          GLX.Utils.StrToFloatDef(FTempString[2]));
        quat:=QuaternionMakeFromImag(
          GLX.Utils.StrToFloatDef(FTempString[3]),
          GLX.Utils.StrToFloatDef(FTempString[4]),
          GLX.Utils.StrToFloatDef(FTempString[5]));
        FFramePositions.Add(pos);
        FFrameQuaternions.Add(quat);
