...
uses
  System.Classes, GLX.VectorFileObjects, GLX.Material, GLX.CrossPlatform, GLX.VectorGeometry,
  GLX.VectorLists, GLX.Color, GLX.RenderContextInfo;
...
uses System.SysUtils, GLX.VectorTypes;
