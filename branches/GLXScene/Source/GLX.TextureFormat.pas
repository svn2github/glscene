...
function DecodeTextureTarget(const TextureTarget: TGLTextureTarget): GLEnum;
function EncodeTextureTarget(const glTarget: GLEnum): TGLTextureTarget;
...
const
  cTargetToEnum: array[TGLTextureTarget] of GLEnum =
  (
    0,
    GL_TEXTURE_1D,
    GL_TEXTURE_2D,
