...
uses
  ...
  GLX.Texture, GLX.Graphics, Winapi.OpenGL, Winapi.OpenGLext, 
  GLX.CrossPlatform, GLX.TextureFormat, GLX.VectorGeometry;
...
initialization
  ...
  RegisterTextureImageClass(TGLProcTextureNoise);
