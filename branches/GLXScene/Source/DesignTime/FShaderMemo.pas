...
function VKShaderEditorForm: TGLShaderMemoForm;
...
var
  vShaderEditor: TGLShaderMemoForm;

function VKShaderEditorForm: TGLShaderMemoForm;
begin
  if not Assigned(vShaderEditor) then
    vShaderEditor := TGLShaderMemoForm.Create(nil);
...
procedure TGLShaderMemoForm.FormCreate(Sender: TObject);
var
  reg: TRegistry;
  No: Integer;
  item: TMenuItem;
