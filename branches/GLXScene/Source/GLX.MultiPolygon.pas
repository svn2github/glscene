...
{ TODO
  ...
  And I reactivated the TVectorPool object. The GLX.VectorLists are not suitable for this job.
...
uses
  ...
  Winapi.OpenGL, Winapi.OpenGLext,   GLX.OpenGLAdapter,  GLX.Spline,
  GLX.XOpenGL,  GLX.Context, GLX.VectorTypes,
  GLX.VectorGeometry, GLX.VectorLists, GLX.PersistentClasses,
  GLX.Scene, GLX.Objects, GLX.GeomObjects, GLX.Nodes, GLX.BaseClasses,
  GLX.Coordinates, GLX.RenderContextInfo;
...
type
  ...
  private
    ...
    FAktArray: GLX.VectorGeometry.PByteArray; // pointer to actual page
