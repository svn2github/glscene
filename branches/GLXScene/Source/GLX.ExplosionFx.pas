...
uses
  Winapi.OpenGL, Winapi.OpenGLext,  GLX.VectorGeometry, GLX.Scene, GLX.VectorFileObjects,
  GLX.VectorTypes, GLX.VectorLists, GLX.XCollection, GLX.Coordinates,
  GLX.RenderContextInfo, GLX.Context, GLX.State;
