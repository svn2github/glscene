...
uses
  ...
  GLX.Scene, GLX.VectorGeometry, GLX.XCollection, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Spline, GLX.Objects,
  GLX.CrossPlatform, GLX.Strings, GLX.BaseClasses, GLX.VectorTypes;
...
function TGLPathNode.GetPositionCoordinate(const Index: Integer): GLfloat;
begin
  result := FPosition.V[Index];
end;

procedure TGLPathNode.SetPositionCoordinate(const Index: integer; const AValue: GLfloat);
begin
...
function TGLPathNode.GetRotationCoordinate(const Index: Integer): GLfloat;
begin
  result := FRotation.V[Index];
end;

procedure TGLPathNode.SetRotationCoordinate(const Index: integer; const AValue: GLfloat);
begin
...
function TGLPathNode.GetScaleCoordinate(const Index: Integer): GLfloat;
begin
  result := FScale.V[Index];
end;

procedure TGLPathNode.SetScaleCoordinate(const Index: integer; const AValue: GLfloat);
begin
...
function TGLPathNode.GetDirectionCoordinate(const Index: Integer): GLfloat;
begin
...
function TGLPathNode.GetUpCoordinate(const Index: Integer): GLfloat;
begin
  result := FUp.V[Index];
end;

procedure TGLPathNode.SetUpCoordinate(const Index: integer; const AValue: GLfloat);
begin
  FUp.V[Index] := AValue;
  if Collection <> nil then
    (Collection as TGLPathNodes).NotifyChange;
