...
type
  ...
  protected
    ...
    procedure DoApply(var rci: TGLRenderContextInfo; Sender: TObject); virtual; abstract;
    ...
    function DoUnApply(var rci: TGLRenderContextInfo): Boolean; virtual; abstract;
  ...
  public
    ...
    // Restore non-standard material states that were altered
    function UnApply(var ARci: TGLRenderContextInfo): Boolean; virtual; abstract;
  ...
  TGLLibMaterial = class(TGLAbstractLibMaterial, IVKTextureNotifyAble)
  private
...
procedure TGLDepthProperties.SetDepthWrite(Value: GLboolean);
begin
...
// ------------------
{$IFDEF VKS_REGION}{$REGION 'TGLAbstractLibMaterial'}{$ENDIF}
...
// ------------------ TGLLibMaterial ------------------
// ------------------
{$IFDEF VKS_REGION}{$REGION 'TGLLibMaterial'}{$ENDIF}
...
// ------------------ TGLLibMaterials ------------------
// ------------------
 {$IFDEF VKS_REGION}{$REGION 'TGLLibMaterials'}{$ENDIF}
...
{$IFDEF VKS_REGION}{$REGION 'TGLAbstractMaterialLibrary'}{$ENDIF}
...
{$IFDEF VKS_REGION}{$REGION 'TGLMaterialLibrary'}{$ENDIF}
...
{$IFDEF VKS_REGION}{$REGION 'TGLBlendingParameters'}{$ENDIF}
...
procedure TGLBlendingParameters.SetAlphaFuncRef(const Value: GLclampf);
begin
