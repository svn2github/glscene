...
uses
  ...
  GLX.Scene, GLX.Objects, GLX.Texture, GLX.VectorFileObjects, GLX.Coordinates,
  GLX.Context, GLX.Material, GLX.Color, GLX.State,
  GLX.Nodes, GLX.VectorGeometry, GLX.Spline, GLX.VectorLists, GLX.RenderContextInfo;
