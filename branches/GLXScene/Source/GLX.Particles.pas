...
//
{
   Particle systems for GLX.Scene, based on replication of full-featured scene objects. 
...
type
  ...
  { Manager object of a particle system. 
   ...
   value and use the KillParticle function instead of "Free" to kill a
       ...
       look into GLX.ParticleFX instead, TGLParticles being rather focused on
       complex particles.
  }
...
procedure TGLParticles.SetCubeSize(const val: GLfloat);
begin
