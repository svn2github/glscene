...
uses
  ...
  GLX.Scene, GLX.VectorGeometry, GLX.Texture, GLX.Material, GLX.Silhouette, GLX.Strings,
  GLX.CrossPlatform, GLX.PersistentClasses, GLX.RenderContextInfo, GLX.BaseClasses,
  GLX.Context , GLX.VectorTypes;
