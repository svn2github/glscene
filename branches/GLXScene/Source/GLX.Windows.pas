...
uses
  ...
  GLX.Scene, GLX.HUDObjects, GLX.Material, Winapi.OpenGL, Winapi.OpenGLext,  GLX.Context,
  GLX.BitmapFont, GLX.WindowsFont, GLX.VectorGeometry, GLX.Gui,
  GLX.CrossPlatform, GLX.Color, GLX.RenderContextInfo, GLX.BaseClasses,
  GLX.Objects, GLX.State, GLX.Utils;
...
type
  ...
  protected
    ...
    procedure WriteTextAt(var rci: TGLRenderContextInfo; const X, Y: GLfloat;
  ...
  TGLCustomRenderEvent = procedure(Sender: TGLCustomControl; Bitmap: TBitmap)
    of object;
  ...
  StringGrid = class(TGLFocusControl)
  private
...
procedure TGLBaseComponent.SetRotation(const val: GLfloat);
begin
...
procedure StringGrid.SetScrollbar(const val: TGLScrollbar);
...
procedure StringGrid.SetGuiLayout(NewGui: TGLGuiLayout);
...
procedure StringGrid.InternalRender(var rci: TGLRenderContextInfo; renderSelf,
  renderChildren: Boolean);
...
initialization
  RegisterClasses([TGLBaseControl, TGLPopupMenu, TGLForm, TGLPanel, TGLButton,
    TGLCheckBox, TGLEdit, TGLLabel, TGLAdvancedLabel, TGLScrollbar, StringGrid,
    TGLCustomControl]);
end.
