...
uses
  ...
  Vcl.Dialogs, Vcl.ExtCtrls, Vcl.StdCtrls, Vcl.ComCtrls, Vcl.Buttons,
  Vcl.imaging.Jpeg,
   
  GLScene, GLObjects, GLWin32Viewer, GLTexture, OpenGL1x, GLCgShader, Cg,
  cgGL, GLVectorGeometry, GLCadencer, GLVectorFileObjects, GLFile3DS,
  GLGraph, GLVectorTypes, GLGeomObjects, GLMaterial, GLCoordinates,
