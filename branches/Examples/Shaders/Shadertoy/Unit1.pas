...
uses
  ...
  System.SysUtils, System.Classes, Controls, Dialogs, Forms,
   
  GLScene, GLBaseClasses, GLObjects, GLCadencer, GLWin32Viewer, GLKeyboard,
  GLRenderContextInfo, OpenGLAdapter, OpenGLTokens, GLVectorGeometry,
...
begin
  ShellExecute(Handle, 'open', 'https://www.shadertoy.com/view/ldS3zW', nil,
    nil, SW_Normal);
  close;
end;
