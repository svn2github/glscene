...
uses
  ...
  Vcl.StdCtrls, Vcl.Buttons, Vcl.Controls, Vcl.ExtCtrls, Vcl.ComCtrls,
  Vcl.Forms, Vcl.Graphics, Vcl.Imaging.Jpeg,
  // GLS
  GLCadencer, GLVectorFileObjects, GLScene, GLObjects, GLMaterial,
  GLNavigator, GLTerrainRenderer, GLCoordinates, GLCrossPlatform,
  GLBaseClasses, GLWin32Viewer,  GLSkydome, GLFileMD2, GLFile3DS,
  ahGLRandomHDS, GLTexture, GLColor,
  GLVectorGeometry, GLKeyboard;
