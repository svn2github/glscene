...
type
  ...
  TGLLines    = array[Word]of Pointer;  PLines    =^TGLLines;
...
begin
  Winapi.Windows.SetTextColor(hDC,Color);
end;
...
begin
  Winapi.Windows.SetBkColor(hDC,Color);
end;

procedure TFastDIB.Ellipse(x1,y1,x2,y2:Integer);
begin
  Winapi.Windows.Ellipse(hDC,x1,y1,x2,y2);
end;

procedure TFastDIB.FillRect(Rect:TRect);
begin
  Winapi.Windows.FillRect(hDC,Rect,hBrush);
end;

procedure TFastDIB.LineTo(x,y:Integer);
begin
  Winapi.Windows.LineTo(hDC,x,y);
end;
...
begin
  Winapi.Windows.Polygon(hDC,Points,High(Points)+1);
end;

procedure TFastDIB.Polyline(Points:array of TPoint);
begin
  Winapi.Windows.Polyline(hDC,Points,High(Points)+1);
end;

procedure TFastDIB.Rectangle(x1,y1,x2,y2:Integer);
begin
  Winapi.Windows.Rectangle(hDC,x1,y1,x2,y2);
end;

procedure TFastDIB.TextOut(x,y:Integer;Text:string);
begin
  Winapi.Windows.TextOut(hDC,x,y,PChar(Text),Length(Text));
end;

procedure TFastDIB.DrawText(Text:string;Rect:TRect;Flags:Integer);
begin
  Winapi.Windows.DrawText(hDC,PChar(Text),Length(Text),Rect,Flags);
end;
