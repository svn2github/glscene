...
begin
  ...
  begin
    ...
    with ViewData.xyGrid do
    begin
      if xMaxYCB.Checked then
        CurrentYCoord := yRange.Maximum
      else
        CurrentYCoord := yRange.Minimum;
    ...
    with ViewData do
      if xMaxZCB.Checked then
        CurrentZCoord := yzGrid.zRange.Maximum * xyGrid.zScale
      else
        CurrentZCoord := yzGrid.zRange.Minimum * xyGrid.zScale;
    ...
    with ViewData.xyGrid do
    begin
      if yMaxXCB.Checked then
        CurrentXCoord := xRange.Maximum
      else
        CurrentXCoord := xRange.Minimum;
    ...
    with ViewData do
      if zMaxYCB.Checked then
        CurrentYCoord := xyGrid.yRange.Maximum
      else
        CurrentYCoord := xyGrid.yRange.Minimum;
