...
uses
  ...
  GLCoordinates, GLCrossPlatform, GLWin32Viewer, GLBitmapFont,
  GLWindowsFont, ComCtrls, GLParticles, GLColor, OpenGLTokens,
  uGlobal, Menus, GLBaseClasses, GLVectorGeometry, Vcl.ExtDlgs ;
...
uses
  IniFiles,
  System.DateUtils,
  uParser, GLState, GLMaterial, Math, System.UITypes, GLVectorTypes,
