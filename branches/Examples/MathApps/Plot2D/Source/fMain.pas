...
begin
  ...
  DataPath := PlotPath + 'Examples\';

  PrinterExists := Printer.Printers.Count > 0;
  StyleFName := PlotPath + 'Styles.sty';
  LayoutFName := PlotPath + 'Layout.lay';
...
begin
  ...
  if DataPath = '' then DataPath := PlotPath + 'Examples\';
  if ImagePath = '' then ImagePath := PlotPath + 'Images\';
