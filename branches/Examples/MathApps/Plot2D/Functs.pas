...
uses
  ...
  Dialogs, StdCtrls, CheckLst, Buttons, ComCtrls, Menus, uGlobal, ImgList,
...
uses
  uParser,
  Main, ClipBrd, Math, GridOpts, Derivative,
  IntegrateX, IntegrateY, Between, VolumeX, VolumeY, fxValue, fx1Value,
  fx2Value, TextBlocks, Numeric;
