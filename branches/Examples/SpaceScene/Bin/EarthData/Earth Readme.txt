Copied from original ... so some of this has 'changed', but it is good info and credits.
...
Menu: - Mouse right click : adjust focal length
Menu: - 'E' : center and target Earth
Menu: - 'M' : center and target Moon
Menu: - '0'..'9' : adjust the speed, from paused (0) to superfast (9)
Menu: - 'C' : toggle constellation lines visibility
Menu: - 'H' : loads high-resolution resources
