...
uses
  ...
  GLVectorFileObjects,
  GLTexture, GLWin32Viewer, GLObjects, GLCoordinates, GLCrossPlatform,
  GLFile3DS, GLBaseClasses;
...
var
  ...
  ExplosionCount,LevelLineLevel, MaxLines,
  Total, StageDistance, CurrentAtom:Integer;
...
begin
  ...
  begin               //Needs app directory to load a mesh
     ...
     exp.Speed:= 3.9;     {.1 .. 2 ..?}
  end else ShowMessage('sphere.3ds missing No e !');
...
begin
  ...
  If ((Rotator > 360)or(Rotator < -360))  {360 degree circles}
   then Rotator:=0;{safety catch, still limit keyboard reverse spin}
...
begin
	...
	begin {Flat circles rotating clock-counter-clockwise}
		if (stage[1].elements > 0) then	BuildStagez(1);
		if (stage[2].elements > 0) then	BuildStagez(2);
		if (stage[3].elements > 0) then	BuildStagez(3);
		if (stage[4].elements > 0) then	BuildStagez(4);
		if (stage[5].elements > 0) then	BuildStagez(5);
		if (stage[6].elements > 0) then	BuildStagez(6);
		if (stage[7].elements > 0) then	BuildStagez(7);
	end else
	begin {3d}{Variations in 3 planes of rotation}
		if (stage[1].elements > 0) then	BuildStagey(1);
		if (stage[2].elements > 0) then	BuildStagex(2);
		if (stage[3].elements > 0) then	BuildStagez(3);
		if (stage[4].elements > 0) then	BuildStagey(4);
		if (stage[5].elements > 0) then	BuildStagex(5);
		if (stage[6].elements > 0) then	BuildStagey(6);
		if (stage[7].elements > 0) then	BuildStagex(7);
	end;
...
begin
	...
	begin        {2d} {front-back}       {Clockwise}        {on itself}
		...
		stage[2].rot_x := 0.0; stage[2].rot_y := -1.0; stage[2].rot_z := 0.0;
		stage[3].rot_x := 0.0; stage[3].rot_y := 1.0;  stage[3].rot_z := 0.0;
		stage[4].rot_x := 0.0; stage[4].rot_y := -1.0; stage[4].rot_z := 0.0;
		stage[5].rot_x := 0.0; stage[5].rot_y := 1.0;  stage[5].rot_z := 0.0;
		stage[6].rot_x := 0.0; stage[6].rot_y := -1.0; stage[6].rot_z := 0.0;
		stage[7].rot_x := 0.0; stage[7].rot_y := 1.0;  stage[7].rot_z := 0.0;
	End else
	begin   {3d} {front-back}       {Clockwise}        {on itself}
		stage[1].rot_x := 1.0; stage[1].rot_y := 1.0; stage[1].rot_z := 0.0;
		stage[2].rot_x := -1.0; stage[2].rot_y :=-1.0; stage[2].rot_z := 0.0;
		stage[3].rot_x := 1.0; stage[3].rot_y := -1.0; stage[3].rot_z := 1.0;
		stage[4].rot_x := -1.0; stage[4].rot_y := -1.0; stage[4].rot_z := 1.0;
		stage[5].rot_x := 1.0; stage[5].rot_y := 1.0; stage[5].rot_z := 1.0;
		stage[6].rot_x := -1.0; stage[6].rot_y := -1.0; stage[6].rot_z := -1.0;
		stage[7].rot_x := 1.0; stage[7].rot_y := 1.0; stage[7].rot_z := 0.0;
	End;
...
begin
	Case Key of
     ...
     {limit -0 revolution to limit reset from -360 to 0}
		 'j': if (SpeedDemon > -1) then SpeedDemon:=SpeedDemon-1.0;
		 ';': SpeedDemon:=SpeedDemon+1.0;
		 'm': if (speed > -1) then speed:=speed-0.1;
		 '/': speed:=speed+0.1;
		 'k': if (speed > -1) then speed:=speed-1.0;
		 'l': speed:=speed+1.0;
		 'r': begin   {Reset speed to default}
            speed :=1;
            SpeedDemon :=0;
     ...
     'e': begin{Explode the Central atom...  DropMesh}
...
begin
  ...
  If (ToggleFPSDisplay1.Checked) then
      isFPSDisplayed := True else isFPSDisplayed := False;
...
begin
      ...
      AaMass    :='1.0079';
  Case i of
  1:Begin   {Hydrogen		H	1 0 0 0 0 0 0}
      name:='Hydrogen';
      symbol:='H';
      Group     :='1A';
  ...
  2:Begin {Helium		He	2 0 0 0 0 0 0}
      name:='Helium';
      symbol:='He';
      Group     :='0';
  ...
  3:Begin {Lithium		Li	2 1 0 0 0 0 0}
      name:='Lithium';
      symbol:='Li';
      Group     :='1A';
  ...
  4:Begin {Beryllium	Be	2 2 0 0 0 0 0}
      name:='Beryllium';
      symbol:='Be';
      Group     :='2A';
  ...
  6:Begin {Carbon		C	2 4 0 0 0 0 0}
      name:='Carbon';
      symbol:='C';
      Group     :='4A';
  ...
  7:Begin {Nitrogen	N	2 5 0 0 0 0 0}
      name:='Nitrogen';
      symbol:='N';
      Group     :='5A';
      MetalState:='NG';     {NSM  SLGN}
  ...
  8:Begin {Oxygen		O	2 6 0 0 0 0 0}
      name:='Oxygen';
      symbol:='O';
      Group     :='6A';
      MetalState:='NG';     {NSM  SLGN}
  ...
  9:Begin {Fluorine	F	2 7 0 0 0 0 0}
      name:='Fluorine';
      symbol:='F';
      Group     :='7A';
      MetalState:='NG';     {NSM  SLGN}
  ...
  10:Begin {Neon		Ne	2 8 0 0 0 0 0}
      name:='Neon';
      symbol:='Ne';
      Group     :='0';
      MetalState:='NG';     {NSM  SLGN}
  ...
  11:Begin {Sodium		Na	2 8 1 0 0 0 0}
      name:='Sodium';
      symbol:='Na';
      Group     :='1A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  12:Begin {Magnesium	Mg	2 8 2 0 0 0 0}
      name:='Magnesium';
      symbol:='Mg';
      Group     :='2A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  13:Begin {Aluminum	Al	2 8 3 0 0 0 0}
      name:='Aluminum';
      symbol:='Al';
      Group     :='3A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  14:Begin {Silicon		Si	2 8 4 0 0 0 0}
      name:='Silicon';
      symbol:='Si';
      Group     :='4A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  15:Begin {Phosphorus	P	2 8 5 0 0 0 0}
      name:='Phosphorus';
      symbol:='P';
      Group     :='5A';
      MetalState:='NS';     {NSM  SLGN}
  ...
  16:Begin {Sulfur		S	2 8 6 0 0 0 0}
      name:='Sulfur';
      symbol:='S';
      Group     :='6A';
      MetalState:='NS';     {NSM  SLGN}
  ...
  17:Begin {Chlorine	Cl	2 8 7 0 0 0 0}
      name:='Chlorine';
      symbol:='Cl';
      Group     :='7A';
      MetalState:='NG';     {NSM  SLGN}
  ...
  18:Begin {Argon		Ar	2 8 8 0 0 0 0}
      name:='Argon';
      symbol:='Ar';
      Group     :='0';
      MetalState:='NG';     {NSM  SLGN}
  ...
  19:Begin {Potassium	K	2 8 8 1 0 0 0}
      name:='Potassium';
      symbol:='K';
      Group     :='1A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  20:Begin {Calcium		Ca	2 8 8 2 0 0 0}
      name:='Calcium';
      symbol:='Ca';
      Group     :='2A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  21:Begin {Scandium	Sc	2 8 9 2 0 0 0}
      name:='Scandium';
      symbol:='Sc';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  22:Begin {Titanium	Ti	2 8 10 2 0 0 0}
      name:='Titanium';
      symbol:='Ti';
      Group     :='4B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  23:Begin {Vanadium	V	2 8 11 2 0 0 0}
      name:='Vanadium';
      symbol:='V';
      Group     :='5B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  24:Begin {Chromium	Cr	2 8 13 1 0 0 0}
      name:='Chromium';
      symbol:='Cr';
      Group     :='6B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  25:Begin {Manganese	Mn	2 8 13 2 0 0 0}
      name:='Manganese';
      symbol:='Mn';
      Group     :='7B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  26:Begin {Iron		Fe	2 8 14 3 0 0 0}
      name:='Iron';
      symbol:='Fe';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  27:Begin {Cobalt		Co	2 8 15 2 0 0 0}
      name:='Cobalt';
      symbol:='Co';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  28:Begin {Nickel		Ni	2 8 16 2 0 0 0}
      name:='Nickel';
      symbol:='Ni';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  29:Begin {Copper		Cu	2 8 18 1 0 0 0}
      name:='Copper';
      symbol:='Cu';
      Group     :='1B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  30:Begin {Zinc		Zn	2 8 18 2 0 0 0}
      name:='Zinc';
      symbol:='Zn';
      Group     :='2B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  31:Begin {Gallium		Ga	2 8 18 3 0 0 0}
      name:='Gallium';
      symbol:='Ga';
      Group     :='3A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  32:Begin {Germanium	Ge	2 8 18 4 0 0 0}
      name:='Germanium';
      symbol:='Ge';
      Group     :='4A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  33:Begin {Arsenic		As	2 8 18 5 0 0 0}
      name:='Arsenic';
      symbol:='As';
      Group     :='5A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  34:Begin {Selenium	Se	2 8 18 6 0 0 0}
      name:='Selenium';
      symbol:='Se';
      Group     :='6A';
      MetalState:='NS';     {NSM  SLGN}
  ...
  35:Begin {Bromine		Br	2 8 18 7 0 0 0}
      name:='Bromine';
      symbol:='Br';
      Group     :='7A';
  ...
  36:Begin {Krypton		Kr	2 8 18 8 0 0 0}
      name:='Krypton';
      symbol:='Kr';
      Group     :='0';
      MetalState:='NG';     {NSM  SLGN}
  ...
  37:Begin {Rubidium	Rb	2 8 18 8 1 0 0}
      name:='Rubidium';
      symbol:='Rb';
      Group     :='1A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  38:Begin {Strontium	Sr	2 8 18 8 2 0 0}
      name:='Strontium';
      symbol:='Sr';
      Group     :='2A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  39:Begin {Yttrium		Y	2 8 18 9 2 0 0}
      name:='Yttrium';
      symbol:='Y';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  40:Begin {Zirconium	Zr	2 8 18 10 2 0 0}
      name:='Zirconium';
      symbol:='Zr';
      Group     :='4B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  41:Begin {Niobium		Nb	2 8 18 12 1 0 0}
      name:='Niobium';
      symbol:='Nb';
      Group     :='5B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  42:Begin {Molybdenum	Mo	2 8 18 13 1 0 0}
      name:='Molybdenum';
      symbol:='Mo';
      Group     :='6B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  43:Begin {Technetium	Tc	2 8 18 14 1 0 0}
      name:='Technetium';
      symbol:='Tc';
      Group     :='7B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  44:Begin {Ruthenium	Ru	2 8 18 15 1 0 0}
      name:='Ruthenium';
      symbol:='Ru';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  45:Begin {Rhodium		Rh	2 8 18 16 1 0 0}
      name:='Rhodium';
      symbol:='Rh';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  46:Begin {Palladium	Pd	2 8 18 18 0 0 0}
      name:='Palladium';
      symbol:='Pd';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  47:Begin {Silver		Ag	2 8 18 18 1 0 0}
      name:='Silver';
      symbol:='Ag';
      Group     :='1B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  48:Begin {Cadmium		Cd	2 8 18 18 2 0 0}
      name:='Cadmium';
      symbol:='Cd';
      Group     :='2B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  49:Begin {Indium		In	2 8 18 18 3 0 0}
      name:='Indium';
      symbol:='In';
      Group     :='3A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  50:Begin {Tin		Sn	2 8 18 18 4 0 0}
      name:='Tin';
      symbol:='Sn';
      Group     :='4A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  51:Begin {Antimony	Sb	2 8 18 18 5 0 0}
      name:='Antimony';
      symbol:='Sb';
      Group     :='5A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  52:Begin {Tellurium	Te	2 8 18 18 6 0 0}
      name:='Tellurium';
      symbol:='Te';
      Group     :='6A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  53:Begin {Iodine		I	2 8 18 18 7 0 0}
      name:='Iodine';
      symbol:='I';
      Group     :='7A';
      MetalState:='NS';     {NSM  SLGN}
  ...
  54:Begin {Xenon		Xe	2 8 18 18 8 0 0}
      name:='Xenon';
      symbol:='Xe';
      Group     :='0';
      MetalState:='NG';     {NSM  SLGN}
  ...
  55:Begin {Cesium		Cs	2 8 18 18 8 1 0}
      name:='Cesium';
      symbol:='Cs';
      Group     :='1A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  56:Begin {Barium		Ba	2 8 18 18 8 2 0}
      name:='Barium';
      symbol:='Ba';
      Group     :='2A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  57:Begin {Lanthanum	La	2 8 28 28 9 2 0}
      name:='Lanthanum';
      symbol:='La';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  58:Begin {Cerium		Ce	2 8 18 20 8 2 0}
      name:='Cerium';
      symbol:='Ce';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  59:Begin {Praseodymium	Pr	2 8 18 21 8 2 0}
      name:='Praseodymium';
      symbol:='Pr';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  60:Begin {Neodymium	Nd	2 8 18 22 8 2 0}
      name:='Neodymium';
      symbol:='Nd';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  61:Begin {Promethium	Pm	2 8 18 23 8 2 0}
      name:='Promethium';
      symbol:='Pm';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  62:Begin {Samarium	Sm	2 8 18 24 8 2 0}
      name:='Samarium';
      symbol:='Sm';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  63:Begin {Europium	Eu	2 8 18 25 8 2 0}
      name:='Europium';
      symbol:='Eu';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  64:Begin {Gadolinium	Gd	2 8 18 25 9 2 0}
      name:='Gadolinium';
      symbol:='Gd';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  65:Begin {Terbium		Tb	2 8 18 27 8 2 0}
      name:='Terbium';
      symbol:='Tb';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  66:Begin {Dysprosium	Dy	2 8 18 28 8 2 0}
      name:='Dysprosium';
      symbol:='Dy';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  67:Begin {Holmium		Ho 	2 8 18 29 8 2 0}
      name:='Holmium';
      symbol:='Ho';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  68:Begin {Erbium		Er 	2 8 18 30 8 2 0}
      name:='Erbium';
      symbol:='Er';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  69:Begin {Thulium		Tm	2 8 18 31 8 2 0}
      name:='Thulium';
      symbol:='Tm';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  70:Begin {Ytterbium	Yb	2 8 18 32 8 2 0}
      name:='Ytterbium';
      symbol:='Yb';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  71:Begin {Lutetium	Lu	2 8 18 32 9 2 0}
      name:='Lutetium';
      symbol:='Lu';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  72:Begin {Hafnium		Hf	2 8 18 32 10 2 0}
      name:='Hafnium';
      symbol:='Hf';
      Group     :='4B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  73:Begin {Tantalum	Ta	2 8 18 32 11 2 0}
      name:='Tantalum';
      symbol:='Ta';
      Group     :='5B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  74:Begin {Tungsten	W	2 8 18 32 12 2 0}
      name:='Tungsten';
      symbol:='W';
      Group     :='6B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  75:Begin {Rhenium		Re	2 8 18 32 13 2 0}
      name:='Rhenium';
      symbol:='Re';
      Group     :='7B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  76:Begin {Osmium		Os	2 8 18 32 14 2 0}
      name:='Osmium';
      symbol:='Os';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  77:Begin {Iridium		Ir	2 8 18 32 15 2 0}
      name:='Iridium';
      symbol:='Ir';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  78:Begin {Platinum	Pt	2 8 18 32 17 1 0}
      name:='Platinum';
      symbol:='Pt';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  79:Begin {Gold		Au	2 8 18 32 18 1 0}
      name:='Gold';
      symbol:='Au';
      Group     :='1B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  80:Begin {Mercury		Hg	2 8 18 32 18 2 0}
      name:='Mercury';
      symbol:='Hg';
      Group     :='2B';
  ...
  81:Begin {Thallium	Tl	2 8 18 32 18 3 0}
      name:='Thallium';
      symbol:='Tl';
      Group     :='3A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  82:Begin {Lead		Pb	2 8 18 32 18 4 0}
      name:='Lead';
      symbol:='Pb';
      Group     :='4A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  83:Begin {Bismuth		Bi	2 8 18 32 18 5 0}
      name:='Bismuth';
      symbol:='Bi';
      Group     :='5A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  84:Begin {Polonium	Po	2 8 18 32 18 6 0}
      name:='Polonium';
      symbol:='Po';
      Group     :='6A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  85:Begin {Astatine	At	2 8 18 32 18 7 0}
      name:='Astatine';
      symbol:='At';
      Group     :='7A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  86:Begin {Radon		Rn	2 8 18 32 18 8 0}
      name:='Radon';
      symbol:='Rn';
      Group     :='0';
      MetalState:='NG';     {NSM  SLGN}
  ...
  87:Begin {Francium	Fr	2 8 18 32 18 8 1}
      name:='Francium';
      symbol:='Fr';
      Group     :='1A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  88:Begin {Radium		Ra	2 8 18 32 18 8 2}
      name:='Radium';
      symbol:='Ra';
      Group     :='2A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  89:Begin {Actinium	Ac	2 8 18 32 18 9 2}
      name:='Actinium';
      symbol:='Ac';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  90:Begin {Thorium		Th	2 8 18 32 18 10 2}
      name:='Thorium';
      symbol:='Th';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  91:Begin {Protactinium	Pa	2 8 18 32 20 9 2}
      name:='Protactinium';
      symbol:='Pa';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  92:Begin {Uranium		U	2 8 18 32 21 8 2}
      name:='Uranium';
      symbol:='U';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  93:Begin {Neptunium	Np	2 8 18 32 23 8 2}
      name:='Neptunium';
      symbol:='Np';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  94:Begin {Plutonium	Pu	2 8 18 32 24 8 2}
      name:='Plutonium';
      symbol:='Pu';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  95:Begin {Americium	Am	2 8 18 32 25 8 2}
      name:='Americium';
      symbol:='Am';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  96:Begin {Curium		Cm	2 8 18 32 25 9 2}
      name:='Curium';
      symbol:='Cm';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  97:Begin {Berkelium	Bk	2 8 18 32 26 9 2}
      name:='Berkelium';
      symbol:='Bk';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  98:Begin {Californium	Cf	2 8 18 32 28 8 2}
      name:='Californium';
      symbol:='Cf';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  99:Begin {Einsteinium	Es	2 8 18 32 29 8 2}
      name:='Einsteinium';
      symbol:='Es';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  100:Begin {Fermium		Fm	2 8 18 32 30 8 2}
      name:='Fermium';
      symbol:='Fm';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
   ...
   101:Begin {Mendelevium	Md	2 8 18 32 31 8 2}
      name:='Mendelevium';
      symbol:='Md';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  102:Begin {Nobelium	No	2 8 18 32 32 8 2}
      name:='Nobelium';
      symbol:='No';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  103:Begin {Lawrencium	Lr	2 8 18 32 32 9 2}
      name:='Lawrencium';
      symbol:='Lr';
      Group     :='3B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  104:Begin {Rutherfordium	Rf	2 8 18 32 32 10 2}
      name:='Rutherfordium';
      symbol:='Rf';
      Group     :='4B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  105:Begin {Dubnium		Db	2 8 18 32 32 11 2}
      name:='Dubnium';
      symbol:='Db';
      Group     :='5B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  106:Begin {Bohrium		Bh	2 8 18 32 32 12 2}
      name:='Bohrium';
      symbol:='Bh';
      Group     :='6B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  107:Begin {Seaborgium	Sg	2 8 18 32 32 13 2}
      name:='Seaborgium';
      symbol:='Sg';
      Group     :='7B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  108:Begin {Hassium		Hs	2 8 18 32 32 14 2}
      name:='Hassium';
      symbol:='Hs';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  109:Begin {Meitnerium	Mt	2 8 18 32 32 15 2}
      name:='Meitnerium';
      symbol:='Mt';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  110:Begin {Ununnilium	Uun	2 8 18 32 32 17 2}
      name:='Ununnilium';
      symbol:='Uun';
      Group     :='8B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  111:Begin {Unununium 	Uuu	2 8 18 32 32 18 1}
      name:='Unununium';
      symbol:='Uuu';
      Group     :='1B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  112:Begin {Ununbium 	Uub	2 8 18 32 32 18 2}
      name:='Ununbium';
      symbol:='Uub';
      Group     :='2B';
      MetalState:='MS';     {NSM  SLGN}
  ...
  113:Begin {Ununquadium 	Uuq	2 8 18 32 32 18 4}
      name:='Ununquadium';
      symbol:='Uuq';
      Group     :='3A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  114:Begin {Ununhexium 	Uuh	2 8 18 32 32 18 6}
      name:='Ununhexium';
      symbol:='Uuh';
      Group     :='4A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  115:Begin {Ununoctium 	Uuo	2 8 18 32 32 18 8}
      name:='Ununoctium';
      symbol:='Uuo';
      Group     :='6A';
      MetalState:='MS';     {NSM  SLGN}
  ...
  116:Begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      name:='UnRealium';
      symbol:='Uux';
      Group     :='7A';
      MetalState:='SS';     {NSM  SLGN}
  ...
  117:Begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      name:='UraGasium';
      symbol:='Uug';
      Group     :='0';
  ...
  StatusBar1.simpletext:=
         ...
         {+', Symbol: '}+' : '+ symbol
                        ...
                        +' : '+ MetalState
                        +', Electrons: '
  +Inttostr(stage[1].elements)+', '
  +Inttostr(stage[2].elements)+', '
  +Inttostr(stage[3].elements)+', '
  +Inttostr(stage[4].elements)+', '
  +Inttostr(stage[5].elements)+', '
  +Inttostr(stage[6].elements)+', '
  +Inttostr(stage[7].elements)+
...
Begin
  Case (Leveled) of
  1:for i:=0 to 1 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube1.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        ...
        Material.FrontProperties.Specular.Blue:=
          ((GetRValue(NewColor)+GetGValue(NewColor)
          +GetBValue(NewColor)+GetBValue(NewColor))
          /768);{0.626959;}
        Material.FrontProperties.Specular.Green:=
          ((GetRValue(NewColor)+GetGValue(NewColor)
          +GetGValue(NewColor)+GetBValue(NewColor))
          /768);{0.626959;}
        Material.FrontProperties.Specular.Red:=
          ((GetRValue(NewColor)+GetGValue(NewColor)
          +GetRValue(NewColor)+GetBValue(NewColor))
          /768);{0.727811;}
        Material.FrontProperties.Shininess:=76;
      end;
    end;
  2:for i:=0 to 7 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube2.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
  ...
  3:for i:=0 to 17 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube3.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
  ...
  4:for i:=0 to 31 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube4.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
  ...
  5:for i:=0 to 31 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube5.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
  ...
  6:for i:=0 to 31 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube6.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
  ...
  7:for i:=0 to 31 do begin {NotRealOne	XXX	2 8 18 32 32 32 32}
      with (DummyCube7.Children[i] as TGLSphere) do
      begin
        Material.FrontProperties.Ambient.Alpha:=0.55;
        Material.FrontProperties.Ambient.Blue:=
