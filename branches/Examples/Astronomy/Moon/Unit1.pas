...
uses
  ...
  GLScene, GLTerrainRenderer, GLObjects, GLHeightData, GLMaterial,
  GLCadencer, GLTexture, GLHUDObjects, GLBitmapFont,
  GLSkydome, GLWin32Viewer, GLVectorGeometry, GLMesh, GLVectorFileObjects,
  GLState, GLFireFX, GLCoordinates, GLCrossPlatform, GLBaseClasses,
  GLFile3DS;
...
{   if IsKeyDown(VK_SHIFT) then
  ...
  // with GLCamera1.Position do begin
         GLDummyCube1.Translate(GLfreeform1.direction.Z*speed,
                   -GLfreeform1.direction.y*speed,
                   -GLfreeform1.direction.X*speed);
...
begin
   case Key of
      'w', 'W' : with GLMaterialLibrary1.Materials[0].Material do
      begin
