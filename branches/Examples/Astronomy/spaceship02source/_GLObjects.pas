...
uses
  ...
  GLVectorGeometry, GLScene, GLTexture, OpenGL1x, GLContext,
  OpenGLTokens, GLColor, GLRenderContextInfo, GLCoordinates,
...
// DrawNode
//
procedure TGLLines.DrawNode(var rci : TGLRenderContextInfo; X, Y, Z: Single; Color: TGLColor);
begin
   glPushMatrix;
   glTranslatef(x, y, z);
   case NodesAspect of
