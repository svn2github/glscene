...
begin
  ...
  // testa se o botão do mouse clicado foi o esquerdo
  begin
  ...
  begin
    ...
    if Assigned(pickup) then
      ...
      begin
        ...
        if (pickup.Position.X = GLCube1.Position.X) and
          (pickup.Position.Y = GLCube1.Position.Y) and
          ((pickup.Position.Z = GLCube1.Position.Z + 1) or
          (pickup.Position.Z = GLCube1.Position.Z - 1)) then
        begin
          Ze := pickup.Position.Z;
          pickup.Position.Z := GLCube1.Position.Z;
          GLCube1.Position.Z := Ze;
        end;
        if (pickup.Position.Z = GLCube1.Position.Z) and
          (pickup.Position.Y = GLCube1.Position.Y) and
          ((pickup.Position.X = GLCube1.Position.X + 1) or
          (pickup.Position.X = GLCube1.Position.X - 1)) then
        begin
