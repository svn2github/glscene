...
uses
  ...
  GLBehaviours, Classes, Controls, GLVectorGeometry, SysUtils, GLWin32Viewer, tga, types, dialogs,
  GLSkydome, gltexture, GLCoordinates, GLCrossPlatform, GLBaseClasses,
  GLMaterial;
...
procedure TForm1.SSpriteProgress(Sender : TObject; const deltaTime,
  newTime : Double);
var
  life : Double;
...
begin
  with TGlSprite(Sender) do
    ...
    if life > 25 then
      ...
      begin Form1.GLParticles1.KillParticle(TGlSprite(Sender)) end
    ...
    // rather than reusing free particles from pool
      ...
      begin Material.FrontProperties.Diffuse.Alpha := (24 - life) / 24 end;
    end;
...
begin
  with GLSceneViewer1 do
    begin if PtInRect(ClientRect, ScreenToClient(MousePos)) then
      begin
