...
uses
  ...
  GLWin32Viewer, GLScene, GLObjects, GLMesh, GLTexture, GLVectorTypes,
  GLVectorGeometry, GLVectorFileObjects, GLMaterial, GLCoordinates,
  GLCrossPlatform, GLBaseClasses, GLColor;
...
begin
  ...
  lMeshObj := TMeshObject.CreateOwned(tarmesh.MeshObjects);
