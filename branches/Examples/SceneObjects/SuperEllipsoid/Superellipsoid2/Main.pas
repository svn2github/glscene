...
uses
  ...
  //GLS
  GLWin32Viewer, GLBaseClasses, GLScene, GLObjects, GLCoordinates,
  GLCrossPlatform, OpenGLTokens, GLState,
  GLGraph, GLGeomObjects, GLMesh, GLHUDObjects, GLBitmapFont, GLWindowsFont,
  GLVectorGeometry, GLColor, GLTexture;
