...
uses
  ...
  Vcl.Dialogs, Vcl.StdCtrls, Vcl.Imaging.Jpeg, Vcl.ExtCtrls, Vcl.Menus, Vcl.ExtDlgs,
  Vcl.ComCtrls,
  //GLS
  GLTexture, GLCadencer, GLWin32Viewer, GLScene, GLObjects,
  GLVectorGeometry, GLGeomObjects, GLCoordinates, GLCrossPlatform, GLBaseClasses,
