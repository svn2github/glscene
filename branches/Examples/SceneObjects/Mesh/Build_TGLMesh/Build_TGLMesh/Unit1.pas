...
uses
  ...
  //GLS
  GLScene, GLObjects, GLWin32Viewer, GLTexture, GLWaterPlane, GLCadencer,
  GLFile3DS, GLVectorTypes, GLVectorGeometry,  GLVectorFileObjects, GLVectorLists,
  GLGraph, GLMesh, GLGeomObjects, GLAsyncTimer, GLCelShader, GLOutlineShader,
  GLHiddenLineShader, GLCoordinates, GLCrossPlatform, GLBaseClasses;
...
var
  ...
  vert1, vert2, vert3, ad_vert4, ad_vert5: TGLvertexdata;
