...
type
  ...
  published
    ...
    property ArrowHeadHeight: TGLFloat read FArrowHeadHeight
...
begin // Shut up compuiler
  ...
  glVertex3f((FHeight - FArrowHeadHeight) * MultiplierX,
    (FHeight - FArrowHeadHeight) * MultiplierY, (FHeight - FArrowHeadHeight) *
    MultiplierZ);
  glEnd;
  ...
  gluCylinder(quadric, BottomRadius, 0, FArrowHeadHeight, { Slices } 8,
    { Stacks } 2);
