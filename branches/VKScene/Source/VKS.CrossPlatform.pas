...
type
  ...
  TVKMouseButton = (mbLeft, mbRight, mbMiddle); // idem TMouseButton;
  TVKMouseEvent = procedure(Sender: TObject; Button: TVKMouseButton;
    Shift: TShiftState; X, Y: Integer) of object;
  TVKMouseMoveEvent = TMouseMoveEvent;
  TVKKeyEvent = TKeyEvent;
  TVKKeyPressEvent = TKeyEvent; // instead of TKeyPressEvent;
...
procedure IntersectGLRect(var aRect: TVKRect; const rect2: TVKRect);
function PtInRect(const Rect: TVKRect; const P: TPoint): Boolean;
