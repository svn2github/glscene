...
function CompressedInternalFormatToVulkan(intFormat: TVKInternalFormat):
  Integer;
...
function GetUncompressedFormat(const intFormat: TVKInternalFormat;
  out internalFormat: TVKInternalFormat; out colorFormat: Cardinal): Boolean;

function DecodeTextureTarget(const TextureTarget: TVKTextureTarget): Cardinal;
function EncodeTextureTarget(const glTarget: Cardinal): TVKTextureTarget;
...
const
  ...
  cTextureFormatToVulkan: array[low(TVKInternalFormat)..high(TVKInternalFormat)] of TFormatDesc =
  (
...
function DecodeTextureTarget(const TextureTarget: TVKTextureTarget): Cardinal;
const
  cTargetToEnum: array[TVKTextureTarget] of Cardinal =
  (
    0,
    GL_TEXTURE_1D,
    GL_TEXTURE_2D,
