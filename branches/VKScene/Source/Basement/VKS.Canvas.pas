...
{: VKS.Canvas<p>
 ...
 <b>History : </b><font size=-1><ul>
      ...
      <li>04/04/10 - Yar - Fixes after VKS.State revision
      <li>07/11/09 - DaStr - Some cosmetic fixes. Overloaded TVKCanvas.EllipseBB(),
                             TVKCanvas.Ellipse(), TVKCanvas.FillEllipse()
      <li>31/07/07 - DaStr - Added missing StopPrimitive call to TVKCanvas.FillRect
                             (Bugtracker ID = 1775528)
      <li>06/06/07 - DaStr - Removed ConvertColorVector and ConvertWinColor (now in VKS.Color.pas)
                             Added VKS.Color to uses (BugtrackerID = 1732211)
                             Removed TColor declaration (now in VKS.CrossPlatform.pas)
      ...
      <li>08/07/04 - LR - Replace Graphics and TPoint by VKS.CrossPlatform for Linux
