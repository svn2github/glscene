...
{ : VKS.XCollection<p>
  ...
  TVKInterfacedPersistent (BugTracker ID = 1938988)
...
uses
  ...
  VKS.CrossPlatform, VKS.PersistentClasses
...
type
  ...
  TXCollectionItem = class(TVKInterfacedPersistent)
  private
