...
type
  ...
  TVKTextureNeededEvent = procedure(Sender: TObject; var textureFileName: string)
    of object;
  ...
  protected
    ...
    FOnTextureNeeded: TVKTextureNeededEvent;
    ...
    function GetTextureTarget: TVKTextureTarget; virtual;
    function GetHeight: Integer; virtual;
    function GetWidth: Integer; virtual;
    function GetDepth: Integer; virtual;
    property OnTextureNeeded: TVKTextureNeededEvent read FOnTextureNeeded write FOnTextureNeeded;
  public
  ...
  {Base class for image data classes internally based on a TVKPicture. }
  TVKPictureImage = class(TVKTextureImage)
  private
    FBitmap: TVKImage;
    FVKPicture: TVKPicture;
  ...
  {Stores any image compatible with Delphi's TVKPicture mechanism.
 ...
 TVKCubeMapTarget = Integer;
  ...
  public
    ...
    property Picture[index: TVKCubeMapTarget]: TVKPicture read GetPicture write SetPicture;
  published
  ...
  public
    constructor Create(AOwner: TPersistent); override;
    destructor Destroy; override;
    property OnTextureNeeded: TVKTextureNeededEvent read FOnTextureNeeded write
      FOnTextureNeeded;
    ...
    {Applies to TEXTURE1 }
    procedure ApplyAsTexture2(var rci: TVKRenderContextInfo; textureMatrix: PMatrix = nil);
    ...
    {Returns Vulkan texture format corresponding to current options. }
  ...
  published
    ...
    and neither TFiler nor TVKPicture allow proper use of the built-in
    ...
    property MagFilter: TVKMagFilter read FMagFilter write SetMagFilter default maLinear;
    {Texture minification filter. }
    property MinFilter: TVKMinFilter read FMinFilter write SetMinFilter default miLinearMipMapLinear;
    {Texture application mode. }
    property TextureMode: TVKTextureMode read FTextureMode write SetTextureMode default tmDecal;
    {Wrapping mode for the texture. }
    property TextureWrap: TVKTextureWrap read FTextureWrap write SetTextureWrap default twBoth;
  ...
  published
    ...
    property TextureOffset: TVKCoordinates read FTextureOffset write SetTextureOffset;
    property TextureScale: TVKCoordinates read FTextureScale write SetTextureScale;
  end;
...
//
function TVKTextureImage.GetTextureTarget: TVKTextureTarget;
begin
end;
...
function TVKTextureImage.GetWidth: Integer;
begin
  Result := 0;
end;

function TVKTextureImage.GetDepth: Integer;
begin
  Result := 0;
end;

procedure TVKTextureImage.SaveToFile(const FileName: String);
begin
end;

class function TVKTextureImage.FriendlyName: String;
begin
  Result := '';
end;

function TVKTextureImage.GetBitmap32: TVKImage;
begin
  Result := nil;
end;
...
begin
  ...
  begin
    FVKPicture := TVKPicture.Create(nil);
...
begin
  ...
  begin
    FPicture[i] := TVKPicture.Create(nil);
  ...
  try
    ...
    begin
      ...
      try
        ...
        FPicture[TVKCubeMapTarget(I)].Bitmap.OnChange := PictureChanged;
      end;
    end;
  finally
    LImage.Destroy;
...
procedure TVKCubeMapImage.SetPicture(index: TVKCubeMapTarget; const val: TVKPicture);
begin
...
begin
  if not Assigned(FMapSCoordinates) then
    FMapSCoordinates := TVKCoordinates4.CreateInitialized(Self, XHmgVector, csVector);
...
function TVKTexture.AllocateHandle: Cardinal;
var
...
function TVKTexture.GetHandle: Cardinal;
var
  target: Cardinal;
  LBinding: array[TVKTextureTarget] of Cardinal;
...
procedure TVKTexture.PrepareImage(target: Cardinal);
var
  bitmap32: TVKImage;
  texComp: TVKTextureCompression;
  glFormat: Cardinal;
...
procedure TVKTexture.PrepareParams(target: Cardinal);
const
