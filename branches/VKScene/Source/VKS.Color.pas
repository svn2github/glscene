...
// CreateInitialized
//
constructor TVKColor.CreateInitialized(AOwner: TPersistent;
  const Color: TColorVector; changeEvent: TNotifyEvent = nil);
begin
  Create(AOwner);
  Initialize(Color);
...
begin
  if Assigned(Source) and (Source is TVKColor) then
  begin
...
// AddColor
//
procedure TVKColorManager.AddColor(const aName: String;
