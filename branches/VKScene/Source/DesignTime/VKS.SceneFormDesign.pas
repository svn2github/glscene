...
type
  ...
  // TVKBaseSceneFormWizard
  //
  TVKBaseSceneFormWizard = class(
      TNotifierObject,
      IOTAWizard,
      IOTAFormWizard,
      IOTACreator,
  ...
  // TVKSimpleSceneFormWizard
  //

  TVKSimpleSceneFormWizard = class(TVKBaseSceneFormWizard)
  protected
  ...
  // TVKExtendedSceneFormWizard
  //

  TVKExtendedSceneFormWizard = class(TVKBaseSceneFormWizard)
  protected
    function GetIDString: string; override;
    function GetName: string; override;
    function NewFormFile(
  ...
  // TVKBaseSceneProjectCreator
  //

  TVKBaseSceneProjectCreator = class(
    TInterfacedObject,
    IOTACreator,
    IOTAProjectCreator,
  ...
  // TVKBaseSceneProjectWizard
  //

  TVKBaseSceneProjectWizard = class(
      TNotifierObject,
      IOTAWizard,
      IOTARepositoryWizard,
      IOTARepositoryWizard60,
  ...
  // TVKSimpleSceneProjectWizard
  //

  TVKSimpleSceneProjectWizard = class(TVKBaseSceneProjectWizard)
  public
    function GetIDString: string; override;
    function GetName: string; override;
  ...
  // TVKSimpleSceneProjectCreator
  //

  TVKSimpleSceneProjectCreator = class(TVKBaseSceneProjectCreator)
  public
  ...
  TVKExtendedSceneProjectWizard = class(TVKBaseSceneProjectWizard)
  public
    function GetIDString: string; override;
    function GetName: string; override;
    procedure Execute; override;
  ...
  TVKExtendedSceneProjectCreator = class(TVKBaseSceneProjectCreator)
  public
    procedure NewDefaultProjectModule(const Project: IOTAProject); override;
  end;
...
resourcestring
  ...
  rBaseProjectLocalizedDescription = 'Template of GLScene Base Application with TVKSceneForm';

  rSimpleProjectLocalizedName = 'GLScene Simple Application';
  rSimpleProjectLocalizedDescription = 'Template of GLScene Simple Application with TVKSceneForm';

  rExtendedProjectLocalizedName = 'GLScene Extended Application';
  rExtendedProjectLocalizedDescription = 'Template of GLScene Extended Application with TVKSceneForm';
...
const
  LineEnding = #10#13;
  sCategoryGLSceneNew = 'Embarcadero.RADStudio.GLScene.New';

procedure Register;
begin
  RegisterCustomModule(TVKSceneForm, TCustomModule);
  RegisterPackageWizard(TVKBaseSceneFormWizard.Create);
  RegisterPackageWizard(TVKSimpleSceneFormWizard.Create);
  RegisterPackageWizard(TVKExtendedSceneFormWizard.Create);
  RegisterPackageWizard(TVKBaseSceneProjectWizard.Create);
  RegisterPackageWizard(TVKSimpleSceneProjectWizard.Create);
  RegisterPackageWizard(TVKExtendedSceneProjectWizard.Create);
end;
...
const
  sSource =
    ...
    '  VKS.Scene, VKS.SceneForm;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
    '  T%1:s = class(TVKSceneForm)' + LineEnding +
    '  private' + LineEnding +
...
const
  sSource =
    ...
    'uses' + LineEnding +
    '  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,' + LineEnding +
    '  VKS.Scene, VKS.SceneForm, VKS.Cadencer;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
    '  T%1:s = class(TVKSceneForm)' + LineEnding +
    '    GLScene1: TVKScene;' + LineEnding +
    '    GLCadencer1: TVKCadencer;' + LineEnding +
    '    GLCamera1: TVKCamera;' + LineEnding +
    '    GLLightSource1: TVKLightSource;' + LineEnding +
    '    GLDummyCube1: TVKDummyCube;' + LineEnding +
    '    GLCube1: TVKCube;' + LineEnding +
...
const
  FormText =
    ...
    '  object GLScene1: TVKScene' + LineEnding   +
    '    Left = 24' + LineEnding   +
    '    Top = 24' + LineEnding   +
    '    object GLCamera1: TVKCamera' + LineEnding   +
    ...
    '      object GLLightSource1: TVKLightSource' + LineEnding   +
    '        ConstAttenuation = 1.000000000000000000' + LineEnding   +
    '        SpotCutOff = 180.000000000000000000' + LineEnding   +
    '      end' + LineEnding   +
    '    end' + LineEnding   +
    '    object GLDummyCube1: TVKDummyCube' + LineEnding   +
    '    end ' + LineEnding   +
    '    object GLCube1: TVKCube' + LineEnding   +
    ...
    '    end' + LineEnding   +
    '  end' + LineEnding   +
    '  object GLCadencer1: TVKCadencer' + LineEnding   +
...
const
  sSource =
    ...
    '  Dialogs, VKS.Scene, GLSceneForm, VKS.Cadencer, VKS.Material, VKS.Objects, ' + LineEnding +
    '  VKS.HUDObjects, VKS.WindowsFont, VKS.Skydome, VKS.GeomObjects, VKS.ShadowPlane,' + LineEnding +
    '  VKS.SceneViewer, VKS.BaseClasses, VKS.FilePNG;' + LineEnding +
    ...
    '    GLCamera1: TVKCamera;' + LineEnding +
    '    GLLightSource1: TVKLightSource;' + LineEnding +
    '    GLBackground: TVKDummyCube;' + LineEnding +
    '    GLWorld: TVKDummyCube;' + LineEnding +
    '    GLCameraTarget: TVKDummyCube;' + LineEnding +
    '    GLInterface: TVKDummyCube;' + LineEnding +
    '    GLCone1: TVKCone;' + LineEnding +
    '    ShadowObjects: TVKDummyCube;' + LineEnding +
    '    GLShadowPlane1: TVKShadowPlane;' + LineEnding +
    '    GLWorldObject1: TVKCube;' + LineEnding +
    '    GLWorldObject4: TVKCylinder;' + LineEnding +
    '    GLInterfaceSprite1: TVKHUDSprite;' + LineEnding +
    '    GLInterfaceText1: TVKHUDText;' + LineEnding +
    '    GLSkyDome1: TVKSkyDome;' + LineEnding +
    '    GLWorldObject3: TVKSphere;' + LineEnding +
    '    GLWindowsBitmapFont1: TVKWindowsBitmapFont;' + LineEnding +
    '    GLMaterialLibrary1: TVKMaterialLibrary;' + LineEnding +
    '    procedure GLCadencer1Progress(Sender: TObject; const deltaTime, newTime: Double);' + LineEnding +
    '  private' + LineEnding +
    '    { Private declarations }' + LineEnding +
    '  public' + LineEnding +
...
const
  FormText =
    ...
    '    Left = 72' + LineEnding +
    '    Top = 39' + LineEnding +
    '    object GLBackground: TVKDummyCube' + LineEnding +
    '      CubeSize = 1.000000000000000000' + LineEnding +
    '      object GLSkyDome1: TVKSkyDome' + LineEnding +
    ...
    '      end' + LineEnding +
    '    end' + LineEnding +
    '    object GLWorld: TVKDummyCube' + LineEnding +
    '      CubeSize = 1.000000000000000000' + LineEnding +
    '      object GLLightSource1: TVKLightSource' + LineEnding +
    '        ConstAttenuation = 1.000000000000000000' + LineEnding +
    ...
    '      end' + LineEnding +
    '      object GLCameraTarget: TVKDummyCube' + LineEnding +
    '        CubeSize = 1.000000000000000000' + LineEnding +
    '      end' + LineEnding +
    '      object ShadowObjects: TVKDummyCube' + LineEnding +
    '        CubeSize = 1.000000000000000000' + LineEnding +
    '        object GLWorldObject4: TVKCylinder' + LineEnding +
    ...
    '        end' + LineEnding +
    '        object GLWorldObject3: TVKSphere' + LineEnding +
    ...
    '        end' + LineEnding +
    '        object GLWorldObject1: TVKCube' + LineEnding +
    ...
    '        end' + LineEnding +
    '        object GLCone1: TVKCone' + LineEnding +
    ...
    '        end' + LineEnding +
    '      end' + LineEnding +
    '      object GLShadowPlane1: TVKShadowPlane' + LineEnding +
    '        Direction.Coordinates = {000000000000803F2EBD3BB300000000}' + LineEnding +
    '        PitchAngle = 90.000000000000000000' + LineEnding +
    ...
    '      end' + LineEnding +
    '    end' + LineEnding +
    '    object GLInterface: TVKDummyCube' + LineEnding +
    '      CubeSize = 1.000000000000000000' + LineEnding +
    '      object GLInterfaceText1: TVKHUDText' + LineEnding +
    ...
    '      end' + LineEnding +
    '      object GLInterfaceSprite1: TVKHUDSprite' + LineEnding +
    ...
    '    Top = 39' + LineEnding +
    '  end' + LineEnding +
    '  object GLMaterialLibrary1: TVKMaterialLibrary' + LineEnding +
    ...
    '    Top = 88' + LineEnding +
    '  end' + LineEnding +
    '  object GLWindowsBitmapFont1: TVKWindowsBitmapFont' + LineEnding +
    '    Font.Charset = DEFAULT_CHARSET' + LineEnding +
...
function TVKBaseSceneFormWizard.GetIDString: string;
begin
  Result := 'GLScene.GLBaseSceneForm';
end;

function TVKBaseSceneFormWizard.GetName: string;
begin
  Result := 'Base GLScene Form';
end;

function TVKBaseSceneFormWizard.GetState: TWizardState;
begin
  Result := [wsEnabled];
end;

procedure TVKBaseSceneFormWizard.Execute;
begin
...
constructor TVKBaseSceneFormWizard.CreateAndExecute(
...
function TVKBaseSceneFormWizard.GetDesigner: string;
begin
  Result := dVCL;
end;

function TVKBaseSceneFormWizard.GetGalleryCategory: IOTAGalleryCategory;
begin
  Result := vCategory;
end;

function TVKBaseSceneFormWizard.GetPersonality: string;
begin
  Result := ToolsAPI.sDelphiPersonality;
end;

function TVKBaseSceneFormWizard.GetGlyph: Cardinal;
begin
  Result := LoadIcon(hInstance, 'GLSCENEFORMGLYPH');
end;

function TVKBaseSceneFormWizard.GetPage: string;
begin
  Result := 'GLScene FMX';
end;

function TVKBaseSceneFormWizard.GetAuthor: string;
begin
  Result := 'YarUnderoaker';
end;

function TVKBaseSceneFormWizard.GetComment: string;
begin
  Result := 'Creates a new GLScene form.'
end;

function TVKBaseSceneFormWizard.GetCreatorType: string;
begin
  Result := sForm;
end;

function TVKBaseSceneFormWizard.GetExisting: Boolean;
begin
  Result := False;
end;

function TVKBaseSceneFormWizard.GetFileSystem: string;
begin
  Result := '';
end;

function TVKBaseSceneFormWizard.GetOwner: IOTAModule;
var
...
function TVKBaseSceneFormWizard.GetUnnamed: Boolean;
begin
  Result := True;
end;

function TVKBaseSceneFormWizard.GetAncestorName: string;
begin
  Result := 'GLSceneForm';
end;

function TVKBaseSceneFormWizard.GetImplFileName: string;
var
...
function TVKBaseSceneFormWizard.GetIntfFileName: string;
begin
  Result := '';
end;

function TVKBaseSceneFormWizard.GetFormName: string;
begin
  Result := FClassName;
end;

function TVKBaseSceneFormWizard.GetMainForm: Boolean;
begin
  Result := True;
end;

function TVKBaseSceneFormWizard.GetShowForm: Boolean;
begin
  Result := True;
end;

function TVKBaseSceneFormWizard.GetShowSource: Boolean;
begin
  Result := True;
end;

function TVKBaseSceneFormWizard.NewFormFile(const FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := TBaseFormFile.Create('', FormIdent, AncestorIdent);
end;

function TVKBaseSceneFormWizard.NewImplSource(const ModuleIdent, FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := TBaseUnitFile.Create(ModuleIdent, FormIdent, AncestorIdent);
end;

function TVKBaseSceneFormWizard.NewIntfSource(const ModuleIdent, FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := nil;
end;

procedure TVKBaseSceneFormWizard.FormCreated(const FormEditor: IOTAFormEditor);
var
...
function TVKSimpleSceneFormWizard.GetIDString: string;
begin
  Result := 'GLScene.GLSimpleSceneForm';
end;

function TVKSimpleSceneFormWizard.GetName: string;
begin
  Result := 'Simple GLScene Form';
end;

function TVKSimpleSceneFormWizard.NewFormFile(const FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := TSimpleFormFile.Create('', FormIdent, AncestorIdent);
end;

function TVKSimpleSceneFormWizard.NewImplSource(const ModuleIdent, FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := TSimpleUnitFile.Create(ModuleIdent, FormIdent, AncestorIdent);
end;

function TVKExtendedSceneFormWizard.GetIDString: string;
begin
  Result := 'GLScene.GLExtendedSceneForm';
end;

function TVKExtendedSceneFormWizard.GetName: string;
begin
  Result := 'Extended GLScene Form';
end;

function TVKExtendedSceneFormWizard.NewFormFile(const FormIdent,
  AncestorIdent: string): IOTAFile;
begin
  Result := TExtendedFormFile.Create('', FormIdent, AncestorIdent);
end;

function TVKExtendedSceneFormWizard.NewImplSource(const ModuleIdent, FormIdent,
  AncestorIdent: string): IOTAFile;
begin
...
function TVKBaseSceneProjectWizard.GetIDString: string;
begin
  Result := 'GLScene.GLBaseSceneProject';
end;

function TVKBaseSceneProjectWizard.GetName: string;
begin
  Result := 'Base GLScene Project';
end;

function TVKBaseSceneProjectWizard.GetState: TWizardState;
begin
  Result := [wsEnabled];
end;

procedure TVKBaseSceneProjectWizard.Execute;
var
...
begin
  ...
  (BorlandIDEServices as IOTAModuleServices).CreateModule(
    TVKBaseSceneProjectCreator.Create(LClassName, LUnitIdent, LFileName));
end;

function TVKBaseSceneProjectWizard.GetAuthor: string;
begin
  Result := 'YarUnderoaker';
end;

function TVKBaseSceneProjectWizard.GetComment: string;
begin
  Result := 'Creates a new GLScene project.'
end;

function TVKBaseSceneProjectWizard.GetPage: string;
begin
  Result := 'GLScene FMX';
end;

function TVKBaseSceneProjectWizard.GetGlyph: Cardinal;
begin
  Result := LoadIcon(hInstance, 'GLSCENEFORMGLYPH');
end;

function TVKBaseSceneProjectWizard.GetDesigner: string;
begin
  Result := ToolsAPI.dVCL;
end;

function TVKBaseSceneProjectWizard.GetGalleryCategory: IOTAGalleryCategory;
begin
  Result := vCategory;
end;

function TVKBaseSceneProjectWizard.GetPersonality: string;
begin
  Result := ToolsAPI.sDelphiPersonality;
end;
...
constructor TVKBaseSceneProjectCreator.Create(
...
function TVKBaseSceneProjectCreator.GetCreatorType: string;
begin
  Result := ToolsAPI.sApplication;
end;

function TVKBaseSceneProjectCreator.GetOwner: IOTAModule;
begin
  Result := GetActiveProjectGroup;
end;

function TVKBaseSceneProjectCreator.GetExisting: Boolean;
begin
  Result := False;
end;

function TVKBaseSceneProjectCreator.GetFileSystem: string;
begin
  Result := '';
end;

function TVKBaseSceneProjectCreator.GetUnnamed: Boolean;
begin
  Result := True;
end;

function TVKBaseSceneProjectCreator.GetFileName: string;
var
  i: Integer;
  j: Integer;
...
function TVKBaseSceneProjectCreator.GetOptionFileName: string;
begin
  Result := '';
end;

function TVKBaseSceneProjectCreator.GetShowSource: Boolean;
begin
  Result := False;
end;

procedure TVKBaseSceneProjectCreator.NewDefaultModule;
begin
end;

procedure TVKBaseSceneProjectCreator.NewDefaultProjectModule(const Project: IOTAProject);
begin
  with (BorlandIDEServices as IOTAModuleServices) do
    CreateModule(TVKBaseSceneFormWizard.CreateAndExecute(
    FUnitIdent,
    FClassName,
    FFileName));
end;

function TVKBaseSceneProjectCreator.NewOptionSource(const ProjectName: string): IOTAFile;
begin
  Result := nil;
end;

procedure TVKBaseSceneProjectCreator.NewProjectResource(const Project: IOTAProject);
begin
end;

function TVKBaseSceneProjectCreator.NewProjectSource(const ProjectName: string): IOTAFile;
begin
...
function TVKSimpleSceneProjectWizard.GetIDString: string;
begin
  Result := 'GLScene.GLSimpleSceneProject';
end;

function TVKSimpleSceneProjectWizard.GetName: string;
begin
  Result := 'Simple GLScene Project';
end;

procedure TVKSimpleSceneProjectWizard.Execute;
var
  LUnitIdent, LClassName, LFileName: string;
begin
  LUnitIdent := '';
  ...
  (BorlandIDEServices as IOTAModuleServices).GetNewModuleAndClassName(
    'Unit', LUnitIdent, LClassName, LFileName);
  (BorlandIDEServices as IOTAModuleServices).CreateModule(
    TVKSimpleSceneProjectCreator.Create(LClassName, LUnitIdent, LFileName));
end;
...
procedure TVKSimpleSceneProjectCreator.NewDefaultProjectModule(const Project: IOTAProject);
begin
  with (BorlandIDEServices as IOTAModuleServices) do
    CreateModule(TVKSimpleSceneFormWizard.CreateAndExecute(
    FUnitIdent,
    FClassName,
    FFileName));
end;
...
// ------------------
// ------------------ TVKExtendedSceneProjectWizard ------------------
// ------------------

function TVKExtendedSceneProjectWizard.GetIDString: string;
begin
  Result := 'GLScene.GLExtendedSceneProject';
end;

function TVKExtendedSceneProjectWizard.GetName: string;
begin
  Result := 'Extended GLScene Project';
end;

procedure TVKExtendedSceneProjectWizard.Execute;
var
  LUnitIdent, LClassName, LFileName: string;
begin
  LUnitIdent := '';
  ...
  (BorlandIDEServices as IOTAModuleServices).GetNewModuleAndClassName(
    'Unit', LUnitIdent, LClassName, LFileName);
  (BorlandIDEServices as IOTAModuleServices).CreateModule(
    TVKExtendedSceneProjectCreator.Create(LClassName, LUnitIdent, LFileName));
end;

// ------------------
// ------------------ TVKExtendedSceneProjectCreator ------------------
// ------------------

procedure TVKExtendedSceneProjectCreator.NewDefaultProjectModule(const Project: IOTAProject);
begin
  with (BorlandIDEServices as IOTAModuleServices) do
    CreateModule(TVKExtendedSceneFormWizard.CreateAndExecute(
    FUnitIdent,
    FClassName,
    FFileName));
end;
