...
uses
  ...
  Winapi.OpenGL, Winapi.OpenGLext,  VKS.Context, VKS.CrossPlatform, VKS.VectorGeometry,
  VKS.Scene, VKS.VectorFileObjects, VKS.VectorLists, VKS.XCollection,
  VKS.GeomObjects, VKS.Navigator, VKS.RenderContextInfo, VKS.BaseClasses,
  VKS.Manager, VKS.State;
