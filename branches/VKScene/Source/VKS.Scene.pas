...
uses
  ...
  //VKS
  VKS.OpenGLTokens, VKS.Context, VKS.VectorGeometry, VKS.XCollection, 
  VKS.Silhouette, VKS.PersistentClasses, VKS.State, VKS.Graphics, 
  VKS.GeometryBB, VKS.CrossPlatform, VKS.VectorLists, VKS.Texture, 
  VKS.Color, VKS.BaseClasses, VKS.Coordinates, VKS.RenderContextInfo, 
  VKS.Material, VKS.TextureFormat, VKS.Selection, VKS.Strings, 
  VKS.XOpenGL, VKS.VectorTypes, VKS.ApplicationFileIO, VKS.Utils, VKS.Log;
