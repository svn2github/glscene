...
// (instead of degrees). Use RadianToDeg or DegToRadian to convert between them.
//
...
function TexPointMake(const s, t : Single) : TTexPoint; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function AffineVectorMake(const x, y, z : Single) : TAffineVector; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function AffineVectorMake(const v : TVector) : TAffineVector; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetAffineVector(out v : TAffineVector; const x, y, z : Single); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TAffineVector; const x, y, z : Single); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TAffineVector; const vSrc : TVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TAffineVector; const vSrc : TAffineVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TAffineDblVector; const vSrc : TAffineVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TAffineDblVector; const vSrc : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorMake(const v : TAffineVector; w : Single = 0) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorMake(const x, y, z: Single; w : Single = 0) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function PointMake(const x, y, z: Single) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function PointMake(const v : TAffineVector) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function PointMake(const v : TVector) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TVector; const x, y, z : Single; w : Single = 0); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TVector; const av : TAffineVector; w : Single = 0); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure SetVector(out v : TVector; const vSrc : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakePoint(out v : TVector; const x, y, z: Single); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakePoint(out v : TVector; const av : TAffineVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakePoint(out v : TVector; const av : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakeVector(out v : TAffineVector; const x, y, z: Single); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakeVector(out v : TVector; const x, y, z: Single); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakeVector(out v : TVector; const av : TAffineVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure MakeVector(out v : TVector; const av : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure RstVector(var v : TAffineVector); overload; {$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}
procedure RstVector(var v : TVector); overload; {$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}

//2
function VectorEquals(const Vector1, Vector2: TVector2f): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const Vector1, Vector2: TVector2i): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector2d): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector2s): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector2b): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

//3
//function VectorEquals(const V1, V2: TVector3f): Boolean; overload; //declared further
function VectorEquals(const V1, V2: TVector3i): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector3d): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector3s): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector3b): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

//4
//function VectorEquals(const V1, V2: TVector4f): Boolean; overload; //declared further
function VectorEquals(const V1, V2: TVector4i): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector4d): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector4s): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorEquals(const V1, V2: TVector4b): Boolean; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
function MatrixEquals(const Matrix1, Matrix2: TMatrix4b): Boolean; overload;
  ...
  //2x
function Vector2fMake(const X, Y: Single): TVector2f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2iMake(const X, Y: Longint): TVector2i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2sMake(const X, Y: Smallint): TVector2s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2dMake(const X, Y: Double): TVector2d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2bMake(const X, Y: Byte): TVector2b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector2fMake(const Vector: TVector3f): TVector2f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2iMake(const Vector: TVector3i): TVector2i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2sMake(const Vector: TVector3s): TVector2s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2dMake(const Vector: TVector3d): TVector2d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2bMake(const Vector: TVector3b): TVector2b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector2fMake(const Vector: TVector4f): TVector2f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2iMake(const Vector: TVector4i): TVector2i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2sMake(const Vector: TVector4s): TVector2s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2dMake(const Vector: TVector4d): TVector2d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector2bMake(const Vector: TVector4b): TVector2b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

  //3x
function Vector3fMake(const X: Single;   const Y: Single = 0;   const Z: Single = 0): TVector3f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3iMake(const X: Longint;  const Y: Longint = 0;  const Z: Longint = 0): TVector3i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3sMake(const X: Smallint; const Y: Smallint = 0; const Z: Smallint = 0): TVector3s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3dMake(const X: Double;   const Y: Double = 0;   const Z: Double = 0): TVector3d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3bMake(const X: Byte;     const Y: Byte = 0;     const Z: Byte = 0): TVector3b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector3fMake(const Vector: TVector2f; const Z: Single = 0): TVector3f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3iMake(const Vector: TVector2i; const Z: Longint = 0): TVector3i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3sMake(const Vector: TVector2s; const Z: Smallint = 0): TVector3s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3dMake(const Vector: TVector2d; const Z: Double = 0): TVector3d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3bMake(const Vector: TVector2b; const Z: Byte = 0): TVector3b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector3fMake(const Vector: TVector4f): TVector3f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3iMake(const Vector: TVector4i): TVector3i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3sMake(const Vector: TVector4s): TVector3s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3dMake(const Vector: TVector4d): TVector3d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector3bMake(const Vector: TVector4b): TVector3b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

  //4x
function Vector4fMake(const X: Single;   const Y: Single = 0;   const Z: Single = 0;   const W: Single = 0): TVector4f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4iMake(const X: Longint;  const Y: Longint = 0;  const Z: Longint = 0;  const W: Longint = 0): TVector4i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4sMake(const X: Smallint; const Y: Smallint = 0; const Z: Smallint = 0; const W: Smallint = 0): TVector4s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4dMake(const X: Double;   const Y: Double = 0;   const Z: Double = 0;   const W: Double = 0): TVector4d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4bMake(const X: Byte;     const Y: Byte = 0;     const Z: Byte = 0;     const W: Byte = 0): TVector4b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector4fMake(const Vector: TVector3f; const W: Single = 0): TVector4f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4iMake(const Vector: TVector3i; const W: Longint = 0): TVector4i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4sMake(const Vector: TVector3s; const W: Smallint = 0): TVector4s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4dMake(const Vector: TVector3d; const W: Double = 0): TVector4d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4bMake(const Vector: TVector3b; const W: Byte = 0): TVector4b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function Vector4fMake(const Vector: TVector2f; const Z: Single = 0;   const W: Single = 0): TVector4f; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4iMake(const Vector: TVector2i; const Z: Longint = 0;  const W: Longint = 0): TVector4i; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4sMake(const Vector: TVector2s; const Z: Smallint = 0; const W: Smallint = 0): TVector4s; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4dMake(const Vector: TVector2d; const Z: Double = 0;   const W: Double = 0): TVector4d; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function Vector4bMake(const Vector: TVector2b; const Z: Byte = 0;     const W: Byte = 0): TVector4b; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
function VectorAdd(const v : TAffineVector; const f : Single) : TAffineVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Sums up f to each component of the vector
function VectorAdd(const v : TVector; const f : Single) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
//: Sums up f to each component of the vector
procedure AddVector(var v : TAffineVector; const f : Single); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Sums up f to each component of the vector
procedure AddVector(var v : TVector; const f : Single); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

//: Adds V2 to V1, result is placed in V1. W coordinate is always 1.
procedure AddPoint(var v1 : TVector; const v2 : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

//: Returns the sum of two homogeneous vectors. W coordinate is always 1.
function PointAdd(var v1 : TVector; const v2 : TVector): TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
function VectorSubtract(const v1 : TAffineVector; delta : Single) : TAffineVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorSubtract(const v1 : TVector; delta : Single) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Subtracts V2 from V1, result is placed in V1
...
function TexPointCombine(const t1, t2 : TTexPoint; f1, f2 : Single) : TTexPoint;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of two vectors and return the result
function VectorCombine(const V1, V2: TAffineVector; const F1, F2: Single): TAffineVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of three vectors and return the result
function VectorCombine3(const V1, V2, V3: TAffineVector; const F1, F2, F3: Single): TAffineVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure VectorCombine3(const V1, V2, V3: TAffineVector; const F1, F2, F3: Single; var vr : TAffineVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
//: Makes a linear combination of two vectors and return the result
function VectorCombine(const V1, V2: TVector; const F1, F2: Single): TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of two vectors and return the result
function VectorCombine(const V1 : TVector; const V2: TAffineVector; const F1, F2: Single): TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of two vectors and place result in vr
procedure VectorCombine(const V1 : TVector; const V2: TAffineVector; const F1, F2: Single; var vr : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of two vectors and place result in vr
...
//: Makes a linear combination of three vectors and return the result
function VectorCombine3(const V1, V2, V3: TVector; const F1, F2, F3: Single): TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Makes a linear combination of three vectors and return the result
...
function Lerp(const start, stop, t : Single) : Single;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Calculates angular interpolation between start and stop at point t
function AngleLerp(start, stop, t : Single) : Single;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
function TexPointLerp(const t1, t2 : TTexPoint; t : Single) : TTexPoint; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
//: Calculates linear interpolation between vector1 and vector2 at point t
function VectorLerp(const v1, v2 : TVector; t : Single) : TVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Calculates linear interpolation between vector1 and vector2 at point t, places result in vr
procedure VectorLerp(const v1, v2 : TVector; t : Single; var vr : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
procedure DivideVector(var v : TVector; const divider : TVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
procedure DivideVector(var v : TAffineVector; const divider : TAffineVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

function VectorDivide(const v: TVector; const divider : TVector): TVector; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function VectorDivide(const v: TAffineVector; const divider : TAffineVector): TAffineVector; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}

//: True if all components are equal.
function TexpointEquals(const p1, p2: TTexpoint): Boolean; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: True if all components are equal.
function RectEquals(const Rect1, Rect2: TRect): Boolean; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: True if all components are equal.
function VectorEquals(const V1, V2: TVector) : Boolean; overload; {$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}
//: True if all components are equal.
function VectorEquals(const V1, V2: TAffineVector) : Boolean; overload; {$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}
//: True if X, Y and Z components are equal.
function AffineVectorEquals(const V1, V2: TVector) : Boolean; overload; {$IFDEF VKS_INLINE_VICE_ASM_VICE_ASM}inline;{$ENDIF}
//: True if x=y=z=0, w ignored
function VectorIsNull(const v : TVector) : Boolean; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: True if x=y=z=0, w ignored
function VectorIsNull(const v : TAffineVector) : Boolean; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
procedure AbsVector(var v : TVector); overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Vector components are replaced by their Abs() value. }
procedure AbsVector(var v : TAffineVector); overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Returns a vector with components replaced by their Abs value. }
function VectorAbs(const v : TVector) : TVector; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
//: Returns a vector with components replaced by their Abs value. }
function VectorAbs(const v : TAffineVector) : TAffineVector; overload;{$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
{$IFDEF VKS_PLATFORM_HAS_EXTENDED}
...
{$ENDIF VKS_PLATFORM_HAS_EXTENDED}
...
function ClampInteger(const value, min, max : Integer) : Integer; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
function ClampInteger(const value, min, max : Cardinal) : Cardinal; overload; {$IFDEF VKS_INLINE_VICE_ASM}inline;{$ENDIF}
...
{$else}
begin
   Result:=Abs(v2.X-v1.X)+Abs(v2.Y-v1.Y)+Abs(v2.Z-v1.Z)+Abs(v2.W-v1.W);
{$endif}
end;
...
begin
   dest.X.X:=src.X.X; dest.X.Y:=src.X.Y; dest.X.Z:=src.X.Z;
   dest.Y.X:=src.Y.X; dest.Y.Y:=src.Y.Y; dest.Y.Z:=src.Y.Z;
   dest.Z.X:=src.Z.X; dest.Z.Y:=src.Z.Y; dest.Z.Z:=src.Z.Z;
end;
...
begin
   dest.X.X:=src.X.X; dest.X.Y:=src.X.Y; dest.X.Z:=src.X.Z; dest.X.W:=0;
   dest.Y.X:=src.Y.X; dest.Y.Y:=src.Y.Y; dest.Y.Z:=src.Y.Z; dest.Y.W:=0;
   dest.Z.X:=src.Z.X; dest.Z.Y:=src.Z.Y; dest.Z.Z:=src.Z.Z; dest.Z.W:=0;
   dest.W.X:=0;              dest.W.Y:=0;              dest.W.Z:=0;              dest.W.W:=1;
end;
...
procedure NormalizeMatrix(var M : TMatrix);
begin
   M.X.W:=0; NormalizeVector(M.X);
   M.Y.W:=0; NormalizeVector(M.Y);
...
var
   f : Single;
begin
   f:=M.X.Y; M.X.Y:=M.Y.X; M.Y.X:=f;
   f:=M.X.Z; M.X.Z:=M.Z.X; M.Z.X:=f;
   f:=M.Y.Z; M.Y.Z:=M.Z.Y; M.Z.Y:=f;
end;
...
begin
   f:=M.X.Y; M.X.Y:=M.Y.X; M.Y.X:=f;
   f:=M.X.Z; M.X.Z:=M.Z.X; M.Z.X:=f;
   f:=M.X.W; M.X.W:=M.W.X; M.W.X:=f;
   f:=M.Y.Z; M.Y.Z:=M.Z.Y; M.Z.Y:=f;
   f:=M.Y.W; M.Y.W:=M.W.Y; M.W.Y:=f;
   f:=M.Z.W; M.Z.W:=M.W.Z; M.W.Z:=f;
end;
...
begin
   ...
   Result.W.X:=-( Result.X.X*mat.W.X
                   +Result.Y.X*mat.W.Y
                   +Result.Z.X*mat.W.Z);
   Result.W.Y:=-( Result.X.Y*mat.W.X
                   +Result.Y.Y*mat.W.Y
                   +Result.Z.Y*mat.W.Z);
   Result.W.Z:=-( Result.X.Z*mat.W.X
                   +Result.Y.Z*mat.W.Y
                   +Result.Z.Z*mat.W.Z);
end;
...
begin
  ...
  Result := CreateTranslationMatrix(AffineVectorMake(
    (viewport.Z - 2 * (x - viewport.X)) / deltax,
	  (viewport.W - 2 * (y - viewport.Y)) / deltay,
    0.0));
...
var
   n : Single;
begin
   n:=RSqrt(plane.X*plane.X+plane.Y*plane.Y+plane.Z*plane.Z);
   ScaleVector(plane, n);
end;
...
begin
  ...
  {$else}
    det := Abs((linePt1.X - linePt0.X) * (lineDir0.Y*lineDir1.Z - lineDir1.Y*lineDir0.Z) -
               (linePt1.Y - linePt0.Y) * (lineDir0.X*lineDir1.Z - lineDir1.X*lineDir0.Z) +
               (linePt1.Z - linePt0.Z) * (lineDir0.X*lineDir1.Y - lineDir1.X*lineDir0.Y));
  {$endif}
  if det < cBIAS then
...
begin
   n:=Length(Imag);
   if n>=1 then Result.ImagPart.X:=Imag[0];
   if n>=2 then Result.ImagPart.Y:=Imag[1];
   if n>=3 then Result.ImagPart.Z:=Imag[2];
...
begin
   ...
   if traceMat>EPSILON2 then begin
   ...
   end else if (mat.X.X>mat.Y.Y) and (mat.X.X>mat.Z.Z) then begin  // Row 0:
      s:=Sqrt(MaxFloat(EPSILON2, cOne+mat.X.X-mat.Y.Y-mat.Z.Z))*2;
      invS:=1/s;
   ...
   end else if (mat.Y.Y>mat.Z.Z) then begin  // Row 1:
      s:=Sqrt(MaxFloat(EPSILON2, cOne+mat.Y.Y-mat.X.X-mat.Z.Z))*2;
      invS:=1/s;
      ...
      s:=Sqrt(MaxFloat(EPSILON2, cOne+mat.Z.Z-mat.X.X-mat.Y.Y))*2;
      invS:=1/s;
...
function IsInCube(const p, d : TAffineVector) : Boolean; overload;
begin
   Result:=    ((p.X>=-d.X) and (p.X<=d.X))
           and ((p.Y>=-d.Y) and (p.Y<=d.Y))
           and ((p.Z>=-d.Z) and (p.Z<=d.Z));
end;
...
begin
   if v1.X>v.X then v.X:=v1.X;
   if v1.Y>v.Y then v.Y:=v1.Y;
   if v1.Z>v.Z then v.Z:=v1.Z;
   if v1.W>v.W then v.W:=v1.W;
end;
...
begin
  Result:=MatrixMultiply(Matrix, CreateRotationMatrix(AffineVectorMake(Matrix.Y.X, Matrix.Y.Y, Matrix.Y.Z), Angle));
end;
...
begin
  Result:=MatrixMultiply(Matrix, CreateRotationMatrix(AffineVectorMake(Matrix.X.X, Matrix.X.Y, Matrix.X.Z), Angle));
end;
...
begin
   Result:=MatrixMultiply(Matrix, CreateRotationMatrix(AffineVectorMake(Matrix.Z.X, Matrix.Z.Y, Matrix.Z.Z), Angle));
end;
