...
uses
  ...
  //VKS
  VKS.VectorGeometry, VKS.VectorTypes, VKS.Texture, VKS.Cadencer, Winapi.OpenGL, Winapi.OpenGLext,  VKS.Scene,
...
procedure TVKGeometryProgram.SetVerticesOut(const Value: GLint);
begin
