...
{: VKS.MeshUtils.<p>
   ...
   General utilities for mesh manipulations.<p>
	...
	<b>History : </b><font size=-1><ul>
      <li>10/12/14 - PW - Renamed MeshUtils unit to VKS.MeshUtils
...
uses
  ...
  VKS.PersistentClasses, VKS.VectorLists, VKS.VectorGeometry, VKS.VectorTypes,
  VKS.CrossPlatform;
...
begin
  ...
  boundaryList[b0].maxSqArea := VKS.MeshUtils.polygonArea(b0);
...
begin
  ...
  begin
    ...
    boundaryList[0].maxSqArea := VKS.MeshUtils.polygonArea(0);
    maxMaxSqArea := boundaryList[0].maxSqArea;

    for i := 1 to count - 1 do
    begin
      boundaryList[i].maxSqArea := VKS.MeshUtils.polygonArea(i);
