...
uses
  ...
  VKS.VectorGeometry, VKS.HeightData, VKS.VectorLists, VKS.CrossPlatform,
  VKS.Context, VKS.OpenGLTokens, VKS.XOpenGL;
...
type
  ...
  private
    ...
    FListHandle: TVKListHandle;
    FTag: Integer;
    FObserverPosition: TAffineVector;
    FNorth, FSouth, FWest, FEast: TVKROAMPatch; // neighbours
    FHighRes: Boolean;
    FMaxDepth: Integer;
...
var
  ...
  FVBOIndicesHandle: TVKVBOElementArrayHandle;
...
// SetHeightData
//
procedure TVKROAMPatch.SetHeightData(val: THeightData);
begin
  FHeightData := val;
...
// ConnectToTheNorth
//
procedure TVKROAMPatch.ConnectToTheNorth(northPatch: TVKROAMPatch);
begin
...
// ComputeVariance
//
procedure TVKROAMPatch.ComputeVariance(variance: Integer);
var
...
// ResetTessellation
//
procedure TVKROAMPatch.ResetTessellation;
begin
...
function TVKROAMPatch.Tesselate: boolean;
...
function TVKROAMPatch.SafeTesselate: boolean;
var
  Fail: boolean;
begin
  Result := False;
...
// RenderAccum
//
procedure TVKROAMPatch.RenderAccum(vertices: TAffineVectorList;
  vertexIndices: TIntegerList; texCoords: TTexPointList;
  autoFlushVertexCount: Integer);
var
...
// FlushAccum
//
class procedure TVKROAMPatch.FlushAccum(vertices: TAffineVectorList;
  vertexIndices: TIntegerList; texCoords: TTexPointList);
begin
...
procedure TVKROAMPatch.RenderROAM(vertices: TAffineVectorList;
  vertexIndices: TIntegerList; texCoords: TTexPointList);
...
// RenderAsStrips
//
procedure TVKROAMPatch.RenderAsStrips(vertices: TAffineVectorList;
  vertexIndices: TIntegerList; texCoords: TTexPointList);
...
FVBOVertHandle := TVKVBOArrayBufferHandle.Create;
FVBOTexHandle := TVKVBOArrayBufferHandle.Create;
FVBOIndicesHandle := TVKVBOElementArrayHandle.Create;
