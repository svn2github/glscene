...
{: VKS.VectorGeometry<p>
   ...
   all Intel processors after Pentium should be immune to this.<p>
	...
	<b>History : </b><font size=-1><ul>
      <li>10/12/14 - PW - Renamed "VectorGeometry.pas" to "VKS.VectorGeometry.pas"
...
type
  TVKInterpolationType = (itLinear, itPower, itSin, itSinAlt, itTan, itLn, itExp);
...
function InterpolateCombinedSafe(const OriginalStart, OriginalStop, OriginalCurrent: Single; const TargetStart, TargetStop: Single; const DistortionDegree: Single; const InterpolationType: TVKInterpolationType): Single;
function InterpolateCombinedFast(const OriginalStart, OriginalStop, OriginalCurrent: Single; const TargetStart, TargetStop: Single; const DistortionDegree: Single; const InterpolationType: TVKInterpolationType): Single;
function InterpolateCombined(const Start, Stop, Delta: Single; const DistortionDegree: Single; const InterpolationType: TVKInterpolationType): Single;
