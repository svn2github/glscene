...
uses 
  ...
  VKS.VectorGeometry, VKS.VectorLists, VKS.CrossPlatform;

type
   // TVKSilhouetteStyle
   //
   TVKSilhouetteStyle = (ssOmni, ssParallel);
   ...
   TVKSilhouette = class
      ...
      public
         ...
         property Parameters : TVKSilhouetteParameters read FParameters write FParameters;
   ...
   TBaseConnectivity = class
       ...
       public
          ...
          procedure CreateSilhouette(const ASilhouetteParameters : TVKSilhouetteParameters; var ASilhouette : TVKSilhouette; AddToSilhouette : boolean); virtual;
...
// Create
//
constructor TVKSilhouette.Create;
begin
   inherited;
...
// Destroy
//
destructor TVKSilhouette.Destroy;
begin
   FCapIndices.Free;
   FIndices.Free;
   FVertices.Free;
...
// SetIndices
//
procedure TVKSilhouette.SetIndices(const value : TIntegerList);
begin
...
// SetCapIndices
//
procedure TVKSilhouette.SetCapIndices(const value : TIntegerList);
begin
...
// SetVertices
//
procedure TVKSilhouette.SetVertices(const value : TVectorList);
begin
...
//
procedure TVKSilhouette.ExtrudeVerticesToInfinity(const origin : TAffineVector);
var
...
// AddEdgeToSilhouette
//
procedure TVKSilhouette.AddEdgeToSilhouette(const v0, v1 : TAffineVector;
                                            tightButSlow : Boolean);
begin
...
//
procedure TVKSilhouette.AddIndexedEdgeToSilhouette(const Vi0, Vi1 : integer);
...
// AddCapToSilhouette
//
procedure TVKSilhouette.AddCapToSilhouette(const v0, v1, v2 : TAffineVector;
                                           tightButSlow : Boolean);
begin
   if tightButSlow then
...
//
procedure TVKSilhouette.AddIndexedCapToSilhouette(const vi0, vi1, vi2 : Integer);
begin
...
procedure TBaseConnectivity.CreateSilhouette(const ASilhouetteParameters : TVKSilhouetteParameters; var ASilhouette : TVKSilhouette; AddToSilhouette : boolean);
begin
  // Purely virtual!
end;
...
procedure TConnectivity.CreateSilhouette(
            const silhouetteParameters : TVKSilhouetteParameters;
            var aSilhouette : TVKSilhouette; addToSilhouette : boolean);
var
   i : Integer;
   vis : PIntegerArray;
   tVi0, tVi1 : Integer;
...
function TConnectivity.ReuseOrFindVertexID(
     const seenFrom : TAffineVector; aSilhouette : TVKSilhouette; index : Integer) : Integer;
var
   pMemIndex : PInteger;
   memIndex, i : Integer;
   oldCount : Integer;
