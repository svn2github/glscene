...
constructor TVKWindowsBitmapFont.Create(AOwner: TComponent);
begin
  inherited;
  FFont := TFont.Create;
...
destructor TVKWindowsBitmapFont.Destroy;
begin
  FFont.Free;
  Ranges.Clear; 
  inherited;
...
function TVKWindowsBitmapFont.FontTextureWidth: Integer;
begin
...
function TVKWindowsBitmapFont.FontTextureHeight: Integer;
begin
...
procedure TVKWindowsBitmapFont.SetFont(value: TFont);
begin
  FFont.Assign(value);
end;
...
procedure TVKWindowsBitmapFont.NotifyChange(Sender: TObject);
begin
  StreamlineRanges;
  FreeTextureHandle;
  InvalidateUsers;
...
function TVKWindowsBitmapFont.StoreRanges: Boolean;
begin
...
procedure TVKWindowsBitmapFont.SetList(const AList: TIntegerList);
var
  i : integer;
  f, n, s : integer;
begin
...
procedure TVKWindowsBitmapFont.EnsureChars(const AStart, AEnd: widechar);
var
  c : WideChar;
...
//add characters to internal list
procedure TVKWindowsBitmapFont.EnsureString(const s: String);
var
  i : Integer;
  ACharList : TIntegerList;
begin
...
function TVKWindowsBitmapFont.TextureFormat: Integer;
begin
  Result := GL_ALPHA;
end;
...
initialization
  ...
  Win32PlatformIsUnicode := (Win32Platform = VER_PLATFORM_WIN32_NT);
   ...
   // class registrations
  RegisterClasses([TVKWindowsBitmapFont]);
