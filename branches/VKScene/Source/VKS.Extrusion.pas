...
{: VKS.Extrusion<p>
 ...
 <b>Historique : </b><font size=-1><ul>
      ...
      <li>31/07/07 - DanB - Implemented AxisAlignedDimensionsUnscaled for
                            TVKRevolutionSolid & TVKExtrusionSolid
      <li>06/06/07 - DaStr - Added VKS.Color to uses (BugtrackerID = 1732211)
      <li>30/03/07 - DaStr - Added $I GLScene.inc
      <li>14/03/07 - DaStr - Added explicit pointer dereferencing
                             (thanks Burkhard Carstens) (Bugtracker ID = 1678644)
      <li>02/01/06 - LC - Fixed TVKExtrusionSolid texuring. Bugtracker ID=1619318
      <li>02/08/04 - LR, YHC - BCB corrections: use record instead array
      <li>02/11/01 - Egg - TVKPipe.BuildList now has a "persistent" cache
      <li>25/11/01 - Egg - TVKPipe nodes can now be colored
      <li>19/07/01 - Egg - Fix in TVKRevolutionSolid due to RotateAround change
      <li>29/03/01 - Uwe - Added a TVKExtrusionSolid based on TMultiPolygonBase,
                           Fixes in TVKRevolutionSolid
...
uses
  System.Classes,
  VKS.OpenGLTokens,  VKS.Context,  VKS.Objects,  VKS.Scene, VKS.MultiPolygon,
...
type
  ...
  { Extrudes a complex Polygon into Z direction.<p>
    ...
    Stacks, Normals and NormalDirection are equivalent to TVKRevolutionSolid.<p>
...
procedure TVKRevolutionSolid.BuildList(var rci: TRenderContextInfo);
var
...
procedure TVKPipe.BuildList(var rci: TRenderContextInfo);
type
  TNodeData = record
    pos: TAffineVector;
  ...
  PRowData = ^TRowData;
const
  cPNCMtoEnum: array[pncmEmission..pncmAmbientAndDiffuse] of TVKEnum =
...
begin
  ...
  begin
    ...
    GetMem(ra, SizeOf(TVKFloat) * Nodes.Count);
    for i := 0 to Nodes.Count - 1 do
...
procedure TVKExtrusionSolid.BuildList(var rci: TRenderContextInfo);
var
...
procedure TVKExtrusionSolid.SetHeight(const Value: TVKFloat);
begin
