...
uses
  System.Classes, VKS.VectorFileObjects, VKS.ApplicationFileIO;
...
// LoadFromStream
//
procedure TVKGTSVectorFile.LoadFromStream(aStream : TStream);
var
...
// ------------------------------------------------------------------
   ...
   RegisterVectorFileFormat('gts', 'GNU Triangulated Surface', TVKGTSVectorFile);
