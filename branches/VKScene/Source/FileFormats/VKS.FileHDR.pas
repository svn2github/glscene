...
type
  ...
  TVKHDRImage = class(TVKBaseImage)
  private
...
procedure TVKHDRImage.LoadFromStream(stream: TStream);
const
...
function TVKHDRImage.GetProgramType: Ansistring;
begin
  Result := fProgramType;
end;

procedure TVKHDRImage.SetProgramType(aval: Ansistring);
var
  i: integer;
begin
