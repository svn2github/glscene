...
uses
  ...
  //
  VKS.VectorFileObjects, VKS.ApplicationFileIO, VKS.VectorGeometry,
  VKS.VectorTypes, VKS.VectorLists, Q3BSP, VKS.BSP, VKS.Texture,
  VKS.Graphics, VKS.CrossPlatform, VKS.State, VKS.Utils,
...
initialization
  ...
  RegisterVectorFileFormat('q3bsp', 'Quake3 BSP files', TVKQ3BSPVectorFile);

  // registering this extension too might be a little abusive right now...
  RegisterVectorFileFormat('bsp', 'BSP files', TVKQ3BSPVectorFile);
end.
