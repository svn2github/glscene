...
var
  ...
  begin
    ...
    begin
      aNormal.X := VKS.Utils.StrToFloatDef(sl[2], 0);
      aNormal.Y := VKS.Utils.StrToFloatDef(sl[3], 0);
      aNormal.Z := VKS.Utils.StrToFloatDef(sl[4], 0);
    end;
  end;
  ...
  begin
    ...
    begin
      aVertex.X := VKS.Utils.StrToFloatDef(sl[1], 0);
      aVertex.Y := VKS.Utils.StrToFloatDef(sl[2], 0);
      aVertex.Z := VKS.Utils.StrToFloatDef(sl[3], 0);
    end;
  end;
