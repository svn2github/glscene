...
{ : VKS.FileLMTS<p>
  ...
  <li>29/05/08 - DaStr - Replaced VKS.Utils with VKS.Graphics (BugTracker ID = 1923844)
  Added $I GLScene.inc
...
type
  ...
  TMaterialInfo = record
    ...
    FAmbient, FDiffuse, FEmission, FSpecular, BAmbient, BDiffuse, BEmission,
      BSpecular: TVector;
    ImageAlpha: TVKTextureImageAlpha;
    magFilter: TVKMagFilter;
    minFilter: TVKMinFilter;
    TextureMode: TVKTextureMode;
    TextureWrap: TVKTextureWrap;
