...
//
{
  ...
  TVKActor Components in GLScene.  
...
type
  ...
  protected
    ...
    procedure ReadInsert(basemesh: TVKBaseMesh);
...
const
  ...
  function TVKDXFVectorFile.ReadLine: STRING;
  var
    j: Integer;
    FLine: STRING;
    NewlineChar: CHAR;
...
{
  procedure TVKDXFVectorFile.DoProgress (Stage: TVKProgressStage; PercentDone: single; RedrawNow: Boolean; const Msg: string);
  var perc:BYTE;
  begin
  ...
  procedure TVKDXFVectorFile.PushCode(code: Integer);
  begin
    PushedCode := code;
    HasPushedCode := True;
  end;

  function TVKDXFVectorFile.GetCode: Integer;
  var
    S: STRING;
  begin
  ...
  function TVKDXFVectorFile.ReadDouble: double;
  var
    S: String;
    c: CHAR;
  begin
  ...
  function TVKDXFVectorFile.ReadInt: Integer;
  var
    S: String;
  begin
    S := Trim(ReadLine);
  ...
  procedure TVKDXFVectorFile.SkipSection;
  var
    S: String;
    code: Integer;
  begin
  ...
  procedure TVKDXFVectorFile.SkipTable;
  var
    S: String;
    code: Integer;
  begin
  ...
  procedure TVKDXFVectorFile.ReadLayer;
  var
  ...
  procedure TVKDXFVectorFile.ReadLayerTable;
  var
    S: STRING;
    code: Integer;
  begin
  ...
  procedure TVKDXFVectorFile.ReadTables;
  var
    S: String;
    code: Integer;
  begin
    ...
    procedure TVKDXFVectorFile.ReadBlocks;
    var
      S: String;
      code: Integer;
      blockname: String;
      blockmesh: TVKFreeForm;

    begin
      // This code reads blocks into orphaned TVKFreeForms.
      ...
      repeat
        ...
        begin
          blockmesh := TVKFreeForm.create(owner);
    ...
    procedure TVKDXFVectorFile.ReadInsert(basemesh: TVKBaseMesh);
    var
    ...
    begin
      ...
      if idx >= 0 then
      begin
        blockmesh := FBlocks.Objects[idx] as TVKBaseMesh;
        ...
        (*
          ...
          begin
          blockproxy:=TVKproxyObject.CreateAsChild(basemesh);
    ...
    procedure TVKDXFVectorFile.ReadEntity3Dface(basemesh: TVKBaseMesh);
    var
      code, i: Integer;
    ...
    procedure TVKDXFVectorFile.ReadEntities(basemesh: TVKBaseMesh);
    var
      code: Integer;
      S: STRING;
    begin
    ...
    procedure TVKDXFVectorFile.LoadFromStream(aStream: TStream);
    var
      S: STRING;
      code, i: Integer;
    begin
      ...
      for i := FBlocks.count - 1 downto 0 do
        (FBlocks.Objects[i] as TVKFreeForm).free;
      FBlocks.free;
...
RegisterVectorFileFormat('dxf', 'AutoCAD Exchange Format', TVKDXFVectorFile);
