...
type
  ...
  published
    ...
    property LeafBackMaterialName: TVKLibMaterialName read FLeafBackMaterialName
      write SetLeafBackMaterialName;
    property BranchMaterialName: TVKLibMaterialName read FBranchMaterialName
...
// Create
//
constructor TVKTreeBranch.Create(AOwner: TVKTreeBranches;
  AParent: TVKTreeBranch);
begin
  FOwner := AOwner;
  FParent := AParent;
...
// BuildBranch
//
procedure TVKTreeBranch.BuildBranch(branchNoise: TVKTreeBranchNoise;
  const matrix: TMatrix; TexCoordY, Twist: Single; Level: Integer);
var
  i: Integer;
  Tree: TVKTree;
...
procedure TVKTree.BuildMesh(GLBaseMesh: TVKBaseMesh);
  ...
  procedure RecursBranches(Branch: TVKTreeBranch; bone: TVKSkeletonBone;
