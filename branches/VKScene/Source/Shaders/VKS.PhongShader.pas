...
{: VKS.PhongShader<p>
   ...
   <b>History : </b><font size=-1><ul>
      ...
      <li>20/03/07 - DaStr - Moved some of the stuff from TVKCustomAsmShader back here
      <li>25/02/07 - DaStr - Completely replaced with a descendant of TVKCustomAsmShader.
...
uses
  ...
  //VKS
  VKS.Texture, VKS.VectorGeometry, VKS.VectorLists, VKS.OpenGLTokens, VKS.Context,
  VKS.AsmShader, VKS.RenderContextInfo, VKS.CustomShader, VKS.State;
