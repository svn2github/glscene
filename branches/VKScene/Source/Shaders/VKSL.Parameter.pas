...
uses
  System.Classes,
  //VKS
  VKS.OpenGLTokens, VKS.VectorTypes, VKS.TextureFormat, VKS.RenderContextInfo;
...
const
  cGLSLTypeString: array[TVKSLDataType] of AnsiString = (
    'undefined',
    'float',
    'vec2',
    'vec3',
  ...
  cGLSLSamplerString: array[TVKSLSamplerType] of AnsiString = (
    'undefined',
    'sampler1D',
    'sampler2D',
    'sampler3D',
...
const
  cGLgsInTypes : array[TVKgsInTypes] of GLenum =
...
procedure FillUniformAutoSetMethodList(AList: TStrings;
  TypeFilter: TVKSLDataType); overload;
procedure FillUniformAutoSetMethodList(AList: TStrings;
  TypeFilter: TVKSLSamplerType); overload;
...
const
  cGLSLTypeComponents: array[TVKSLDataType] of Integer =
  (
    0,
    1,
    2,
  ...
  cGLSLTypeEnum: array[TVKSLDataType] of Integer =
  (
    0,
    GL_FLOAT,
    GL_FLOAT,
...
type
  TAutoSetMethodRec = record
    Name: string;
    UniformType: TVKSLDataType;
    SamplerType: TVKSLSamplerType;
...
procedure FillUniformAutoSetMethodList(AList: TStrings; TypeFilter: TVKSLDataType);
var
  I: Integer;
begin
  for I := 0 to High(vMethods) do
...
procedure FillUniformAutoSetMethodList(AList: TStrings; TypeFilter: TVKSLSamplerType);
var
  I: Integer;
begin
  for I := 0 to High(vMethods) do
