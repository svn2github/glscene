...
//
{: GLSL.VertexDisplacementShader <p>
...
unit GLSL.VertexDisplacementShader;
...
//TVKCustomGLSLSimpleVertexDisplacementShader
//
{: Custom class for GLSLVertexDisplacementShader.<p>
 VertexDisplacement Shader : Spherical Environment Mapping }
Type
  TVKCustomGLSLVertexDisplacementShader = class(TVKCustomGLSLShader)
  private
...
//    property DiffuseColor : TVKColor read FDiffuseColor Write setDiffuseColor;
  ...
  TVKSLVertexDisplacementShader = class(TVKCustomGLSLVertexDisplacementShader)
  published
...
constructor TVKCustomGLSLVertexDisplacementShader.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TVKCustomGLSLVertexDisplacementShader.Destroy;
begin
...
function TVKCustomGLSLVertexDisplacementShader.GetMaterialLibrary: TVKAbstractMaterialLibrary;
begin
  Result := FMaterialLibrary;
end;

procedure TVKCustomGLSLVertexDisplacementShader.SetMaterialLibrary(const Value: TVKAbstractMaterialLibrary);
begin
...
procedure TVKCustomGLSLVertexDisplacementShader.SetMainTexTexture(const Value: TVKTexture);
begin
...
function TVKCustomGLSLVertexDisplacementShader.GetMainTexName: TVKLibMaterialName;
begin
  Result := TVKMaterialLibrary(FMaterialLibrary).GetNameOfTexture(FMainTexture);
  if Result = '' then Result := FMainTexName;
end;

procedure TVKCustomGLSLVertexDisplacementShader.SetMainTexName(const Value: TVKLibMaterialName);
begin
...
//procedure TVKCustomGLSLVertexDisplacementShader.SetDiffuseColor(AValue: TVKColor);
//begin
//  FDiffuseColor.DirectColor := AValue.Color;
//end;

procedure TVKCustomGLSLVertexDisplacementShader.SetAmbientColor(AValue: TVKColor);
begin
  FAmbientColor.DirectColor := AValue.Color;
end;

procedure TVKCustomGLSLVertexDisplacementShader.SetSpecularColor(AValue: TVKColor);
begin
  FSpecularColor.DirectColor := AValue.Color;
end;

procedure TVKCustomGLSLVertexDisplacementShader.Notification(AComponent: TComponent; Operation: TOperation);
var
  Index: Integer;
begin
  inherited;
