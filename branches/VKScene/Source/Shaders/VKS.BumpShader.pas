...
uses
  ...
  //VKS 
  VKS.Material, VKS.Graphics, VKS.Utils, VKS.VectorGeometry, VKS.OpenGLTokens,
  VKS.Context, VKS.VectorLists, VKS.Color, VKS.RenderContextInfo, VKS.State,
  VKS.TextureFormat;
...
constructor TVKBumpShader.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TVKBumpShader.Destroy;
begin
...
procedure TVKBumpShader.Loaded;
begin
  inherited;
end;
...
function TVKBumpShader.GenerateVertexProgram: string;
var
  VP: TStringList;
...
function TVKBumpShader.GenerateFragmentProgram: string;
var
  FP: TStringList;
  DoSpecular,
    DoTangent,
...
procedure TVKBumpShader.DeleteVertexPrograms;
begin
...
procedure TVKBumpShader.DeleteFragmentPrograms;
begin
...
procedure TVKBumpShader.SetBumpMethod(const Value: TBumpMethod);
begin
...
procedure TVKBumpShader.SetBumpSpace(const Value: TBumpSpace);
begin
...
procedure TVKBumpShader.SetBumpOptions(const Value: TBumpOptions);
begin
...
procedure TVKBumpShader.SetSpecularMode(const Value: TSpecularMode);
begin
...
procedure TVKBumpShader.SetDesignTimeEnabled(const Value: Boolean);
begin
...
procedure TVKBumpShader.SetParallaxOffset(const Value: Single);
begin
