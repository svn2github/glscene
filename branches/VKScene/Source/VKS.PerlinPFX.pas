...
uses
  ...
  VKS.ParticleFX, VKS.Graphics, VKS.CrossPlatform,
  VKS.PerlinNoise3D, Winapi.OpenGL, Winapi.OpenGLext,  VKS.VectorGeometry;
...
// Create
//
constructor TVKPerlinPFXManager.Create(aOwner : TComponent);
begin
   inherited;
   FTexMapSize:=6;
   FNoiseScale:=100;
...
// Destroy
//
destructor TVKPerlinPFXManager.Destroy;
begin
   inherited Destroy;
end;
...
// SetTexMapSize
//
procedure TVKPerlinPFXManager.SetTexMapSize(const val : Integer);
begin
...
// SetNoiseSeed
//
procedure TVKPerlinPFXManager.SetNoiseSeed(const val : Integer);
begin
...
// SetNoiseScale
//
procedure TVKPerlinPFXManager.SetNoiseScale(const val : Integer);
begin
...
// SetNoiseAmplitude
//
procedure TVKPerlinPFXManager.SetNoiseAmplitude(const val : Integer);
begin
...
// SetSmoothness
//
procedure TVKPerlinPFXManager.SetSmoothness(const val : Single);
begin
...
// SetBrightness
//
procedure TVKPerlinPFXManager.SetBrightness(const val : Single);
begin
...
// SetGamma
//
procedure TVKPerlinPFXManager.SetGamma(const val : Single);
begin
...
// BindTexture
//
procedure TVKPerlinPFXManager.PrepareImage(bmp32 : TVKBitmap32; var texFormat : Integer);

   procedure PrepareSubImage(dx, dy, s : Integer; noise : TVKPerlin3DNoise);
   var
      s2 : Integer;
      x, y, d : Integer;
...
begin
   ...
   noise:=TVKPerlin3DNoise.Create(NoiseSeed);
   try
...
// ------------------------------------------------------------------
   ...
   // class registrations
   RegisterClasses([TVKPerlinPFXManager]);
