...
type
   ...
   TScreenSaverPreviewEvent = procedure (Sender: TObject; previewHwnd : HWND) of object;
	...
	TVKScreenSaver = class (TComponent)
		private
...
// Create
//
constructor TVKScreenSaver.Create(AOwner : TComponent);
begin
	inherited;
...
// Destroy
//
destructor TVKScreenSaver.Destroy;
begin
...
// Loaded
//
procedure TVKScreenSaver.Loaded;
var
	param : String;
begin
	inherited;
...
// ConfigureSaver
//
procedure TVKScreenSaver.ConfigureSaver;
begin
...
// SetPassword
//
procedure TVKScreenSaver.SetPassword;
begin
	SetScreenSaverPassword;
end;
...
// PreviewSaver
//
procedure TVKScreenSaver.PreviewSaver;
var
	frm : TForm;
	previewHwnd : HWND;
	previewRect : TRect;
...
// ExecuteSaver
//
procedure TVKScreenSaver.ExecuteSaver;
var
	frm : TForm;
begin
...
// CloseSaver
//
function TVKScreenSaver.CloseSaver : Boolean;
type
...
// FormMouseMove
//
procedure TVKScreenSaver.FormMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
// FormKeyPress
//
procedure TVKScreenSaver.FormKeyPress(Sender: TObject; var Key: Char);
begin
	CloseSaver;
end;
...
// OnMouseTimer
//
procedure TVKScreenSaver.OnMouseTimer(Sender: TObject);
var
   mousePos : TPoint;
begin
...
initialization
  ...
  RegisterClasses([TVKScreenSaver]);
