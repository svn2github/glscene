    ...
    with Joint do
      ...
      begin
        ...
        BallAndSocketSetConeAngle(FNewtonUserJoint,
          VKS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FConeAngle));
        BallAndSocketSetTwistAngle(FNewtonUserJoint,
          VKS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FMinTwistAngle),
          VKS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FMaxTwistAngle));
    ...
    with Joint do
      ...
      begin
        ...
        HingeSetLimits(FNewtonUserJoint,
          VKS.VectorGeometry.DegToRad(FCustomHingeOptions.FMinAngle),
          VKS.VectorGeometry.DegToRad(FCustomHingeOptions.FMaxAngle));
        CustomSetBodiesCollisionState(FNewtonUserJoint, Ord(FCollisionState));
        NewtonJointSetStiffness(CustomGetNewtonJoint(FNewtonUserJoint),
          FStiffness);
