...
uses
  ...
  FMX.Types,
  //VKS
  VKS.Graphics, VKS.Vfw, VKS.Scene, VKS.SceneViewer, VKS.CrossPlatform;
...
// Create
//
constructor TVKAVIRecorder.Create(AOwner: TComponent);
begin
  inherited;
...
// Destroy
//
destructor TVKAVIRecorder.Destroy;
begin
...
// Restricted
//
function TVKAVIRecorder.Restricted(s: integer): integer;
begin
...
// SetHeight
//
procedure TVKAVIRecorder.SetHeight(const val: integer);
begin
...
// SetWidth
//
procedure TVKAVIRecorder.SetWidth(const val: integer);
begin
...
// SetSizeRestriction
//
procedure TVKAVIRecorder.SetSizeRestriction(const val: TAVISizeRestriction);
begin
...
//
procedure TVKAVIRecorder.AddAVIFrame;
var
  bmp32: TVKBitmap32;
  bmp: TBitmap;
begin
...
//
procedure TVKAVIRecorder.AddAVIFrame(bmp: TBitmap);
begin
  if RecorderState <> rsRecording then
    raise Exception.Create('Cannot add frame to AVI. AVI file not created.');
  { TODO : E2003 Undeclared identifier: 'Draw' }
...
// InternalAddAVIFrame
//
procedure TVKAVIRecorder.InternalAddAVIFrame;
begin
...
function TVKAVIRecorder.CreateAVIFile(DPI: integer = 0): boolean;
var
...
procedure TVKAVIRecorder.CloseAVIFile(UserAbort: boolean = false);
begin
...
// Recording
//
function TVKAVIRecorder.Recording: boolean;
begin
