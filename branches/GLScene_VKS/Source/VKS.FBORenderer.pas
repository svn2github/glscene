...
uses
  ...
  VKS.VectorGeometry, VKS.Scene, VKS.Texture, VKS.Context,
  VKS.FBO, VKS.Color, VKS.Material, VKS.RenderContextInfo,
  VKS.State, VKS.OpenGLTokens, VKS.TextureFormat,
  VKS.VectorTypes, VKS.MultisampleImage, VKS.Log;
