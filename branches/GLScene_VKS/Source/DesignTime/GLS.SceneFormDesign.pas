...
const
  sSource =
    ...
    '  GLS.Scene, GLS.SceneForm;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
...
const
  sSource =
    ...
    'uses' + LineEnding +
    '  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,' + LineEnding +
    '  GLS.Scene, GLS.SceneForm, GLS.Cadencer;' + LineEnding +
    '' + LineEnding +
    'type' + LineEnding +
    '  T%1:s = class(TVKSceneForm)' + LineEnding +
...
const
  sSource =
    ...
    '  Dialogs, GLS.Scene, GLSceneForm, GLS.Cadencer, GLS.Material, GLS.Objects, ' + LineEnding +
    '  GLS.HUDObjects, GLS.WindowsFont, GLS.Skydome, GLS.GeomObjects, GLS.ShadowPlane,' + LineEnding +
    '  GLS.SceneViewer, GLS.BaseClasses, GLS.FilePNG;' + LineEnding +
