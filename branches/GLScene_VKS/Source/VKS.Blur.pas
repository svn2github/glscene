...
uses
  ...
  FMX.Graphics,
  //VKS 
  VKS.Scene, VKS.VectorGeometry, VKS.Objects, VKS.BitmapFont, VKS.Texture, VKS.Material,
  VKS.HudObjects, VKS.Color, VKS.Graphics, VKS.Context, VKS.OpenGLTokens,
  VKS.XOpenGL, VKS.State, VKS.TextureFormat, VKS.BaseClasses, VKS.RenderContextInfo;
...
procedure TVKBlur.DoRender(var ARci: TRenderContextInfo;
