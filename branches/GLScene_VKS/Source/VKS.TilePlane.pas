...
uses
  System.Classes, VKS.Scene, VKS.VectorGeometry, VKS.OpenGLTokens, VKS.Context,
  VKS.Material, VKS.Objects, VKS.CrossPlatform, VKS.PersistentClasses,
  VKS.VectorLists, VKS.RenderContextInfo, VKS.XOpenGL;
...
// DoRender
//
procedure TVKTilePlane.DoRender(var ARci : TRenderContextInfo;
...
// BuildList
//
procedure TVKTilePlane.BuildList(var rci : TRenderContextInfo);
type
