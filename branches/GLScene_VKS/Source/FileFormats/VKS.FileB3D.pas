...
var
  ...
  begin
    ...
    begin
      ...
      LightLib := TVKBaseMesh(GetOwner).LightmapLibrary;
...
begin
  ...
  try
    ...
    if GetOwner is TVKBaseMesh then
      (GetOwner as TVKBaseMesh).NormalsOrientation := MnoDefault;
...
RegisterVectorFileFormat('b3d', 'Blitz 3D model files', TVKB3DVectorFile);
