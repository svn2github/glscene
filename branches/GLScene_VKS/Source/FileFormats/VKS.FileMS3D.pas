...
uses
  ...
  VKS.CrossPlatform, VKS.VectorFileObjects, VKS.VectorTypes, VKS.Material,
...
type
  ...
  TVKMS3DVectorFile = class(TVectorFile)
  public
...
class function TVKMS3DVectorFile.Capabilities: TDataFileCapabilities;
begin
  Result := [dfcRead];
end;
