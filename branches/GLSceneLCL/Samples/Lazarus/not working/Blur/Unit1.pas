...
begin
 ...
 // GLMaterialLibrary1.Materials[0].Material.Texture.Image.LoadFromFile(MediaPath+'\marbletiles.jpg');
  GLCube1.Material.Texture.Image.LoadFromFile(MediaPath+'\marbletiles.jpg');
end;
