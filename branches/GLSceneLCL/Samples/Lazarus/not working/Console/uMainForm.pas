...
uses
  ...
  //GLScene
  GLTexture, GLTextureFormat, GLBitmapFont, GLWindowsFont, GLScene, GLObjects,
...
begin
  ...
  //optional stuff:
 // Console.HudSprite.Material.Texture.Image.AsBitmap.LoadFromFile(MediaPath+'GLScene.bmp');
