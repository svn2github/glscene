...
begin
  ...
  boundaryList[b0].maxSqArea := VXS.MeshUtils.polygonArea(b0);
...
begin
  ...
  begin
    ...
    boundaryList[0].maxSqArea := VXS.MeshUtils.polygonArea(0);
    maxMaxSqArea := boundaryList[0].maxSqArea;

    for i := 1 to count - 1 do
    begin
      boundaryList[i].maxSqArea := VXS.MeshUtils.polygonArea(i);
