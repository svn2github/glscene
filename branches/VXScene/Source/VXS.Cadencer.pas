...
type
  ...
  private
    ...
    FMode: TVXCadencerMode;
    FTimeReference: TVXCadencerTimeReference;
    FCurrentTime: Double;
    FOriginTime: Double;
  ...
  protected
    ...
    procedure SetScene(const val: TVXScene);
    procedure SetMode(const val: TVXCadencerMode);
    procedure SetTimeReference(const val: TVXCadencerTimeReference);
    ...
    begin
      ...
      try
        ...
        begin
          ...
          begin
            cad := TVXCadencer(vASAPCadencerList[i]);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              TVXCadenceAbleComponent(FSubscribedCadenceableComponents[i]).DoProgress(pt);
              i := i + 1;
            end;
