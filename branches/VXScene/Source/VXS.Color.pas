...
var
  // Specifies if TVXColor should allocate memory for
...
begin
  ...
  begin
    vColorManager := TVXColorManager.Create;
...
procedure TVXColor.SetDirectColorVector(const aColor: TColorVector);
begin
  SetVector(FColor, aColor);
end;
...
function TVXColorManager.GetColorName(const aColor: TColorVector): String;
