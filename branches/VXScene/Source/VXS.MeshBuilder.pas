...
unit VXS.MeshBuilder;

interface

uses
  System.SysUtils, System.Classes, VXS.Scene, VXS.VectorFileObjects,
  VXS.VectorTypes, VXS.VectorGeometry, VXS.VectorLists;

procedure BuildCube(Mesh: TVXMeshObject; Position, Scale: TAffineVector);
procedure BuildCylinder(Mesh: TVXMeshObject; Position, Scale: TAffineVector;
  Slices: Integer);
procedure BuildCylinder2(Mesh: TVXMeshObject; Position, Scale: TAffineVector;
