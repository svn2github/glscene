...
//
{
  Code for loading animated MD3 files into VXScene FreeForms and Actors.
}
unit VXS.FileMD3;
...
type
  ...
  TVXMD3VectorFile = class (TVXVectorFile)
    public
...
class function TVXMD3VectorFile.Capabilities : TVXDataFileCapabilities;
begin
  Result:=[dfcRead];
end;

procedure TVXMD3VectorFile.LoadFromStream(aStream : TStream);
var
  i,j,k,
  numVerts,
  numtris     : Integer;
...
// ------------------------------------------------------------------
   ...
   RegisterVectorFileFormat('md3', 'MD3 files', TVXMD3VectorFile);
