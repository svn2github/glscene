...
type
  TVXXVectorFile = class(TVXVectorFile)
  public
...
class function TVXXVectorFile.Capabilities: TVXDataFileCapabilities;
begin
  Result := [dfcRead];
end;

procedure TVXXVectorFile.LoadFromStream(aStream: TStream);
var
  DXFile: TDXFile;
...
RegisterVectorFileFormat('x', 'DirectX Model files', TVXXVectorFile);
