...
type
  ...
  TVXPLYVectorFile = class(TVXVectorFile)
  public
...
class function TVXPLYVectorFile.Capabilities: TVXDataFileCapabilities;
begin
  Result := [dfcRead];
end;

procedure TVXPLYVectorFile.LoadFromStream(aStream: TStream);
var
...
RegisterVectorFileFormat('ply', 'Stanford triangle format', TVXPLYVectorFile);
