...
type
  ...
  TMaterialInfo = record
    ...
    FAmbient, FDiffuse, FEmission, FSpecular, BAmbient, BDiffuse, BEmission,
      BSpecular: TVector;
    ImageAlpha: TVXTextureImageAlpha;
    magFilter: TVXMagFilter;
    minFilter: TVXMinFilter;
    TextureMode: TVXTextureMode;
    TextureWrap: TVXTextureWrap;
    Blendingmode: TBlendingMode;
    FaceCulling: TFaceCulling;
    mathash: integer;
  end;

  TVXLMTSVectorFile = class(TVXVectorFile)
  public
...
class function TVXLMTSVectorFile.Capabilities: TVXDataFileCapabilities;
begin
  Result := [dfcRead, dfcWrite];
end;

procedure TVXLMTSVectorFile.LoadFromStream(aStream: TStream);
var
  MO: TVXMeshObject;
  FG: TFGVertexIndexList;
  LL: TVXMaterialLibrary;
  ML: TVXMaterialLibrary;
  LMTS: TLMTS;
  T: TLMTS_TexData;
...
procedure TVXLMTSVectorFile.SaveToStream(aStream: TStream);
var
  MO: TVXMeshObject;
  FG: TFGVertexIndexList;
