...
//
{
    Support-code to load Q3BSP Files into TVXFreeForm-Components.  
...
type
  ...
  TVXQ3BSPVectorFile = class(TVXVectorFile)
  public
...
class function TVXQ3BSPVectorFile.Capabilities: TVXDataFileCapabilities;
begin
  Result := [dfcRead];
end;

procedure TVXQ3BSPVectorFile.LoadFromStream(aStream: TStream);
...
// ------------------------------------------------------------------
  ...
  RegisterVectorFileFormat('q3bsp', 'Quake3 BSP files', TVXQ3BSPVectorFile);

  // registering this extension too might be a little abusive right now...
  RegisterVectorFileFormat('bsp', 'BSP files', TVXQ3BSPVectorFile);
end.
