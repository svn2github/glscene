...
type
  TVXLWOVectorFile = class(TVXVectorFile)
  private
    FLWO: TLWObjectFile;
    FPnts: TLWPnts;
    procedure AddLayr(Layr: TLWLayr; LWO: TLWObjectFile);
    procedure AddSurf(Surf: TLWSurf; LWO: TLWObjectFile);
    procedure AddPnts(Pnts: TLWPnts; Mesh: TVXMeshObject);
    procedure AddPols(Pols: TLWPols; Mesh: TVXMeshObject);
    procedure AddVMap(VMap: TLWVMap; Mesh: TVXMeshObject);
  public
...
procedure TVXLWOVectorFile.AddLayr(Layr: TLWLayr; LWO: TLWObjectFile);
var
  Idx: Integer;
  Mesh: TVXMeshObject;
  Pnts: TLWPnts;
...
procedure TVXLWOVectorFile.AddPnts(Pnts: TLWPnts; Mesh: TVXMeshObject);
var
  i: Integer;
begin
...
procedure TVXLWOVectorFile.AddPols(Pols: TLWPols; Mesh: TVXMeshObject);
var
  Idx: Integer;
...
procedure TVXLWOVectorFile.AddSurf(Surf: TLWSurf; LWO: TLWObjectFile);
var
  matLib: TVXMaterialLibrary;
  libMat: TVXLibMaterial;
  tex2Mat: TVXLibMaterial;
  colr: TColr12;
...
procedure TVXLWOVectorFile.AddVMap(VMap: TLWVMap; Mesh: TVXMeshObject);
var
  i: integer;
begin
...
procedure TVXLWOVectorFile.LoadFromStream(aStream: TStream);
var
  Ind: Integer;
begin
...
initialization
  RegisterVectorFileFormat('lwo', 'Lightwave3D object file (6.0 or above)', TVXLWOVectorFile);
