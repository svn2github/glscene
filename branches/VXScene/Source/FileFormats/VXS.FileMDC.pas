...
type
  TVXMDCVectorFile = class(TVXVectorFile)
  public
...
class function TVXMDCVectorFile.Capabilities: TVXDataFileCapabilities;
begin
  Result := [DfcRead];
end;

procedure TVXMDCVectorFile.LoadFromStream(AStream: TStream);
...
RegisterVectorFileFormat('mdc', 'MDC files', TVXMDCVectorFile);
