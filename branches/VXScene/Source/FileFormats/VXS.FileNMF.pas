...
//
{
  VXS.FileNMF - NormalMapper loading into GLScene FreeForms/Actors
}
unit VXS.FileNMF;
...
type
  TVXNMFVectorFile = class(TVXVectorFile)
  public
...
class function TVXNMFVectorFile.Capabilities: TVXDataFileCapabilities;
begin
...
// LoadFromStream
//
procedure TVXNMFVectorFile.LoadFromStream(aStream: TStream);
var
  i, j: Integer;
  mesh: TVXMeshObject;
  nmf: TFileNMF;
...
// SaveToStream
//
procedure TVXNMFVectorFile.SaveToStream(aStream: TStream);
var
  i, j: Integer;
  nmf: TFileNMF;
...
RegisterVectorFileFormat('nmf', 'NormalMapper files', TVXNMFVectorFile);
