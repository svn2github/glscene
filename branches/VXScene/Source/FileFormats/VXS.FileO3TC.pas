...
procedure TVXO3TCImage.LoadFromFile(const filename: string);
var
  fs: TStream;
begin
...
procedure TVXO3TCImage.SaveToFile(const filename: string);
var
  fs: TStream;
begin
...
class function TVXO3TCImage.Capabilities: TVXDataFileCapabilities;
begin
