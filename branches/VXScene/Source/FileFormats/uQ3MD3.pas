...
procedure LoadQ3Anims(Animations:TVXActorAnimations;
...
procedure LoadQ3Skin(FileName:string; Actor:TVXActor);
  ...
  for strindex:=0 to Strings.Count-1 do begin
    ...
    if GotValues and (str1<>'') then begin
      ...
      with Animations.Add do begin
        ...
        Reference:=aarMorph;
        // Need a way in TVXActorAnimation to tell whether it is
...
var
  ...
  function GetMeshObjectByName(MeshObjects:TVXMeshObjectList; Name:string; var mesh:TVXMeshObject):Boolean;
  var
    i : integer;
  begin
    Result:=False;
