...
type
  ...
  private
    FVertexProgramHandle: TVXVertexProgramHandle;
    FFragmentProgramHandle: TVXFragmentProgramHandle;
...
begin
  ...
  try
    ...
    begin
      FVertexProgramHandle := TVXVertexProgramHandle.CreateAndAllocate;
    ...
    if not Assigned(FFragmentProgramHandle) then
      ...
      begin
        FFragmentProgramHandle := TVXFragmentProgramHandle.CreateAndAllocate;
