...
const
  cGLSLTypeString: array[TVXSLDataType] of AnsiString = (
    'undefined',
    'float',
    'vec2',
    'vec3',
  ...
  cGLSLSamplerString: array[TVXSLSamplerType] of AnsiString = (
    'undefined',
    'sampler1D',
    'sampler2D',
    'sampler3D',
...
const
  cGLgsInTypes : array[TVXgsInTypes] of GLenum =
    (GL_POINTS, GL_LINES, GL_LINES_ADJACENCY_EXT, GL_TRIANGLES,
     GL_TRIANGLES_ADJACENCY_EXT);
  cGLgsOutTypes: array[TVXgsOutTypes] of GLenum =
...
procedure RegisterUniformAutoSetMethod(AMethodName: string;
  AType: TVXSLDataType; AMethod: TUniformAutoSetMethod);
procedure FillUniformAutoSetMethodList(AList: TStrings;
  TypeFilter: TVXSLDataType); overload;
procedure FillUniformAutoSetMethodList(AList: TStrings;
  TypeFilter: TVXSLSamplerType); overload;
...
const
  cGLSLTypeComponents: array[TVXSLDataType] of Integer =
  (
    0,
    1,
    2,
  ...
  cGLSLTypeEnum: array[TVXSLDataType] of Integer =
  (
    0,
    GL_FLOAT,
    GL_FLOAT,
...
type
  TAutoSetMethodRec = record
    Name: string;
    UniformType: TVXSLDataType;
    SamplerType: TVXSLSamplerType;
...
procedure FillUniformAutoSetMethodList(AList: TStrings; TypeFilter: TVXSLDataType);
var
  I: Integer;
begin
  for I := 0 to High(vMethods) do
...
procedure FillUniformAutoSetMethodList(AList: TStrings; TypeFilter: TVXSLSamplerType);
var
  I: Integer;
begin
  for I := 0 to High(vMethods) do
