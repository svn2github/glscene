...
{
  DelphiWebScriptII symbol creation for VXS.VectorGeometry types
  and functions. 
...
uses
  System.Classes, dws2Exprs, dws2Symbols, dws2Comp;
...
uses
  dws2Functions, VXS.VectorGeometry;
...
procedure Register;
begin
  RegisterComponents('VXScene DWS', [TDwsVectorGeometryUnit]);
end;
