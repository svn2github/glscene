...
//
{
  Editor frame for a TVXFaceProperties. 
}
unit FRFaceEditor;
...
type
  ...
  private
    ...
    Updating: Boolean;
    FFaceProperties: TVXFaceProperties;
    procedure SetFaceProperties(const val: TVXFaceProperties);
    procedure OnColorChange(Sender: TObject);
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    property OnChange: TNotifyEvent read FOnChange write FOnChange;
    property FaceProperties: TVXFaceProperties read FFaceProperties
...
begin
  inherited;
  FFaceProperties := TVXFaceProperties.Create(nil);
...
procedure TRFaceEditor.SetFaceProperties(const val: TVXFaceProperties);
begin
  Updating := True;
  try
