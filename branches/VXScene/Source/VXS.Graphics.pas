...
//
{
   ...
   is active in VXScene.inc and recompile.
}
...
{$ENDIF}
  ...
  public
    destructor Destroy; override;
    procedure Add(const Ext, Desc: string; DescID: Integer; AClass: TVXBaseImageClass);
...
procedure RegisterRasterFormat(const AExtension, ADescription: string; AClass: TVXBaseImageClass);
begin
...
procedure TRasterFileFormatsList.Add(const Ext, Desc: string; DescID: Integer; AClass: TVXBaseImageClass);
var
...
function TRasterFileFormatsList.FindFromFileName(const fileName: string): TVXBaseImageClass;
var
  ext: string;
begin
...
function TRasterFileFormatsList.FindFromStream(const AStream: TStream): TVXBaseImageClass;
var
  ext: string;
...
function TVXBaseImage.DataSize: Cardinal;
var
  l: TVXImageLODRange;
  s: Cardinal;
begin
...
function TVXBaseImage.GetData: PPixel32Array;
begin
  Result := fData;
end;
...
function TVXImage.GetScanLine(index: Integer): PPixel32Array;
begin
  Narrow;
...
procedure TVXImage.SetAlphaTransparentForColor(const aColor: TPixel32);
var
  color: TPixel24;
begin
  color.r := aColor.r;
...
procedure TVXImage.SetAlphaTransparentForColor(const aColor: TPixel24);
var
  i: Integer;
  intCol: Integer;
begin
