...
unit VXS.VerletSkeletonColliders;
...
uses
  ...
  VXS.PersistentClasses, VXS.VectorGeometry, VXS.VectorFileObjects,
  VXS.VerletTypes,  VXS.VectorTypes;
...
type
  ...
  TSCVerletBase = class(TVXSkeletonCollider)
    private
    ...
    public
      ...
      procedure AddToVerletWorld(VerletWorld : TVXVerletWorld); virtual;
  ...
  TSCVerletSphere = class(TSCVerletBase)
    ...
    public
      ...
      procedure WriteToFiler(writer : TVirtualWriter); override;
      procedure ReadFromFiler(reader : TVirtualReader); override;
      procedure AddToVerletWorld(VerletWorld : TVXVerletWorld); override;
...
procedure AddSCVerletConstriantsToVerletWorld(
  colliders : TVXSkeletonColliderList; world : TVXVerletWorld);
...
// AddToVerletWorld
//
procedure TSCVerletBase.AddToVerletWorld(VerletWorld : TVXVerletWorld);
begin
  AlignCollider;
end;
...
// AddToVerletWorld
//
procedure TSCVerletSphere.AddToVerletWorld(VerletWorld : TVXVerletWorld);
begin
...
// AddToVerletWorld
//
procedure TSCVerletCapsule.AddToVerletWorld(VerletWorld : TVXVerletWorld);
begin
