...
type
  ...
  TVXTeapot = class(TVXSceneObject)
  private
    FGrid: Cardinal;
  public
...
constructor TVXTeapot.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  FGrid := 5;
end;

function TVXTeapot.AxisAlignedDimensionsUnscaled: TVector;
begin
  SetVector(Result, 0.55, 0.25, 0.35);
end;

procedure TVXTeapot.BuildList(var rci: TVXRenderContextInfo);
