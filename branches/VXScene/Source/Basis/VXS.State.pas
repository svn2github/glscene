...
// DONE: remove stTexture1D, 2D, etc from TVXState if possible, since they are
...
type
  ...
  TVXStateType = (sttCurrent, sttPoint, sttLine, sttPolygon, sttPolygonStipple,
    ...
    sttMultisample);
  TVXStateTypes = set of TVXStateType;

const
  cAllAttribBits = [low(TVXStateType)..High(TVXStateType)];
...
// Reflects all relevant (binary) states of OpenVX subsystem
  TVXState = (stAlphaTest, stAutoNormal,
...
type
  ...
  TVXBufferBindingTarget = (bbtUniform, bbtTransformFeedBack);
  ...
  private
    ...
    FStates: TVXStates;
    FListStates: array of TVXStateTypes;
    ...
    FTextureBinding: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1, TVXTextureTarget] of Cardinal;
    FTextureBindingTime: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1, TVXTextureTarget] of Double;
  ...
  protected
    ...
    function GetTextureBinding(Index: Integer; target: TVXTextureTarget):
      GLuint;
    function GetTextureBindingTime(Index: Integer; target: TVXTextureTarget):
      Double;
    procedure SetTextureBinding(Index: Integer; target: TVXTextureTarget;
      const Value: GLuint);
    function GetActiveTextureEnabled(Target: TVXTextureTarget): Boolean;
    procedure SetActiveTextureEnabled(Target: TVXTextureTarget; const Value:
      Boolean);
  ...
  public
    ...
    property TextureBindingTime[Index: Integer; target: TVXTextureTarget]: Double
      read GetTextureBindingTime;
    property ActiveTextureEnabled[Target: TVXTextureTarget]: Boolean read
...
constructor TVXStateCache.Create;
var
  I: Integer;
begin
  inherited;
...
procedure TVXStateCache.PushAttrib(stateTypes: TVXStateTypes);
var
  tempFlag: GLuint;
  I: Integer;
begin
  // TODO: replace with proper client side push/pop
  tempFlag := 0;
  for I := Integer(Low(TVXStateType)) to Integer(high(TVXStateType)) do
  begin
    if TVXStateType(I) in stateTypes then
    begin
      tempFlag := tempFlag or cGLStateTypeToGLEnum[TVXStateType(I)];
    end;
  end;
...
procedure TVXStateCache.SetMaterialDiffuseColor(const aFace: GLEnum; const diffuse: TVector);
var
  i: Integer;
begin
  if FForwardContext then Exit;
...
procedure TVXStateCache.SetVertexArrayBinding(const Value: GLuint);
begin
...
function TVXStateCache.GetArrayBufferBinding: GLuint;
begin
  Result := FArrayBufferBinding;
end;

procedure TVXStateCache.SetArrayBufferBinding(const Value: GLuint);
begin
...
function TVXStateCache.GetElementBufferBinding: GLuint;
begin
  Result := FElementBufferBinding
end;

procedure TVXStateCache.SetElementBufferBinding(const Value: GLuint);
begin
...
function TVXStateCache.GetEnablePrimitiveRestart: GLboolean;
begin
  Result := FEnablePrimitiveRestart;
end;

procedure TVXStateCache.SetEnablePrimitiveRestart(const enabled: GLboolean);
begin
...
function TVXStateCache.GetPrimitiveRestartIndex: GLuint;
begin
  Result := FPrimitiveRestartIndex;
end;

procedure TVXStateCache.SetPrimitiveRestartIndex(const index: GLuint);
begin
...
procedure TVXStateCache.SetEnableProgramPointSize(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetBlendColor(const Value: TVector);
begin
...
procedure TVXStateCache.SetClampReadColor(const Value: GLEnum);
begin
...
procedure TVXStateCache.SetCopyReadBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetCopyWriteBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetCurrentProgram(const Value: GLuint);
begin
...
procedure TVXStateCache.SetTextureBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetCurrentVertexAttrib(Index: Integer;
  const Value: TVector);
begin
...
procedure TVXStateCache.SetDepthRange(const ZNear, ZFar: GLclampd);
begin
...
procedure TVXStateCache.SetDepthRangeFar(const Value: GLclampd);
begin
...
procedure TVXStateCache.SetDepthRangeNear(const Value: GLclampd);
begin
...
procedure TVXStateCache.SetDrawFrameBuffer(const Value: GLuint);
begin
...
procedure TVXStateCache.SetEnableBlend(Index: Integer;
...
procedure TVXStateCache.SetEnableClipDistance(Index: Cardinal;
  const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableColorLogicOp(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableCullFace(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableDepthClamp(const enabled: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableDepthTest(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableDither(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableFramebufferSRGB(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableLineSmooth(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableMultisample(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnablePolygonOffsetFill(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnablePolygonOffsetLine(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnablePolygonOffsetPoint(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnablePolygonSmooth(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableSampleAlphaToCoverage(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableSampleCoverage(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableSampleMask(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableSampleAlphaToOne(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetEnableScissorTest(const Value: GLboolean);
begin

end;

procedure TVXStateCache.SetEnableStencilTest(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetFrameBuffer(const Value: GLuint);
begin
...
function TVXStateCache.GetCurrentVertexAttrib(Index: Integer): TVector;
begin
  Result := FCurrentVertexAttrib[Index];
end;

function TVXStateCache.GetDepthRangeFar: GLclampd;
begin
  Result := FDepthRange[1];
end;

function TVXStateCache.GetDepthRangeNear: GLclampd;
begin
  Result := FDepthRange[0];
end;

function TVXStateCache.GetEnableBlend(Index: Integer): GLboolean;
begin
  Result := FEnableBlend[Index];
end;

function TVXStateCache.GetEnableClipDistance(
  ClipDistance: Cardinal): GLboolean;
begin
  Result := FEnableClipDistance[ClipDistance];
end;

function TVXStateCache.GetSampleMaskValue(Index: Integer): GLbitfield;
begin
  Result := FSampleMaskValue[Index];
end;

function TVXStateCache.GetMaxTextureSize: GLuint;
begin
...
function TVXStateCache.GetMax3DTextureSize: GLuint;
begin
...
function TVXStateCache.GetMaxCubeTextureSize: GLuint;
begin
...
function TVXStateCache.GetMaxArrayTextureSize: GLuint;
begin
...
function TVXStateCache.GetMaxTextureImageUnits: GLuint;
begin
...
function TVXStateCache.GetMaxTextureAnisotropy: GLuint;
begin
...
function TVXStateCache.GetMaxSamples: GLuint;
begin
...
function TVXStateCache.GetTextureBinding(Index: Integer;
  target: TVXTextureTarget): GLuint;
begin
  Result := FTextureBinding[Index, target];
end;

function TVXStateCache.GetTextureBindingTime(Index: Integer; target: TVXTextureTarget):
  Double;
begin
  Result := FTextureBindingTime[Index, target];
end;

function TVXStateCache.GetSamplerBinding(Index: GLuint): GLuint;
begin
  Result := FSamplerBinding[Index];
end;

procedure TVXStateCache.SetSamplerBinding(Index: GLuint; const Value: GLuint);
begin
...
procedure TVXStateCache.SetLineStippleFactor(const Value: GLint);
begin
...
procedure TVXStateCache.SetLineStipplePattern(const Value: GLushort);
begin
...
procedure TVXStateCache.SetPackAlignment(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackImageHeight(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackLSBFirst(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetPackRowLength(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackSkipImages(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackSkipPixels(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackSkipRows(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPackSwapBytes(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetPixelPackBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPixelUnpackBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetPointSpriteCoordOrigin(const Value: GLEnum);
begin
...
procedure TVXStateCache.SetProvokingVertex(const Value: GLEnum);
begin
...
procedure TVXStateCache.SetReadFrameBuffer(const Value: GLuint);
begin
...
procedure TVXStateCache.SetRenderBuffer(const Value: GLuint);
begin
...
procedure TVXStateCache.SetSampleCoverageInvert(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetSampleMaskValue(Index: Integer;
...
procedure TVXStateCache.SetScissorBox(const Value: TVector4i);
begin
...
procedure TVXStateCache.SetStencilBackWriteMask(const Value: GLuint);
begin
...
procedure TVXStateCache.SetStencilClearValue(const Value: GLuint);
begin
...
procedure TVXStateCache.SetColorClearValue(const Value: TVector);
begin
...
procedure TVXStateCache.SetTextureBinding(Index: Integer; target:
  TVXTextureTarget;
  const Value: GLuint);
var
  lastActiveTexture: GLuint;
...
procedure TVXStateCache.SetActiveTextureEnabled(Target: TVXTextureTarget;
  const Value: Boolean);
var
  glTarget: GLEnum;
begin
...
procedure TVXStateCache.SetTransformFeedbackBufferBinding(const Value: GLuint);
begin
...
procedure TVXStateCache.SetEnableTextureCubeMapSeamless(const Value:
  GLboolean);
begin
...
procedure TVXStateCache.NewList(list: GLuint; mode: GLEnum);
var
  I: GLuint;
begin
  Assert(mode = GL_COMPILE,
    'Compile & executing not supported by TVXStateCache');
  FCurrentList := list - 1;
...
procedure TVXStateCache.EndList;
begin
  glEndList;
  FInsideList := False;
end;

procedure TVXStateCache.CallList(list: GLuint);
begin
...
procedure TVXStateCache.SetUniformBufferBinding(const Value: GLuint);
begin
...
function TVXStateCache.GetMaxTextureUnits: GLuint;
begin
...
procedure TVXStateCache.SetUnpackAlignment(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackImageHeight(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackLSBFirst(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetUnpackRowLength(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackSkipImages(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackSkipPixels(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackSkipRows(const Value: GLuint);
begin
...
procedure TVXStateCache.SetUnpackSwapBytes(const Value: GLboolean);
begin
...
procedure TVXStateCache.SetViewPort(const Value: TVector4i);
begin
...
procedure TVXStateCache.SetFFPLight(Value: Boolean);
begin
  FFFPLight := Value and not FForwardContext;
end;

function TVXStateCache.GetMaxLights: Integer;
begin
...
function TVXStateCache.GetLightEnabling(I: Integer): Boolean;
begin
  Result := FLightEnabling[I];
end;

procedure TVXStateCache.SetLightEnabling(I: Integer; Value: Boolean);
var
  J, K: Integer;
begin
...
function TVXStateCache.GetLightIndicesAsAddress: PGLInt;
begin
  Result := @FLightIndices[0];
end;

function TVXStateCache.GetLightStateAsAddress: Pointer;
var
  I, J, C: Integer;
begin
...
function TVXStateCache.GetLightPosition(I: Integer): TVector;
begin
  Result := FLightStates.Position[I];
end;

procedure TVXStateCache.SetLightPosition(I: Integer; const Value: TVector);
begin
...
function TVXStateCache.GetLightSpotDirection(I: Integer): TAffineVector;
begin
  Result := AffineVectorMake(FLightStates.SpotDirection[I]);
end;

procedure TVXStateCache.SetLightSpotDirection(I: Integer; const Value: TAffineVector);
begin
...
function TVXStateCache.GetLightAmbient(I: Integer): TVector;
begin
  Result := FLightStates.Ambient[I];
end;

procedure TVXStateCache.SetLightAmbient(I: Integer; const Value: TVector);
begin
...
function TVXStateCache.GetLightDiffuse(I: Integer): TVector;
begin
  Result := FLightStates.Diffuse[I];
end;

procedure TVXStateCache.SetLightDiffuse(I: Integer; const Value: TVector);
begin
...
function TVXStateCache.GetLightSpecular(I: Integer): TVector;
begin
  Result := FLightStates.Specular[I];
end;

procedure TVXStateCache.SetLightSpecular(I: Integer; const Value: TVector);
begin
...
function TVXStateCache.GetSpotCutoff(I: Integer): Single;
begin
  Result := FSpotCutoff[I];
end;

procedure TVXStateCache.SetSpotCutoff(I: Integer; const Value: Single);
begin
...
function TVXStateCache.GetSpotExponent(I: Integer): Single;
begin
  Result := FLightStates.SpotCosCutoffExponent[I].Y;
end;

procedure TVXStateCache.SetSpotExponent(I: Integer; const Value: Single);
begin
...
function TVXStateCache.GetConstantAtten(I: Integer): Single;
begin
  Result := FLightStates.Attenuation[I].X ;
end;

procedure TVXStateCache.SetConstantAtten(I: Integer; const Value: Single);
begin
...
function TVXStateCache.GetLinearAtten(I: Integer): Single;
begin
  Result := FLightStates.Attenuation[I].Y ;
end;

procedure TVXStateCache.SetLinearAtten(I: Integer; const Value: Single);
begin
...
function TVXStateCache.GetQuadAtten(I: Integer): Single;
begin
  Result := FLightStates.Attenuation[I].Z ;
end;

procedure TVXStateCache.SetQuadAtten(I: Integer; const Value: Single);
begin
...
procedure TVXStateCache.SetForwardContext(Value: Boolean);
begin
