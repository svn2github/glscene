...
type
  ...
  TVXTetrahedron = class(TVXBaseMesh)
  public
  ...
  {The octahedron has no texture coordinates defined, ie. without using
    a texture generation mode, no texture will be mapped. }
  TVXOctahedron = class(TVXBaseMesh)
  public
    procedure BuildList(var rci: TVXRenderContextInfo); override;
  end;
  ...
  {The hexahedron has no texture coordinates defined, ie. without using
    a texture generation mode, no texture will be mapped. }
  TVXHexahedron = class(TVXBaseMesh)
  public
    procedure BuildList(var rci: TVXRenderContextInfo); override;
  end;
  ...
  {The dodecahedron has no texture coordinates defined, ie. without using
   a texture generation mode, no texture will be mapped. }
  TVXDodecahedron = class(TVXBaseMesh)
  public
    procedure BuildList(var rci: TVXRenderContextInfo); override;
  end;
  ...
  {The icosahedron has no texture coordinates defined, ie. without using
     a texture generation mode, no texture will be mapped. }
  TVXIcosahedron = class(TVXBaseMesh)
  public
    procedure BuildList(var rci: TVXRenderContextInfo); override;
  end;
...
procedure TVXHexahedron.BuildList(var rci: TVXRenderContextInfo);
const
...
//==================================================================
  ...
  RegisterClasses([TVXDodecahedron, TVXIcosahedron, TVXHexahedron, TVXOctahedron, TVXTetrahedron]);
