...
uses
  System.Classes, VXS.CrossPlatform, VXS.HeightData, VXS.Material;
...
type
	TVXTexturedHDS = class (TVXHeightDataSource)
	   ...
	   published
         ...
         property MaterialLibrary  : TVXMaterialLibrary read FMaterialLibrary  write FMaterialLibrary;
...
// MarkDirty
//
procedure TVXTexturedHDS.MarkDirty(const area : TVXRect);
begin
   inherited;
