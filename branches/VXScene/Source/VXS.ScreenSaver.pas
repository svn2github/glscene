...
type
   ...
   TScreenSaverPreviewEvent = procedure (Sender: TObject; previewHwnd : HWND) of object;
	...
	TVXScreenSaver = class (TComponent)
		private
...
// Create
//
constructor TVXScreenSaver.Create(AOwner : TComponent);
begin
	inherited;
...
// Destroy
//
destructor TVXScreenSaver.Destroy;
begin
...
// Loaded
//
procedure TVXScreenSaver.Loaded;
var
	param : String;
begin
	inherited;
...
// ConfigureSaver
//
procedure TVXScreenSaver.ConfigureSaver;
begin
...
// SetPassword
//
procedure TVXScreenSaver.SetPassword;
begin
	SetScreenSaverPassword;
end;
...
// PreviewSaver
//
procedure TVXScreenSaver.PreviewSaver;
var
	frm : TForm;
	previewHwnd : HWND;
	previewRect : TRect;
...
// ExecuteSaver
//
procedure TVXScreenSaver.ExecuteSaver;
var
	frm : TForm;
begin
...
// CloseSaver
//
function TVXScreenSaver.CloseSaver : Boolean;
type
...
// FormMouseMove
//
procedure TVXScreenSaver.FormMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Single);
begin
...
// FormKeyPress
//
procedure TVXScreenSaver.FormKeyPress(Sender: TObject; var Key: Char);
begin
	CloseSaver;
end;
...
// OnMouseTimer
//
procedure TVXScreenSaver.OnMouseTimer(Sender: TObject);
var
   mousePos : TPoint;
begin
...
initialization
  ...
  RegisterClasses([TVXScreenSaver]);
