...
type
  ...
  private
    ...
    FOnHeightDataPostRender: TVXHeightDataPostRenderEvent;
    FOnMaxCLODTrianglesReached: TMaxCLODTrianglesReachedEvent;
    FQualityStyle: TVXTerrainHighResStyle;
    FOcclusionFrameSkip: Integer;
    FOcclusionTesselate: TVXTerrainOcclusionTesselate;
  ...
  public
    ...
    TileManagement: TVXTileManagementFlags;
...
constructor TVXTerrainRenderer.Create(AOwner: TComponent);
var
  i: Integer;
begin
...
var
  list: TList;
begin
  with Sender as TVXHeightData do
  begin
...
begin
  ...
  begin
    ...
    begin
      hd := TVXHeightData(hashList.Items[j]);
      if hd.Tag = 0 then
      begin
        hashList.Delete(j);
        OnTileDestroyed(hd);
...
begin
  ...
  begin
    hd := TVXHeightData(hashList.Items[i]);
    ...
    for i := 0 to cTilesHashSize do
      ...
      begin
        ...
        begin
          ...
          begin
            (hd.ObjectTag as TVXROAMPatch).Free;
            hd.ObjectTag := nil;
          end;
        end;
        Clear;
      ...
      begin
        ...
        begin
          ...
          if hd.ObjectTag <> nil then
            TVXROAMPatch(hd.ObjectTag).OcclusionSkip := OcclusionFrameSkip;
        end;
      end;
    NotifyChange(Self);
  end;
...
// class registrations
RegisterClass(TVXTerrainRenderer);
