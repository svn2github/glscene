...
// SetEvents
//
procedure TVXTimeEventsMGR.SetEvents(const val : TTimeEvents);
begin
   FEvents.Assign(val);
end;
...
// DoProgress
//
procedure TVXTimeEventsMGR.DoProgress(const progressTime : TProgressTimes);
var
   i : Integer;
begin
...
begin
  FEnabled := Value;
  FStartTime := ((GetOwner as TTimeEvents).Owner as TVXTimeEventsMGR).Cadencer.CurrentTime;
end;
