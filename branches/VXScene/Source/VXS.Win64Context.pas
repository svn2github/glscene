...
procedure TVXWinContext.CreateOldContext(aDC: HDC);
begin
...
procedure TVXWinContext.CreateNewContext(aDC: HDC);
var
...
const
  ...
  cLayerToSet: array [TVXContextLayer] of Byte = (32, 16, 0, 1, 2);
var
...
begin
  ...
  begin
    ...
    begin
      if wglShareLists(TVXWinContext(ServiceContext).FRC, FRC) then
      begin
...
begin
  ...
  begin
    FShareContext := TVXWinContext(aContext);
