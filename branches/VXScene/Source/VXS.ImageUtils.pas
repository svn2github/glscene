...
{$IFDEF VXS_REGIONS}{$REGION 'OpenGL format image to RGBA Float'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$REGION 'Decompression'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$ENDREGION 'Decompression'}{$ENDIF}
{$IFDEF VXS_REGIONS}{$REGION 'RGBA Float to OpenGL format image'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$ENDREGION 'RGBA Float to OpenGL format image'}{$ENDIF}
{$IFDEF VXS_REGIONS}{$REGION 'Compression'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$ENDREGION 'Compression'}{$ENDIF}
{$IFDEF VXS_REGIONS}{$REGION 'Image filters'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$ENDREGION 'Image filters'}{$ENDIF}
{$IFDEF VXS_REGIONS}{$REGION 'Data type conversion table'}{$ENDIF}
...
{$IFDEF VXS_REGIONS}{$ENDREGION 'Data type conversion table'}{$ENDIF}
...
procedure Div2(var Value: Integer); {$IFDEF VXS_INLINE} inline; {$ENDIF}
begin
  Value := Value div 2;
  if Value = 0 then
    Value := 1;
