...
procedure OptimizeMesh(aMeshObject : TVXMeshObject; options : TMeshOptimizerOptions); overload;
procedure OptimizeMesh(aMeshObject : TVXMeshObject); overload;
procedure FacesSmooth(aMeshObj: TVXMeshObject; aWeldDistance: Single=0.0000001; aThreshold: Single=35.0; InvertNormals:boolean=false);
