...
type
  ...
  TVXSilhouetteParameters = packed record
    SeenFrom, LightDirection: TAffineVector;
    Style: TVXSilhouetteStyle;
  ...
  { Base class storing a volume silhouette.
    ...
    This is the base class, you can use the TVXSilhouette subclass if you
  ...
  private
    ...
    FParameters: TVXSilhouetteParameters;
  protected
  ...
  public
    ...
    property Parameters: TVXSilhouetteParameters read FParameters write FParameters;
  ...
  public
    ...
    procedure CreateSilhouette(const ASilhouetteParameters: TVXSilhouetteParameters; var ASilhouette: TVXSilhouette;
  ...
  protected
    ...
    function ReuseOrFindVertexID(const SeenFrom: TAffineVector; ASilhouette: TVXSilhouette; index: integer): integer;
  public
...
constructor TVXSilhouette.Create;
begin
  inherited;
...
destructor TVXSilhouette.Destroy;
begin
  FCapIndices.Free;
  FIndices.Free;
  FVertices.Free;
...
procedure TVXSilhouette.SetIndices(const value: TIntegerList);
begin
  FIndices.Assign(value);
end;

procedure TVXSilhouette.SetCapIndices(const value: TIntegerList);
begin
  FCapIndices.Assign(value);
end;

procedure TVXSilhouette.SetVertices(const value: TVectorList);
begin
  FVertices.Assign(value);
end;

procedure TVXSilhouette.Flush;
begin
  FVertices.Flush;
  FIndices.Flush;
  FCapIndices.Flush;
...
procedure TVXSilhouette.ExtrudeVerticesToInfinity(const origin: TAffineVector);
var
...
procedure TVXSilhouette.AddEdgeToSilhouette(const v0, v1: TAffineVector; tightButSlow: Boolean);
begin
...
procedure TVXSilhouette.AddIndexedEdgeToSilhouette(const Vi0, Vi1: integer);

begin
  Indices.Add(Vi0, Vi1);
end;

procedure TVXSilhouette.AddCapToSilhouette(const v0, v1, v2: TAffineVector; tightButSlow: Boolean);
begin
  if tightButSlow then
...
procedure TVXSilhouette.AddIndexedCapToSilhouette(const Vi0, Vi1, vi2: integer);
begin
...
procedure TBaseConnectivity.CreateSilhouette(const ASilhouetteParameters: TVXSilhouetteParameters;
  var ASilhouette: TVXSilhouette; AddToSilhouette: Boolean);
begin
  // Purely virtual!
end;
...
procedure TConnectivity.CreateSilhouette(const silhouetteParameters: TVXSilhouetteParameters; var ASilhouette: TVXSilhouette;
...
function TConnectivity.ReuseOrFindVertexID(const SeenFrom: TAffineVector; ASilhouette: TVXSilhouette; index: integer): integer;
var
  pMemIndex: PInteger;
  memIndex, i: integer;
  oldCount: integer;
