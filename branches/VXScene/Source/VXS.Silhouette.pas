...
uses 
  ...
  VXS.VectorGeometry, VXS.VectorLists, VXS.CrossPlatform;
...
type
   ...
   TBaseConnectivity = class
       ...
       public
          ...
          procedure CreateSilhouette(const ASilhouetteParameters : TVXSilhouetteParameters; var ASilhouette : TVXSilhouette; AddToSilhouette : boolean); virtual;
   ...
   TConnectivity = class(TBaseConnectivity)
       protected
          ...
          function ReuseOrFindVertexID(const seenFrom : TAffineVector;
                     aSilhouette : TVXSilhouette; index : Integer) : Integer;
       public
...
// AddEdgeToSilhouette
//
procedure TVXSilhouette.AddEdgeToSilhouette(const v0, v1 : TAffineVector;
                                            tightButSlow : Boolean);
begin
...
// AddCapToSilhouette
//
procedure TVXSilhouette.AddCapToSilhouette(const v0, v1, v2 : TAffineVector;
                                           tightButSlow : Boolean);
begin
   if tightButSlow then
...
procedure TBaseConnectivity.CreateSilhouette(const ASilhouetteParameters : TVXSilhouetteParameters; var ASilhouette : TVXSilhouette; AddToSilhouette : boolean);
begin
  // Purely virtual!
end;
...
procedure TConnectivity.CreateSilhouette(
            const silhouetteParameters : TVXSilhouetteParameters;
...
function TConnectivity.ReuseOrFindVertexID(
     const seenFrom : TAffineVector; aSilhouette : TVXSilhouette; index : Integer) : Integer;
var
   pMemIndex : PInteger;
   memIndex, i : Integer;
   oldCount : Integer;
