...
begin
  ...
  begin
    FFullScreen := TVXDisplayOptions(Source).FFullScreen;
    FScreenResolution := TVXDisplayOptions(Source).FScreenResolution;
    FWindowAttributes := TVXDisplayOptions(Source).FWindowAttributes;
    FWindowFitting := TVXDisplayOptions(Source).FWindowFitting;
  end
  else
