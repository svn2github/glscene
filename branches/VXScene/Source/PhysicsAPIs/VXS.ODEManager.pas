...
type
  ...
  TODEElements = class;
  TVXODEBehaviour = class;
  TODEElementBase = class;
  TODEJointBase = class;

  TVXODEManager = class(TComponent)
  private
    FWorld: PdxWorld;
    FSpace: PdxSpace;
    ...
    FGeomColorDynD, FGeomColorDynE, FGeomColorStat: TVXColor;
  protected
    ...
    procedure SetGravity(Value: TVXCoordinates);
    procedure SetIterations(const val: Integer);
    function GetODEBehaviour(index: Integer): TVXODEBehaviour;
    procedure RegisterODEBehaviour(ODEBehaviour: TVXODEBehaviour);
    procedure UnregisterODEBehaviour(ODEBehaviour: TVXODEBehaviour);
    procedure SetRenderPoint(const Value: TVXRenderPoint);
    procedure RenderEvent(Sender: TObject; var rci: TVXRenderContextInfo);
    procedure RenderPointFreed(Sender: TObject);
    procedure SetVisible(const Value: Boolean);
    procedure SetVisibleAtRunTime(const Value: Boolean);
    procedure SetGeomColorDynE(const Value: TVXColor);
    procedure GeomColorChangeDynE(Sender: TObject);
    procedure SetGeomColorDynD(const Value: TVXColor);
    procedure GeomColorChangeDynD(Sender: TObject);
    procedure SetGeomColorStat(const Value: TVXColor);
    procedure GeomColorChangeStat(Sender: TObject);
    property ODEBehaviours[index: Integer]: TVXODEBehaviour read GetODEBehaviour;
  public
  ...
  published
    ...
    property GeomColorDynD: TVXColor read FGeomColorDynD write SetGeomColorDynD;
    property GeomColorDynE: TVXColor read FGeomColorDynE write SetGeomColorDynE;
    property GeomColorStat: TVXColor read FGeomColorStat write SetGeomColorStat;
  end;
  ...
  TVXODEBehaviour = class(TVXBehaviour)
  private
    FManager: TVXODEManager;
    FManagerName: String;
  ...
  protected
    ...
    procedure Loaded; override;
    procedure SetManager(Value: TVXODEManager);
  ...
  published
    property Manager: TVXODEManager read FManager write SetManager;
  ...
  TVXODEDynamic = class(TVXODEBehaviour)
  private
    FBody: PdxBody;
    FMass: TdMass;
  ...
  TVXODEStatic = class(TVXODEBehaviour)
  private
    FElements: TODEElements;
  protected
    procedure Initialize; override;
  ...
  private
    ...
    FPosition, FDirection, FUp: TVXCoordinates;
  ...
  protected
    ...
    procedure SetPosition(const Value: TVXCoordinates);
  ...
  TVXODEJointList = class(TComponent)
  private
    FJoints: TODEJoints;
  protected
  ...
  protected
    ...
    procedure Loaded; override;
    function IsODEInitialized: Boolean;
    procedure RegisterJointWithObject(Obj: TVXBaseSceneObject);
    procedure UnregisterJointWithObject(Obj: TVXBaseSceneObject);
    procedure Attach;
    procedure SetManager(const Value: TVXODEManager);
    procedure SetObject1(const Value: TVXBaseSceneObject);
    procedure SetObject2(const Value: TVXBaseSceneObject);
    procedure SetEnabled(const Value: Boolean);
  ...
  published
    property Manager: TVXODEManager read FManager write SetManager;
    property Object1: TVXBaseSceneObject read FObject1 write SetObject1;
    property Object2: TVXBaseSceneObject read FObject2 write SetObject2;
  ...
  public
    ...
    class function FriendlyDescription: String; override;
  published
    property Anchor: TVXCoordinates read FAnchor write SetAnchor;
    property Axis: TVXCoordinates read FAxis write SetAxis;
  ...
  private
    FAnchor, FAxis1, FAxis2: TVXCoordinates;
    FAxis1Params, FAxis2Params: TODEJointParams;
  protected
    procedure WriteToFiler(writer: TWriter); override;
    procedure ReadFromFiler(reader: TReader); override;
    procedure SetAnchor(const Value: TVXCoordinates);
    procedure SetAxis1(const Value: TVXCoordinates);
    procedure SetAxis2(const Value: TVXCoordinates);
    procedure AnchorChange(Sender: TObject);
  ...
  published
    property Anchor: TVXCoordinates read FAnchor write SetAnchor;
    property Axis1: TVXCoordinates read FAxis1 write SetAxis1;
    property Axis2: TVXCoordinates read FAxis2 write SetAxis2;
...
function GetBodyFromVXSceneObject(anObject: TVXBaseSceneObject): PdxBody;
...
function GetOdeStatic(Obj: TVXBaseSceneObject): TVXODEStatic;
function GetOrCreateOdeStatic(Obj: TVXBaseSceneObject): TVXODEStatic;
function GetOdeDynamic(Obj: TVXBaseSceneObject): TVXODEDynamic;
...
procedure nearCallBack(Data: Pointer; o1, o2: PdxGeom); cdecl;
begin
  TVXODEManager(Data).Collision(o1, o2);
end;
...
begin
  ...
  if Assigned(anObject) then
    if anObject is TVXODEDynamic then
      Result := TVXODEDynamic(anObject).Body;
end;
...
begin
  ...
  if Assigned(anObject) then
  begin
    temp := TVXODEDynamic(anObject.Behaviours.GetByClass(TVXODEDynamic));
    if temp <> nil then
      Result := temp.Body;
  end;
end;
...
function GetSurfaceFromObject(anObject: TObject): TODECollisionSurface;
var
  ODEBehaviour: TVXODEBehaviour;
begin
  Result := nil;
  if Assigned(anObject) then
    if anObject is TVXODEBehaviour then
      Result := TVXODEBehaviour(anObject).Surface
    else
    begin
      if (anObject is TVXBaseSceneObject) then
      begin
        ODEBehaviour := TVXODEBehaviour(TVXBaseSceneObject(anObject)
          .Behaviours.GetByClass(TVXODEBehaviour));
...
function IsGLODEObject(Obj: TVXBaseSceneObject): Boolean;
var
  temp: TVXODEDynamic;
begin
  Result := False;
  ...
  begin
    temp := TVXODEDynamic(Obj.Behaviours.GetByClass(TVXODEDynamic));
...
function GetOdeStatic(Obj: TVXBaseSceneObject): TVXODEStatic;
begin
  Result := TVXODEStatic(Obj.Behaviours.GetByClass(TVXODEStatic));
end;

function GetOrCreateOdeStatic(Obj: TVXBaseSceneObject): TVXODEStatic;
begin
  Result := TVXODEStatic(Obj.GetOrCreateBehaviour(TVXODEStatic));
end;

function GetOdeDynamic(Obj: TVXBaseSceneObject): TVXODEDynamic;
begin
  Result := TVXODEDynamic(Obj.Behaviours.GetByClass(TVXODEDynamic));
end;

function GetOrCreateOdeDynamic(Obj: TVXBaseSceneObject): TVXODEDynamic;
begin
  Result := TVXODEDynamic(Obj.GetOrCreateBehaviour(TVXODEDynamic));
end;
...
constructor TVXODEManager.Create(AOwner: TComponent);
begin
  FWorld := nil;
  if not InitODE('') then
  ...
  FGravity := TVXCoordinates.CreateInitialized(Self, NullHmgPoint, csVector);
  ...
  FGeomColorDynD := TVXColor.CreateInitialized(Self, clrRed,
    GeomColorChangeDynD);
  FGeomColorDynE := TVXColor.CreateInitialized(Self, clrLime,
    GeomColorChangeDynE);
  FGeomColorStat := TVXColor.CreateInitialized(Self, clrBlue,
    GeomColorChangeStat);

  RegisterManager(Self);
end;

destructor TVXODEManager.Destroy;
begin
  RenderPoint := nil;
...
procedure TVXODEManager.RegisterODEBehaviour(ODEBehaviour: TVXODEBehaviour);
begin
  FODEBehaviours.Add(ODEBehaviour);
end;

procedure TVXODEManager.UnregisterODEBehaviour(ODEBehaviour: TVXODEBehaviour);
begin
  FODEBehaviours.Remove(ODEBehaviour);
end;

procedure TVXODEManager.Loaded;
begin
  GravityChange(Self);
end;

procedure TVXODEManager.SetGravity(Value: TVXCoordinates);
begin
  FGravity.SetPoint(Value.DirectX, Value.DirectY, Value.DirectZ);
end;

procedure TVXODEManager.GravityChange(Sender: TObject);
begin
  if Assigned(FWorld) then
    dWorldSetGravity(FWorld, FGravity.X, FGravity.Y, FGravity.Z);
end;

procedure TVXODEManager.CalcContact(Object1, Object2: TObject;
...
procedure TVXODEManager.Collision(g1, g2: PdxGeom);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if TObject(Obj1) is TVXODEBehaviour then
        if Assigned(TVXODEBehaviour(Obj1).FOnCollision) then
          TVXODEBehaviour(Obj1).FOnCollision(Self, Obj2, FContacts[i],
            HandleCollision);
      if TObject(Obj2) is TVXODEBehaviour then
        if Assigned(TVXODEBehaviour(Obj2).FOnCollision) then
          TVXODEBehaviour(Obj2).FOnCollision(Self, Obj1, FContacts[i],
            HandleCollision);
    end
    else
    begin
...
procedure TVXODEManager.Step(deltaTime: double);
var
  i: Integer;
  vec: PdVector3;
  Body: PdxBody;
...
begin
  ...
  for i := 0 to FODEBehaviours.Count - 1 do
    if ODEBehaviours[i] is TVXODEStatic then
      if ODEBehaviours[i].Initialized then
        TVXODEStatic(ODEBehaviours[i]).AlignElements;
  ...
  for i := 0 to FODEBehaviours.Count - 1 do
    if ODEBehaviours[i] is TVXODEDynamic then
      if ODEBehaviours[i].Initialized then
        TVXODEDynamic(ODEBehaviours[i]).AlignObject;
  ...
  begin
    if TObject(FRFContactList[0]) is TVXODEDynamic then
    begin
      Body := TVXODEDynamic(FRFContactList[0]).Body;
      Coeff := 1 - (TVXODEDynamic(FRFContactList[0])
        .Surface.RollingFrictionCoeff / TVXODEDynamic(FRFContactList[0])
        .Mass.Mass);
    end;
...
procedure TVXODEManager.NotifyChange(Sender: TObject);
begin
  if Assigned(RenderPoint) then
    RenderPoint.StructureChanged;
end;

procedure TVXODEManager.SetIterations(const val: Integer);
begin
  FIterations := val;
  if Assigned(FWorld) then
    dWorldSetQuickStepNumIterations(FWorld, FIterations);
...
procedure TVXODEManager.SetMaxContacts(const Value: Integer);
begin
...
function TVXODEManager.GetODEBehaviour(index: Integer): TVXODEBehaviour;
begin
  Result := TVXODEBehaviour(FODEBehaviours[index]);
end;

procedure TVXODEManager.SetRenderPoint(const Value: TVXRenderPoint);
begin
...
procedure TVXODEManager.RenderEvent(Sender: TObject;
...
begin
  ...
  begin
    if ODEBehaviours[i] is TVXODEDynamic then
      if TVXODEDynamic(ODEBehaviours[i]).GetEnabled then
...
procedure TVXODEManager.RenderPointFreed(Sender: TObject);
begin
  FRenderPoint := nil;
end;

procedure TVXODEManager.SetVisible(const Value: Boolean);
begin
...
procedure TVXODEManager.SetVisibleAtRunTime(const Value: Boolean);
begin
...
procedure TVXODEManager.SetGeomColorDynD(const Value: TVXColor);
begin
  FGeomColorDynD.Assign(Value);
  NotifyChange(Self);
end;

procedure TVXODEManager.GeomColorChangeDynD(Sender: TObject);
begin
  NotifyChange(Self);
end;

procedure TVXODEManager.SetGeomColorDynE(const Value: TVXColor);
begin
  FGeomColorDynE.Assign(Value);
  NotifyChange(Self);
end;

procedure TVXODEManager.GeomColorChangeDynE(Sender: TObject);
begin
  NotifyChange(Self);
end;

procedure TVXODEManager.SetGeomColorStat(const Value: TVXColor);
begin
  FGeomColorStat.Assign(Value);
  NotifyChange(Self);
end;

procedure TVXODEManager.GeomColorChangeStat(Sender: TObject);
begin
  NotifyChange(Self);
end;
...
begin
  ...
  if Assigned(FOwnerBaseSceneObject) then
    RegisterVXSceneObject(OwnerBaseSceneObject);
end;

// Destroy
//
destructor TVXODEBehaviour.Destroy;
begin
  if Assigned(Manager) then
    Manager := nil;
  if Assigned(FOwnerBaseSceneObject) then
    UnregisterVXSceneObject(FOwnerBaseSceneObject);
  FSurface.Free;
  inherited;
end;
...
// Initialize
//
procedure TVXODEBehaviour.Initialize;
begin
  FInitialized := True;
end;
...
// Finalize
//
procedure TVXODEBehaviour.Finalize;
begin
  FInitialized := False;
end;
...
// Reinitialize
//
procedure TVXODEBehaviour.Reinitialize;
begin
  if Initialized then
    Finalize;
  Initialize;
...
// WriteToFiler
//
procedure TVXODEBehaviour.WriteToFiler(writer: TWriter);
begin
  inherited;
  with writer do
  begin
...
// ReadFromFiler
//
procedure TVXODEBehaviour.ReadFromFiler(reader: TReader);
begin
  inherited;
  with reader do
  begin
...
// Loaded
//
procedure TVXODEBehaviour.Loaded;
var
  mng: TComponent;
begin
  inherited;
  ...
  begin
    mng := FindManager(TVXODEManager, FManagerName);
    if Assigned(mng) then
      Manager := TVXODEManager(mng);
    FManagerName := '';
  end
end;
...
// Render
//
procedure TVXODEBehaviour.Render(var rci: TVXRenderContextInfo);
begin
  // virtual
end;
...
// NotifyChange
//
procedure TVXODEBehaviour.NotifyChange(Sender: TObject);
begin
  if Assigned(Manager) then
...
// SetManager
//
procedure TVXODEBehaviour.SetManager(Value: TVXODEManager);
begin
...
// SetSurface
//
procedure TVXODEBehaviour.SetSurface(Value: TODECollisionSurface);
begin
...
// GetAbsoluteMatrix
//
function TVXODEBehaviour.GetAbsoluteMatrix: TMatrix;
begin
  Result := IdentityHMGMatrix;
  if Assigned(Owner.Owner) then
    if Owner.Owner is TVXBaseSceneObject then
      Result := TVXBaseSceneObject(Owner.Owner).AbsoluteMatrix;
end;
...
// Destroy
//
destructor TVXODEDynamic.Destroy;
begin
  FElements.Free;
  FJointRegister.Free;
  inherited;
...
// Render
//
procedure TVXODEDynamic.Render(var rci: TVXRenderContextInfo);
var
  Mat: TMatrix;
begin
  if Assigned(Owner.Owner) then
...
// FriendlyName
//
class function TVXODEDynamic.FriendlyName: String;
begin
  Result := 'ODE Dynamic';
end;
...
// Initialize
//
procedure TVXODEDynamic.Initialize;
var
  i: Integer;
begin
...
// Finalize
//
procedure TVXODEDynamic.Finalize;
var
  i: Integer;
begin
...
// WriteToFiler
//
procedure TVXODEDynamic.WriteToFiler(writer: TWriter);
begin
  inherited;
  with writer do
  begin
...
// ReadFromFiler
//
procedure TVXODEDynamic.ReadFromFiler(reader: TReader);
var
  archiveVersion: Integer;
begin
  inherited;
...
// AddNewElement
//
function TVXODEDynamic.AddNewElement(AChild: TODEElementClass): TODEElementBase;
var
  calcmass: TdMass;
begin
...
// CalculateMass
//
function TVXODEDynamic.CalculateMass: TdMass;
var
  i: Integer;
  m: TdMass;
begin
...
// CalibrateCenterOfMass
//
procedure TVXODEDynamic.CalibrateCenterOfMass;
var
  Pos: TAffineVector;
begin
...
// GetMass
//
function TVXODEDynamic.GetMass: TdMass;
begin
...
// SetMass
//
procedure TVXODEDynamic.SetMass(const Value: TdMass);
begin
  FMass := Value;
...
// UniqueItem
//
class function TVXODEDynamic.UniqueItem: Boolean;
begin
  Result := True;
end;
...
// SetEnabled
//
procedure TVXODEDynamic.SetEnabled(const Value: Boolean);
begin
  FEnabled := Value;
  if Assigned(FBody) then
  begin
...
// GetEnabled
//
function TVXODEDynamic.GetEnabled: Boolean;
begin
  if Assigned(FBody) then
...
// AddForce
//
procedure TVXODEDynamic.AddForce(Force: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddlForceAtPos
//
procedure TVXODEDynamic.AddForceAtPos(Force, Pos: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddForceAtRelPos
//
procedure TVXODEDynamic.AddForceAtRelPos(Force, Pos: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddRelForce
//
procedure TVXODEDynamic.AddRelForce(Force: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddRelForceAtPos
//
procedure TVXODEDynamic.AddRelForceAtPos(Force, Pos: TAffineVector);
begin
  if Assigned(FBody) then
    dBodyAddForceAtPos(FBody, Force.X, Force.Y, Force.Z, Pos.X, Pos.Y, Pos.Z);
end;
...
// AddRelForceAtRelPos
//
procedure TVXODEDynamic.AddRelForceAtRelPos(Force, Pos: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddTorque
//
procedure TVXODEDynamic.AddTorque(Torque: TAffineVector);
begin
  if Assigned(FBody) then
...
// AddRelTorque
//
procedure TVXODEDynamic.AddRelTorque(Torque: TAffineVector);
begin
  if Assigned(FBody) then
...
// ReadFromFiler
//
procedure TVXODEStatic.ReadFromFiler(reader: TReader);
begin
  inherited;
  with reader do
  begin
...
begin
  if Assigned(Owner) then
    if Owner is TVXODEBehaviour then
      TVXODEBehaviour(Owner).NotifyChange(Self);
end;
...
begin
  ...
  FDensity := 1;
  FInitialized := False;
  FDynamic := (Owner.Owner is TVXODEDynamic);
...
begin
  ...
  if Owner.Owner is TVXODEBehaviour then
    Manager := TVXODEBehaviour(Owner.Owner).Manager;
  if not Assigned(Manager) then
    Exit;

  if FDynamic then
  begin
    if Owner.Owner is TVXODEDynamic then
      Body := TVXODEDynamic(Owner.Owner).Body;
...
begin
  ...
  if Owner.Owner is TVXODEBehaviour then
    Mat := TVXODEBehaviour(Owner.Owner).AbsoluteMatrix;
...
// SetPosition
//
procedure TODEElementBase.SetPosition(const Value: TVXCoordinates);
begin
...
// Render
//
procedure TODEElementSphere.Render(var rci: TVXRenderContextInfo);
var
...
// Render
//
procedure TODEElementCapsule.Render(var rci: TVXRenderContextInfo);
var
...
// Render
//
procedure TODEElementCylinder.Render(var rci: TVXRenderContextInfo);
var
  i, J, Stacks, Slices: Integer;
begin
  glPushMatrix;
...
begin
  ...
  if Assigned(TODEElements(collection).Owner) then
    if TODEElements(collection).Owner is TVXODEStatic then
      Result := True;
end;
...
// Create
//
constructor TVXODEJointList.Create(AOwner: TComponent);
begin
  inherited;
...
// Destroy
//
destructor TVXODEJointList.Destroy;
begin
  FJoints.Free;
  inherited;
end;
...
// DefineProperties
//
procedure TVXODEJointList.DefineProperties(Filer: TFiler);
begin
  inherited;
...
// WriteJoints
//
procedure TVXODEJointList.WriteJoints(stream: TStream);
var
  writer: TWriter;
begin
...
// ReadJoints
//
procedure TVXODEJointList.ReadJoints(stream: TStream);
var
  reader: TReader;
begin
...
// Loaded
//
procedure TVXODEJointList.Loaded;
var
  i: Integer;
begin
  inherited;
...
// Notification
//
procedure TVXODEJointList.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  i: Integer;
begin
  inherited;
  if (Operation = opRemove) and (AComponent is TVXBaseSceneObject) then
    for i := 0 to Joints.Count - 1 do
    begin
      if TVXBaseSceneObject(AComponent) = Joints[i].Object1 then
        Joints[i].Object1 := nil;
      if TVXBaseSceneObject(AComponent) = Joints[i].Object2 then
...
//
procedure TODEJointBase.RegisterJointWithObject(Obj: TVXBaseSceneObject);
var
  temp: TVXODEDynamic;
begin
  if Assigned(Obj) then
...
//
procedure TODEJointBase.UnregisterJointWithObject(Obj: TVXBaseSceneObject);
var
  temp: TVXODEDynamic;
begin
  if Assigned(Obj) then
...
begin
  ...
  if Enabled then
  begin
    Body1 := GetBodyFromVXSceneObject(FObject1);
    Body2 := GetBodyFromVXSceneObject(FObject2);
  end
  else
  begin
    Body1 := nil;
...
// SetManager
//
procedure TODEJointBase.SetManager(const Value: TVXODEManager);
begin
  if FManager <> Value then
  begin
    if Assigned(FManager) then
...
// SetObject1
//
procedure TODEJointBase.SetObject1(const Value: TVXBaseSceneObject);
begin
...
// SetObject2
//
procedure TODEJointBase.SetObject2(const Value: TVXBaseSceneObject);
begin
...
begin
  ...
  begin
    Obj := GetVXSceneObject(FObject1Name);
    if Assigned(Obj) then
      Object1 := Obj;
    FObject1Name := '';
  end;
  ...
  begin
    Obj := GetVXSceneObject(FObject2Name);
    if Assigned(Obj) then
      Object2 := Obj;
    FObject2Name := '';
  end;
...
// SetAnchor
//
procedure TGLODEJointHinge.SetAnchor(const Value: TVXCoordinates);
begin
...
// SetAxis
//
procedure TGLODEJointHinge.SetAxis(const Value: TVXCoordinates);
begin
  FAxis.Assign(Value);
end;
...
// SetAnchor
//
procedure TODEJointBall.SetAnchor(const Value: TVXCoordinates);
begin
  FAnchor.Assign(Value);
end;
...
// SetAxis
//
procedure TODEJointSlider.SetAxis(const Value: TVXCoordinates);
begin
  FAxis.Assign(Value);
end;
...
begin
  ...
  FAnchor := TVXCoordinates.CreateInitialized(Self, NullHmgPoint, csPoint);
  FAnchor.OnNotifyChange := AnchorChange;
  FAxis1 := TVXCoordinates.CreateInitialized(Self, ZHmgVector, csVector);
  FAxis1.OnNotifyChange := Axis1Change;
  FAxis2 := TVXCoordinates.CreateInitialized(Self, ZHmgVector, csVector);
...
// SetAxis2
//
procedure TGLODEJointHinge2.SetAxis2(const Value: TVXCoordinates);
begin
  FAxis2.Assign(Value);
end;
...
begin
  ...
  FAxis1 := TVXCoordinates.CreateInitialized(Self, ZHmgVector, csVector);
  FAxis1.OnNotifyChange := Axis1Change;
  FAxis2 := TVXCoordinates.CreateInitialized(Self, XHmgVector, csVector);
  FAxis2.OnNotifyChange := Axis2Change;
  FAxis1Params := TODEJointParams.Create(Self);
  FAxis1Params.SetCallback := SetAxis1Param;
  FAxis1Params.GetCallback := GetAxis1Param;
