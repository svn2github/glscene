...
//
{
   String constants that are used in many VXScene units
}
...
resourcestring
  ...
  // SceneEdit
  strVXSceneEditor = 'VXScene Editor';
  ...
  // Object categories in VXSceneRegistry
  ...
  strCUDAEditor = 'VXScene CUDA Component Editor';
