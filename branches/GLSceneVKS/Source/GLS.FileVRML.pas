...
//
{
   Preliminary VRML vector file support for VKScene.
...
var
  ...
  function AddMaterialToLibrary(VRMLMaterial : TVRMLMaterial) : TVKLibMaterial;
  var
    matname : String;
  begin
    Result:=nil;
  ...
  var
    ...
    fg : TFGVertexNormalTexIndexList;
    face : TIntegerList;
    tempLibMat : TVKLibMaterial;
    saveTransform, mat : TMatrix;
    saveMaterial : TVKLibMaterial;
    axis : TAffineVector;
    angle : Single;
  begin
