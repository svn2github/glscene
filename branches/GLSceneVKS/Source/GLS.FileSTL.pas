...
var
  ...
  begin
    ...
    begin
      aNormal.X := GLS.Utils.StrToFloatDef(sl[2], 0);
      aNormal.Y := GLS.Utils.StrToFloatDef(sl[3], 0);
      aNormal.Z := GLS.Utils.StrToFloatDef(sl[4], 0);
    end;
  end;
  ...
  begin
    ...
    begin
      aVertex.X := GLS.Utils.StrToFloatDef(sl[1], 0);
      aVertex.Y := GLS.Utils.StrToFloatDef(sl[2], 0);
      aVertex.Z := GLS.Utils.StrToFloatDef(sl[3], 0);
    end;
  end;
