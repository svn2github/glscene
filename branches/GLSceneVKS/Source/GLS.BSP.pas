...
uses
  System.Classes, GLS.VectorFileObjects, GLS.Material, GLS.CrossPlatform, GLS.VectorGeometry,
  GLS.VectorLists, GLS.Color, GLS.RenderContextInfo;
...
uses System.SysUtils, GLS.VectorTypes;
