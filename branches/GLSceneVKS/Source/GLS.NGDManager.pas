...
uses
  ...
  GLS.Color, GLS.GeometryBB; // For show debug
...
type
  ...
  protected
    ...
    procedure SetGLLines(const Value: TVKLines);
  ...
  published
    ...
    property DebugOption: TNGDDebugOption read FNGDDebugOption write
      FNGDDebugOption;
    property Line: TVKLines read FGLLines write SetGLLines;
...
procedure TVKNGDManager.SetGLLines(const Value: TVKLines);
begin
  if Assigned(FGLLines) then
    FGLLines.Nodes.Clear;
    ...
    with Joint do
      ...
      begin
        ...
        BallAndSocketSetConeAngle(FNewtonUserJoint,
          GLS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FConeAngle));
        BallAndSocketSetTwistAngle(FNewtonUserJoint,
          GLS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FMinTwistAngle),
          GLS.VectorGeometry.DegToRad(FCustomBallAndSocketOptions.FMaxTwistAngle));
    ...
    with Joint do
      ...
      begin
        ...
        HingeSetLimits(FNewtonUserJoint,
          GLS.VectorGeometry.DegToRad(FCustomHingeOptions.FMinAngle),
          GLS.VectorGeometry.DegToRad(FCustomHingeOptions.FMaxAngle));
        CustomSetBodiesCollisionState(FNewtonUserJoint, Ord(FCollisionState));
        NewtonJointSetStiffness(CustomGetNewtonJoint(FNewtonUserJoint),
          FStiffness);
...
procedure TVKNGDBehaviour.SetHeightFieldOptions(const Value: THeightField);
begin
