...
uses
  System.Classes,
  //GLS
  GLS.Texture, GLS.Scene, GLS.VectorGeometry, GLS.Context, GLS.Material,
  GLS.GLSLShader, GLS.CustomShader, GLS.RenderContextInfo, GLS.TextureFormat,
  GLS.VectorTypes;
