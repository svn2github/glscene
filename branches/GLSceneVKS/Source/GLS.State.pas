...
type
  ...
  private
    ...
    FMaxSamples: GLuint;
    FTextureBinding: array[0..MAX_HARDWARE_TEXTURE_UNIT - 1, TVKTextureTarget] of GLuint;
  ...
  public
    ...
    property TextureBinding[Index: Integer; target: TVKTextureTarget]: GLuint
  ...
  { Sets the blend equation for RGB + alpha to the same value. }
    ...
    procedure SetBufferIndexedBinding(const Value: GLuint; ATarget: TVKBufferBindingTarget; AIndex: GLuint; ABufferSize: GLsizeiptr); overload;
    procedure SetBufferIndexedBinding(const Value: GLuint; ATarget: TVKBufferBindingTarget; AIndex: GLuint; AOffset: GLintptr; ARangeSize: GLsizeiptr); overload;
...
{$WARN SYMBOL_DEPRECATED OFF}
  cGLStateTypeToGLEnum: array[TVKStateType] of GLEnum = (
...
{$WARN SYMBOL_DEPRECATED ON}
  ...
  cGLBufferBindingTarget: array[TVKBufferBindingTarget] of GLEnum =
...
procedure TVKStateCache.SetActiveTexture(const Value: GLint);
begin
...
procedure TVKStateCache.SetVertexArrayBinding(const Value: GLuint);
begin
...
function TVKStateCache.GetArrayBufferBinding: GLuint;
begin
  Result := FArrayBufferBinding;
end;

procedure TVKStateCache.SetArrayBufferBinding(const Value: GLuint);
begin
...
function TVKStateCache.GetElementBufferBinding: GLuint;
begin
  Result := FElementBufferBinding
end;

procedure TVKStateCache.SetElementBufferBinding(const Value: GLuint);
begin
...
function TVKStateCache.GetEnablePrimitiveRestart: GLboolean;
begin
  Result := FEnablePrimitiveRestart;
end;

procedure TVKStateCache.SetEnablePrimitiveRestart(const enabled: GLboolean);
begin
...
function TVKStateCache.GetPrimitiveRestartIndex: GLuint;
begin
  Result := FPrimitiveRestartIndex;
end;

procedure TVKStateCache.SetPrimitiveRestartIndex(const index: GLuint);
begin
...
procedure TVKStateCache.SetEnableProgramPointSize(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetClampReadColor(const Value: GLEnum);
begin
...
procedure TVKStateCache.SetCopyReadBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetCopyWriteBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetCurrentProgram(const Value: GLuint);
begin
...
procedure TVKStateCache.SetTextureBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetDepthClearValue(const Value: GLfloat);
begin
...
procedure TVKStateCache.SetDepthRange(const ZNear, ZFar: GLclampd);
begin
...
procedure TVKStateCache.SetDepthRangeFar(const Value: GLclampd);
begin
...
procedure TVKStateCache.SetDepthRangeNear(const Value: GLclampd);
begin
...
procedure TVKStateCache.SetDepthWriteMask(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetDrawFrameBuffer(const Value: GLuint);
begin
...
procedure TVKStateCache.SetEnableColorLogicOp(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetEnableCullFace(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableDepthClamp(const enabled: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableDepthTest(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableDither(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableFramebufferSRGB(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableLineSmooth(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableMultisample(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnablePolygonOffsetFill(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnablePolygonOffsetLine(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnablePolygonOffsetPoint(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnablePolygonSmooth(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableSampleAlphaToCoverage(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetEnableSampleCoverage(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetEnableSampleMask(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetEnableSampleAlphaToOne(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetEnableScissorTest(const Value: GLboolean);
begin

end;

procedure TVKStateCache.SetEnableStencilTest(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetFrameBuffer(const Value: GLuint);
begin
...
function TVKStateCache.GetCurrentQuery(Index: TQueryType): GLuint;
begin
...
function TVKStateCache.GetDepthRangeFar: GLclampd;
begin
  Result := FDepthRange[1];
end;

function TVKStateCache.GetDepthRangeNear: GLclampd;
begin
  Result := FDepthRange[0];
end;

function TVKStateCache.GetEnableBlend(Index: Integer): GLboolean;
begin
...
function TVKStateCache.GetSampleMaskValue(Index: Integer): GLbitfield;
begin
  Result := FSampleMaskValue[Index];
end;

function TVKStateCache.GetMaxTextureSize: GLuint;
begin
...
function TVKStateCache.GetMax3DTextureSize: GLuint;
begin
...
function TVKStateCache.GetMaxCubeTextureSize: GLuint;
begin
...
function TVKStateCache.GetMaxArrayTextureSize: GLuint;
begin
...
function TVKStateCache.GetMaxTextureImageUnits: GLuint;
begin
...
function TVKStateCache.GetMaxTextureAnisotropy: GLuint;
begin
...
function TVKStateCache.GetMaxSamples: GLuint;
begin
...
function TVKStateCache.GetTextureBinding(Index: Integer;
  target: TVKTextureTarget): GLuint;
begin
...
function TVKStateCache.GetSamplerBinding(Index: GLuint): GLuint;
begin
  Result := FSamplerBinding[Index];
end;

procedure TVKStateCache.SetSamplerBinding(Index: GLuint; const Value: GLuint);
begin
...
procedure TVKStateCache.SetLineStippleFactor(const Value: GLint);
begin
...
procedure TVKStateCache.SetLineStipplePattern(const Value: GLushort);
begin
...
procedure TVKStateCache.SetPackAlignment(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackImageHeight(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackLSBFirst(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetPackRowLength(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackSkipImages(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackSkipPixels(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackSkipRows(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPackSwapBytes(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetPixelPackBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPixelUnpackBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetPointFadeThresholdSize(const Value: GLfloat);
begin
...
procedure TVKStateCache.SetPointSize(const Value: GLfloat);
begin
...
procedure TVKStateCache.SetPointSpriteCoordOrigin(const Value: GLEnum);
begin
...
procedure TVKStateCache.SetPolygonOffset(const factor, units: GLfloat);
begin
...
procedure TVKStateCache.SetPolygonOffsetFactor(const Value: GLfloat);
begin
...
procedure TVKStateCache.SetPolygonOffsetUnits(const Value: GLfloat);
begin
...
procedure TVKStateCache.SetProvokingVertex(const Value: GLEnum);
begin
...
procedure TVKStateCache.SetReadFrameBuffer(const Value: GLuint);
begin
...
procedure TVKStateCache.SetRenderBuffer(const Value: GLuint);
begin
...
procedure TVKStateCache.SetSampleCoverage(const Value: GLfloat;
  invert: GLboolean);
begin
...
procedure TVKStateCache.SetSampleCoverageInvert(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetSampleCoverageValue(const Value: GLfloat);
begin
...
begin
  ...
  begin
    if FInsideList then
      ...
      FScissorBox := Value;
    glScissor(Value.V[0], Value.V[1], Value.V[2], Value.V[3]);
  end;
end;

procedure TVKStateCache.SetStencilBackWriteMask(const Value: GLuint);
begin
...
procedure TVKStateCache.SetStencilWriteMask(const Value: GLuint);
{$IFDEF GLS_CACHE_MISS_CHECK}
var I: GLuint;
{$ENDIF}
begin
...
procedure TVKStateCache.SetTransformFeedbackBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.NewList(list: GLuint; mode: GLEnum);
var
  I: GLuint;
begin
...
procedure TVKStateCache.CallList(list: GLuint);
begin
...
procedure TVKStateCache.SetUniformBufferBinding(const Value: GLuint);
begin
...
procedure TVKStateCache.SetBufferIndexedBinding(const Value: GLuint;
  ATarget: TVKBufferBindingTarget; AIndex: GLuint; ABufferSize: GLsizeiptr);
begin
  Assert(not FInsideList);
...
procedure TVKStateCache.SetBufferIndexedBinding(const Value: GLuint;
  ATarget: TVKBufferBindingTarget; AIndex: GLuint;
...
function TVKStateCache.GetMaxTextureUnits: GLuint;
begin
...
procedure TVKStateCache.SetUnpackAlignment(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackImageHeight(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackLSBFirst(const Value: GLboolean);
begin
...
procedure TVKStateCache.SetUnpackRowLength(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackSkipImages(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackSkipPixels(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackSkipRows(const Value: GLuint);
begin
...
procedure TVKStateCache.SetUnpackSwapBytes(const Value: GLboolean);
begin
