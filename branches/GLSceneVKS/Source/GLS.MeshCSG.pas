...
procedure CSG_Operation(obj1, obj2: TVKMeshObject; Operation: TCSGOperation; Res: TVKMeshObject; const MaterialName1, MaterialName2: string);
...
procedure CSG_Iterate_tri(const vec, nor: TCSGTri; BSP: TBSPMeshObject; Node: TFGBSPNode; ResMesh: TVKMeshObject; ResFG: TFGVertexNormalTexIndexList; keepinside, keepoutside, inverttriangle: Boolean);
