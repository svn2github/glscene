          ...
          begin
            ...
            try
              ...
              begin
                ...
                Diffuse.Alpha := GLS.Utils.StrToFloatDef(objMtl.MaterialStringProperty(matName, 'd'), 1);
...
begin
  ...
  try
    ...
    begin
      ...
      for i := 0 to 3 do
        if sl.Count > i then
          Result.V[i] := GLS.Utils.StrToFloatDef(sl[i], 0)
        else
          Break;
    end
    else
...
initialization
  ...
  GLS.VectorFileObjects.RegisterVectorFileFormat('obj', 'WaveFront model file', TVKOBJVectorFile);
  GLS.VectorFileObjects.RegisterVectorFileFormat('objf', 'Stripe model file', TVKOBJVectorFile);
