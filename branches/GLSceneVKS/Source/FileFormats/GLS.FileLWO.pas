...
type
  ...
  private
    ...
    procedure AddPnts(Pnts: TLWPnts; Mesh: TVKMeshObject);
    procedure AddPols(Pols: TLWPols; Mesh: TVKMeshObject);
    procedure AddVMap(VMap: TLWVMap; Mesh: TVKMeshObject);
  public
...
procedure TVKLWOVectorFile.AddLayr(Layr: TLWLayr; LWO: TLWObjectFile);
var
  Idx: Integer;
  Mesh: TVKMeshObject;
  Pnts: TLWPnts;
...
procedure TVKLWOVectorFile.AddPnts(Pnts: TLWPnts; Mesh: TVKMeshObject);
var
  i: Integer;
begin
...
procedure TVKLWOVectorFile.AddPols(Pols: TLWPols; Mesh: TVKMeshObject);
var
  Idx: Integer;
...
procedure TVKLWOVectorFile.AddSurf(Surf: TLWSurf; LWO: TLWObjectFile);
var
  matLib: TVKMaterialLibrary;
  libMat: TVKLibMaterial;
  tex2Mat: TVKLibMaterial;
  colr: TColr12;
...
procedure TVKLWOVectorFile.AddVMap(VMap: TLWVMap; Mesh: TVKMeshObject);
var
  i: integer;
begin
...
procedure TVKLWOVectorFile.LoadFromStream(aStream: TStream);
var
  Ind: Integer;
begin
...
initialization
  RegisterVectorFileFormat('lwo', 'Lightwave3D object file (6.0 or above)', TVKLWOVectorFile);
