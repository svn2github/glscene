   ...
   try
      ...
      while sl[i]<>'end' do begin
         ...
         while Pos(Copy(sl[i], 1, 1), ' 1234567890')>0 do begin
            ...
            frame.Position.Add(GLS.Utils.StrToFloatDef(tl[1]), GLS.Utils.StrToFloatDef(tl[2]), GLS.Utils.StrToFloatDef(tl[3]));
            v:=AffineVectorMake(GLS.Utils.StrToFloatDef(tl[4]), GLS.Utils.StrToFloatDef(tl[5]), GLS.Utils.StrToFloatDef(tl[6]));
         ...
         while sl[i]<>'end' do begin
            ...
            for k:=1 to 3 do with mesh do begin
                 ...
                 then begin
                   ...
                   nVert:=FindOrAdd(boneIDs, AffineVectorMake(GLS.Utils.StrToFloatDef(tl[1]), GLS.Utils.StrToFloatDef(tl[2]), GLS.Utils.StrToFloatDef(tl[3])),                                AffineVectorMake(GLS.Utils.StrToFloatDef(tl[4]), GLS.Utils.StrToFloatDef(tl[5]), GLS.Utils.StrToFloatDef(tl[6])));
                   nTex:=TexCoords.FindOrAdd(AffineVectorMake(GLS.Utils.StrToFloatDef(tl[7]), GLS.Utils.StrToFloatDef(tl[8]), 0));
                 ...
                 begin
                   ...
                   nVert:=FindOrAdd(boneID,AffineVectorMake(GLS.Utils.StrToFloatDef(tl[1]), GLS.Utils.StrToFloatDef(tl[2]), GLS.Utils.StrToFloatDef(tl[3])),                                AffineVectorMake(GLS.Utils.StrToFloatDef(tl[4]), GLS.Utils.StrToFloatDef(tl[5]), GLS.Utils.StrToFloatDef(tl[6])));
                   nTex:=TexCoords.FindOrAdd(AffineVectorMake(GLS.Utils.StrToFloatDef(tl[7]), GLS.Utils.StrToFloatDef(tl[8]), 0));
                   faceGroup.Add(nVert, nVert, nTex);
                   Inc(i);
                 end;
