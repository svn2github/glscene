...
uses
  GLS.VectorGeometry, GLS.Utils, GLS.Types;
// ------------------
// ------------------ TVKTINVectorFile ------------------
// ------------------
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if tl.Count = 9 then
        begin
            SetVector(v1, GLS.Utils.StrToFloatDef(tl[0],0), GLS.Utils.StrToFloatDef(tl[1],0), GLS.Utils.StrToFloatDef(tl[2],0));
            SetVector(v2, GLS.Utils.StrToFloatDef(tl[3],0), GLS.Utils.StrToFloatDef(tl[4],0), GLS.Utils.StrToFloatDef(tl[5],0));
            SetVector(v3, GLS.Utils.StrToFloatDef(tl[6],0), GLS.Utils.StrToFloatDef(tl[7],0), GLS.Utils.StrToFloatDef(tl[8],0));
